...
%changelog
* Mon Jan 19 2026 Grigory Ustinov <grenka@altlinux.org> 4.3.1-alt1
- Automatically updated to 4.3.1.

* Tue Oct 14 2025 Grigory Ustinov <grenka@altlinux.org> 4.2.0-alt1
- Automatically updated to 4.2.0.

* Wed Jun 25 2025 Grigory Ustinov <grenka@altlinux.org> 4.1.0-alt1
...
* Tue Mar 18 2025 Grigory Ustinov <grenka@altlinux.org> 3.4.4-alt1
- Automatically updated to 3.4.4.

* Thu Oct 31 2024 Grigory Ustinov <grenka@altlinux.org> 3.4.3-alt1
