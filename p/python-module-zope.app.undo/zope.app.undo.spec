...
%py3_requires zope.app zope.app.security zope.component zope.interface
%py3_requires zope.location zope.publisher zope.security zope.traversing
...
%py3_requires zope.app.testing zope.app.component zope.site zope.testing
