...
BuildRequires: perl(Benchmark.pm) perl(Carp.pm) perl(Exporter.pm) perl(ExtUtils/MakeMaker.pm) perl(File/Slurp.pm) perl(File/Spec/Functions.pm) perl(File/Temp.pm) perl(Test/More.pm) perl(Unicode/UTF8.pm) perl(constant.pm) perl(strict.pm) perl(warnings.pm)
