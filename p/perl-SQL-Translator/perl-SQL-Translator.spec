...
Source0: http://www.cpan.org/authors/id/V/VE/VEESH/SQL-Translator-%{version}.tar.gz
...
%changelog
* Thu Apr 03 2025 Igor Vlasenko <viy@altlinux.org> 1.66-alt1
- automated CPAN update

* Fri Jan 26 2024 Igor Vlasenko <viy@altlinux.org> 1.65-alt1
- automated CPAN update

* Sat Dec 23 2023 Igor Vlasenko <viy@altlinux.org> 1.64-alt1
- automated CPAN update

* Sat Feb 25 2023 Igor Vlasenko <viy@altlinux.org> 1.63-alt1
- automated CPAN update

* Thu Oct 01 2020 Igor Vlasenko <viy@altlinux.ru> 1.62-alt1
- automated CPAN update

* Wed Apr 22 2020 Igor Vlasenko <viy@altlinux.ru> 1.61-alt1
- automated CPAN update
