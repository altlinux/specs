...
BuildPreReq: python-module-requests python-module-pkginfo
BuildPreReq: python-module-pretend python-module-nose
BuildPreReq: python-module-py
%if_with python3
BuildRequires(pre): rpm-build-python3
BuildPreReq: python3-devel python3-module-setuptools-tests
BuildPreReq: python3-module-requests python3-module-pkginfo
BuildPreReq: python3-module-pretend python3-module-nose
