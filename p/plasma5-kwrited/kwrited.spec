...
Provides: kf5-kwrited = %EVR
Obsoletes: kf5-kwrited < %EVR
...
Provides: kf5-kwrited-common = %EVR
Obsoletes: kf5-kwrited-common < %EVR
%description common
%name common package
...
Provides: kf5-kwrited-devel = %EVR
Obsoletes: kf5-kwrited-devel < %EVR
%description devel
...
- renamed kf5-kwrited -> plasma5-kwrited
