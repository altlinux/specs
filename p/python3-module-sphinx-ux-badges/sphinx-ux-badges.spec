...
%define pypi_name sphinx-ux-badges
%define module_name sphinx_ux_badges
...
Summary: API badge styling for Sphinx autodoc
License: MIT
Group: Development/Python3
Url: https://pypi.org/project/sphinx-ux-badges/
...
%description
API badge styling for Sphinx autodoc.
...
%check
cd %src_dir
%pyproject_run_pytest %tests_dir/ext/badges/
cd -
