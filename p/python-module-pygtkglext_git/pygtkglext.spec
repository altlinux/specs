...
# git://git.gnome.org/pygtkglext
Source: pygtkglext-%version.tar

# Automatically added by buildreq on Sun Jul 27 2008
BuildRequires: gcc-c++ libgtkglext-devel python-module-pygtk_git-devel
...
Requires: python-module-pygtk_git-devel
...
%prep
%setup
mv pygtkglext.pc.in pygtkglext_git.pc.in
...
%dir %python_sitelibdir/gtk-2.0/%qname
%python_sitelibdir/gtk-2.0/%qname/gdkgl
%python_sitelibdir/gtk-2.0/%qname/gtkgl

%files devel
%_datadir/pygtk_git/2.0/defs/
%_pkgconfigdir/*
...
* Sun Mar 13 2011 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 1.1.0-alt5.git20100112.1
- Rebuilt for debuginfo

* Tue Mar 02 2010 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 1.1.0-alt5.git20100112
- Created for use with pygtk_git
