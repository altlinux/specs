...
BuildRequires: perl-Class-C3-XS perl-Moose perl-Test-Exception perl-namespace-autoclean perl(List/MoreUtils.pm)
...
%changelog
* Wed Apr 22 2020 Igor Vlasenko <viy@altlinux.ru> 0.12-alt1.3
