...
%define pypi_name sphinx-autodoc-typehints-gp
%define module_name sphinx_autodoc_typehints_gp
...
Summary: Cross-referenced type annotations for Sphinx autodoc
License: MIT
Group: Development/Python3
Url: https://pypi.org/project/sphinx-autodoc-typehints-gp/
...
%pyproject_run_pytest %tests_dir/ext/typehints_gp/ \
