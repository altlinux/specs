...
echo "########################################################################"
echo "                             Attention!"
echo "               For PostgreSQL 16.2 and old need to run the file"
...
* Wed Feb 25 2026 Alexei Takaseev <taf@altlinux.org> 16.13-alt1
- 16.13

* Thu Feb 12 2026 Alexei Takaseev <taf@altlinux.org> 16.12-alt1
- 16.12 (Fixes CVE-2026-2003, CVE-2026-2004, CVE-2026-2005, CVE-2026-2006)

* Wed Jan 14 2026 Alexei Takaseev <taf@altlinux.org> 16.11-alt2
- Add Conflicts: 18-1C

* Wed Nov 12 2025 Alexei Takaseev <taf@altlinux.org> 16.11-alt1
- 16.11 (Fixes CVE-2025-12817, CVE-2025-12818)
- Use LLVM 20.1

* Wed Sep 24 2025 Alexei Takaseev <taf@altlinux.org> 16.10-alt2
...
* Wed Aug 13 2025 Alexei Takaseev <taf@altlinux.org> 16.10-alt1
- 16.10 (Fixes CVE-2025-8713, CVE-2025-8714, CVE-2025-8715)
...
* Tue Apr 08 2025 Alexei Takaseev <taf@altlinux.org> 16.8-alt3
- Rollback change log_directory from 16.8-alt2
- Set path to logfile via /etc/sysconfig/postgresql
- Enable checksums by default

* Tue Apr 01 2025 Alexei Takaseev <taf@altlinux.org> 16.8-alt2
- Add catalog /var/log/postgres for logs
- Use LLVM 19.1
- Enable JIT on loongarch64 and Disable on E2K

* Tue Feb 18 2025 Alexei Takaseev <taf@altlinux.org> 16.8-alt1
- 16.8 (Fixes CVE-2025-1094)

* Fri Feb 14 2025 Alexei Takaseev <taf@altlinux.org> 16.6-alt5
...
* Sat Feb 08 2025 Alexei Takaseev <taf@altlinux.org> 16.6-alt4
...
* Wed Nov 20 2024 Alexei Takaseev <taf@altlinux.org> 16.6-alt1
- 16.6

* Wed Nov 13 2024 Alexei Takaseev <taf@altlinux.org> 16.5-alt1
- 16.5 (Fixes CVE-2024-10976, CVE-2024-10977, CVE-2024-10978, CVE-2024-10979)
- Fix build by GCC > 13 and LLVM > 15 (drop patch 0002-Fix-search-for-setproctitle.patch)

* Thu Oct 31 2024 Alexei Takaseev <taf@altlinux.org> 16.4-alt4
- Use GCC 13
...
* Thu May 23 2024 Alexei Takaseev <taf@altlinux.org> 16.3-alt2
- Conflicts: 15-1C -> 16-1C

* Sat May 11 2024 Alexei Takaseev <taf@altlinux.org> 16.3-alt1
