...
%define pypi_name sphinx-vite-builder
%define module_name sphinx_vite_builder
...
Summary: Vite-based build backend for Sphinx themes
License: MIT
Group: Development/Python3
Url: https://pypi.org/project/sphinx-vite-builder/
...
%description
Vite-based build backend for Sphinx themes.
...
%check
cd %src_dir
%pyproject_run_pytest %tests_dir/test_sphinx_vite_builder*.py
cd -
