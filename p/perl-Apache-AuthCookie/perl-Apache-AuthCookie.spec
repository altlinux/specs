...
BuildRequires: apache2-mod_perl apache-mod_perl perl-CGI perl-libwww perl(Class/Load.pm) perl(autobox.pm) perl(Apache/TestMM.pm) perl(WWW/Form/UrlEncoded.pm) perl(Hash/MultiValue.pm) perl(HTTP/Body.pm)
