...
BuildRequires: libgmp-devel perl-devel perl(Devel/CheckLib.pm) perl(Alien/Base/Wrapper.pm) perl(Alien/GMP.pm) perl(Alien/Role/Alt.pm) perl(Class/Method/Modifiers.pm)
...
%files
%doc Changes COPYING.LIB README.md
%perl_vendor_archlib/Math
%perl_vendor_autolib/Math

%changelog
* Fri Mar 25 2022 Igor Vlasenko <viy@altlinux.org> 2.25-alt1
- automated CPAN update

* Tue Nov 23 2021 Igor Vlasenko <viy@altlinux.org> 2.24-alt1
- automated CPAN update

* Fri Nov 05 2021 Igor Vlasenko <viy@altlinux.org> 2.23-alt1
- automated CPAN update

* Fri Sep 24 2021 Igor Vlasenko <viy@altlinux.org> 2.22-alt1
- automated CPAN update

* Fri Sep 17 2021 Igor Vlasenko <viy@altlinux.org> 2.21-alt1
- automated CPAN update

* Wed Feb 12 2020 Igor Vlasenko <viy@altlinux.ru> 2.20-alt1
- automated CPAN update

* Thu Jan 24 2019 Igor Vlasenko <viy@altlinux.ru> 2.19-alt1.1
- rebuild with new perl 5.28.1

* Thu Apr 12 2018 Igor Vlasenko <viy@altlinux.ru> 2.19-alt1
- automated CPAN update

* Sat Apr 07 2018 Igor Vlasenko <viy@altlinux.ru> 2.18-alt1
- automated CPAN update

* Thu Apr 05 2018 Igor Vlasenko <viy@altlinux.ru> 2.17-alt1
- automated CPAN update
