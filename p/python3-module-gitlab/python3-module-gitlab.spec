...
%changelog
* Thu May 28 2026 Alexander Makeenkov <amakeenk@altlinux.org> 8.4.0-alt1
- Updated to version 8.4.0.

* Wed Apr 29 2026 Egor Ignatov <egori@altlinux.org> 8.3.0-alt1
- New version 8.3.0.

* Wed Apr 08 2026 Egor Ignatov <egori@altlinux.org> 8.2.0-alt1
...
* Sun Jan 18 2026 Alexander Makeenkov <amakeenk@altlinux.org> 7.1.0-alt1
- Updated to version 7.1.0.

* Sat Nov 01 2025 Alexander Makeenkov <amakeenk@altlinux.org> 7.0.0-alt1
...
* Thu Jun 19 2025 Alexander Makeenkov <amakeenk@altlinux.org> 6.0.0-alt1
- Updated to version 6.0.0.

* Mon Feb 17 2025 Alexander Makeenkov <amakeenk@altlinux.org> 5.6.0-alt1
- Updated to version 5.6.0.

* Tue Jan 07 2025 Alexander Makeenkov <amakeenk@altlinux.org> 5.3.1-alt1
- Updated to version 5.3.1.

* Sat Dec 28 2024 Alexander Makeenkov <amakeenk@altlinux.org> 5.3.0-alt1
