...
Version: 3.4.0
#Release: alt3.1
Summary: Zope 3 Skin Container Package
License: ZPLv2.1
Group: Development/Python
Url: http://pypi.python.org/pypi/zope.app.skins/
...
%py_requires zope.app zope.deprecation

%description
A meta-package in which generated skin interfaces are placed.

%package -n python3-module-%oname
Summary: Zope 3 Skin Container Package
Group: Development/Python3
%py3_requires zope.app zope.deprecation
...
* Fri Jul 25 2014 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 3.4.0-alt3
