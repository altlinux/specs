...
%changelog
* Fri Sep 04 2026 Alexander Makeenkov <amakeenk@altlinux.org> 1.15.0-alt1
- Updated to version 1.15.0.

* Sat Jul 25 2026 Alexander Makeenkov <amakeenk@altlinux.org> 1.14.0-alt1
- Updated to version 1.14.0.

* Sat May 23 2026 Alexander Makeenkov <amakeenk@altlinux.org> 1.13.0-alt1
- Updated to version 1.13.0.

* Sat May 09 2026 Alexander Makeenkov <amakeenk@altlinux.org> 1.12.1-alt1
- Updated to version 1.12.1.

* Sun Jan 18 2026 Alexander Makeenkov <amakeenk@altlinux.org> 1.11.1-alt1
- Updated to version 1.11.1.

* Sat Nov 08 2025 Alexander Makeenkov <amakeenk@altlinux.org> 1.11.0-alt1
...
* Sat Jan 20 2024 Alexander Makeenkov <amakeenk@altlinux.org> 1.5.0-alt1
