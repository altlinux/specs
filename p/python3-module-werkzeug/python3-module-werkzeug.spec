...
* Tue Mar 24 2026 Anton Zhukharev <ancieg@altlinux.org> 3.1.7-alt1
- Updated to 3.1.7.
...
* Tue Dec 02 2025 Anton Zhukharev <ancieg@altlinux.org> 3.1.4-alt2
- Fixed check dependencies source after 3.1.4-alt1.

* Sat Nov 29 2025 Andrey Cherepanov <cas@altlinux.org> 3.1.4-alt1
- New version.

* Mon Nov 11 2024 Anton Zhukharev <ancieg@altlinux.org> 3.1.3-alt1
- Updated to 3.1.3.

* Thu Oct 31 2024 Anton Zhukharev <ancieg@altlinux.org> 3.0.6-alt1
- Updated to 3.0.6.

* Fri Oct 25 2024 Anton Zhukharev <ancieg@altlinux.org> 3.0.5-alt1
- Updated to 3.0.5.

* Mon Aug 26 2024 Anton Zhukharev <ancieg@altlinux.org> 3.0.4-alt1
- Updated to 3.0.4.
