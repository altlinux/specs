...
%changelog
* Sun May 10 2026 Ajrat Makhmutov <rauty@altlinux.org> 1.0.5-alt4
- Fix FTBFS: Add perl(diagnostics.pm) to the BuildRequires for tests.

* Thu Jan 24 2019 Igor Vlasenko <viy@altlinux.ru> 1.0.5-alt3.2
