...
%changelog
* Wed Sep 17 2025 Igor Vlasenko <viy@altlinux.org> 2.29-alt1
- automated CPAN update

* Thu Apr 24 2025 Igor Vlasenko <viy@altlinux.org> 2.28-alt1
- automated CPAN update

* Thu Apr 03 2025 Igor Vlasenko <viy@altlinux.org> 2.27-alt1
- automated CPAN update

* Tue Feb 06 2024 Igor Vlasenko <viy@altlinux.org> 2.26-alt1
- automated CPAN update

* Thu Dec 29 2022 Igor Vlasenko <viy@altlinux.org> 2.24-alt1
- automated CPAN update

* Sat Dec 24 2022 Igor Vlasenko <viy@altlinux.org> 2.23-alt1
- automated CPAN update

* Mon Nov 01 2021 Igor Vlasenko <viy@altlinux.org> 2.22-alt1
- automated CPAN update

* Thu Jun 10 2021 Igor Vlasenko <viy@altlinux.org> 2.21-alt1
- automated CPAN update

* Wed Apr 28 2021 Igor Vlasenko <viy@altlinux.org> 2.20-alt1
- automated CPAN update
