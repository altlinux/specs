...
BuildRequires: libjq-devel python-module-Cython python-module-html5lib python-module-nose python-module-notebook python-module-setuptools-tests python-module-tox python3-module-Cython python3-module-html5lib python3-module-nose python3-module-notebook python3-module-setuptools-tests python3-module-tox rpm-build-python3 time
