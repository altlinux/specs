...
BuildArch: noarch
BuildRequires: perl(Test/Requires.pm) perl(Try/Tiny.pm) perl(URI/Escape.pm) perl(HTTP/Request/Common.pm) perl-devel perl(CPAN/Meta.pm) perl(Module/Build.pm) perl(CPAN/Meta/Prereqs.pm)
