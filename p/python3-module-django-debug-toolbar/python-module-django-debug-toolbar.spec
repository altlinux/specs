...
%changelog
* Mon Sep 21 2026 Alexander Burmatov <thatman@altlinux.org> 8.0.0-alt1
- new version 8.0.0.

* Thu Aug 27 2026 Alexander Burmatov <thatman@altlinux.org> 7.1.1-alt1
- new version 7.1.1.

* Wed Aug 12 2026 Alexander Burmatov <thatman@altlinux.org> 7.1.0-alt1
- new version 7.1.0.
...
* Wed Jan 21 2026 Alexander Burmatov <thatman@altlinux.org> 6.2.0-alt1
- new version 6.2.0.

* Wed Nov 12 2025 Alexander Burmatov <thatman@altlinux.org> 6.1.0-alt1
- new version 6.1.0.

* Wed Oct 15 2025 Alexander Burmatov <thatman@altlinux.org> 6.0.0-alt1
- new version 6.0.0.

* Mon May 12 2025 Alexander Burmatov <thatman@altlinux.org> 5.2.0-alt1
- new version 5.2.0.

* Sat Apr 26 2025 Alexander Burmatov <thatman@altlinux.org> 5.1.0-alt1
- new version 5.1.0.

* Thu Jan 30 2025 Alexander Burmatov <thatman@altlinux.org> 5.0.1-alt1
- new version 5.0.1.
