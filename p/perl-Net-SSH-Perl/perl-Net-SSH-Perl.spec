...
BuildRequires: perl-Crypt-DH perl-Crypt-DSA perl-Crypt-IDEA perl-Crypt-RSA perl-devel perl-Digest-BubbleBabble perl-Digest-HMAC perl-Math-GMP perl-String-CRC32 perl-Crypt-Blowfish perl-Crypt-DES perl-Math-BigInt-GMP perl-Crypt-DES_EDE3 perl(File/HomeDir.pm)
