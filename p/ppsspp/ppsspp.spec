...
Source4: https://github.com/hrydgard/ppsspp-lang/archive/%ppsspp_lang_commit/ppsspp-lang-%ppsspp_lang_commit.tar.gz
Source5: https://github.com/KhronosGroup/SPIRV-Cross/archive/%spirv_cross_commit/SPIRV-Cross-%spirv_cross_commit.tar.gz
Source6: %name.desktop
Source7: %name-qt.desktop

Patch0: %name-alt-libpng.patch
...
%__install -Dp -m0644 %SOURCE6 %buildroot%_desktopdir/
