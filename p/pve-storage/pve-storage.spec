...
%changelog
* Thu Aug 13 2026 Sergey Konev <darisishe@altlinux.org> 9.1.6-alt2
- zfspool: pass 'zfs send -U' only if zfs supports it (Closes: 60145)
...
* Tue Apr 16 2024 Andrew A. Vasilyev <andy@altlinux.org> 8.1.5-alt1
- 8.1.5

* Fri Mar 29 2024 Andrew A. Vasilyev <andy@altlinux.org> 8.1.4-alt1
- 8.1.4
