...
%changelog
* Tue May 05 2026 Alexander Danilov <admsasha@altlinux.org> 1.3.12-alt1
- New version 1.3.12 (Fixes: CVE-2026-41205).

* Fri Apr 11 2025 Grigory Ustinov <grenka@altlinux.org> 1.3.10-alt1
- Automatically updated to 1.3.10.

* Wed Feb 05 2025 Grigory Ustinov <grenka@altlinux.org> 1.3.9-alt1
- Automatically updated to 1.3.9.

* Mon Dec 30 2024 Grigory Ustinov <grenka@altlinux.org> 1.3.8-alt1
- Automatically updated to 1.3.8.

* Thu Dec 05 2024 Grigory Ustinov <grenka@altlinux.org> 1.3.7-alt1
- Automatically updated to 1.3.7.

* Tue Oct 22 2024 Grigory Ustinov <grenka@altlinux.org> 1.3.6-alt1
...
* Tue Jan 23 2024 Grigory Ustinov <grenka@altlinux.org> 1.3.1-alt1
