...
%changelog
* Sat Oct 25 2025 Grigory Ustinov <grenka@altlinux.org> 1.7.3-alt1
- Automatically updated to 1.7.3.

* Tue Nov 12 2024 Grigory Ustinov <grenka@altlinux.org> 1.6.10-alt1
- Automatically updated to 1.6.10.

* Fri Nov 08 2024 Grigory Ustinov <grenka@altlinux.org> 1.6.9-alt1
- Automatically updated to 1.6.9.

* Thu Nov 07 2024 Grigory Ustinov <grenka@altlinux.org> 1.6.8-alt1
- Automatically updated to 1.6.8.

* Wed Nov 06 2024 Grigory Ustinov <grenka@altlinux.org> 1.6.6-alt1
- Automatically updated to 1.6.6.

* Sat Nov 02 2024 Grigory Ustinov <grenka@altlinux.org> 1.6.4-alt1
- Automatically updated to 1.6.4.

* Fri Nov 01 2024 Grigory Ustinov <grenka@altlinux.org> 1.6.3-alt1
