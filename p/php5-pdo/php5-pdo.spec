%define		php5_extension	pdo

Name:	 	php5-%php5_extension
Version:	%php5_version
Release:	%php5_release

Summary:	PHP5 Data Objects Interface
...
- Fix PHP warning on module load (Closes: #18527)
...
- Rebuild to fix Requires on pdo_* modules (#15580)

* Tue Apr 15 2008 Nikolay A. Fetisov <naf@altlinux.ru> 5.2.5-alt1.1
- PDO is a standart PHP extention now, use sources from PHP distribution
