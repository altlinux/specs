...
Release: alt1.git20150122.1.1.1
%define mname kids
...
%changelog
* Tue May 24 2016 Ivan Zakharyaschev <imz@altlinux.org> 0.0.1-alt1.git20150122.1.1.1
- (AUTO) subst_x86_64.

* Sun Mar 13 2016 Ivan Zakharyaschev <imz@altlinux.org> 0.0.1-alt1.git20150122.1.1
