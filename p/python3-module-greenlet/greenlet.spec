...
%changelog
* Thu Jul 23 2026 Sergey Bolshakov <sbolshakov@altlinux.org> 3.5.4-alt1
- 3.5.4 released

* Mon Feb 23 2026 Grigory Ustinov <grenka@altlinux.org> 3.3.2-alt1
- Automatically updated to 3.3.2.

* Mon Jan 26 2026 Grigory Ustinov <grenka@altlinux.org> 3.3.1-alt1
- Automatically updated to 3.3.1.

* Tue Aug 19 2025 Grigory Ustinov <grenka@altlinux.org> 3.2.4-alt1
- Automatically updated to 3.2.4.

* Tue Jun 24 2025 Grigory Ustinov <grenka@altlinux.org> 3.2.3-alt1
- Automatically updated to 3.2.3.

* Mon May 12 2025 Grigory Ustinov <grenka@altlinux.org> 3.2.2-alt1
- Automatically updated to 3.2.2.

* Thu Apr 24 2025 Grigory Ustinov <grenka@altlinux.org> 3.2.1-alt1
- Automatically updated to 3.2.1.

* Wed Apr 16 2025 Grigory Ustinov <grenka@altlinux.org> 3.2.0-alt1
- Automatically updated to 3.2.0.

* Thu Oct 03 2024 Grigory Ustinov <grenka@altlinux.org> 3.1.1-alt1
