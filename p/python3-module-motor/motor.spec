...
%changelog
* Thu May 15 2025 Grigory Ustinov <grenka@altlinux.org> 3.7.1-alt1
- Automatically updated to 3.7.1.

* Fri Jan 31 2025 Grigory Ustinov <grenka@altlinux.org> 3.7.0-alt1
- Automatically updated to 3.7.0.

* Wed Jan 15 2025 Grigory Ustinov <grenka@altlinux.org> 3.6.1-alt1
- Automatically updated to 3.6.1.

* Wed Sep 25 2024 Grigory Ustinov <grenka@altlinux.org> 3.6.0-alt1
