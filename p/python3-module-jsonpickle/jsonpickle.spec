...
* Tue Jun 03 2025 Anton Vyatkin <toni@altlinux.org> 4.1.1-alt1
- New version 4.1.1.

* Thu May 22 2025 Anton Vyatkin <toni@altlinux.org> 4.1.0-alt1
- New version 4.1.0.

* Sat Mar 29 2025 Anton Vyatkin <toni@altlinux.org> 4.0.5-alt1
- New version 4.0.5.

* Fri Mar 28 2025 Anton Vyatkin <toni@altlinux.org> 4.0.4-alt1
- New version 4.0.4.

* Tue Feb 18 2025 Anton Vyatkin <toni@altlinux.org> 4.0.2-alt1
- New version 4.0.2.

* Mon Dec 16 2024 Anton Vyatkin <toni@altlinux.org> 4.0.1-alt1
- New version 4.0.1.

* Mon Nov 18 2024 Anton Vyatkin <toni@altlinux.org> 4.0.0-alt1
- New version 4.0.0.
...
* Mon Jun 10 2024 Anton Vyatkin <toni@altlinux.org> 3.2.1-alt1
- New version 3.2.1.

* Sat Apr 13 2024 Anton Vyatkin <toni@altlinux.org> 3.0.4-alt1
- New version 3.0.4.

* Tue Feb 20 2024 Anton Vyatkin <toni@altlinux.org> 3.0.3-alt1
- New version 3.0.3.

* Tue Jan 23 2024 Anton Vyatkin <toni@altlinux.org> 3.0.2-alt1.2
- NMU: fix FTBFS.
