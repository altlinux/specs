...
BuildRequires: perl-Module-Build perl(Test/Inter.pm) perl(Test/Pod.pm) perl(Test/Pod/Coverage.pm) perl(File/Find/Rule.pm)
...
%changelog
* Wed Sep 17 2025 Igor Vlasenko <viy@altlinux.org> 3.85-alt1
- automated CPAN update

* Fri Jun 13 2025 Igor Vlasenko <viy@altlinux.org> 3.84-alt1
- automated CPAN update

* Thu Apr 03 2025 Igor Vlasenko <viy@altlinux.org> 3.82-alt1
- automated CPAN update

* Tue Mar 19 2024 Igor Vlasenko <viy@altlinux.org> 3.78-alt1
- automated CPAN update

* Tue Dec 05 2023 Igor Vlasenko <viy@altlinux.org> 3.77-alt1
- automated CPAN update

* Wed Sep 06 2023 Igor Vlasenko <viy@altlinux.org> 3.76-alt1
- automated CPAN update

* Sun Sep 03 2023 Igor Vlasenko <viy@altlinux.org> 3.75-alt1
- automated CPAN update

* Tue Jun 13 2023 Igor Vlasenko <viy@altlinux.org> 3.74-alt1
- automated CPAN update

* Fri Mar 10 2023 Igor Vlasenko <viy@altlinux.org> 3.73-alt1
- automated CPAN update

* Fri Sep 02 2022 Igor Vlasenko <viy@altlinux.org> 3.72-alt1
- automated CPAN update

* Thu Jun 02 2022 Igor Vlasenko <viy@altlinux.org> 3.71-alt1
- automated CPAN update

* Fri Mar 25 2022 Igor Vlasenko <viy@altlinux.org> 3.70-alt1
- automated CPAN update

* Sun Dec 05 2021 Igor Vlasenko <viy@altlinux.org> 3.69-alt1
- automated CPAN update

* Mon Sep 06 2021 Igor Vlasenko <viy@altlinux.org> 3.68-alt1
- automated CPAN update

* Wed Mar 03 2021 Igor Vlasenko <viy@altlinux.org> 3.67-alt1
- automated CPAN update
...
* Fri Jun 05 2020 Igor Vlasenko <viy@altlinux.ru> 3.64-alt1
- automated CPAN update

* Sat Mar 14 2020 Igor Vlasenko <viy@altlinux.ru> 3.63-alt1
- automated CPAN update

* Wed Sep 11 2019 Igor Vlasenko <viy@altlinux.ru> 3.62-alt1
- automated CPAN update

* Wed Jun 05 2019 Igor Vlasenko <viy@altlinux.ru> 3.61-alt1
- automated CPAN update
