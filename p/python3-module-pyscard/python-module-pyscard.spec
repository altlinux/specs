...
License: LGPL-2.0-or-later AND Python AND CC-BY-SA-3.0
Group: Development/Python3
URL: https://sourceforge.net/projects/pyscard/
VCS: https://github.com/LudovicRousseau/pyscard
...
%doc src/smartcard/Examples
%python3_sitelibdir/smartcard
%python3_sitelibdir/%rname-%version.dist-info

%changelog
* Wed Jul 29 2026 Anton Midyukov <antohami@altlinux.org> 2.3.1-alt1
- New version.
- Fix License tag.
