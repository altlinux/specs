...
# Automatically added by buildreq on Tue Dec 20 2022
# optimized out: cmake-modules glibc-kernheaders-generic glibc-kernheaders-x86 libcrypt-devel libgpg-error libgpg-error-devel libncurses-devel libprotobuf-devel libsasl2-3 libstdc++-devel libtinfo-devel mpdecimal perl pkg-config python3 python3-base python3-module-Pygments python3-module-alabaster python3-module-babel python3-module-charset-normalizer python3-module-docutils python3-module-idna python3-module-imagesize python3-module-jinja2 python3-module-markupsafe python3-module-packaging python3-module-pytz python3-module-requests python3-module-sphinx python3-module-urllib3 sh4 xz zlib-devel
BuildRequires: cmake gcc-c++ libaio-devel libcurl-devel libev-devel libgcrypt-devel
BuildRequires: libldap-devel libprotobuf-lite-devel libsasl2-devel libssl-devel
...
%changelog
* Tue Dec 20 2022 Alexei Takaseev <taf@altlinux.org> 2.4.27-alt1
