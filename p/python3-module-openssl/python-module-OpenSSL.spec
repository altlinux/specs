...
%changelog
* Tue Aug 11 2026 Vladimir Didenko <cow@altlinux.org> 26.4.0-alt1
- new version 26.4.0

* Thu Jun 25 2026 Vladimir Didenko <cow@altlinux.org> 26.3.0-alt1
- new version 26.3.0

* Mon May 25 2026 Vladimir Didenko <cow@altlinux.org> 26.2.0-alt1
- new version 26.2.0

* Tue Oct 14 2025 Vladimir Didenko <cow@altlinux.org> 25.3.0-alt1
- new version 25.3.0

* Tue May 27 2025 Stanislav Levin <slev@altlinux.org> 25.1.0-alt1.1
- NMU: added runtime dependency on typing-extensions for Python 3.12 and earlier

* Thu May 22 2025 Vitaly Lipatov <lav@altlinux.ru> 25.1.0-alt1
- new version 25.1.0 (with rpmrb script)
- update strict requires for cryptography (up to 46.0)

* Thu Jan 9 2025 Vladimir Didenko <cow@altlinux.org> 24.3.0-alt1
- new version 24.3.0

* Tue Jul 23 2024 Vladimir Didenko <cow@altlinux.org> 24.2.1-alt1
- new version 24.2.1

* Sun Feb 18 2024 Vitaly Lipatov <lav@altlinux.ru> 24.0.0-alt1
- new version 24.0.0 (with rpmrb script)
- update strict requires for cryptography (up to 43.0)

* Sun Feb 18 2024 Vitaly Lipatov <lav@altlinux.ru> 23.2.0-alt2
- add strict requires for cryptography (ALT bug 44944)
