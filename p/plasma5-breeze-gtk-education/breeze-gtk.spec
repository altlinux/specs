...
Summary: Breeze GTK2/3 theme (version for Education)
...
%description
This is GTK2/3 port of default KDE Breeze style (version for Education).

%package -n gtk-theme-breeze-education
Group: Graphical desktop/KDE
Summary: %summary
