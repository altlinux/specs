...
%changelog
* Thu Feb 26 2026 Grigory Ustinov <grenka@altlinux.org> 1.9.4-alt1
- Automatically updated to 1.9.4.

* Mon Jan 19 2026 Grigory Ustinov <grenka@altlinux.org> 1.9.3-alt1
- Automatically updated to 1.9.3.

* Mon Jul 07 2025 Grigory Ustinov <grenka@altlinux.org> 1.8.6-alt1
- Automatically updated to 1.8.6.

* Tue Jun 24 2025 Grigory Ustinov <grenka@altlinux.org> 1.8.5-alt1
- Automatically updated to 1.8.5.

* Wed Feb 19 2025 Grigory Ustinov <grenka@altlinux.org> 1.8.3-alt1
- Automatically updated to 1.8.3.

* Wed Jan 15 2025 Grigory Ustinov <grenka@altlinux.org> 1.8.2-alt1
- Automatically updated to 1.8.2.

* Wed Nov 27 2024 Grigory Ustinov <grenka@altlinux.org> 1.8.0-alt1
- Automatically updated to 1.8.0.

* Wed Sep 25 2024 Grigory Ustinov <grenka@altlinux.org> 1.7.10-alt1
- Automatically updated to 1.7.10.
