...
BuildArch: noarch
BuildRequires: perl-Crypt-CBC perl-devel perl-Test-Exception perl-Dancer perl-String-CRC32 perl-Test-NoWarnings perl-Crypt-Rijndael perl-YAML perl(Session/Storage/Secure.pm) perl(Time/Duration/Parse.pm) perl(Plack/Test.pm) perl(Test/Requires.pm) perl(PerlX/Maybe.pm)
...
%files
%doc Changes README.mkdn LICENSE CONTRIBUTORS CONTRIBUTING.md
