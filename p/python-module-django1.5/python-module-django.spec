...
Name: python-module-%{oname}%branch
Version: %version
Release: %release
...
Conflicts: python-module-django-mod_python
...
Conflicts: python-module-django-dbbackend-mysql
...
Conflicts: python-module-django-dbbackend-psycopg
...
Conflicts: python-module-django-dbbackend-psycopg2
...
Conflicts: python-module-django-dbbackend-sqlite3

%description dbbackend-sqlite3
%summary

%if_with python3
%package -n python3-module-%{oname}%branch
...
Obsoletes: python3-module-%oname <= 1.5.0-alt1.alpha

%description -n python3-module-%{oname}%branch
%summary

%package -n python3-module-%{oname}%branch-tests
Summary: Tests for Django (Python 3)
Group: Development/Python3
BuildArch: noarch
Requires: python3-module-%{oname}%branch = %EVR
Provides: python3-module-%oname-tests = %EVR
Obsoletes: python3-module-%oname-tests <= 1.5.0-alt1.alpha
%add_python3_req_skip new

%description -n python3-module-%{oname}%branch-tests
%summary

This package contains tests for Django.

%package -n python3-module-%{oname}%branch-mod_python
Summary: mod_python support for Django (Python 3)
Group: Development/Python3
Requires: python3-module-%{oname}%branch = %EVR
Requires: apache2-mod_python
Provides: python3-module-%oname-mod_python = %EVR
Obsoletes: python3-module-%oname-mod_python <= 1.5.0-alt1.alpha

%description -n python3-module-%{oname}%branch-mod_python
%summary

%package -n python3-module-%{oname}%branch-dbbackend-mysql
Summary: MySQLSQL support for Django (Python 3)
Group: Development/Python3
Requires: python3-module-%{oname}%branch = %EVR
Provides: python3-module-%oname-dbbackend-mysql = %EVR
Obsoletes: python3-module-%oname-dbbackend-mysql <= 1.5.0-alt1.alpha
%py3_requires MySQLdb

%description -n python3-module-%{oname}%branch-dbbackend-mysql
%summary

%package -n python3-module-%{oname}%branch-dbbackend-psycopg
Summary: PostgreSQL support for Django. (via psycopg) (Python 3)
Group: Development/Python3
Requires: python3-module-%{oname}%branch = %EVR
Provides: python3-module-%oname-dbbackend-psycopg = %EVR
Obsoletes: python3-module-%oname-dbbackend-psycopg <= 1.5.0-alt1.alpha
%py3_requires psycopg

%description -n python3-module-%{oname}%branch-dbbackend-psycopg
%summary

%package -n python3-module-%{oname}%branch-dbbackend-psycopg2
Summary: PostgreSQL support for Django. (via psycopg2) (Python 3)
Group: Development/Python3
Requires: python3-module-%{oname}%branch = %EVR
Provides: python3-module-%oname-dbbackend-psycopg2 = %EVR
Obsoletes: python3-module-%oname-dbbackend-psycopg2 <= 1.5.0-alt1.alpha
%py3_requires psycopg2

%description -n python3-module-%{oname}%branch-dbbackend-psycopg2
%summary

%package -n python3-module-%{oname}%branch-dbbackend-sqlite3
Summary: SQLite3 support for Django (Python 3)
Group: Development/Python3
Requires: python3-module-%{oname}%branch = %EVR
Provides: python3-module-%oname-dbbackend-sqlite3 = %EVR
Obsoletes: python3-module-%oname-dbbackend-sqlite3 <= 1.5.0-alt1.alpha
%py3_requires sqlite3

%description -n python3-module-%{oname}%branch-dbbackend-sqlite3
%summary
...
Group: Development/Python
Provides: python3-module-%oname-doc = %EVR
Provides: python3-module-%{oname}%branch-doc = %EVR
Obsoletes: python3-module-%oname-doc <= 1.5.0-alt1.alpha
...
%if_with python3
%files -n python3-module-%{oname}%branch
...
%files -n python3-module-%{oname}%branch-tests
...
%if_with python3
#files -n python3-module-%{oname}%branch-mod_python
#python3_sitelibdir/%oname/core/handlers/modpython.py*
#python3_sitelibdir/%oname/contrib/auth/handlers/modpython.py*

%files -n python3-module-%{oname}%branch-dbbackend-mysql
%python3_sitelibdir/%oname/db/backends/mysql/

#files -n python3-module-%{oname}%branch-dbbackend-psycopg
#python3_sitelibdir/%oname/db/backends/postgresql/

%files -n python3-module-%{oname}%branch-dbbackend-psycopg2
%python3_sitelibdir/%oname/db/backends/postgresql_psycopg2/

%files -n python3-module-%{oname}%branch-dbbackend-sqlite3
