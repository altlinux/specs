...
%build
make PREFIX=%_prefix CFLAGS="$CFLAGS -Isrc/external/js0n -std=gnu17"

%install
make install PREFIX=%_prefix DESTDIR=%buildroot CFLAGS="$CFLAGS -Isrc/external/js0n -std=gnu17"
...
%changelog
* Tue Aug 04 2026 Aleksandr Shamaraev <shad@altlinux.org> 0.85.00-alt3
- fixed FTBFS (-std=gnu17)
- added libcanberra-gtk2 depencity

* Sun Jan 12 2025 Grigory Ustinov <grenka@altlinux.org> 0.85.00-alt2
- Cleanup spec.
