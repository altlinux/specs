...
%changelog
* Fri Aug 14 2026 Andrey Cherepanov <cas@altlinux.org> 4.1.5-alt1
- New version.

* Tue Jul 07 2026 Andrey Cherepanov <cas@altlinux.org> 4.1.4-alt1
- New version.
...
* Wed Sep 24 2025 Andrey Cherepanov <cas@altlinux.org> 4.1.0-alt1
- New version.

* Mon Sep 22 2025 Andrey Cherepanov <cas@altlinux.org> 4.0.7-alt1
- New version.

* Sat Jun 07 2025 Andrey Cherepanov <cas@altlinux.org> 4.0.6-alt1
- New version.

* Thu Feb 20 2025 Andrey Cherepanov <cas@altlinux.org> 4.0.5-alt1
- New version.
...
* Sat Oct 19 2024 Andrey Cherepanov <cas@altlinux.org> 4.0.3-alt1
- New version.

* Wed Sep 18 2024 Andrey Cherepanov <cas@altlinux.org> 4.0.2-alt1
- New version.

* Fri Aug 30 2024 Andrey Cherepanov <cas@altlinux.org> 4.0.1-alt1
- New version.

* Thu Aug 29 2024 Andrey Cherepanov <cas@altlinux.org> 4.0.0-alt1
- New version.

* Thu Jul 11 2024 Andrey Cherepanov <cas@altlinux.org> 3.3.2-alt1
- New version.

* Tue Jun 18 2024 Andrey Cherepanov <cas@altlinux.org> 3.3.1-alt1
- New version.

* Fri Apr 05 2024 Andrey Cherepanov <cas@altlinux.org> 3.3.0-alt1
- New version.

* Thu Jan 18 2024 Andrey Cherepanov <cas@altlinux.org> 3.2.2-alt1
- New version.
