...
BuildRequires: gcc-c++ libqpdf-devel python3-module-PasteScript python3-module-build python3-module-flit python3-module-mpl_toolkits python3-module-pybind11 python3-module-setuptools_scm python3-module-sphinxcontrib python3-module-wheel
