...
%changelog
* Wed Sep 23 2026 Evgeniy Martynenko <enimalojd@altlinux.org> 4.28.0-alt1
- New version (4.28.0).

* Mon Sep 21 2026 Evgeniy Martynenko <enimalojd@altlinux.org> 4.27.5-alt1
- New version (4.27.5).

* Thu Sep 17 2026 Evgeniy Martynenko <enimalojd@altlinux.org> 4.27.3-alt1
- New version (4.27.3).

* Wed Sep 16 2026 Evgeniy Martynenko <enimalojd@altlinux.org> 4.27.2-alt1
- New version (4.27.2).

* Sat Sep 12 2026 Evgeniy Martynenko <enimalojd@altlinux.org> 4.27.0-alt1
- New version (4.27.0).

* Thu Sep 10 2026 Evgeniy Martynenko <enimalojd@altlinux.org> 4.26.1-alt1
- New version (4.26.1).

* Tue Aug 25 2026 Evgeniy Martynenko <enimalojd@altlinux.org> 4.25.2-alt1
- New version (4.25.2).

* Mon Aug 24 2026 Evgeniy Martynenko <enimalojd@altlinux.org> 4.25.1-alt1
- New version (4.25.1).
...
* Wed Jul 22 2026 Evgeniy Martynenko <enimalojd@altlinux.org> 4.24.1-alt1
- New version (4.24.1).

* Wed Jul 08 2026 Evgeniy Martynenko <enimalojd@altlinux.org> 4.22.4-alt1
- New version (4.22.4).

* Mon Jul 06 2026 Evgeniy Martynenko <enimalojd@altlinux.org> 4.22.3-alt1
- New version (4.22.3).
