...
%changelog
* Mon Aug 26 2013 Vitaly Lipatov <lav@altlinux.ru> 1.4.5-alt2
- separate build 1.4.x for ALT Linux Sisyphus

* Fri Feb 22 2013 Aleksey Avdeev <solo@altlinux.ru> 1.4.5-alt1
- Version 1.4.5
