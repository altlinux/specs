...
%py3_requires zope.app zope.component zope.error zope.publisher
...
%changelog
* Tue Apr 30 2019 Grigory Ustinov <grenka@altlinux.org> 3.5.3-alt3.2
- Rebuild with python3.7.

* Mon Jun 06 2016 Ivan Zakharyaschev <imz@altlinux.org> 3.5.3-alt3.1.1
- (AUTO) subst_x86_64.
...
* Fri Jul 18 2014 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 3.5.3-alt3
