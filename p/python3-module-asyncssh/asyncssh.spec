...
%changelog
* Sun Jan 18 2026 Grigory Ustinov <grenka@altlinux.org> 2.22.0-alt1
- Automatically updated to 2.22.0.

* Sun Oct 12 2025 Grigory Ustinov <grenka@altlinux.org> 2.21.1-alt1
- Automatically updated to 2.21.1.

* Tue May 06 2025 Grigory Ustinov <grenka@altlinux.org> 2.21.0-alt1
- Automatically updated to 2.21.0.

* Wed Feb 26 2025 Grigory Ustinov <grenka@altlinux.org> 2.20.0-alt1
...
* Sun Oct 27 2024 Grigory Ustinov <grenka@altlinux.org> 2.18.0-alt1
- Automatically updated to 2.18.0.

* Mon Sep 30 2024 Grigory Ustinov <grenka@altlinux.org> 2.17.0-alt1
