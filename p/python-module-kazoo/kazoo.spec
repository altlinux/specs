...
BuildRequires: python-module-sphinx python-module-alabaster python-module-docutils python-module-html5lib python-module-objects.inv python-module-pbr python-module-eventlet python-module-gevent
