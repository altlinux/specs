...
Version: 2.0
Release: alt1.b10.git20120306
Summary: toscawidgets2 wrapper for elRTE
License: MIT
Group: Development/Python
Url: https://pypi.python.org/pypi/tw2.jqplugins.elrte/
Packager: Eugeny A. Rostovtsev (REAL) <real at altlinux.org>

# https://github.com/toscawidgets/tw2.jqplugins.elrte.git
# branch: develop
...
%description
tw2.jqplugins.elrte is a `toscawidgets2 (tw2)` wrapper for `elRTE`.
...
%files
%doc *.rst
%python_sitelibdir/tw2/jqplugins/elrte
%python_sitelibdir/*.egg-info

%if_with python3
%files -n python3-module-%oname
%doc *.rst
%python3_sitelibdir/tw2/jqplugins/elrte
%python3_sitelibdir/*.egg-info
%endif

%changelog
* Sat Feb 07 2015 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 2.0-alt1.b10.git20120306
