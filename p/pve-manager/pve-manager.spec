...
Requires: pve-container >= 5.1.11 pve-firewall pve-ha-manager pve-qemu-server >= 8.2.7 pve-i18n >= 1.0.3 pve-docs
...
BuildRequires: pve-storage >= 8.2.8 pve-cluster >= 7.2.3
BuildRequires: pve-common >= 8.2.6 pve-guest-common >= 5.1.4
BuildRequires: libpve-cluster-perl >= 6.1.6 libpve-cluster-api-perl >= 7.0.5 pve-container >= 5.1.11 pve-qemu-server >= 8.2.7
