...
%changelog
* Tue Jan 02 2024 Igor Vlasenko <viy@altlinux.org> 0.67-alt1
- automated CPAN update

* Fri May 20 2022 Igor Vlasenko <viy@altlinux.org> 0.66-alt1
- automated CPAN update

* Thu Apr 14 2022 Igor Vlasenko <viy@altlinux.org> 0.65-alt1
- automated CPAN update

* Wed Dec 29 2021 Igor Vlasenko <viy@altlinux.org> 0.64-alt1
- automated CPAN update

* Mon Oct 11 2021 Igor Vlasenko <viy@altlinux.org> 0.63-alt1
- automated CPAN update
...
* Wed Oct 24 2018 Igor Vlasenko <viy@altlinux.ru> 0.51-alt1
- automated CPAN update

* Wed Apr 25 2018 Igor Vlasenko <viy@altlinux.ru> 0.50-alt1
- automated CPAN update
