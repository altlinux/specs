...
BuildRequires: perl-Class-XSAccessor perl-Dist-Zilla-Plugin-Git perl-Module-Build-Tiny perl-Moose-Autobox perl-MooseX-Aliases perl-MooseX-Params-Validate perl-MooseX-SemiAffordanceAccessor perl-MooseX-StrictConstructor perl-Pod-Weaver perl-Ref-Util perl-Ref-Util-XS perl-Sub-Name perl-Test-Moose-More perl-YAML
...
%changelog
* Tue Nov 04 2025 Nikolay A. Fetisov <naf@altlinux.org> 3.005-alt1
- New version
