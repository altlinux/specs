...
%changelog
* Thu Feb 11 2021 Alexei Takaseev <taf@altlinux.org> 9.5.25-alt1
- 9.5.25
...
* Wed Aug 12 2020 Alexei Takaseev <taf@altlinux.org> 9.5.23-alt1
...
* Wed Nov 13 2019 Alexei Takaseev <taf@altlinux.org> 9.5.20-alt1
- 9.5.20

* Wed Aug 07 2019 Alexei Takaseev <taf@altlinux.org> 9.5.19-alt1
...
* Thu Apr 04 2019 Alexei Takaseev <taf@altlinux.org> 9.5.16-alt2
...
* Thu Feb 14 2019 Alexei Takaseev <taf@altlinux.org> 9.5.16-alt1
- 9.5.16
- Replace PreReq to Requires(pre)
- Remove deadcode for chroot

* Thu Jan 24 2019 Igor Vlasenko <viy@altlinux.ru> 9.5.15-alt1.1
- rebuild with new perl 5.28.1

* Thu Nov 08 2018 Alexei Takaseev <taf@altlinux.org> 9.5.15-alt1
- 9.5.15

* Fri Oct 19 2018 Alexei Takaseev <taf@altlinux.org> 9.5.14-alt4
- Disable package libs for --without devel. This will provide
  one set of libraries for all versions of the PG.

* Mon Oct 08 2018 Igor Vlasenko <viy@altlinux.ru> 9.5.14-alt3
- NMU: removed Provides: postgresql-perl from old postgresses

* Tue Sep 04 2018 Alexei Takaseev <taf@altlinux.org> 9.5.14-alt2
- Add BR: libkrb5-devel
- Rebuild with OpenSSL 1.1.x

* Sat Aug 11 2018 Alexei Takaseev <taf@altlinux.org> 9.5.14-alt1
- 9.5.14
- (Fixes CVE-2018-10915, CVE-2018-10925)

* Wed May 09 2018 Alexei Takaseev <taf@altlinux.org> 9.5.13-alt1
- 9.5.13
- (Fixes CVE-2018-1115)

* Fri Mar 02 2018 Alexei Takaseev <taf@altlinux.org> 9.5.12-alt1
- 9.5.12
- (Fixes CVE-2018-1058)

* Wed Feb 07 2018 Alexei Takaseev <taf@altlinux.org> 9.5.11-alt1
- 9.5.11

* Fri Feb 02 2018 Alexei Takaseev <taf@altlinux.org> 9.5.10-alt2
- Rename pg_rewind's copy_file_range() to avoid conflict with new linux syscall

* Fri Dec 15 2017 Igor Vlasenko <viy@altlinux.ru> 9.5.10-alt1.1
- rebuild with new perl 5.26.1

* Thu Nov 09 2017 Alexei Takaseev <taf@altlinux.org> 9.5.10-alt1
- 9.5.10
- Remove conflicts to PG 9.1, 9.2

* Thu Oct 05 2017 Alexei Takaseev <taf@altlinux.org> 9.5.9-alt2
- Add conflict to PG 10

* Wed Aug 30 2017 Alexei Takaseev <taf@altlinux.org> 9.5.9-alt1
- 9.5.9

* Wed Aug 09 2017 Alexei Takaseev <taf@altlinux.org> 9.5.8-alt1
- 9.5.8
- (Fixes CVE-2017-7547)

* Wed May 10 2017 Alexei Takaseev <taf@altlinux.org> 9.5.7-alt1
- 9.5.7

* Wed Mar 22 2017 Vladimir D. Seleznev <vseleznv@altlinux.org> 9.5.6-alt1.qa1
- NMU: rebuild against Tcl/Tk 8.6

* Sun Feb 12 2017 Alexei Takaseev <taf@altlinux.org> 9.5.6-alt1
- 9.5.6

* Fri Feb 03 2017 Igor Vlasenko <viy@altlinux.ru> 9.5.5-alt1.1
- rebuild with new perl 5.24.1

* Thu Oct 27 2016 Alexei Takaseev <taf@altlinux.org> 9.5.5-alt1
- 9.5.5
