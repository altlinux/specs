...
%changelog
* Tue Feb 17 2026 Grigory Ustinov <grenka@altlinux.org> 4.4.10-alt1
- Build new version.

* Wed Jan 28 2026 Grigory Ustinov <grenka@altlinux.org> 4.4.9-alt1
- Build new version.

* Sun Aug 03 2025 Grigory Ustinov <grenka@altlinux.org> 4.4.3-alt1
- Build new version.

* Mon Jul 07 2025 Grigory Ustinov <grenka@altlinux.org> 4.4.2-alt1
- Build new version.

* Tue Jun 03 2025 Grigory Ustinov <grenka@altlinux.org> 4.4.1-alt1
- Build new version.

* Tue Apr 22 2025 Grigory Ustinov <grenka@altlinux.org> 4.4.0-alt1
- Build new version.
