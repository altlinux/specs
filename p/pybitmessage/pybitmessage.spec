...
cat > %name <<@@@
#!/bin/sh
cd %python_sitelibdir_noarch/%name
...
mv %buildroot%_datadir/%name %buildroot%python_sitelibdir_noarch/%name
...
%changelog
* Mon Mar 31 2014 Fr. Br. George <george@altlinux.ru> 0.4.2-alt1
