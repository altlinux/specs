...
%changelog
* Mon Jan 26 2026 Grigory Ustinov <grenka@altlinux.org> 5.1.1-alt1
- Automatically updated to 5.1.1.

* Sun Jan 18 2026 Grigory Ustinov <grenka@altlinux.org> 5.1.0-alt1
- Automatically updated to 5.1.0.

* Thu Aug 21 2025 Grigory Ustinov <grenka@altlinux.org> 5.0.4-alt1
- Automatically updated to 5.0.4.

* Wed Jul 02 2025 Grigory Ustinov <grenka@altlinux.org> 5.0.3-alt1
- Automatically updated to 5.0.3.

* Tue Jun 24 2025 Grigory Ustinov <grenka@altlinux.org> 5.0.2-alt1
- Automatically updated to 5.0.2.

* Mon May 12 2025 Grigory Ustinov <grenka@altlinux.org> 5.0.1-alt1
...
* Mon Dec 30 2024 Grigory Ustinov <grenka@altlinux.org> 4.7.0-alt1
- Automatically updated to 4.7.0.

* Tue Oct 29 2024 Grigory Ustinov <grenka@altlinux.org> 4.6.0-alt1
...
* Mon Mar 18 2024 Grigory Ustinov <grenka@altlinux.org> 4.4.0-alt1
- Automatically updated to 4.4.0.

* Tue Mar 05 2024 Grigory Ustinov <grenka@altlinux.org> 4.3.0-alt1
- Automatically updated to 4.3.0.

* Tue Feb 06 2024 Grigory Ustinov <grenka@altlinux.org> 4.2.0-alt1
- Automatically updated to 4.2.0.

* Tue Aug 01 2023 Grigory Ustinov <grenka@altlinux.org> 4.1.5-alt1
- Automatically updated to 4.1.5.
