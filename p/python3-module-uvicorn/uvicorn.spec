...
%add_pyproject_deps_check_filter zttp
...
%check
%pyproject_run_pytest -k 'not websockets-sansio' tests
...
%changelog
* Wed Jul 29 2026 Sergey Bolshakov <sbolshakov@altlinux.org> 0.52.0-alt1
- 0.52.0 released

* Mon Jul 13 2026 Sergey Bolshakov <sbolshakov@altlinux.org> 0.51.0-alt1
- 0.51.0 released

* Wed Apr 22 2026 Sergey Bolshakov <sbolshakov@altlinux.org> 0.45.0-alt1
- 0.45.0 released

* Wed Apr 08 2026 Sergey Bolshakov <sbolshakov@altlinux.org> 0.44.0-alt1
- 0.44.0 released
