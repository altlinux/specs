...
%changelog
* Wed May 14 2025 Grigory Ustinov <grenka@altlinux.org> 0.27.1-alt1
- Automatically updated to 0.27.1.

* Tue May 13 2025 Grigory Ustinov <grenka@altlinux.org> 0.27.0-alt1
...
* Mon Nov 18 2024 Grigory Ustinov <grenka@altlinux.org> 0.25.3-alt1
- Automatically updated to 0.25.3.

* Mon Nov 11 2024 Grigory Ustinov <grenka@altlinux.org> 0.25.2-alt1
- Automatically updated to 0.25.2.
...
* Tue Apr 30 2024 Grigory Ustinov <grenka@altlinux.org> 0.24.0-alt1
- Automatically updated to 0.24.0.

* Tue Mar 26 2024 Grigory Ustinov <grenka@altlinux.org> 0.23.2-alt1
- Automatically updated to 0.23.2.

* Mon Mar 18 2024 Grigory Ustinov <grenka@altlinux.org> 0.23.1-alt1
- Automatically updated to 0.23.1.

* Mon Mar 11 2024 Grigory Ustinov <grenka@altlinux.org> 0.23.0-alt1
- Automatically updated to 0.23.0.

* Thu Dec 28 2023 Grigory Ustinov <grenka@altlinux.org> 0.21.0-alt1
- Automatically updated to 0.21.0.
