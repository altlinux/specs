...
Source0:    http://www.cpan.org/authors/id/B/BR/BRIANDFOY/%{upstream_name}-%{version}.tar.gz
...
%files
%doc Changes META.json META.yml eg examples README.pod SECURITY.md
%{perl_vendor_privlib}/*
...
* Fri Mar 22 2024 Igor Vlasenko <viy@altlinux.org> 1.296-alt1_1
- update by mgaimport

* Fri Jan 26 2024 Igor Vlasenko <viy@altlinux.org> 1.296-alt1
- automated CPAN update

* Thu Jan 20 2022 Igor Vlasenko <viy@altlinux.org> 1.295-alt1_1
- update by mgaimport

* Wed Jan 19 2022 Igor Vlasenko <viy@altlinux.org> 1.295-alt1
- automated CPAN update
