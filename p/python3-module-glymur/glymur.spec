...
BuildRequires: python3-module-osgeo
%endif
...
%changelog
* Thu Feb 05 2026 Grigory Ustinov <grenka@altlinux.org> 0.14.7-alt1
- Automatically updated to 0.14.7.

* Tue Jan 27 2026 Grigory Ustinov <grenka@altlinux.org> 0.14.6-alt1
- Automatically updated to 0.14.6.

* Mon Jan 26 2026 Grigory Ustinov <grenka@altlinux.org> 0.14.5-alt1
- Automatically updated to 0.14.5.

* Sun Oct 12 2025 Grigory Ustinov <grenka@altlinux.org> 0.14.4-alt1
...
* Wed Apr 09 2025 Grigory Ustinov <grenka@altlinux.org> 0.14.1-alt1
- Automatically updated to 0.14.1.

* Thu Mar 20 2025 Grigory Ustinov <grenka@altlinux.org> 0.14.0-alt1
- Automatically updated to 0.14.0.

* Wed Feb 05 2025 Grigory Ustinov <grenka@altlinux.org> 0.13.8-alt1
- Automatically updated to 0.13.8.

* Wed Jan 15 2025 Grigory Ustinov <grenka@altlinux.org> 0.13.7-alt1
- Automatically updated to 0.13.7.
