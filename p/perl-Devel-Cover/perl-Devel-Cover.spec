...
%files
%doc Changes docs README.md CLAUDE.md
...
%changelog
* Fri Aug 08 2025 Igor Vlasenko <viy@altlinux.org> 1.51-alt1
- automated CPAN update

* Fri Jun 13 2025 Igor Vlasenko <viy@altlinux.org> 1.50-alt1
- automated CPAN update
...
* Sun May 21 2023 Igor Vlasenko <viy@altlinux.org> 1.40-alt1
- automated CPAN update

* Sat Apr 29 2023 Igor Vlasenko <viy@altlinux.org> 1.39-alt1
- automated CPAN update
...
* Thu Sep 20 2018 Igor Vlasenko <viy@altlinux.ru> 1.31-alt1
- automated CPAN update

* Fri Jul 20 2018 Igor Vlasenko <viy@altlinux.ru> 1.30-alt1
- automated CPAN update
