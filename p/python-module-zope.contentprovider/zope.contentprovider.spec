...
BuildRequires: python-module-setuptools-tests python-module-zope.browserpage python-module-zope.testing python3-module-pytest python3-module-zope.browserpage python3-module-zope.testing rpm-build-python3
