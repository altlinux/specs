...
%define pypi_name sphinx-gp-highlighting
%define module_name sphinx_gp_highlighting
...
Summary: Code highlighting helpers for Sphinx
License: MIT
Group: Development/Python3
Url: https://pypi.org/project/sphinx-gp-highlighting/
...
%description
Code highlighting helpers for Sphinx.
...
%check
cd %src_dir
%pyproject_run_pytest %tests_dir/ext/highlighting/
cd -
