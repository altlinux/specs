...
%define pypi_name XStatic-moment
...
%changelog
* Tue Feb 11 2020 Andrey Bychkov <mrdrew@altlinux.org> 2.8.4.1-alt3
- Build for python2 disabled.

* Fri Feb 02 2018 Stanislav Levin <slev@altlinux.org> 2.8.4.1-alt2.1
- (NMU) Fix Requires and BuildRequires to python-setuptools

* Wed Jun 14 2017 Alexey Shabalin <shaba@altlinux.ru> 2.8.4.1-alt2
- build as noarch
