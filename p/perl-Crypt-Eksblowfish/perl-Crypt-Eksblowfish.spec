...
BuildRequires: perl(CPAN.pm) perl(Cwd.pm) perl(Encode.pm) perl(Exporter.pm) perl(File/Spec.pm) perl(MIME/Base64.pm) perl(XSLoader.pm) perl-Module-Build perl-devel perl-podlators
