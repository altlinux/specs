...
%changelog
* Wed Aug 05 2026 Alexander Burmatov <thatman@altlinux.org> 9.7.7-alt1
- Updated to 9.7.7.

* Mon Apr 13 2026 Alexander Burmatov <thatman@altlinux.org> 9.7.6-alt1
- Updated to 9.7.6.

* Wed Mar 18 2026 Alexander Burmatov <thatman@altlinux.org> 9.7.5-alt1
- Updated to 9.7.5.

* Wed Mar 04 2026 Alexander Burmatov <thatman@altlinux.org> 9.7.4-alt1
- Updated to 9.7.4.

* Wed Dec 24 2025 Alexander Burmatov <thatman@altlinux.org> 9.7.1-alt1
- Updated to 9.7.1.

* Wed Nov 26 2025 Alexander Burmatov <thatman@altlinux.org> 9.7.0-alt1
- Updated to 9.7.0.

* Wed Oct 15 2025 Alexander Burmatov <thatman@altlinux.org> 9.6.22-alt1
- Updated to 9.6.22.

* Mon Sep 22 2025 Alexander Burmatov <thatman@altlinux.org> 9.6.20-alt1
- Updated to 9.6.20.

* Wed Aug 27 2025 Alexander Burmatov <thatman@altlinux.org> 9.6.18-alt1
- Updated to 9.6.18.

* Mon Jul 28 2025 Alexander Burmatov <thatman@altlinux.org> 9.6.16-alt1
- Updated to 9.6.16.

* Wed May 28 2025 Alexander Burmatov <thatman@altlinux.org> 9.6.14-alt1
- Updated to 9.6.14.

* Thu Apr 17 2025 Alexander Burmatov <thatman@altlinux.org> 9.6.12-alt1
- Updated to 9.6.12.

* Tue Mar 25 2025 Alexander Burmatov <thatman@altlinux.org> 9.6.9-alt1
- Updated to 9.6.9.

* Fri Mar 14 2025 Alexander Burmatov <thatman@altlinux.org> 9.6.8-alt1
- Updated to 9.6.8.

* Wed Dec 18 2024 Alexander Burmatov <thatman@altlinux.org> 9.5.49-alt1
- Updated to 9.5.49.

* Mon Nov 11 2024 Alexander Burmatov <thatman@altlinux.org> 9.5.44-alt1
- Updated to 9.5.44.

* Sun Oct 13 2024 Anton Zhukharev <ancieg@altlinux.org> 9.5.40-alt1
- Updated to 9.5.40.
