...
%changelog
* Wed Jul 01 2026 Gleb F-Malinovskiy <glebfm@altlinux.org> 6.0.2-alt2
- Enabled bootstrap switch and disabled tests to bootstrap with python 3.14.

* Sun Oct 12 2025 Grigory Ustinov <grenka@altlinux.org> 6.0.2-alt1
- Automatically updated to 6.0.2.

* Wed Sep 03 2025 Grigory Ustinov <grenka@altlinux.org> 6.0.1-alt1.1
- Built without check for python3.13.

* Wed Sep 03 2025 Grigory Ustinov <grenka@altlinux.org> 6.0.1-alt1
- Automatically updated to 6.0.1.

* Thu Jun 26 2025 Grigory Ustinov <grenka@altlinux.org> 6.0.0-alt1
- Automatically updated to 6.0.0.

* Tue Apr 22 2025 Grigory Ustinov <grenka@altlinux.org> 5.4.0-alt1
- Automatically updated to 5.4.0.

* Wed Apr 09 2025 Grigory Ustinov <grenka@altlinux.org> 5.3.2-alt1
- Automatically updated to 5.3.2.
