...
# optimized out: libgpg-error openssl-config perl perl-AnyEvent perl-CPAN-Meta-Requirements perl-Compress-Raw-Zlib perl-Data-OptList perl-Digest-SHA perl-EV perl-Encode perl-Future perl-Guard perl-IO-Compress perl-IO-Socket-IP perl-IO-Socket-SSL perl-JSON-PP perl-JSON-XS perl-Net-SSLeay perl-Params-Util perl-Parse-CPAN-Meta perl-Pod-Escapes perl-Pod-Simple perl-Pod-Usage perl-Sub-Install perl-Sub-Uplevel perl-Try-Tiny perl-Types-Serialiser perl-URI perl-Unicode-Normalize perl-common-sense perl-devel perl-parent perl-podlators python-modules python2-base python3 python3-base sh5
BuildRequires: perl-CPAN-Meta perl-Cpanel-JSON-XS perl-CryptX perl-Heap perl-IO-Async perl-IO-Socket-Socks perl-JSON perl-Metrics-Any perl-Module-Runtime perl-Mojolicious perl-Role-Tiny perl-Sub-Attribute perl-Sub-Exporter perl-Test-Exception perl-Test-Fatal perl-Test-Pod perl-Test-Requires perl-Test-Warn
...
%changelog
* Mon Nov 03 2025 Nikolay A. Fetisov <naf@altlinux.org> 1.05-alt1
- New version
