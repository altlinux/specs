...
python -m unittest -v Products.PloneTestCase.tests
...
%changelog
* Sun Aug 30 2015 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 0.9.19-alt3.dev0.git20141203
- Enabled check
