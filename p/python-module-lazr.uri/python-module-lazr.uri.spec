...
%files
%doc %python_sitelibdir/lazr/uri/NEWS.txt
%doc %python_sitelibdir/lazr/uri/README.txt
%python_sitelibdir/*
...
%doc %python3_sitelibdir/lazr/uri/NEWS.txt
%doc %python3_sitelibdir/lazr/uri/README.txt
%python3_sitelibdir/*
