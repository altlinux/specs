...
ln -s /dev/null %buildroot%_unitdir/%{name}.service
...
%changelog
* Fri Jul 23 2021 Aleksei Nikiforov <darktemplar@altlinux.org> 1.2.1-alt3
- Masked autogenerated %{name}.service (Closes: #40533).
