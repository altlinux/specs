...
%changelog
* Thu Apr 03 2025 Igor Vlasenko <viy@altlinux.org> 0.090-alt1
- automated CPAN update

* Fri Jul 28 2023 Igor Vlasenko <viy@altlinux.org> 0.088-alt1
- automated CPAN update

* Sat Jul 08 2023 Igor Vlasenko <viy@altlinux.org> 0.086-alt1
- automated CPAN update

* Thu Jun 22 2023 Igor Vlasenko <viy@altlinux.org> 0.084-alt1
- automated CPAN update

* Mon Jul 25 2022 Igor Vlasenko <viy@altlinux.org> 0.082-alt1
- automated CPAN update

* Thu Nov 11 2021 Igor Vlasenko <viy@altlinux.org> 0.080-alt1
- automated CPAN update

* Tue Aug 17 2021 Igor Vlasenko <viy@altlinux.org> 0.078-alt1
- automated CPAN update

* Wed Aug 08 2018 Igor Vlasenko <viy@altlinux.ru> 0.076-alt1
- automated CPAN update
