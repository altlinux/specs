...
BuildRequires: libsowing-devel perl(B/Hooks/EndOfScope.pm) perl(B/Hooks/OP/Check.pm) perl(DynaLoader.pm) perl(ExtUtils/Depends.pm) perl(ExtUtils/MakeMaker.pm) perl(File/Spec.pm) perl(Test/Exception.pm) perl(Test/More.pm) perl(parent.pm) perl(strict.pm) perl(warnings.pm) perl(Module/Metadata.pm)
...
Source: http://www.cpan.org/authors/id/E/ET/ETHER/B-Hooks-Parser-%{version}.tar.gz
