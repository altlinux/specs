...
BuildRequires: libnss-mysql perl-Email-Abstract perl-Email-Address perl-IO-All perl-Return-Value perl-Test-Pod perl-Test-Pod-Coverage perl(Capture/Tiny.pm)
