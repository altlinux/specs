...
%changelog
* Fri Aug 08 2025 Igor Vlasenko <viy@altlinux.org> 1:0.637-alt1
- automated CPAN update

* Thu Jun 22 2023 Igor Vlasenko <viy@altlinux.org> 1:0.636-alt1
- automated CPAN update

* Sun May 21 2023 Igor Vlasenko <viy@altlinux.org> 1:0.635-alt1
- automated CPAN update
...
* Wed Sep 01 2021 Igor Vlasenko <viy@altlinux.org> 0.611-alt1
- automated CPAN update

* Tue Aug 17 2021 Igor Vlasenko <viy@altlinux.org> 0.60-alt1
- automated CPAN update

* Sun Jun 23 2019 Igor Vlasenko <viy@altlinux.ru> 0.59-alt1
- automated CPAN update
...
* Thu Jan 24 2019 Igor Vlasenko <viy@altlinux.ru> 0.55-alt1.1
