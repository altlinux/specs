...
Obsoletes: python3-module-pyspnego <= 0.12.1-alt2
Provides: python3-module-pyspnego = %EVR
...
%changelog
* Mon Aug 17 2026 Grigory Ustinov <grenka@altlinux.org> 0.12.1-alt3
- Renamed back to spnego according original module name.
...
* Mon Oct 14 2024 Grigory Ustinov <grenka@altlinux.org> 0.11.1-alt1
