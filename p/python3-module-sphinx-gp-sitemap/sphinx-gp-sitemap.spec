...
%define pypi_name sphinx-gp-sitemap
%define module_name sphinx_gp_sitemap
...
Url: https://pypi.org/project/sphinx-gp-sitemap/
...
%check
cd %src_dir
%pyproject_run_pytest %tests_dir/ext/sitemap/
cd -
