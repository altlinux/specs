...
%changelog
* Wed Mar 04 2026 Grigory Ustinov <grenka@altlinux.org> 7.4.2-alt1
- Automatically updated to 7.4.2.

* Thu Jan 29 2026 Grigory Ustinov <grenka@altlinux.org> 7.4.1-alt1
- Automatically updated to 7.4.1.

* Mon Jul 07 2025 Grigory Ustinov <grenka@altlinux.org> 7.3.2-alt1
- Automatically updated to 7.3.2.

* Thu Jun 26 2025 Grigory Ustinov <grenka@altlinux.org> 7.3.1-alt1
- Automatically updated to 7.3.1.

* Sat Feb 08 2025 Grigory Ustinov <grenka@altlinux.org> 7.2.2-alt1
- Automatically updated to 7.2.2.

* Fri Jan 17 2025 Grigory Ustinov <grenka@altlinux.org> 7.2-alt1
