...
%changelog
* Wed Feb 12 2020 Alexei Takaseev <taf@altlinux.org> 9.4.26-alt1
- 9.4.26

* Wed Nov 13 2019 Alexei Takaseev <taf@altlinux.org> 9.4.25-alt1
- 9.4.25

* Wed Aug 07 2019 Alexei Takaseev <taf@altlinux.org> 9.4.24-alt1
- 9.4.24 (Fixes CVE-2019-10208)

* Thu Jun 20 2019 Alexei Takaseev <taf@altlinux.org> 9.4.23-alt1
- 9.4.23
...
* Thu Jan 24 2019 Igor Vlasenko <viy@altlinux.ru> 9.4.20-alt1.1
...
* Mon Oct 08 2018 Igor Vlasenko <viy@altlinux.ru> 9.4.19-alt3
- NMU: removed Provides: postgresql-perl from old postgresses

* Tue Sep 04 2018 Alexei Takaseev <taf@altlinux.org> 9.4.19-alt2
- Add BR: libkrb5-devel
- Rebuild with OpenSSL 1.1.x

* Sat Aug 11 2018 Alexei Takaseev <taf@altlinux.org> 9.4.19-alt1
- 9.4.19
- (Fixes CVE-2018-10915)
