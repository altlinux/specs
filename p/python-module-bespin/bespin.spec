...
%changelog
* Tue Mar 17 2015 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 0.5.1.8-alt1.git20150301
- Version 0.5.1.8

* Thu Feb 26 2015 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 0.5.1.7-alt1.git20150226
- Version 0.5.1.7

* Tue Feb 24 2015 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 0.5.1.6-alt1.git20150224
- Version 0.5.1.6

* Wed Feb 18 2015 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 0.4.9.7-alt1.git20150218
- Version 0.4.9.7
