...
%define pypi_name sphinx-gp-opengraph
%define module_name sphinx_gp_opengraph
...
Summary: OpenGraph and Twitter meta-tag emission for Sphinx
License: MIT
Group: Development/Python3
Url: https://pypi.org/project/sphinx-gp-opengraph/
...
%check
cd %src_dir
%pyproject_run_pytest %tests_dir/ext/opengraph/
cd -
