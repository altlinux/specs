...
Patch17: php8-8.2-phpize-php-config-name.patch
...
%changelog
* Sun Jul 12 2026 Anton Farygin <rider@altlinux.org> 8.2.32-alt1
- 8.2.31 -> 8.2.32 (Fixes: CVE-2026-14355)
- moved session.save_path and opcache.lockfile_path out of /tmp

* Sun Jul 12 2026 Anton Farygin <rider@altlinux.org> 8.2.31-alt2
- moved session.save_path and opcache.lockfile_path out of /tmp

* Tue May 19 2026 Anton Farygin <rider@altlinux.org> 8.2.31-alt1
- 8.2.30 -> 8.2.31 (Fixes: CVE-2026-6735, CVE-2026-7259, CVE-2025-14179,
- CVE-2026-6722, CVE-2026-7261, CVE-2026-7262, CVE-2026-7568, CVE-2026-7258)

* Mon Dec 22 2025 Anton Farygin <rider@altlinux.org> 8.2.30-alt1
- 8.2.29 -> 8.2.30 (Fixes: CVE-2025-14180, CVE-2025-14178, CVE-2025-14177)

* Thu Jul 31 2025 Anton Farygin <rider@altlinux.com> 8.2.29-alt1
- 8.2.28 -> 8.2.29 (Fixes: CVE-2025-1735, CVE-2025-6491, CVE-2025-1220)

* Wed Mar 12 2025 Anton Farygin <rider@altlinux.ru> 8.2.28-alt1
- 8.2.27 -> 8.2.28 (Fixes: CVE-2025-1219, CVE-2025-1736, CVE-2025-1861, CVE-2025-1734,
                   CVE-2025-1217)

- cleanup old files in updated mysqlnd and openssl triggers (Closes: #53200)

* Tue Dec 24 2024 Anton Farygin <rider@altlinux.ru> 8.2.27-alt1
- 8.2.26 -> 8.2.27

* Wed Nov 27 2024 Anton Farygin <rider@altlinux.ru> 8.2.26-alt1
- 8.2.25 -> 8.2.26 (Fixes: CVE-2024-8932, CVE-2024-8929, CVE-2024-11234, CVE-2024-11233)

* Wed Nov 06 2024 Anton Farygin <rider@altlinux.ru> 8.2.25-alt1
- 8.2.24 -> 8.2.25

* Tue Oct 01 2024 Anton Farygin <rider@altlinux.ru> 8.2.24-alt1
- 8.2.23 -> 8.2.24 (Fixes: CVE-2024-8926, CVE-2024-8927, CVE-2024-9026, CVE-2024-8925)

* Wed Sep 11 2024 Anton Farygin <rider@altlinux.ru> 8.2.23-alt1
- 8.2.22 -> 8.2.23
...
* Wed Jul 10 2024 Anton Farygin <rider@altlinux.ru> 8.2.21-alt1
- 8.2.20 -> 8.2.21

* Sun Jun 09 2024 Anton Farygin <rider@altlinux.ru> 8.2.20-alt1
- 8.2.19 -> 8.2.20 (Fixed: CVE-2024-4577, CVE-2024-5458, CVE-2024-5585)
...
- ALT patches for the build system have been updated to the new version and
  now external modules are always linked with the shared php library
...
* Tue Apr 18 2023 Anton Farygin <rider@altlinux.ru> 8.2.5-alt1
- 8.2.4 -> 8.2.5

* Sat Mar 18 2023 Anton Farygin <rider@altlinux.ru> 8.2.4-alt1
- 8.2.3 -> 8.2.4
