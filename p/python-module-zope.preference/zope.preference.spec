...
%py_requires zope ZODB3 zope.annotation zope.component zope.container
...
%py3_requires zope ZODB3 zope.annotation zope.component zope.container
...
Summary: Tests for User Preferences Framework
Group: Development/Python3
...
This package contains tests for User Preferences Framework.
...
* Wed Jul 23 2014 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 4.0.0-alt2.a1
...
* Wed Jun 29 2011 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 3.8.0-alt2
