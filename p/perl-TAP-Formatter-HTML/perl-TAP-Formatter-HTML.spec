...
BuildRequires: perl(Alien/SeleniumRC.pm) perl(App/Prove.pm) perl(Fcntl.pm) perl(File/Spec/Functions.pm) perl(File/Temp.pm) perl(IO/File.pm) perl(TAP/Base.pm) perl(TAP/Harness.pm) perl(TAP/Parser/Aggregator.pm) perl(Time/HiRes.pm) perl(URI/file.pm) perl-Module-Build perl-devel perl-podlators
