...
%changelog
* Wed May 16 2018 Andrey Bychkov <mrdrew@altlinux.org> 0.5.3-alt1.git20150511.1.2
- (NMU) rebuild with python3.6

* Sun Mar 13 2016 Ivan Zakharyaschev <imz@altlinux.org> 0.5.3-alt1.git20150511.1.1
