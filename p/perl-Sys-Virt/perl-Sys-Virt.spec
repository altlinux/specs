...
%changelog
* Thu Jul 10 2025 Igor Vlasenko <viy@altlinux.org> 11.2.0-alt1
- automated CPAN update

* Tue Dec 05 2023 Igor Vlasenko <viy@altlinux.org> 9.8.0-alt1
- automated CPAN update

* Fri Sep 08 2023 Igor Vlasenko <viy@altlinux.org> 9.7.0-alt1
- automated CPAN update

* Sun Sep 03 2023 Igor Vlasenko <viy@altlinux.org> 9.4.0-alt1
- automated CPAN update

* Sun May 21 2023 Igor Vlasenko <viy@altlinux.org> 9.2.0-alt1
- automated CPAN update

* Tue Jan 31 2023 Igor Vlasenko <viy@altlinux.org> 9.0.0-alt1
- automated CPAN update

* Mon Nov 28 2022 Igor Vlasenko <viy@altlinux.org> 8.9.0-alt1
- automated CPAN update

* Thu Oct 06 2022 Igor Vlasenko <viy@altlinux.org> 8.8.0-alt1
- automated CPAN update

* Thu Aug 18 2022 Igor Vlasenko <viy@altlinux.org> 8.5.0-alt1
- automated CPAN update

* Thu Jan 27 2022 Igor Vlasenko <viy@altlinux.org> 8.0.0-alt1
- automated CPAN update

* Wed Dec 29 2021 Igor Vlasenko <viy@altlinux.org> 7.10.0-alt1
- automated CPAN update

* Tue Nov 23 2021 Igor Vlasenko <viy@altlinux.org> 7.9.0-alt1
- automated CPAN update

* Mon Sep 06 2021 Igor Vlasenko <viy@altlinux.org> 7.7.0-alt1
- automated CPAN update

* Thu Jun 17 2021 Igor Vlasenko <viy@altlinux.org> 7.4.0-alt1
- automated CPAN update

* Sun May 16 2021 Igor Vlasenko <viy@altlinux.org> 7.3.0-alt1
- automated CPAN update
