...
# LoL
%add_python3_req_skip missing_dependency_for_lazy_import_test
# Unpacked generates from tests
%add_python3_req_skip foo
...
rm -v  %buildroot%dynload_dir/_tkinter.cpython-%pyshortver%pyabi-%pyarch.so
...
%ifarch %e2k
rm -f %buildroot%dynload_dir/nis.cpython-%pyshortver%pyabi-%pyarch.so
%endif
...
ignore="-i test_freeze_simple_script testPeek test_embed test_site" # We are too fast
...
%dynload_dir/_bisect.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_blake2.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_bz2.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_codecs_cn.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_codecs_hk.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_codecs_iso2022.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_codecs_jp.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_codecs_kr.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_codecs_tw.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_csv.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_ctypes.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_dbm.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_decimal.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_elementtree.cpython-%pyshortver%pyabi-%{pyarch}.so
%if_with gdbm
%dynload_dir/_gdbm.cpython-%pyshortver%pyabi-%{pyarch}.so
%endif
%dynload_dir/_hashlib.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_heapq.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_hmac.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_interpchannels.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_interpqueues.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_interpreters.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_json.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_lsprof.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_lzma.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_math_integer.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_md5.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_multibytecodec.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_multiprocessing.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_pickle.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_posixshmem.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_posixsubprocess.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_queue.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_random.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_remote_debugging.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_sha1.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_sha2.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_sha3.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_socket.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_ssl.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_statistics.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_struct.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_uuid.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_zoneinfo.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/_zstd.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/array.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/binascii.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/cmath.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/fcntl.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/grp.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/math.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/mmap.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/pyexpat.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/readline.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/resource.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/select.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/syslog.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/termios.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/unicodedata.cpython-%pyshortver%pyabi-%{pyarch}.so
%dynload_dir/zlib.cpython-%pyshortver%pyabi-%{pyarch}.so
...
%dir %pylibdir/profiling/
%dir %pylibdir/profiling/__pycache__/
%pylibdir/profiling/*.py
%pylibdir/profiling/__pycache__/*%bytecode_suffixes
%pylibdir/profiling/sampling
%pylibdir/profiling/tracing
...
%pylibdir/tkinter
%dynload_dir/_tkinter.cpython-%pyshortver%pyabi-%pyarch.so
%pylibdir/turtle.py
...
%dynload_dir/_sqlite3.cpython-%pyshortver%pyabi-%pyarch.so

%files modules-curses
%pylibdir/curses
%dynload_dir/_curses.cpython-%pyshortver%pyabi-%pyarch.so
%dynload_dir/_curses_panel.cpython-%pyshortver%pyabi-%pyarch.so
...
%dynload_dir/_ctypes_test.cpython-%pyshortver%pyabi-%pyarch.so
%dynload_dir/_testbuffer.cpython-%pyshortver%pyabi-%pyarch.so
%dynload_dir/_testcapi.cpython-%pyshortver%pyabi-%pyarch.so
%dynload_dir/_testclinic.cpython-%pyshortver%pyabi-%pyarch.so
%dynload_dir/_testclinic_limited.cpython-%pyshortver%pyabi-%pyarch.so
%dynload_dir/_testimportmultiple.cpython-%pyshortver%pyabi-%pyarch.so
%dynload_dir/_testinternalcapi.cpython-%pyshortver%pyabi-%pyarch.so
%dynload_dir/_testlimitedcapi.cpython-%pyshortver%pyabi-%pyarch.so
%dynload_dir/_testmultiphase.cpython-%pyshortver%pyabi-%pyarch.so
%dynload_dir/_testsinglephase.cpython-%pyshortver%pyabi-%pyarch.so
%dynload_dir/_xxtestfuzz.cpython-%pyshortver%pyabi-%pyarch.so
%dynload_dir/xxlimited.cpython-%pyshortver%pyabi-%pyarch.so
%dynload_dir/xxlimited_35.cpython-%pyshortver%pyabi-%pyarch.so
%dynload_dir/xxlimited_3_13.cpython-%pyshortver%pyabi-%pyarch.so
%dynload_dir/xxsubtype.cpython-%pyshortver%pyabi-%pyarch.so
%if_with tk
...
%changelog
* Wed Aug 05 2026 Daniel Zagaynov <kotopesutility@altlinux.org> 3.15.0.0.rc1-alt1
- Update to upstream 3.15.0.rc1
- Add %%pyarch to extension modules
- Drop SOABI3, recover SOABI
