...
PreReq: tetex-latex >= 2.0 
Requires: xmltex >= 1.8
# Automatically added by buildreq on Fri Oct 17 2003
BuildRequires: docbook-dtds docbook-utils openjade perl-SGMLSpm sgml-common unzip
...
Patch0: passivetex-fonts.patch
Patch1: passivetex-marker-fix.patch
Patch2: passivetex-head-indent.patch
Patch3: passivetex-static-align.patch
Patch4: passivetex-float-placement.patch
Patch5: passivetex-evenfirst-fix.patch
Patch6: passivetex-arrow-hack.patch
Patch7: passivetex-alt-urw.patch
...
%changelog
* Thu Jan 14 2010 Repocop Q. A. Robot <repocop@altlinux.org> 20030310-alt3.qa1
- NMU (by repocop): the following fixes applied:
  * altlinux-policy-tex-obsolete-util-calls-in-post for passivetex
