...
%define oname %mname-angular-sanitize
...
Version: 1.2.1.1
Release: alt1.1.1
Summary: Angular-Sanitize 1.2.1 (XStatic packaging standard)
License: MIT
Group: Development/Python
Url: https://pypi.python.org/pypi/XStatic-Angular-Sanitize/
...
%py_provides %mname.pkg.angular_sanitize
...
%description
Angular-Sanitize JavaScript library packaged for setuptools
(easy_install) / pip.
...
%py3_provides %mname.pkg.angular_sanitize
