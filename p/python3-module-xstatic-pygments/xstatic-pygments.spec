...
%define pypi_name XStatic-Pygments

Name: python3-module-%oname
Version: 1.6.0.1
Release: alt3

Summary: Pygments (XStatic packaging standard)
License: BSD
...
%changelog
* Thu Nov 21 2019 Andrey Bychkov <mrdrew@altlinux.org> 1.6.0.1-alt3
- python2 disabled

* Fri Feb 02 2018 Stanislav Levin <slev@altlinux.org> 1.6.0.1-alt2.1
- (NMU) Fix Requires and BuildRequires to python-setuptools

* Wed Jun 14 2017 Alexey Shabalin <shaba@altlinux.ru> 1.6.0.1-alt2
- build as noarch

* Tue May 24 2016 Ivan Zakharyaschev <imz@altlinux.org> 1.6.0.1-alt1.1.1.1
- (AUTO) subst_x86_64.
