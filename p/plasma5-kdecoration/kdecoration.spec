...
Provides: kf5-kdecoration-common = %EVR
Obsoletes: kf5-kdecoration-common < %EVR
%description common
%name common package
...
Provides: kf5-kdecoration-devel = %EVR
Obsoletes: kf5-kdecoration-devel < %EVR
%description devel
...
%_K5lib/libkdecorations2.so.*
%files -n %libkdecorationsprivate
%_K5lib/libkdecorations2private.so.%sover_private
...
- renamed kf5-kdecoration -> plasma5-kdecoration
