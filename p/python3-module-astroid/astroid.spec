...
* Wed Feb 25 2026 Stanislav Levin <slev@altlinux.org> 4.1.1-alt1
- 4.0.3 -> 4.1.1.

* Wed Feb 04 2026 Stanislav Levin <slev@altlinux.org> 4.0.3-alt1
- 4.0.2 -> 4.0.3.

* Fri Nov 14 2025 Stanislav Levin <slev@altlinux.org> 4.0.2-alt1
- 3.3.11 -> 4.0.2.

* Mon Jul 14 2025 Stanislav Levin <slev@altlinux.org> 3.3.11-alt1
- 3.3.10 -> 3.3.11.
...
* Mon Mar 10 2025 Stanislav Levin <slev@altlinux.org> 3.3.9-alt1
- 3.3.8 -> 3.3.9.

* Tue Dec 24 2024 Stanislav Levin <slev@altlinux.org> 3.3.8-alt1
- 3.3.7 -> 3.3.8.
...
* Mon Oct 07 2024 Stanislav Levin <slev@altlinux.org> 3.3.5-alt1
- 3.3.4 -> 3.3.5.

* Tue Sep 24 2024 Stanislav Levin <slev@altlinux.org> 3.3.4-alt1
- 3.3.3 -> 3.3.4.

* Mon Sep 23 2024 Stanislav Levin <slev@altlinux.org> 3.3.3-alt1
- 3.3.2 -> 3.3.3.

* Thu Aug 22 2024 Stanislav Levin <slev@altlinux.org> 3.3.2-alt1
- 3.2.4 -> 3.3.2.

* Mon Jul 22 2024 Stanislav Levin <slev@altlinux.org> 3.2.4-alt1
- 3.2.3 -> 3.2.4.
