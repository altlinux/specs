...
Patch7: perl-Newt-1.08-fix_pointer_type.patch
Patch8: perl-Newt-1.08-formdestroy.patch
Patch9: perl-Newt-1.08-pod.patch
...
%changelog
* Tue Aug 04 2026 Aleksandr Shamaraev <shad@altlinux.org> 1.08-alt4.3
- fixed FTBFS

* Thu Jan 24 2019 Igor Vlasenko <viy@altlinux.ru> 1.08-alt4.2
