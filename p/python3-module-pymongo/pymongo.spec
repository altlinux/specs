...
%changelog
* Tue Jan 27 2026 Grigory Ustinov <grenka@altlinux.org> 4.16.0-alt1
- Automatically updated to 4.16.0.

* Wed Oct 15 2025 Grigory Ustinov <grenka@altlinux.org> 4.15.3-alt1
- Automatically updated to 4.15.3.

* Thu Jun 26 2025 Grigory Ustinov <grenka@altlinux.org> 4.13.2-alt1
- Automatically updated to 4.13.2.

* Thu May 15 2025 Grigory Ustinov <grenka@altlinux.org> 4.13.0-alt1
- Automatically updated to 4.13.0.

* Tue May 06 2025 Grigory Ustinov <grenka@altlinux.org> 4.12.1-alt1
- Automatically updated to 4.12.1.

* Wed Apr 09 2025 Grigory Ustinov <grenka@altlinux.org> 4.12.0-alt1
- Automatically updated to 4.12.0.

* Tue Mar 18 2025 Grigory Ustinov <grenka@altlinux.org> 4.11.3-alt1
- Automatically updated to 4.11.3.
...
* Fri Jan 31 2025 Grigory Ustinov <grenka@altlinux.org> 4.11-alt1
- Automatically updated to 4.11.

* Wed Oct 02 2024 Grigory Ustinov <grenka@altlinux.org> 4.10.1-alt1
- Automatically updated to 4.10.1.

* Tue Oct 01 2024 Grigory Ustinov <grenka@altlinux.org> 4.10.0-alt1
- Automatically updated to 4.10.0.

* Wed Sep 25 2024 Grigory Ustinov <grenka@altlinux.org> 4.9.1-alt1
- Automatically updated to 4.9.1.

* Tue Jul 09 2024 Grigory Ustinov <grenka@altlinux.org> 4.8.0-alt1
- Automatically updated to 4.8.0.

* Wed Jun 05 2024 Grigory Ustinov <grenka@altlinux.org> 4.7.3-alt1
- Automatically updated to 4.7.3.
