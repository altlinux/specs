...
%changelog
* Wed Jan 21 2026 Grigory Ustinov <grenka@altlinux.org> 1.5.5-alt1
- Automatically updated to 1.5.5.
...
* Thu Nov 07 2024 Grigory Ustinov <grenka@altlinux.org> 1.5.2-alt1
- Automatically updated to 1.5.2.

* Wed Sep 25 2024 Grigory Ustinov <grenka@altlinux.org> 1.5.1-alt1
