...
BuildRequires: perl-Linux-Inotify2 perl-Module-Build perl-Module-Pluggable perl-MooseX-Params-Validate perl-MooseX-SemiAffordanceAccessor perl-Test-Exception perl-namespace-autoclean perl(Test/Requires.pm) perl(Types/Standard.pm) perl(Test2/V0.pm)
...
%changelog
* Mon Jan 21 2019 Igor Vlasenko <viy@altlinux.ru> 0.31-alt1
