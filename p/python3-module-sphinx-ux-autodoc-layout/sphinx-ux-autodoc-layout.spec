...
%define pypi_name sphinx-ux-autodoc-layout
%define module_name sphinx_ux_autodoc_layout
...
Summary: Autodoc layout and CSS transforms for Sphinx
License: MIT
Group: Development/Python3
Url: https://pypi.org/project/sphinx-ux-autodoc-layout/
...
%description
Autodoc layout and CSS transforms for Sphinx.
...
%check
cd %src_dir
%pyproject_run_pytest %tests_dir/ext/layout/
cd -
