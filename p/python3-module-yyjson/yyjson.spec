...
Patch0: %name-%version-alt-no-abi3.patch
...
%changelog
* Tue Aug 25 2026 Denis Rastyogin <gerben@altlinux.org> 4.0.6-alt2
- Fixed FTBFS: dropped the bogus abi3 marking of the C extension.

* Wed May 21 2025 Denis Rastyogin <gerben@altlinux.org> 4.0.6-alt1
- Updated to 4.0.6.
