...
%changelog
* Wed Sep 09 2026 Stanislav Levin <slev@altlinux.org> 21.7.9-alt1
- 21.7.8 -> 21.7.9

* Wed Sep 02 2026 Stanislav Levin <slev@altlinux.org> 21.7.8-alt1
- 21.7.7 -> 21.7.8

* Mon Aug 31 2026 Stanislav Levin <slev@altlinux.org> 21.7.7-alt1
- 21.7.5 -> 21.7.7

* Tue Aug 25 2026 Stanislav Levin <slev@altlinux.org> 21.7.5-alt1
- 21.7.4 -> 21.7.5

* Mon Aug 24 2026 Stanislav Levin <slev@altlinux.org> 21.7.4-alt1
- 21.7.0 -> 21.7.4

* Thu Jul 30 2026 Stanislav Levin <slev@altlinux.org> 21.7.0-alt1
- 21.6.1 -> 21.7.0

* Mon Jul 13 2026 Stanislav Levin <slev@altlinux.org> 21.6.1-alt1
- 21.6.0 -> 21.6.1

* Tue Jul 07 2026 Stanislav Levin <slev@altlinux.org> 21.6.0-alt1
- 21.5.1 -> 21.6.0
...
* Mon Jun 01 2026 Stanislav Levin <slev@altlinux.org> 21.4.2-alt1
- 21.4.1 -> 21.4.2

* Thu May 28 2026 Stanislav Levin <slev@altlinux.org> 21.4.1-alt1
- 21.3.3 -> 21.4.1

* Thu May 14 2026 Stanislav Levin <slev@altlinux.org> 21.3.3-alt1
- 21.3.1 -> 21.3.3.

* Thu May 07 2026 Stanislav Levin <slev@altlinux.org> 21.3.1-alt1
- 21.3.0 -> 21.3.1.

* Tue Apr 28 2026 Stanislav Levin <slev@altlinux.org> 21.3.0-alt1
- 21.2.4 -> 21.3.0.

* Wed Apr 15 2026 Stanislav Levin <slev@altlinux.org> 21.2.4-alt1
- 21.2.3 -> 21.2.4.

* Tue Apr 14 2026 Stanislav Levin <slev@altlinux.org> 21.2.3-alt1
- 21.2.1 -> 21.2.3.
...
* Wed Aug 06 2025 Stanislav Levin <slev@altlinux.org> 20.33.1-alt1
- 20.33.0 -> 20.33.1.

* Mon Aug 04 2025 Stanislav Levin <slev@altlinux.org> 20.33.0-alt1
- 20.32.0 -> 20.33.0.

* Mon Jul 21 2025 Stanislav Levin <slev@altlinux.org> 20.32.0-alt1
- 20.31.2 -> 20.32.0.
...
* Fri Mar 07 2025 Stanislav Levin <slev@altlinux.org> 20.29.3-alt1
- 20.29.2 -> 20.29.3.

* Tue Feb 11 2025 Stanislav Levin <slev@altlinux.org> 20.29.2-alt1
- 20.29.1 -> 20.29.2.

* Mon Jan 20 2025 Stanislav Levin <slev@altlinux.org> 20.29.1-alt1
- 20.29.0 -> 20.29.1.

* Thu Jan 16 2025 Stanislav Levin <slev@altlinux.org> 20.29.0-alt1
- 20.28.1 -> 20.29.0.

* Thu Jan 09 2025 Stanislav Levin <slev@altlinux.org> 20.28.1-alt1
- 20.28.0 -> 20.28.1.

* Tue Nov 26 2024 Stanislav Levin <slev@altlinux.org> 20.28.0-alt1
- 20.27.1 -> 20.28.0.

* Tue Oct 29 2024 Stanislav Levin <slev@altlinux.org> 20.27.1-alt1
- 20.27.0 -> 20.27.1.

* Mon Oct 21 2024 Stanislav Levin <slev@altlinux.org> 20.27.0-alt1
- 20.26.6 -> 20.27.0.
