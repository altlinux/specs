...
%changelog
* Tue Sep 22 2026 Alexander Makeenkov <amakeenk@altlinux.org> 4.37.0-alt1
- Updated to version 4.37.0.

* Sat Sep 12 2026 Alexander Makeenkov <amakeenk@altlinux.org> 4.36.1-alt1
- Updated to version 4.36.1.

* Thu Jul 23 2026 Alexander Makeenkov <amakeenk@altlinux.org> 4.36.0-alt1
- Updated to version 4.36.0.

* Tue Jul 14 2026 Alexander Makeenkov <amakeenk@altlinux.org> 4.35.0-alt1
- Updated to version 4.35.0.
...
* Sat Feb 14 2026 Alexander Makeenkov <amakeenk@altlinux.org> 4.31.0-alt1
- Updated to version 4.31.0.

* Sun Feb 08 2026 Alexander Makeenkov <amakeenk@altlinux.org> 4.30.0-alt1
- Updated to version 4.30.0.
