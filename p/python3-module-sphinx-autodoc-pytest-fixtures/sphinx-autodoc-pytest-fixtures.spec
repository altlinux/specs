...
%define pypi_name sphinx-autodoc-pytest-fixtures
%define module_name sphinx_autodoc_pytest_fixtures
...
Summary: Autodoc pytest-fixture documentation for Sphinx
License: MIT
Group: Development/Python3
Url: https://pypi.org/project/sphinx-autodoc-pytest-fixtures/
...
%description
Autodoc pytest-fixture documentation for Sphinx.
...
%check
cd %src_dir
%pyproject_run_pytest %tests_dir/ext/pytest_fixtures/
cd -
