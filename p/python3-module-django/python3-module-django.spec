...
* Wed May 06 2026 Alexander Burmatov <thatman@altlinux.org> 6.0.5-alt1
- New version 6.0.5.
- Fixes for the following security vulnerabilities:
...
* Wed Feb 18 2026 Alexander Burmatov <thatman@altlinux.org> 5.2.11-alt1
- New version 5.2.11.
- Fixes for the following security vulnerabilities:
...
* Wed Jan 21 2026 Alexander Burmatov <thatman@altlinux.org> 5.2.10-alt1
- New version 5.2.10.
- Some bugfixes.

* Wed Dec 10 2025 Alexander Burmatov <thatman@altlinux.org> 5.2.9-alt1
- New version 5.2.9.
- Fixes for the following security vulnerabilities:
...
* Mon Sep 22 2025 Alexander Burmatov <thatman@altlinux.org> 5.2.6-alt1
- New version 5.2.6.
- Fixes for the following security vulnerabilities:
  + CVE-2025-57833: Potential SQL injection in FilteredRelation column aliases
- Some bugfixes.

* Thu Aug 07 2025 Alexander Burmatov <thatman@altlinux.org> 5.2.5-alt1
- New version 5.2.5.
- Some bugfixes.

* Mon Jul 28 2025 Alexander Burmatov <thatman@altlinux.org> 5.2.4-alt1
- New version 5.2.4.
- Some bugfixes.

* Mon Jun 30 2025 Alexander Burmatov <thatman@altlinux.org> 5.2.3-alt1
- New version 5.2.3.
- Some bugfixes.

* Fri Jun 06 2025 Alexander Burmatov <thatman@altlinux.org> 5.2.2-alt1
- New version 5.2.2.
- Fixes for the following security vulnerabilities:
...
* Fri Mar 14 2025 Alexander Burmatov <thatman@altlinux.org> 5.1.7-alt1
- New version 5.1.7.
- Fixes for the following security vulnerabilities:
...
* Tue Dec 26 2023 Alexander Burmatov <thatman@altlinux.org> 4.2.8-alt1
- New version 4.2.8.
