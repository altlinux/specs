...
%changelog
* Tue Mar 10 2026 Grigory Ustinov <grenka@altlinux.org> 6.8.0-alt1
- Automatically updated to 6.8.0.

* Wed Mar 04 2026 Grigory Ustinov <grenka@altlinux.org> 6.7.5-alt1
- Automatically updated to 6.7.5.

* Fri Feb 27 2026 Grigory Ustinov <grenka@altlinux.org> 6.7.4-alt1
- Automatically updated to 6.7.4.

* Thu Feb 26 2026 Grigory Ustinov <grenka@altlinux.org> 6.7.3-alt1
- Automatically updated to 6.7.3.

* Wed Feb 11 2026 Grigory Ustinov <grenka@altlinux.org> 6.7.0-alt1
- Automatically updated to 6.7.0.

* Wed Jan 28 2026 Grigory Ustinov <grenka@altlinux.org> 6.6.2-alt1
- Automatically updated to 6.6.2.

* Mon Oct 13 2025 Grigory Ustinov <grenka@altlinux.org> 6.1.1-alt1
- Automatically updated to 6.1.1.

* Wed Sep 03 2025 Grigory Ustinov <grenka@altlinux.org> 6.0.0-alt1
- Automatically updated to 6.0.0.

* Sun Aug 03 2025 Grigory Ustinov <grenka@altlinux.org> 5.9.0-alt1
- Automatically updated to 5.9.0.

* Thu Jul 24 2025 Grigory Ustinov <grenka@altlinux.org> 5.8.0-alt1
- Automatically updated to 5.8.0.

* Wed Jul 02 2025 Grigory Ustinov <grenka@altlinux.org> 5.7.0-alt1
- Automatically updated to 5.7.0.

* Thu Jun 26 2025 Grigory Ustinov <grenka@altlinux.org> 5.6.1-alt1
- Automatically updated to 5.6.1.

* Tue May 13 2025 Grigory Ustinov <grenka@altlinux.org> 5.5.0-alt1
- Automatically updated to 5.5.0.

* Mon Mar 17 2025 Grigory Ustinov <grenka@altlinux.org> 5.4.0-alt1
- Automatically updated to 5.4.0.

* Tue Mar 04 2025 Grigory Ustinov <grenka@altlinux.org> 5.3.1-alt1
- Automatically updated to 5.3.1.

* Tue Feb 11 2025 Grigory Ustinov <grenka@altlinux.org> 5.3.0-alt1
- Automatically updated to 5.3.0.

* Tue Jan 28 2025 Grigory Ustinov <grenka@altlinux.org> 5.2.0-alt1
- Automatically updated to 5.2.0.

* Tue Oct 29 2024 Grigory Ustinov <grenka@altlinux.org> 5.1.0-alt1
- Automatically updated to 5.1.0.

* Mon Sep 30 2024 Grigory Ustinov <grenka@altlinux.org> 5.0.1-alt1
- Automatically updated to 5.0.1.

* Wed Sep 25 2024 Grigory Ustinov <grenka@altlinux.org> 5.0.0-alt1
