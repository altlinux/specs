...
%changelog
* Sat Apr 29 2023 Igor Vlasenko <viy@altlinux.org> 5.004-alt1
- automated CPAN update

* Thu Feb 09 2023 Igor Vlasenko <viy@altlinux.org> 5.003-alt1
- automated CPAN update
...
* Wed Feb 23 2022 Igor Vlasenko <viy@altlinux.org> 4.023-alt1
- automated CPAN update

* Fri Feb 18 2022 Igor Vlasenko <viy@altlinux.org> 4.021-alt1
- automated CPAN update

* Tue Feb 08 2022 Igor Vlasenko <viy@altlinux.org> 4.019-alt1
- automated CPAN update

* Tue Sep 01 2020 Igor Vlasenko <viy@altlinux.ru> 4.018-alt1
- automated CPAN update

* Thu Jul 23 2020 Igor Vlasenko <viy@altlinux.ru> 4.017-alt1
- automated CPAN update
...
* Thu Jan 24 2019 Igor Vlasenko <viy@altlinux.ru> 4.005-alt1.1
