...
BuildRequires: python-module-alabaster python-module-docutils python-module-html5lib python-module-objects.inv python-module-setuptools-tests python-module-versiontools python3-module-setuptools-tests python3-module-versiontools rpm-build-python3 time
