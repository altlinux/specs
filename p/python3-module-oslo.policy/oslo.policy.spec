...
%changelog
* Mon Mar 17 2025 Grigory Ustinov <grenka@altlinux.org> 4.5.1-alt1
- Automatically updated to 4.5.1.

* Fri Jan 31 2025 Grigory Ustinov <grenka@altlinux.org> 4.5.0-alt1
- Automatically updated to 4.5.0.

* Thu Oct 03 2024 Grigory Ustinov <grenka@altlinux.org> 4.4.0-alt1
- Automatically updated to 4.4.0.

* Tue May 28 2024 Grigory Ustinov <grenka@altlinux.org> 4.3.0-alt1
