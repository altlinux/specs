...
Summary:	MySQL driver for PHP5 Data Objects Interface
...
- pdo_mysql is a standart PHP extention now, use sources from PHP distribution
...
* Fri Mar 23 2007 Nikolay A. Fetisov <naf@altlinux.ru> 5.2.1-alt1
