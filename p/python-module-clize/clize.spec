...
Version: 3.0
Release: alt1.a2.git20150111.1.1
...
BuildRequires: python-module-alabaster python-module-docutils python-module-html5lib python-module-objects.inv python-module-setuptools-tests python-module-sigtools python3-module-html5lib python3-module-setuptools-tests python3-module-sigtools rpm-build-python3 time
