...
%define pypi_name sphinx-gp-llms
%define module_name sphinx_gp_llms
...
Summary: LLM-friendly documentation outputs for Sphinx
License: MIT
Group: Development/Python3
Url: https://pypi.org/project/sphinx-gp-llms/
...
%check
cd %src_dir
%pyproject_run_pytest %tests_dir/ext/llms/
cd -
