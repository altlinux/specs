...
Provides: mvn(org.codehaus.plexus:plexus-compiler-csharp) = 2.4
Provides: mvn(org.codehaus.plexus:plexus-compiler-csharp:pom:) = 2.4
Provides: mvn(org.codehaus.plexus:plexus-compiler-eclipse) = 2.4
Provides: mvn(org.codehaus.plexus:plexus-compiler-eclipse:pom:) = 2.4
Provides: mvn(org.codehaus.plexus:plexus-compiler-jikes) = 2.4
Provides: mvn(org.codehaus.plexus:plexus-compiler-jikes:pom:) = 2.4
Provides: plexus-compiler-extras = 0:2.4-3.fc23
Requires: java-headless
Requires: jpackage-utils
Requires: mvn(org.codehaus.plexus:plexus-compiler-api)
Requires: mvn(org.codehaus.plexus:plexus-utils)
Requires: mvn(org.eclipse.tycho:org.eclipse.jdt.core)

BuildArch: noarch
Group: Development/Java
Release: alt0.1jpp
Source: plexus-compiler-extras-2.4-3.fc23.cpio
