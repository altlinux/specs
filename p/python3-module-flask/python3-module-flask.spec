...
%changelog
* Tue Jun 02 2026 Anton Zhukharev <ancieg@altlinux.org> 3.1.3-alt3
- Fixed FTBFS (werkzeug==3.1.8).
...
* Mon Apr 08 2024 Anton Zhukharev <ancieg@altlinux.org> 3.0.3-alt1
- Updated to 3.0.3.

* Tue Feb 06 2024 Anton Zhukharev <ancieg@altlinux.org> 3.0.2-alt1
- Updated to 3.0.2.
