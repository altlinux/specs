...
install -p -m644 src/collective/recipe/__init__.py \
	%buildroot%python_sitelibdir/collective/recipe/
...
%exclude %python_sitelibdir/collective/recipe/__init__.py*

%files tests
%python_sitelibdir/collective/recipe/*/tests

%files -n python-module-%mname
%dir %python_sitelibdir/collective/recipe
%python_sitelibdir/collective/recipe/__init__.py*

%changelog
* Wed Nov 12 2014 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 2.21-alt1.dev0.git20141111
