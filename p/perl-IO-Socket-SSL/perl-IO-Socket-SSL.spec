...
%changelog
* Fri Aug 08 2025 Igor Vlasenko <viy@altlinux.org> 2.095-alt1
- automated CPAN update

* Thu Jul 10 2025 Igor Vlasenko <viy@altlinux.org> 2.094-alt1
- automated CPAN update

* Fri Jun 13 2025 Igor Vlasenko <viy@altlinux.org> 2.091-alt1
- automated CPAN update

* Thu Apr 03 2025 Igor Vlasenko <viy@altlinux.org> 2.089-alt1
- automated CPAN update

* Fri Jan 26 2024 Igor Vlasenko <viy@altlinux.org> 2.085-alt1
- automated CPAN update

* Tue Nov 14 2023 Igor Vlasenko <viy@altlinux.org> 2.084-alt1
- automated CPAN update

* Sun May 21 2023 Igor Vlasenko <viy@altlinux.org> 2.083-alt1
- automated CPAN update

* Tue Jan 31 2023 Igor Vlasenko <viy@altlinux.org> 2.081-alt1
- automated CPAN update

* Thu Jan 19 2023 Igor Vlasenko <viy@altlinux.org> 2.080-alt1
- automated CPAN update
...
* Mon Nov 28 2022 Igor Vlasenko <viy@altlinux.org> 2.077-alt1
- automated CPAN update

* Sat Sep 03 2022 Igor Vlasenko <viy@altlinux.org> 2.075-alt1
- automated CPAN update

* Sat Jan 08 2022 Igor Vlasenko <viy@altlinux.org> 2.074-alt1
- automated CPAN update

* Wed Dec 29 2021 Igor Vlasenko <viy@altlinux.org> 2.073-alt1
- automated CPAN update

* Tue Aug 17 2021 Igor Vlasenko <viy@altlinux.org> 2.072-alt1
- automated CPAN update

* Thu May 27 2021 Igor Vlasenko <viy@altlinux.org> 2.071-alt1
- automated CPAN update

* Sat Feb 27 2021 Igor Vlasenko <viy@altlinux.org> 2.070-alt1
- automated CPAN update

* Mon Jan 25 2021 Igor Vlasenko <viy@altlinux.ru> 2.069-alt1
- automated CPAN update

* Tue Mar 31 2020 Igor Vlasenko <viy@altlinux.ru> 2.068-alt1
- automated CPAN update

* Sun Feb 16 2020 Igor Vlasenko <viy@altlinux.ru> 2.067-alt1
- automated CPAN update

* Wed Mar 06 2019 Igor Vlasenko <viy@altlinux.ru> 2.066-alt1
- automated CPAN update
