...
Url: https://pypi.python.org/pypi/plone.uuid/
Packager: Eugeny A. Rostovtsev (REAL) <real at altlinux.org>

# https://github.com/plone/plone.uuid.git
...
%py_requires plone zope.browserpage zope.interface zope.lifecycleevent
%py_requires zope.publisher

%description
This is a minimal package that can be used to obtain a universally
unique identifier (UUID) for an object.
