...
%changelog
* Fri May 16 2025 Igor Vlasenko <viy@altlinux.org> 0.66-alt1
- automated CPAN update

* Thu Apr 03 2025 Igor Vlasenko <viy@altlinux.org> 0.64-alt1
- automated CPAN update

* Sat Oct 21 2023 Igor Vlasenko <viy@altlinux.org> 0.56-alt1
- automated CPAN update

* Sun Aug 13 2023 Igor Vlasenko <viy@altlinux.org> 0.55-alt1
- automated CPAN update

* Sat Feb 25 2023 Igor Vlasenko <viy@altlinux.org> 0.53-alt1
- automated CPAN update

* Fri Oct 28 2022 Igor Vlasenko <viy@altlinux.org> 0.52-alt1
- automated CPAN update
...
* Wed Nov 17 2021 Igor Vlasenko <viy@altlinux.org> 0.48-alt1
- automated CPAN update

* Fri Sep 24 2021 Igor Vlasenko <viy@altlinux.org> 0.47-alt1
- automated CPAN update

* Wed Feb 10 2021 Igor Vlasenko <viy@altlinux.ru> 0.46-alt1
- automated CPAN update

* Thu Jan 24 2019 Igor Vlasenko <viy@altlinux.ru> 0.45-alt1.2
