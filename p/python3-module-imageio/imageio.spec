...
%install
%pyproject_install
# remove testing.py (ALT bug 54111)
# https://bugzilla.altlinux.org/54111
...
%changelog
* Sun Mar 22 2026 Alexander Kovalev <alexvk@altlinux.org> 2.37.3-alt1
- New version 2.37.3.

* Tue Nov 11 2025 Alexander Kovalev <alexvk@altlinux.org> 2.37.2-alt1
- New version 2.37.2.
