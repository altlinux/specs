...
%files
%doc README COPYRIGHT Changes examples CREDITS
%perl_vendor_privlib/M*

%changelog
* Mon Feb 24 2020 Igor Vlasenko <viy@altlinux.ru> 0.100-alt1
- automated CPAN update

* Tue Nov 19 2019 Igor Vlasenko <viy@altlinux.ru> 0.016-alt1
- automated CPAN update
