...
%changelog
* Fri May 02 2014 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 2.2.0-alt5.git20131011
- Rebuilt with SWIG 3.0.0

* Fri Dec 20 2013 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 2.2.0-alt4.git20131011
- Rebuilt with new SWIG

* Thu Oct 24 2013 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 2.2.0-alt3.git20131011
- New snapshot
...
* Mon Sep 03 2012 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 2.0.5-alt2.bzr20120523
- Rebuilt with SWIG 2.0.8

* Mon Aug 13 2012 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 2.0.5-alt1.bzr20120523
- New snapshot
