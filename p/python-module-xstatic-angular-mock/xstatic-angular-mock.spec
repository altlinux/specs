...
%define oname %mname-angular-mock
...
Version: 1.2.1.1
Release: alt1.1
Summary: Angular-Mock 1.2.1 (XStatic packaging standard)
License: MIT
Group: Development/Python
Url: https://pypi.python.org/pypi/XStatic-Angular-Mock/
...
%py_provides %mname.pkg.angular_mock
...
%description
Angular-Mock JavaScript library packaged for setuptools (easy_install) /
pip.
...
%py3_provides %mname.pkg.angular_mock
