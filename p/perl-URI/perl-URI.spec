...
BuildRequires: perl(Test/Fatal.pm) perl(Test/Warnings.pm)
...
%changelog
* Wed Sep 17 2025 Igor Vlasenko <viy@altlinux.org> 5.33-alt1
- automated CPAN update

* Fri May 16 2025 Igor Vlasenko <viy@altlinux.org> 5.32-alt1
- automated CPAN update
...
* Mon Nov 28 2022 Igor Vlasenko <viy@altlinux.org> 5.17-alt1
- automated CPAN update

* Wed Oct 12 2022 Igor Vlasenko <viy@altlinux.org> 5.16-alt1
- automated CPAN update

* Sat Oct 08 2022 Igor Vlasenko <viy@altlinux.org> 5.13-alt1
- automated CPAN update

* Tue Jul 12 2022 Igor Vlasenko <viy@altlinux.org> 5.12-alt1
- automated CPAN update

* Wed Jul 06 2022 Igor Vlasenko <viy@altlinux.org> 5.11-alt1
- automated CPAN update

* Tue Oct 26 2021 Igor Vlasenko <viy@altlinux.org> 5.10-alt1
- automated CPAN update

* Fri Mar 05 2021 Igor Vlasenko <viy@altlinux.org> 5.09-alt1
- automated CPAN update

* Mon Mar 01 2021 Igor Vlasenko <viy@altlinux.org> 5.08-alt1
- automated CPAN update

* Mon Feb 01 2021 Igor Vlasenko <viy@altlinux.ru> 5.07-alt1
- automated CPAN update

* Fri Jan 15 2021 Igor Vlasenko <viy@altlinux.ru> 5.06-alt1
- automated CPAN update

* Sat Oct 24 2020 Igor Vlasenko <viy@altlinux.ru> 5.05-alt1
- automated CPAN update
