...
Patch: perl-Perl-Tidy-20250311-alt-deps.patch
...
%files
%doc examples docs BUGS.md CHANGES.md INSTALL.md README.md SECURITY.md
%perl_vendor_privlib/Perl*
%_bindir/perltidy
%_man1dir/*

%changelog
* Wed Sep 17 2025 Igor Vlasenko <viy@altlinux.org> 20250912-alt1
- automated CPAN update

* Fri Aug 08 2025 Igor Vlasenko <viy@altlinux.org> 20250711-alt1
- automated CPAN update

* Thu Jul 10 2025 Igor Vlasenko <viy@altlinux.org> 20250616-alt1
- automated CPAN update

* Thu Apr 10 2025 Igor Vlasenko <viy@altlinux.org> 20250311-alt1
- automated CPAN update

* Tue Feb 06 2024 Igor Vlasenko <viy@altlinux.org> 20240202-alt1
- automated CPAN update

* Wed Sep 13 2023 Igor Vlasenko <viy@altlinux.org> 20230912-alt1
- automated CPAN update
