...
%changelog
* Mon Sep 07 2026 Alexander Burmatov <thatman@altlinux.org> 3.3.5-alt1
- ^ 3.3.4 -> 3.3.5

* Tue May 05 2026 Alexander Burmatov <thatman@altlinux.org> 3.3.4-alt1
- ^ 3.3.3 -> 3.3.4

* Wed Mar 04 2026 Alexander Burmatov <thatman@altlinux.org> 3.3.3-alt1
- ^ 3.3.2 -> 3.3.3

* Wed Dec 10 2025 Alexander Burmatov <thatman@altlinux.org> 3.3.2-alt1
- ^ 3.2.13 -> 3.3.2

* Wed Nov 26 2025 Alexander Burmatov <thatman@altlinux.org> 3.2.13-alt1
- ^ 3.2.12 -> 3.2.13

* Tue Nov 18 2025 Alexander Burmatov <thatman@altlinux.org> 3.2.12-alt2
- Fix distinfo path.

* Thu Oct 30 2025 Alexander Burmatov <thatman@altlinux.org> 3.2.12-alt1
- ^ 3.2.10 -> 3.2.12

* Mon Sep 22 2025 Alexander Burmatov <thatman@altlinux.org> 3.2.10-alt1
- ^ 3.2.9 -> 3.2.10

* Wed May 28 2025 Alexander Burmatov <thatman@altlinux.org> 3.2.9-alt1
- ^ 3.2.7 -> 3.2.9

* Mon May 12 2025 Alexander Burmatov <thatman@altlinux.org> 3.2.7-alt1
- ^ 3.2.6 -> 3.2.7

* Fri Mar 14 2025 Alexander Burmatov <thatman@altlinux.org> 3.2.6-alt1
- ^ 3.2.4 -> 3.2.6

* Thu Jan 30 2025 Alexander Burmatov <thatman@altlinux.org> 3.2.4-alt1
- ^ 3.2.3 -> 3.2.4
