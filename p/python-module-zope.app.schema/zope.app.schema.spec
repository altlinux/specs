...
%changelog
* Tue Apr 30 2019 Grigory Ustinov <grenka@altlinux.org> 3.5.0-alt4.2
- Rebuild with python3.7.

* Mon Jun 06 2016 Ivan Zakharyaschev <imz@altlinux.org> 3.5.0-alt4.1.1
- (AUTO) subst_x86_64.
...
* Thu Jul 17 2014 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 3.5.0-alt4
