...
%files
%doc Changes README UserSurvey.txt examples
%perl_vendor_privlib/Statistics

%changelog
* Sat Jul 08 2023 Igor Vlasenko <viy@altlinux.org> 3.0801-alt1
- automated CPAN update

* Sat Oct 24 2020 Igor Vlasenko <viy@altlinux.ru> 3.0800-alt1
- automated CPAN update

* Sun Oct 28 2018 Igor Vlasenko <viy@altlinux.ru> 3.0702-alt1
- automated CPAN update

* Fri Jul 20 2018 Igor Vlasenko <viy@altlinux.ru> 3.0701-alt1
- automated CPAN update

* Wed May 02 2018 Igor Vlasenko <viy@altlinux.ru> 3.0613-alt1
- automated CPAN update
