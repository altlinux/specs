...
* Tue Jan 02 2024 Anton Vyatkin <toni@altlinux.org> 5.6.1-alt1
- New version 5.6.1.

* Tue Dec 19 2023 Anton Vyatkin <toni@altlinux.org> 5.5.1-alt1
- New version 5.5.1.

* Tue Oct 31 2023 Anton Vyatkin <toni@altlinux.org> 5.5.0-alt1
- New version 5.5.0.
