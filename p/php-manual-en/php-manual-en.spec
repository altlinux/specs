...
License: PHP
Summary: On-line manual for PHP (English)
Summary(ru_RU.UTF-8): Электронная документация PHP на английском языке
...
%changelog
* Mon Aug 15 2011 Sergey Kurakin <kurakin@altlinux.org> 1:20110812-alt1
- new version

* Tue Dec 22 2009 Sergey Kurakin <kurakin@altlinux.org> 1:20091218-alt1
- new version

* Wed Jul 22 2009 Sergey Kurakin <kurakin@altlinux.org> 1:20090716-alt1
- new version
- spare level removed from the directory tree (fix #12162)
- fixed directory ownership
- minor spec changes

* Sun May 13 2007 L.A. Kostis <lakostis@altlinux.ru> 1:20070503-alt1
- new version.
