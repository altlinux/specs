...
%changelog
* Sun Oct 12 2025 Grigory Ustinov <grenka@altlinux.org> 2.6.15-alt1
- Automatically updated to 2.6.15.

* Mon Sep 08 2025 Grigory Ustinov <grenka@altlinux.org> 2.6.14-alt1
- Automatically updated to 2.6.14.

* Tue Aug 19 2025 Grigory Ustinov <grenka@altlinux.org> 2.6.13-alt1
- Automatically updated to 2.6.13.

* Wed May 28 2025 Grigory Ustinov <grenka@altlinux.org> 2.6.12-alt1
- Automatically updated to 2.6.12.

* Mon Apr 21 2025 Grigory Ustinov <grenka@altlinux.org> 2.6.10-alt1
- Automatically updated to 2.6.10.

* Mon Mar 10 2025 Grigory Ustinov <grenka@altlinux.org> 2.6.9-alt1
- Automatically updated to 2.6.9.

* Tue Feb 25 2025 Grigory Ustinov <grenka@altlinux.org> 2.6.8-alt1
- Automatically updated to 2.6.8.
...
* Sun Jan 05 2025 Grigory Ustinov <grenka@altlinux.org> 2.6.5-alt1
- Automatically updated to 2.6.5.

* Mon Dec 30 2024 Grigory Ustinov <grenka@altlinux.org> 2.6.4-alt1
- Automatically updated to 2.6.4.

* Tue Nov 26 2024 Grigory Ustinov <grenka@altlinux.org> 2.6.3-alt1
- Automatically updated to 2.6.3.

* Mon Nov 11 2024 Grigory Ustinov <grenka@altlinux.org> 2.6.2-alt1
