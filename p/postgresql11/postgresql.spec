...
* Mon Jul 24 2023 Alexei Takaseev <taf@altlinux.org> 11.20-alt2
- Use autoconf_2.60

* Wed May 10 2023 Alexei Takaseev <taf@altlinux.org> 11.20-alt1
- 11.20 (Fixes CVE-2023-2454, CVE-2023-2455)

* Mon Mar 20 2023 Alexei Takaseev <taf@altlinux.org> 11.19-alt4
- Delete noreplace for /etc/sysconfig/postgresql

* Fri Mar 03 2023 Alexei Takaseev <taf@altlinux.org> 11.19-alt3
...
* Thu Dec 22 2022 Alexei Takaseev <taf@altlinux.org> 11.18-alt2
- Add conflicts for server-devel subpackages
- Add triggerpostun for PG 15
- Change BR llvn 12.0 -> llvm13.0

* Wed Nov 09 2022 Alexei Takaseev <taf@altlinux.org> 11.18-alt1
- 11.18
- Add patch for E2K

* Wed Aug 10 2022 Alexei Takaseev <taf@altlinux.org> 11.17-alt1
- 11.17 (Fixes CVE-2022-2625)

* Wed May 11 2022 Alexei Takaseev <taf@altlinux.org> 11.16-alt1
...
* Thu Feb 24 2022 Alexei Takaseev <taf@altlinux.org> 11.15-alt2
...
* Wed Aug 25 2021 Alexei Takaseev <taf@altlinux.org> 11.13-alt2
- Change conflict 1C 12 -> 1C 13
- Added -ffat-lto-objects to -flto=auto -ffat-lto-objects

* Wed Aug 11 2021 Alexei Takaseev <taf@altlinux.org> 11.13-alt1
- 11.13 (Fixes CVE-2021-3677)

* Mon May 17 2021 Alexei Takaseev <taf@altlinux.org> 11.12-alt1
