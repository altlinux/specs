...
%define pypi_name XStatic-bootswatch
...
%changelog
* Thu Nov 21 2019 Andrey Bychkov <mrdrew@altlinux.org> 3.3.7.0-alt2
- python2 disabled

* Fri Feb 02 2018 Stanislav Levin <slev@altlinux.org> 3.3.7.0-alt1.1
- (NMU) Fix Requires and BuildRequires to python-setuptools

* Wed Jun 14 2017 Alexey Shabalin <shaba@altlinux.ru> 3.3.7.0-alt1
- 3.3.7.0
- build as noarch

* Tue May 24 2016 Ivan Zakharyaschev <imz@altlinux.org> 3.3.5.3-alt1.1.1.1
- (AUTO) subst_x86_64.
