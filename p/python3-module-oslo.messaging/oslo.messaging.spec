...
* Wed Apr 02 2025 Stanislav Levin <slev@altlinux.org> 1:16.1.0-alt1.1
- NMU: fixed FTBFS (setuptools 75.8.1)

* Mon Mar 17 2025 Grigory Ustinov <grenka@altlinux.org> 1:16.1.0-alt1
- Automatically updated to 16.1.0.

* Fri Jan 31 2025 Grigory Ustinov <grenka@altlinux.org> 1:16.0.0-alt1
- Automatically updated to 16.0.0.

* Thu Oct 03 2024 Grigory Ustinov <grenka@altlinux.org> 1:14.9.0-alt1
- Automatically updated to 14.9.0.

* Fri Jul 26 2024 Grigory Ustinov <grenka@altlinux.org> 1:14.8.1-alt1
- Automatically updated to 14.8.1.
...
* Mon May 15 2023 Grigory Ustinov <grenka@altlinux.org> 1:14.3.0-alt1
- Automatically updated to 14.3.0.
