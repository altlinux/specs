...
%changelog
* Wed Jan 21 2026 Grigory Ustinov <grenka@altlinux.org> 5.0.1-alt1
...
* Tue May 06 2025 Grigory Ustinov <grenka@altlinux.org> 4.8.0-alt1
- Automatically updated to 4.8.0.

* Mon Apr 21 2025 Grigory Ustinov <grenka@altlinux.org> 4.6.1-alt1
- Automatically updated to 4.6.1.

* Mon Apr 07 2025 Grigory Ustinov <grenka@altlinux.org> 4.6.0-alt1
- Automatically updated to 4.6.0.

* Sun Feb 02 2025 Grigory Ustinov <grenka@altlinux.org> 4.5.0-alt1
