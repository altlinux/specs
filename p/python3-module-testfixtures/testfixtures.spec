...
%changelog
* Tue Jun 23 2026 Stanislav Levin <slev@altlinux.org> 12.2.0-alt1
- 12.1.0 -> 12.2.0

* Fri Jun 19 2026 Stanislav Levin <slev@altlinux.org> 12.1.0-alt1
- 12.0.1 -> 12.1.0

* Mon Jun 15 2026 Stanislav Levin <slev@altlinux.org> 12.0.1-alt1
- 12.0.0 -> 12.0.1
...
* Mon Jun 10 2024 Stanislav Levin <slev@altlinux.org> 8.3.0-alt1
- 8.2.0 -> 8.3.0.

* Fri May 03 2024 Stanislav Levin <slev@altlinux.org> 8.2.0-alt1
- 8.1.0 -> 8.2.0.

* Fri Mar 01 2024 Stanislav Levin <slev@altlinux.org> 8.1.0-alt1
- 8.0.0 -> 8.1.0.

* Tue Feb 20 2024 Stanislav Levin <slev@altlinux.org> 8.0.0-alt1
- 7.2.2 -> 8.0.0.
