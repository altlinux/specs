...
BuildRequires: gcc-c++ python3-module-Cython python3-module-html5lib python3-module-nose python3-module-notebook rpm-build-python3
...
Provides: python3-module-msgpack = %version-%release
Conflicts: python3-module-msgpack > %version
...
%python3_sitelibdir/msgpack/
%python3_sitelibdir/*.egg-info
%endif

%changelog
* Fri Apr 12 2019 Vitaly Lipatov <lav@altlinux.ru> 0.5.6-alt3
