...
Provides: plexus-compiler-javadoc = 0:2.4-3.fc23
Requires: jpackage-utils

BuildArch: noarch
Group: Development/Java
Release: alt0.1jpp
Source: plexus-compiler-javadoc-2.4-3.fc23.cpio

%description
API documentation for plexus-compiler.
