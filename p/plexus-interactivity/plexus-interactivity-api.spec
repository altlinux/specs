...
Provides: mvn(org.codehaus.plexus:plexus-interactivity-api:pom:) = 1.0.alpha.6
Provides: plexus-interactivity-api = 0:1.0-0.21.alpha6.fc23
...
Release: alt5jpp
Source: plexus-interactivity-api-1.0-0.21.alpha6.fc23.cpio

Provides: plexus-interactivity-api = 0:%version-%release
#Obsoletes: plexus-interactivity < 0:1.0-alt5
#Conflicts: plexus-interactivity < 0:%version-%release

%description
API module for plexus-interactivity.
