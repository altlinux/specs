...
* Sat May 24 2025 Stanislav Levin <slev@altlinux.org> 1:80.8.0-alt1
- 80.7.1 -> 80.8.0.
...
* Thu Nov 21 2024 Stanislav Levin <slev@altlinux.org> 1:75.6.0-alt1
- 75.5.0 -> 75.6.0.

* Fri Nov 15 2024 Stanislav Levin <slev@altlinux.org> 1:75.5.0-alt1
- 75.4.0 -> 75.5.0.

* Tue Nov 12 2024 Stanislav Levin <slev@altlinux.org> 1:75.4.0-alt1
- 75.3.0 -> 75.4.0.

* Wed Nov 06 2024 Stanislav Levin <slev@altlinux.org> 1:75.3.0-alt1
- 75.2.0 -> 75.3.0.
...
- 69.5.1 -> 70.0.0 (fixes: CVE-2024-6345).

* Mon Apr 15 2024 Stanislav Levin <slev@altlinux.org> 1:69.5.1-alt1
- 69.2.0 -> 69.5.1.

* Fri Mar 15 2024 Stanislav Levin <slev@altlinux.org> 1:69.2.0-alt1
- 69.1.1 -> 69.2.0.

* Mon Feb 26 2024 Stanislav Levin <slev@altlinux.org> 1:69.1.1-alt1
- 69.1.0 -> 69.1.1.

* Thu Feb 22 2024 Stanislav Levin <slev@altlinux.org> 1:69.1.0-alt2
- Fixed FTBFS (Pytest 8.0.1).

* Tue Feb 13 2024 Stanislav Levin <slev@altlinux.org> 1:69.1.0-alt1
- 69.0.3 -> 69.1.0.

* Fri Feb 09 2024 Stanislav Levin <slev@altlinux.org> 1:69.0.3-alt3
- Fixed FTBFS (Pytest 8).

* Fri Jan 26 2024 Stanislav Levin <slev@altlinux.org> 1:69.0.3-alt2
- Fixed FTBFS (Python 3.12).

* Tue Dec 26 2023 Stanislav Levin <slev@altlinux.org> 1:69.0.3-alt1
- 68.2.2 -> 69.0.3.

* Tue Sep 19 2023 Stanislav Levin <slev@altlinux.org> 1:68.2.2-alt1
- 68.1.0 -> 68.2.2.

* Wed Aug 16 2023 Stanislav Levin <slev@altlinux.org> 1:68.1.0-alt1
- 68.0.0 -> 68.1.0.
...
* Tue Feb 21 2023 Stanislav Levin <slev@altlinux.org> 1:67.3.3-alt1
- 67.1.0 -> 67.3.3.
