...
%changelog
* Tue Aug 25 2026 Nikolay Strelkov <snk@altlinux.org> 1.6.3-alt1
- New version 1.6.3.

* Mon Aug 24 2026 Nikolay Strelkov <snk@altlinux.org> 1.6.1-alt1
- New version 1.6.1.

* Mon Aug 17 2026 Nikolay Strelkov <snk@altlinux.org> 1.6.0-alt1
- New version 1.6.0.

* Sun Aug 16 2026 Nikolay Strelkov <snk@altlinux.org> 1.5.0-alt1
- New version 1.5.0.

* Sun Jul 26 2026 Nikolay Strelkov <snk@altlinux.org> 1.4.2-alt1
- New version 1.4.2.

* Sat Jun 06 2026 Nikolay Strelkov <snk@altlinux.org> 1.4.0-alt1
- New version 1.4.0.

* Sun May 31 2026 Nikolay Strelkov <snk@altlinux.org> 1.3.2-alt1
- New version 1.3.2.

* Sat May 30 2026 Nikolay Strelkov <snk@altlinux.org> 1.3.1-alt1
- New version 1.3.1.
