...
Version: 1.0.1
#Release: alt1.1.1
Summary: browser-update 1.0 (XStatic packaging standard)
License: MIT
Group: Development/Python
Url: https://pypi.python.org/pypi/XStatic-browser-update/
...
%changelog
* Tue May 24 2016 Ivan Zakharyaschev <imz@altlinux.org> 1.0.1-alt1.1.1.1
- (AUTO) subst_x86_64.
...
* Mon Nov 17 2014 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 1.0.1-alt1
