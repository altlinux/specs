...
%changelog
* Thu Feb 26 2026 Grigory Ustinov <grenka@altlinux.org> 1.36.0-alt1
- Automatically updated to 1.36.0.

* Wed Feb 04 2026 Grigory Ustinov <grenka@altlinux.org> 1.35.1-alt1
- Automatically updated to 1.35.1.

* Sun Jan 18 2026 Grigory Ustinov <grenka@altlinux.org> 1.35.0-alt1
- Automatically updated to 1.35.0.

* Wed Sep 17 2025 Grigory Ustinov <grenka@altlinux.org> 1.34.12-alt1
- Automatically updated to 1.34.12.

* Tue Sep 02 2025 Grigory Ustinov <grenka@altlinux.org> 1.34.8-alt1
- Automatically updated to 1.34.8.

* Tue Aug 19 2025 Grigory Ustinov <grenka@altlinux.org> 1.34.7-alt1
- Automatically updated to 1.34.7.

* Wed Feb 19 2025 Grigory Ustinov <grenka@altlinux.org> 1.34.6-alt1
- Automatically updated to 1.34.6.

* Sat Nov 16 2024 Grigory Ustinov <grenka@altlinux.org> 1.34.5-alt1
- Automatically updated to 1.34.5.

* Tue Jun 04 2024 Grigory Ustinov <grenka@altlinux.org> 1.34.3-alt1
- Automatically updated to 1.34.3.
