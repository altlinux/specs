...
%py3_requires z3c.rml reportlab zope.app.pagetemplate zope.app.publisher
%py3_requires zope.component zope.interface zope.publisher zope.schema
...
%py3_requires zope.app.testing zope.principalannotation
%py3_requires zope.copypastemove zope.app.container zope.app.folder
...
%changelog
* Mon Jun 06 2016 Ivan Zakharyaschev <imz@altlinux.org> 0.2.0-alt3.1.1
- (AUTO) subst_x86_64.
...
* Wed Jul 23 2014 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 0.2.0-alt3
