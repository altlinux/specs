...
Summary: toscawidgets2 wrapper for jquery cookie utilities
License: MIT
Group: Development/Python
Url: https://pypi.python.org/pypi/tw2.jqplugins.cookies/
Packager: Eugeny A. Rostovtsev (REAL) <real at altlinux.org>

# https://github.com/toscawidgets/tw2.jqplugins.cookies.git
# branch: develop
...
%description
tw2.jqplugins.cookies is a toscawidgets2 (tw2) wrapper for the jquery
cookie plugin.
...
%files
%doc *.rst
%python_sitelibdir/tw2/jqplugins/cookies
%python_sitelibdir/*.egg-info

%if_with python3
%files -n python3-module-%oname
%doc *.rst
%python3_sitelibdir/tw2/jqplugins/cookies
%python3_sitelibdir/*.egg-info
%endif

%changelog
* Sat Feb 07 2015 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 2.0.0-alt1.git20120320
