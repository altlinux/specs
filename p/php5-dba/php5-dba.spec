...
- rebuild with system libdb4-devel.

* Mon May 14 2007 L.A. Kostis <lakostis@altlinux.ru> 5.2.2-alt1.1
- rebuild for new php (5.2.2).

* Thu Apr 12 2007 Konstantin A. Lepikhov <lakostis@altlinux.org> 5.2.1-alt2.1
- x86_64 build fix.
