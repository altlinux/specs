...
%changelog
* Tue Aug 25 2026 Stanislav Levin <slev@altlinux.org> 4.0.7-alt1
- 4.0.6 -> 4.0.7
...
* Fri Nov 14 2025 Stanislav Levin <slev@altlinux.org> 4.0.3-alt1
- 3.3.8 -> 4.0.3.

* Mon Aug 11 2025 Stanislav Levin <slev@altlinux.org> 3.3.8-alt1
- 3.3.7 -> 3.3.8.

* Wed May 21 2025 Stanislav Levin <slev@altlinux.org> 3.3.7-alt1
- 3.3.5 -> 3.3.7.

* Mon Mar 10 2025 Stanislav Levin <slev@altlinux.org> 3.3.5-alt1
- 3.3.4 -> 3.3.5.

* Wed Jan 29 2025 Stanislav Levin <slev@altlinux.org> 3.3.4-alt1
- 3.3.3 -> 3.3.4.

* Tue Dec 24 2024 Stanislav Levin <slev@altlinux.org> 3.3.3-alt1
- 3.3.2 -> 3.3.3.

* Mon Dec 02 2024 Stanislav Levin <slev@altlinux.org> 3.3.2-alt1
- 3.3.1 -> 3.3.2.

* Wed Sep 25 2024 Stanislav Levin <slev@altlinux.org> 3.3.1-alt1
- 3.3.0 -> 3.3.1.

* Mon Sep 23 2024 Stanislav Levin <slev@altlinux.org> 3.3.0-alt1
- 3.2.6 -> 3.3.0.

* Thu Aug 22 2024 Stanislav Levin <slev@altlinux.org> 3.2.6-alt2
- Fixed FTBFS (astroid 3.3.1).

* Mon Jul 22 2024 Stanislav Levin <slev@altlinux.org> 3.2.6-alt1
- 3.2.5 -> 3.2.6.
