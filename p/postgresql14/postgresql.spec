...
%package -n %libecpg_name-%postgresql_major-devel
Summary: Development files for ECPG - Embedded SQL in C
Group: Development/Databases
...
%package -n %libecpg_name-%postgresql_major-devel-static
...
%files -f ecpglib.lang -n %libecpg_name-%postgresql_major
%_libdir/libecpg.so.%libecpg_major
%_libdir/libecpg.so.%libecpg_major.*
%_libdir/libecpg_compat.so.*
%_libdir/libpgtypes.so.*

%files -f ecpg.lang -n %libecpg_name-%postgresql_major-devel
%_bindir/ecpg
...
%files -n %libecpg_name-%postgresql_major-devel-static
%_libdir/libecpg*.a
...
* Thu Feb 12 2026 Alexei Takaseev <taf@altlinux.org> 14.21-alt1
- 14.21 (Fixes CVE-2026-2003, CVE-2026-2004, CVE-2026-2005, CVE-2026-2006)
...
* Wed Sep 24 2025 Alexei Takaseev <taf@altlinux.org> 14.19-alt2
...
* Wed Aug 13 2025 Alexei Takaseev <taf@altlinux.org> 14.19-alt1
- 14.19 (Fixes CVE-2025-8713, CVE-2025-8714, CVE-2025-8715)

* Wed May 07 2025 Alexei Takaseev <taf@altlinux.org> 14.18-alt1
- 14.18 (Fixes CVE-2025-4207)

* Sat Apr 12 2025 Alexei Takaseev <taf@altlinux.org> 14.17-alt4
- Add libpq5 subpackage (ALT #53800)

* Tue Apr 08 2025 Alexei Takaseev <taf@altlinux.org> 14.17-alt3
- Rollback change log_directory from 14.17-alt2

* Tue Apr 01 2025 Alexei Takaseev <taf@altlinux.org> 14.17-alt2
- Add catalog /var/log/postgres for logs
- Use LLVM 19.1
- Enable JIT on loongarch64 and Disable on E2K

* Tue Feb 18 2025 Alexei Takaseev <taf@altlinux.org> 14.17-alt1
- 14.17 (Fixes CVE-2025-1094)

* Fri Feb 14 2025 Alexei Takaseev <taf@altlinux.org> 14.15-alt4
...
* Sat Feb 08 2025 Alexei Takaseev <taf@altlinux.org> 14.15-alt3
...
* Mon Jan 27 2025 Alexei Takaseev <taf@altlinux.org> 14.15-alt2
- Add Conflicts: 17-1C

* Wed Nov 20 2024 Alexei Takaseev <taf@altlinux.org> 14.15-alt1
- 14.15

* Wed Nov 13 2024 Alexei Takaseev <taf@altlinux.org> 14.14-alt1
- 14.14 (Fixes CVE-2024-10976, CVE-2024-10977, CVE-2024-10978, CVE-2024-10979)
- Fix build by GCC > 13 and LLVM > 15 (drop patch 0002-Fix-search-for-setproctitle.patch)

* Thu Oct 31 2024 Alexei Takaseev <taf@altlinux.org> 14.13-alt4
- Use GCC 13

* Fri Sep 27 2024 Alexei Takaseev <taf@altlinux.org> 14.13-alt3
...
* Wed Sep 25 2024 Alexei Takaseev <taf@altlinux.org> 14.13-alt2
- Add triggerpostun and conflict for PG 17
- Remove triggerpostun and conflict for PG 10 and 11

* Fri Aug 09 2024 Alexei Takaseev <taf@altlinux.org> 14.13-alt1
- 14.13 (Fixes CVE-2024-7348)
...
* Mon Oct 09 2023 Alexei Takaseev <taf@altlinux.org> 14.9-alt4
...
* Wed Aug 09 2023 Alexei Takaseev <taf@altlinux.org> 14.9-alt1
- 14.9 (Fixes CVE-2023-39417)

* Mon Jul 24 2023 Alexei Takaseev <taf@altlinux.org> 14.8-alt2
- Use autoconf_2.60

* Wed May 10 2023 Alexei Takaseev <taf@altlinux.org> 14.8-alt1
- 14.8 (Fixes CVE-2023-2454, CVE-2023-2455)

* Mon Mar 20 2023 Alexei Takaseev <taf@altlinux.org> 14.7-alt3
- Delete noreplace for /etc/sysconfig/postgresql

* Fri Mar 03 2023 Alexei Takaseev <taf@altlinux.org> 14.7-alt2
...
* Wed Feb 08 2023 Alexei Takaseev <taf@altlinux.org> 14.7-alt1
- 14.7 (Fixes CVE-2022-41862)
...
* Sat Jun 18 2022 Alexei Takaseev <taf@altlinux.org> 14.4-alt1
- 14.4

* Wed May 11 2022 Alexei Takaseev <taf@altlinux.org> 14.3-alt1
- 14.3 (Fixes CVE-2022-1552)

* Wed Apr 13 2022 Alexei Takaseev <taf@altlinux.org> 14.2-alt4
- Build with llvm 12

* Sat Feb 26 2022 Alexei Takaseev <taf@altlinux.org> 14.2-alt3
- Build with JIT feature

* Thu Feb 24 2022 Alexei Takaseev <taf@altlinux.org> 14.2-alt2
- Conflicts: 13-1C -> 14-1C

* Mon Feb 21 2022 Alexei Takaseev <taf@altlinux.org> 14.2-alt1
- 14.2

* Thu Jan 27 2022 Alexei Takaseev <taf@altlinux.org> 14.1-alt2
...
* Wed Nov 10 2021 Alexei Takaseev <taf@altlinux.org> 14.1-alt1
