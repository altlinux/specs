...
%changelog
* Tue Jan 27 2026 Grigory Ustinov <grenka@altlinux.org> 6.7.1-alt1
- Automatically updated to 6.7.1.

* Mon Oct 13 2025 Grigory Ustinov <grenka@altlinux.org> 6.7.0-alt1
- Automatically updated to 6.7.0.

* Tue Aug 19 2025 Grigory Ustinov <grenka@altlinux.org> 6.6.4-alt1
- Automatically updated to 6.6.4.

* Wed Jul 02 2025 Grigory Ustinov <grenka@altlinux.org> 6.6.3-alt1
- Automatically updated to 6.6.3.

* Thu Jun 26 2025 Grigory Ustinov <grenka@altlinux.org> 6.5.1-alt1
- Automatically updated to 6.5.1.

* Tue Jun 24 2025 Grigory Ustinov <grenka@altlinux.org> 6.5.0-alt1
- Automatically updated to 6.5.0.

* Tue May 20 2025 Grigory Ustinov <grenka@altlinux.org> 6.4.4-alt1
- Automatically updated to 6.4.4.

* Fri Apr 11 2025 Grigory Ustinov <grenka@altlinux.org> 6.4.3-alt1
- Automatically updated to 6.4.3.
...
* Tue Apr 01 2025 Grigory Ustinov <grenka@altlinux.org> 6.3.0-alt1
- Automatically updated to 6.3.0.

* Mon Mar 17 2025 Grigory Ustinov <grenka@altlinux.org> 6.2.0-alt1
