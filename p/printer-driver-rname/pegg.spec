...
Patch2: printer-driver-rname-0.23-implicit-declaration-gcc14.patch
...
%changelog
* Fri Jun 20 2025 Constantin Sunzow <protvin@altlinux.org> 0.23-alt2
- Fix FTBFS: implicit declaration of function (GCC 14 compatibility).
