...
%filter_from_requires \,\(/sbin/chkconfig\|/usr/bin/easy_install-2\.7\|/usr/bin/pip\|apt\|curl\|erlang\|ftp\|gawk\|git-core\|grep\|initctl\|local/s*bin\|lxc\|make\|perl-Package\|python-base\|python2-base\|python-module-setuptools\|python-module-virtualenv\|rpm\|salt-minion\|salt-key\|service\|sudo\|systemctl\|systemd\|wget\|yum-config-manager\|rc-update\|/bin/launchctl\|/usr/sbin/installer\|python2\|yum\|dnf\|pacman\|/sbin/uname\|/usr/bin/kstat\),d
...
%changelog
* Sun Oct 15 2023 Michael Shigorin <mike@altlinux.org> 3006.3-alt3.2
- Fix weird Requires: of bootstrap-salt.sh.

* Sun Oct 15 2023 Michael Shigorin <mike@altlinux.org> 3006.3-alt3.1
- Fix flaky sysctl -w use (closes: #47289; thx Vladimir Mokrozub).

* Mon Sep 18 2023 Andrey Cherepanov <cas@altlinux.org> 3006.3-alt3
- Remove autorequirement of salt-sater from python3-module-salt.

* Tue Sep 12 2023 Andrey Cherepanov <cas@altlinux.org> 3006.3-alt2
