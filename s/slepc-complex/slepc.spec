...
Requires: %mpiimpl-devel libprimme-devel
%if "%scalar_type" == "real"
...
ADDLIBS="-lparpack_MPI-LINUX -lBLOPEX"
%endif
...
%changelog
* Fri May 29 2015 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 3.5.4-alt1.git20150525
- Version 3.5.4
...
* Wed Oct 10 2012 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 3.3_p1-alt2
- Rebuilt with gcc 4.7

* Mon Aug 13 2012 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 3.3_p1-alt1
- Version 3.3-p1
