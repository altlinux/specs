Name: sonar-maven-plugin
Version: 3.2
Summary: Maven-plugin module for sonar
License: LGPLv3+
Url: http://www.sonarqube.org
Packager: Igor Vlasenko <viy@altlinux.ru>
Provides: mvn(org.codehaus.sonar:sonar-maven3-plugin) = 3.2
Provides: mvn(org.codehaus.sonar:sonar-maven3-plugin:pom:) = 3.2
Provides: sonar-maven-plugin = 3.2-5.fc23
...
Requires: mvn(org.codehaus.sonar:sonar-batch)
Requires: mvn(org.slf4j:slf4j-api)

BuildArch: noarch
Group: Development/Java
Release: alt0.1jpp
Source: sonar-maven-plugin-3.2-5.fc23.cpio
