Name: sonar-batch-maven-compat
Version: 3.2
Summary: Compatibility layer, which provides MavenProject for non-Maven environments
License: LGPLv3+
Url: http://www.sonarqube.org
Packager: Igor Vlasenko <viy@altlinux.ru>
Provides: mvn(org.codehaus.sonar:sonar-batch-maven-compat) = 3.2
Provides: mvn(org.codehaus.sonar:sonar-batch-maven-compat:pom:) = 3.2
Provides: sonar-batch-maven-compat = 3.2-5.fc23
...
Release: alt0.1jpp
Source: sonar-batch-maven-compat-3.2-5.fc23.cpio
