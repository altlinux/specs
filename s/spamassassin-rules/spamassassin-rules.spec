...
Source: http://www.apache.org/dist/spamassassin/source/Mail-SpamAssassin-rules-%version.r1565117.tgz
...
Requires: perl-Mail-SpamAssassin >= 3.4.0
Conflicts: perl-Mail-SpamAssassin < 3.4.0
