...
%install
scons -j%__nprocs allow_warnings=1 optimize=1 qt=%_qt4dir SWIFT_INSTALLDIR=%buildroot%_prefix %buildroot%_prefix
...
%changelog
* Wed Aug 29 2018 Grigory Ustinov <grenka@altlinux.org> 3.0-alt2.beta2.1
