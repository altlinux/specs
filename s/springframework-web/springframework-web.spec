...
Provides: mvn(org.springframework:spring-web) = 3.2.14.RELEASE
Provides: mvn(org.springframework:spring-web:pom:) = 3.2.14.RELEASE
Provides: springframework-web = 0:3.2.14-2.fc23
...
Release: alt0.1jpp
Source: springframework-web-3.2.14-2.fc23.cpio
