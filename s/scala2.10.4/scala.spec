...
for libname in scala-compiler \
    ...
    scala-swing ; do
        ...
        install -pm 644 src/build/maven/$libname-pom.xml $RPM_BUILD_ROOT%{_mavenpomdir}/JPP.%{oldname}-$libname.pom
%add_maven_depmap JPP.%{oldname}-$libname.pom %{oldname}/$libname.jar
done
...
install -p -m 644 %{SOURCE24} $RPM_BUILD_ROOT%{_sysconfdir}/ant.d/%{name}

%if 0
cp -pr docs/examples $RPM_BUILD_ROOT%{_datadir}/%{name}/
%endif 
...
%{_javadir}/%{oldname}/%{oldname}-compiler.jar
%{_javadir}/%{oldname}/%{oldname}-library.jar
%{_javadir}/%{oldname}/%{oldname}-reflect.jar
%{_javadir}/%{oldname}/scalap.jar
%dir %{_datadir}/%{oldname}
%{_datadir}/%{oldname}/lib/j*.jar
%{_datadir}/%{oldname}/lib/%{oldname}-compiler.jar
%{_datadir}/%{oldname}/lib/%{oldname}-library.jar
%{_datadir}/%{oldname}/lib/%{oldname}-reflect.jar
%{_datadir}/%{oldname}/lib/scalap.jar
%{_datadir}/mime-info/*
...
%files swing
%{_datadir}/%{oldname}/lib/%{oldname}-swing.jar
%{_javadir}/%{oldname}/%{oldname}-swing.jar
%{_mavenpomdir}/JPP.%{oldname}-%{oldname}-swing.pom
%doc docs/LICENSE
