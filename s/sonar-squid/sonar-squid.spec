...
Provides: mvn(org.codehaus.sonar:sonar-squid) = 3.2
Provides: mvn(org.codehaus.sonar:sonar-squid:pom:) = 3.2
Provides: sonar-squid = 3.2-5.fc23
...
Requires: mvn(org.picocontainer:picocontainer)
Requires: mvn(org.slf4j:slf4j-api)

BuildArch: noarch
Group: Development/Java
Release: alt0.1jpp
Source: sonar-squid-3.2-5.fc23.cpio
