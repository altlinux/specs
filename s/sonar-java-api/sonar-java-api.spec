...
Provides: mvn(org.codehaus.sonar:sonar-java-api) = 3.2
Provides: mvn(org.codehaus.sonar:sonar-java-api:pom:) = 3.2
Provides: sonar-java-api = 3.2-5.fc23
...
Release: alt0.1jpp
Source: sonar-java-api-3.2-5.fc23.cpio
