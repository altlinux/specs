...
Release: alt1
License: GPLv2
Url: https://github.com/erdizz/scruffy
Source: %name-%version.tar
Group: System/Libraries
Summary: C/C++ parser and source code analyzer
Packager: Slava Dubrovskiy <dubrsl@altlinux.ru>

BuildRequires: gcc-c++ libmary-devel libmylang-devel libmycpp-devel libpargen-devel

%description
C/C++ parser and source code analyzer
