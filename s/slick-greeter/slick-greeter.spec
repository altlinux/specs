...
%changelog
* Fri Jul 03 2026 Anton Midyukov <antohami@altlinux.org> 2.2.7-alt1
- New version 2.2.7.

* Sun Jan 11 2026 Anton Midyukov <antohami@altlinux.org> 2.2.6-alt1
- New version 2.2.6.

* Sun Dec 28 2025 Anton Midyukov <antohami@altlinux.org> 2.2.5-alt1
- New version 2.2.5.
...
* Tue Dec 19 2023 Anton Midyukov <antohami@altlinux.org> 2.0.2-alt1
- 2.0.2

* Mon Dec 04 2023 Anton Midyukov <antohami@altlinux.org> 2.0.1-alt1
- 2.0.1
...
* Thu Dec 15 2022 Vladimir Didenko <cow@altlinux.org> 1.6.0-alt1
- 1.6.0
