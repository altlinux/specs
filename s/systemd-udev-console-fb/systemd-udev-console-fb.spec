...
install -m 644 96-fb-systemd.rules %buildroot%_udevrulesdir/
...
%_udevrulesdir/96-fb-systemd.rules

%changelog
* Thu Aug 04 2016 Hihin Ruslan <ruslandh@altlinux.ru> 1.00-alt2
- Update script (ALT bug #32350)
