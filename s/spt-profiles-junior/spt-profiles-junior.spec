...
%install
mkdir -p %buildroot/etc/spt/profiles/junior
for d in base live cd cdx dvd4 schoolcd schoolcdx schooldvd4; do
	cp -a "$d" %buildroot/etc/spt/profiles/junior
done
...
%changelog
* Wed Jan 23 2008 Sergey Bolshakov <sbolshakov@altlinux.ru> 0.4-alt5
- RC5 released
