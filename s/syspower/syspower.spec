...
Version: 9.9.9
Release: alt1
Summary: Syspower is a basic power menu and shutdown screen written in gtkmm4
...
%_bindir/%name
%_libexecdir/libsyspower.so
%_datadir/sys64/power/*.css
%_datadir/sys64/power/*.conf
