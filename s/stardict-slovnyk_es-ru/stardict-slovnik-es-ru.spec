%define dict_name		slovnyk_es-ru
%define dict_file		es-es_ru-ru
%define locale			ru_RU
%define dict_eng_name		Spanish-Russian
...
%changelog
* Fri Oct 03 2008 Mikhail Pokidko <pma@altlinux.org> 0.1-alt6
- initial build
