...
%changelog
* Tue Aug 18 2026 Dmitry V. Levin <ldv@altlinux.org> 7.2-alt1
- v7.1 -> v7.2.
...
* Tue Feb 10 2026 Dmitry V. Levin <ldv@altlinux.org> 6.19-alt1
- v6.18 -> v6.19.

* Sun Dec 07 2025 Dmitry V. Levin <ldv@altlinux.org> 6.18-alt1
- v6.17 -> v6.18.

* Mon Sep 29 2025 Dmitry V. Levin <ldv@altlinux.org> 6.17-alt1
- v6.16 -> v6.17.
...
* Tue Mar 25 2025 Dmitry V. Levin <ldv@altlinux.org> 6.14-alt1
- v6.13 -> v6.14.

* Thu Jan 23 2025 Dmitry V. Levin <ldv@altlinux.org> 6.13-alt1
- v6.12 -> v6.13.
...
* Sun Jul 21 2024 Dmitry V. Levin <ldv@altlinux.org> 6.10-alt1
- v6.9 -> v6.10.

* Tue May 14 2024 Dmitry V. Levin <ldv@altlinux.org> 6.9-alt1
- v6.8 -> v6.9.

* Wed Mar 20 2024 Dmitry V. Levin <ldv@altlinux.org> 6.8-alt1
- v6.7 -> v6.8.

* Mon Jan 29 2024 Dmitry V. Levin <ldv@altlinux.org> 6.7-alt1
- v6.6 -> v6.7.

* Tue Oct 31 2023 Dmitry V. Levin <ldv@altlinux.org> 6.6-alt1
- v6.5 -> v6.6.
...
* Mon May 08 2023 Dmitry V. Levin <ldv@altlinux.org> 6.3-alt1
- v6.2 -> v6.3.

* Sun Feb 26 2023 Dmitry V. Levin <ldv@altlinux.org> 6.2-alt1
- v6.1 -> v6.2.
...
* Sat Mar 26 2022 Dmitry V. Levin <ldv@altlinux.org> 5.17-alt1
- v5.16 -> v5.17.

* Mon Jan 10 2022 Dmitry V. Levin <ldv@altlinux.org> 5.16-alt1
- v5.15 -> v5.16.

* Wed Dec 01 2021 Dmitry V. Levin <ldv@altlinux.org> 5.15-alt1
- v5.14 -> v5.15.

* Thu Sep 02 2021 Dmitry V. Levin <ldv@altlinux.org> 5.14-alt1
- v5.13 -> v5.14.

* Sun Jul 18 2021 Dmitry V. Levin <ldv@altlinux.org> 5.13-alt1
- v5.12 -> v5.13.
...
* Thu Sep 24 2020 Dmitry V. Levin <ldv@altlinux.org> 5.9-alt1
- v5.8 -> v5.9.

* Thu Aug 06 2020 Dmitry V. Levin <ldv@altlinux.org> 5.8-alt1
- v5.7-41-g43bd136f1 -> v5.8.
...
* Sun Sep 16 2018 Dmitry V. Levin <ldv@altlinux.org> 4.24.0.85.9eea-alt1
- v4.24 -> v4.24-85-g9eeab9844.
