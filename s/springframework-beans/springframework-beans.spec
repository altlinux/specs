...
Provides: mvn(org.springframework:spring-beans) = 3.2.14.RELEASE
Provides: mvn(org.springframework:spring-beans:pom:) = 3.2.14.RELEASE
Provides: springframework-beans = 0:3.2.14-2.fc23
...
Release: alt0.1jpp
Source: springframework-beans-3.2.14-2.fc23.cpio
