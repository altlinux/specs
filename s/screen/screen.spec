...
- Fixes:
  ...
  + CVE-2025-46805 don't send signals with root privileges
...
* Tue Dec 14 2021 Vladimir D. Seleznev <vseleznv@altlinux.org> 4.8.0-alt3
- Added support for the bracket paste mode and the cursor-style manipulation.
