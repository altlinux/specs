...
install -Dm 644 shell/completion.zsh %buildroot%_datadir/zsh/site-functions/_%name
install -Dm 644 shell/completion.bash %buildroot%_datadir/bash-completion/completions/%name
