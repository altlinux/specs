...
* Sat Apr 13 2024 Anton Midyukov <antohami@altlinux.org> 1.27.6-alt1
- new version (1.27.6) with rpmgs script

* Wed Feb 07 2024 Anton Midyukov <antohami@altlinux.org> 1.27.3-alt1
- new version (1.27.3) with rpmgs script

* Fri Jan 05 2024 Anton Midyukov <antohami@altlinux.org> 1.27.2-alt1
- new version (1.27.2) with rpmgs script

* Tue Dec 05 2023 Anton Midyukov <antohami@altlinux.org> 1.27.0-alt1
- new version (1.27.0) with rpmgs script

* Thu Nov 16 2023 Anton Midyukov <antohami@altlinux.org> 1.26.1-alt1
- new version (1.26.1) with rpmgs script

* Fri Nov 10 2023 Anton Midyukov <antohami@altlinux.org> 1.26.0-alt1
- new version (1.26.0) with rpmgs script
...
* Mon Jun 12 2023 Anton Midyukov <antohami@altlinux.org> 1.23.5-alt1
- new version (1.23.5) with rpmgs script

* Fri Mar 10 2023 Anton Midyukov <antohami@altlinux.org> 1.23.2-alt1
- new version (1.23.2) with rpmgs script

* Sat Feb 18 2023 Anton Midyukov <antohami@altlinux.org> 1.23.1-alt1
- new version (1.23.1) with rpmgs script

* Fri Oct 28 2022 Anton Midyukov <antohami@altlinux.org> 1.22.0-alt1
- new version (1.22.0) with rpmgs script

* Fri Sep 09 2022 Anton Midyukov <antohami@altlinux.org> 1.21.0-alt1
- new version (1.21.0) with rpmgs script

* Sat May 07 2022 Anton Midyukov <antohami@altlinux.org> 1.20.1-alt1
- new version (1.20.1) with rpmgs script

* Thu Mar 03 2022 Anton Midyukov <antohami@altlinux.org> 1.19.1-alt1
- new version (1.19.1) with rpmgs script

* Sun Nov 07 2021 Anton Midyukov <antohami@altlinux.org> 1.18.4-alt1
- new version (1.18.4) with rpmgs script
