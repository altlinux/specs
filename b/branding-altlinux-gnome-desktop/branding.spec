%define theme gnome-desktop
%define Theme Ark Desktop
...
%define variants altlinux-office-desktop altlinux-office-server altlinux-lite altlinux-workbench school-master altlinux-desktop
...
%changelog
* Mon Jun 20 2011 Anton V. Boyarshinov <boyarsh@altlinux.ru> 5.9.9-alt3
- drop dependence on altlinux-menus

* Sat Feb 26 2011 Anton V. Boyarshinov <boyarsh@altlinux.ru> 5.9.9-alt2
- bootsplash images scaling
