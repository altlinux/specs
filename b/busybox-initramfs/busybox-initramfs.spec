...
# for volume_id f2fs detection support
BuildRequires: %bname-source >= %version-alt9
BuildConflicts: %bname-source > %version %bname-source < %version
...
%changelog
* Wed Nov 06 2013 Led <led@altlinux.ru> 1.21.1-alt3
- blkid: support '-u' and '-O' options (ignore now)

* Sun Aug 04 2013 Led <led@altlinux.ru> 1.21.1-alt2
- volume_id: add f2fs detection

* Tue Jul 02 2013 Led <led@altlinux.ru> 1.21.1-alt1
- 1.21.1

* Wed Mar 06 2013 Led <led@altlinux.ru> 1.21.0-alt2
- added:
  + FBSPLASH
...
* Mon Nov 26 2012 Led <led@altlinux.ru> 1.20.2-alt4
- improved blkid wrapper
- cleaned up vol_id wrapper
