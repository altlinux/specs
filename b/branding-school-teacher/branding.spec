...
%define distro_name ALT Linux 7.0.5%status_en School Teacher
%define distro_name_ru Альт Линукс 7.0.5%status Школьный Учитель
