...
BuildRequires: distro-licenses >= 1.4.5
...
%prep
%setup -n branding
cp /usr/share/distro-licenses/ALT_SP_FSB_License/license.{all,ru}.html.in notes/
...
%changelog
* Wed Sep 16 2026 Anton Midyukov <antohami@altlinux.org> 11.0-alt3
...
* Mon Aug 10 2026 Anton Midyukov <antohami@altlinux.org> 11.0-alt0.62
- Change license ALT_SP_FSB from distro-licenses >= 1.4.5.

* Fri Aug 07 2026 Anton Midyukov <antohami@altlinux.org> 11.0-alt0.61
- Update images.
- Disable background in installer.

* Fri Aug 07 2026 Anton Midyukov <antohami@altlinux.org> 11.0-alt0.60
