...
%if_with doc
BuildRequires: python3-module-objects.inv time
...
# generated by 'epm restore --dry-run' from bpython/requirements.txt
%py3_use Pygments
%py3_use curtsies >= 0.3.0
%py3_use greenlet
%py3_use requests
%py3_use setuptools
%py3_use six >= 1.5

# generated by 'epm restore --dry-run' from bpython/setup.py install_requires
%py3_use Pygments
%py3_use requests
%py3_use curtsies >= 0.3.0
%py3_use greenlet
...
sphinx-build3 -b html -d build/doctrees . html
popd
%endif
