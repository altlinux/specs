...
%_datadir/fish/vendor_completions.d/bazel.fish
%_datadir/zsh/site-functions/_bazel

%changelog
* Mon Aug 03 2026 Aleksandr Gamzin <gamzin@altlinux.org> 7.6.0-alt2
- Fix rebuild error for sisyphus.

* Wed Nov 19 2025 Aleksandr Gamzin <gamzin@altlinux.org> 7.6.0-alt1
- Updated to 7.6.0.
