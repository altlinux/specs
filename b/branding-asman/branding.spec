...
%define distro_name Asman %version%status_en
%define distro_name_ru Асман %version%status_en
%define distro_logo applications-all
...
. shell-config
shell_config_set /etc/sysconfig/grub2 GRUB_COLOR_NORMAL light-gray/black
shell_config_set /etc/sysconfig/grub2 GRUB_COLOR_HIGHLIGHT white/dark-gray
...
%_sysconfdir/alterator/sysconfig/lang/langlist.ki_KG
%_sysconfdir/alterator/sysconfig/lang/langlist.uz_UZ

%files graphics
%config /etc/alternatives/packages.d/%name-graphics
%_datadir/design
%exclude %_datadir/design/%brand/icons/system-logo.png

%files bootsplash
%_datadir/design/%brand/icons/system-logo.png
