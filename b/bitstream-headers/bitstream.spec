...
%changelog
* Mon Nov 24 2025 Alexei Takaseev <taf@altlinux.org> 1.6-alt1
- 1.6

* Sun Jul 27 2025 Alexei Takaseev <taf@altlinux.org> 1.5-alt6
- update to git:8b2bf575d593887e8fe58205d80c3948bb91a5bb
- Add new descriptors

* Mon Dec 16 2024 Alexei Takaseev <taf@altlinux.org> 1.5-alt5
- update to git:1a29d709aeeb4a80d2f9e2b5fcb27c4e223a113b

* Wed Oct 04 2023 Alexei Takaseev <taf@altlinux.org> 1.5-alt4
- update to git:2eec995c6f23c2202c2e2adcff925ae212c4ad2d
...
* Mon Sep 24 2018 Alexei Takaseev <taf@altlinux.org> 1.4-alt2
- update to git:6a24dfe25ba7145ade30d5c529a9bfaad7d22201
    * Append size check in scte35_validate.
    * Add more ATSC A/52 support
    * mpga: add mpga_sync_compare_formats_free

* Mon Jul 02 2018 Alexei Takaseev <taf@altlinux.org> 1.4-alt1
- 1.4
- Add to package bitstream.pc file
