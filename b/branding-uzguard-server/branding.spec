...
%define design_graphics_abi_minor 2
...
%define distro_name Uzguard OS Server Idora %version%status_en
%define distro_name_ru Uzguard OS Server Idora %version%status_en
...
BuildArch: noarch
Provides: design-alterator-browser-%theme branding-altlinux-%theme-browser-qt
