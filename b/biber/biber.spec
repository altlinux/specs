...
BuildRequires: perl(DateTime.pm) perl(DateTime/TimeZone.pm) perl(IO/String.pm) perl(LWP/Simple.pm) perl(Pod/Usage.pm) perl(Text/Diff/Config.pm) perl(parent.pm) perl-podlators
...
# Adapt tests to Unicode-Collate-1.27, bug #1674692, in upstream after 2.12
Patch1:         biber-2.12-backport-test-changes-for-U-C-fix.patch
Patch2:         biber-2.12-Updated-tests-after-U-C-upgrade-changed-sortinit.patch
Patch3:         biber-2.12-backport-test-changes-after-U-C-fix.patch
BuildArch:      noarch
...
Requires:       perl(Text/BibTeX.pm) >= 0.850
