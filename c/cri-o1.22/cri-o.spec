...
# golang1.16 needed for kubernetes1.22
...
%changelog
* Thu Jul 04 2024 Alexander Stepchenko <geochip@altlinux.org> 1.22.5-alt3
- Use macros for systemd instead of absolute paths.

* Tue Oct 31 2023 Alexey Shabalin <shaba@altlinux.org> 1.22.5-alt2
- Update BR golang.
