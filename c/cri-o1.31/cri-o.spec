...
%changelog
* Thu Nov 13 2025 Alexander Stepchenko <geochip@altlinux.org> 1.31.13-alt1
- 1.31.12 -> 1.31.13.

* Tue Sep 02 2025 Alexander Stepchenko <geochip@altlinux.org> 1.31.12-alt1
- Update to 1.31.12.

* Sat Aug 30 2025 Alexander Stepchenko <geochip@altlinux.org> 1.31.11-alt1
- Update to 1.31.11.

* Thu Jul 24 2025 Alexander Stepchenko <geochip@altlinux.org> 1.31.10-alt1
- 1.31.9 -> 1.31.10

* Mon Jun 09 2025 Alexander Stepchenko <geochip@altlinux.org> 1.31.9-alt1
- 1.31.7 -> 1.31.9

* Thu May 08 2025 Alexander Stepchenko <geochip@altlinux.org> 1.31.7-alt2
- Fix systemd service disabling before package deletion (Closes: #49768)

* Thu Apr 17 2025 Alexander Stepchenko <geochip@altlinux.org> 1.31.7-alt1
- 1.31.5 -> 1.31.7
