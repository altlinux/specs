...
%define cri_o_minor          25
%define cri_o_patch          5
...
%changelog
* Thu May 08 2025 Alexander Stepchenko <geochip@altlinux.org> 1.25.5-alt3
- Fix systemd service disabling before package deletion (Closes: #49768)

* Thu Jul 04 2024 Alexander Stepchenko <geochip@altlinux.org> 1.25.5-alt2
- Use macros for systemd instead of absolute paths.

* Tue Mar 05 2024 Alexey Shabalin <shaba@altlinux.org> 1.25.5-alt1
- 1.25.5
...
* Tue Oct 31 2023 Alexey Shabalin <shaba@altlinux.org> 1.24.6-alt2
- Update BR golang.

* Tue Jul 04 2023 Alexander Stepchenko <geochip@altlinux.org> 1.24.6-alt1
- 1.23.5 -> 1.24.6 (Fixes: CVE-2022-4318, CVE-2022-2995)

* Tue Jul 04 2023 Alexander Stepchenko <geochip@altlinux.org> 1.23.5-alt1
- 1.22.5 -> 1.23.5

* Fri Jun 09 2023 Alexander Stepchenko <geochip@altlinux.org> 1.22.5-alt1
- 1.22.3 -> 1.22.5 (Fixes: CVE-2022-1708)
- Add systemd service directives for crio
- Rename the package to include major and minor versions
- Use %%release instead of a git commit hash
