...
%changelog
* Thu May 08 2025 Alexander Stepchenko <geochip@altlinux.org> 1.29.13-alt2
- Fix systemd service disabling before package deletion (Closes: #49768)

* Thu Feb 20 2025 Alexander Stepchenko <geochip@altlinux.org> 1.29.13-alt1
- 1.29.12 -> 1.29.13

* Sun Jan 26 2025 Alexander Stepchenko <geochip@altlinux.org> 1.29.12-alt1
- 1.29.9 -> 1.29.12

* Wed Oct 30 2024 Alexander Stepchenko <geochip@altlinux.org> 1.29.9-alt1
- 1.29.8 -> 1.29.9
