...
%changelog
* Thu May 08 2025 Alexander Stepchenko <geochip@altlinux.org> 1.26.4-alt5
- Fix systemd service disabling before package deletion (Closes: #49768)

* Thu Jul 04 2024 Alexander Stepchenko <geochip@altlinux.org> 1.26.4-alt4
- Use macros for systemd instead of absolute paths.

* Tue Mar 05 2024 Ivan A. Melnikov <iv@altlinux.org> 1.26.4-alt3.1
