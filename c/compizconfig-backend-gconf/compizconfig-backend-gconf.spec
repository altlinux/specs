...
Version: 0.8.8
Release: alt2
Summary: GConfig Settings library for plugins - OpenCompositing Project
License: GPL
...
BuildRequires: gcc-c++ libGConf-devel libSM-devel libXcomposite-devel libXdamage-devel
BuildRequires: libXinerama-devel libXrandr-devel libcompizconfig-devel
BuildRequires: libstartup-notification-devel libxslt-devel
...
rm -f %buildroot%_libdir/compizconfig/backends/*.la
