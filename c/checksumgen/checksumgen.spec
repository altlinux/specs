...
%changelog
* Tue Sep 22 2026 Paul Wolneykien <manowar@altlinux.org> 0.4.8-alt1
- Added CHKSUMFROMSTRIP configuration option.
- Added CHKSUMFROM configuration option.
- Add --pubkey option.
- Added --edit-key option.
