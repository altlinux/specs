...
Summary(ru_RU.UTF-8): Программа для создания обложек к CD
Summary(uk_UA.UTF-8): Програма для створення обкладинок для CD
...
cdlabelgen дозволяє генерувати обкладинки для CD.

Знадобиться для покращення колекції дисків з ogg, архівами,
та й поновлення отого втраченого опакунку для диску!

Також використовується в combust.
