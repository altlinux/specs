...
Программа распознавания символов (OCR) Cuneiform, некогда очень популярная в
нашей стране, была выложена компанией Cognitive Technologies в свободный доступ
в 2008 году. Проект cuneiform-linux ставит своей целью полное портирование и
дальнейшее развитие Cuneiform под Linux и другие операционные системы.

%package data
Summary: Language support and other data files required for Cuneiform OCR
Summary(ru_RU.UTF-8): Поддержка различных языков и другие файлы с данными для OCR Cuneiform
Group: Graphics
BuildArch: noarch
...
%add_optflags -Wno-error=implicit-int
...
%changelog
* Wed Apr 22 2026 Artem Semenov <savoptik@altlinux.org> 1.1.0-alt7
