...
# git rev-parse v1.36.5^{commit}
%define git_commit dcd680fd83e792a9b625d38cc03c609722bd0baf

%define prog_name            cri-o
%define cri_o_major          1
%define cri_o_minor          36
...
%changelog
* Wed Sep 09 2026 Alexander Stepchenko <geochip@altlinux.org> 1.36.5-alt1
- 1.36.0 -> 1.36.5.
- Fixes:
