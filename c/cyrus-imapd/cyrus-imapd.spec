...
Patch2: cyrus-imapd-3.8.7-README-build-config.patch
Patch3: cyrus-imapd-3.8.7-sieve.lex-fix-undeclared-func.patch
...
BuildRequires: libsasl2-devel libssl-devel libnl-devel libpcre-devel libkrb5-devel
...
%if_with sphinx
BuildRequires: perl-Pod-POM-View-Restructured
BuildRequires: graphviz fonts-ttf-dejavu
...
# 3.4.6
BuildRequires: libshape-devel libbrotli-devel libnghttp2-devel libchardet-devel libzstd-devel
...
- security fixes:
  ...
  CVE-2026-47082
- build: use std=gnu99.
- BR: added zstd and update python3 deps.
- imap: update bundled configuration.

* Tue Mar 11 2025 Sergey Y. Afonin <asy@altlinux.org> 3.4.6-alt3
