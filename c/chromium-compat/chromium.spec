...
Summary:        An open source web browser developed by Google (old version with NPAPI support)
License:        BSD-3-Clause and LGPL-2.1+
Group:          Networking/WWW
Url:            http://code.google.com/p/chromium/

Source0:        chromium-%version.tar.gz
...
%add_findreq_skiplist %_libdir/chromium/xdg-settings
%add_findreq_skiplist %_libdir/chromium/xdg-mime
...
Requires:       chromium-compat = %version
...
install -pD -m644 %SOURCE200 %buildroot%_sysconfdir/chromium/default
...
for size in 22 24 48 64 128 256; do
	install -Dm644 "src/chrome/app/theme/chromium/product_logo_$size.png" \
		"%buildroot%_iconsdir/hicolor/${size}x${size}/apps/chromium.png"
done
...
# Desktop file
install -Dm0644 %SOURCE101 %buildroot%_desktopdir/chromium.desktop
...
printf '%_bindir/xbrowser\t%_bindir/chromium\t50\n' > %buildroot%_altdir/chromium
printf '%_bindir/chromium\t%_libdir/chromium/chromium-generic\t10\n' > %buildroot%_altdir/chromium-generic
printf '%_bindir/chromium\t%_libdir/chromium/chromium-kde\t15\n' > %buildroot%_altdir/chromium-kde
printf '%_bindir/chromium\t%_libdir/chromium/chromium-gnome\t15\n' > %buildroot%_altdir/chromium-gnome
...
%_man1dir/chrom*
%_desktopdir/chromium.desktop
%_datadir/gnome-control-center/default-apps/chromium-browser.xml
%_iconsdir/hicolor/*/apps/chromium.*
%_altdir/chromium
%_altdir/chromium-generic

%files kde
%attr(755, root, root) %_libdir/chromium/chromium-kde
%_altdir/chromium-kde

%files gnome
%attr(755, root, root) %_libdir/chromium/chromium-gnome
%_altdir/chromium-gnome

%changelog
* Tue Jul 29 2014 Andrey Cherepanov <cas@altlinux.org> 34.0.1847.137-alt2
- Rename package to chromium-compat
- Build with internal library v8
- Add commented command line arguments for PepperFlash support
