...
%package -n catch1-devel
Summary: C++ Unit Test framework ("all in one header")
Group: Development/C++
Conflicts: catch-devel < 1.12.2-alt2
Obsoletes: catch-devel < 1.12.2-alt2

%description -n catch1-devel
Catch stands for C++ Automated Test Cases in Headers 
and is a multi-paradigm automated 
test framework for C++ and Objective-C (and, maybe, C). 
It is implemented entirely in a set of header files, 
...
%files -n catch1-devel
%_includedir/*.hpp

%changelog
* Thu Jul 27 2023 Vitaly Lipatov <lav@altlinux.ru> 1.12.2-alt2
- build as catch1-devel from catch1 source package
