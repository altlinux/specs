Conflicts: cmake
%define oldname cmake
%define compatversion 2.8.10
Name: %oldname-%compatversion
Version: 2.8.10.2
Release: alt2
...
Patch: %oldname-%version-%release.patch
...
%package -n ccmake-%compatversion
Summary: Curses interface for CMake
Group: Development/Tools
Requires: %name = %version-%release
Conflicts: ccmake

%description -n ccmake-%compatversion
...
%package -n ctest-%compatversion
Summary: CMake test driver program
Group: Development/Tools
Requires: %name = %version-%release
Conflicts: ctest

%description -n ctest-%compatversion
...
install -pD -m644 %oldname.macros %buildroot%_rpmmacrosdir/%oldname`echo %compatversion|tr . _`
...
%files -n ccmake-%compatversion
%_bindir/ccmake
%_libdir/libcmForm.so
%_man1dir/ccmake.*


%files -n ctest-%compatversion
%_bindir/ctest
...
%changelog
* Wed Aug 21 2013 Igor Vlasenko <viy@altlinux.ru> 2.8.10.2-alt2
- compat version
