...
Name: clisp
Version: 2.49.95
Release: alt0.1.gitbc6573d7f
Epoch: 1

# For snapshot, the version ends with '+' sign
...
%build
touch version.sh
make -f Makefile.devel src/version.h configures
...
%changelog
* Tue Aug 11 2026 Ivan A. Melnikov <iv@altlinux.org> 1:2.49.95-alt0.1.gitbc6573d7f
- Build from master snapshot to fix UBs that cause segmentation
  faults when built with GCC15.
