...
%changelog
* Sat Jul 25 2026 Anton Midyukov <antohami@altlinux.org> 6.6.9-alt1
- New version 6.6.9.
...
* Mon Jan 26 2026 Anton Midyukov <antohami@altlinux.org> 6.6.6-alt1
- New version 6.6.6.

* Sun Jan 18 2026 Anton Midyukov <antohami@altlinux.org> 6.6.5-alt1
- New version 6.6.5.

* Sun Jan 11 2026 Anton Midyukov <antohami@altlinux.org> 6.6.4-alt1
- New version 6.6.4.

* Wed Dec 17 2025 Anton Midyukov <antohami@altlinux.org> 6.6.2-alt1
- New version 6.6.2.
...
* Wed Apr 30 2025 Anton Midyukov <antohami@altlinux.org> 6.4.10-alt1
- New version 6.4.10.
- Enable internal polkit agent.

* Sun Apr 27 2025 Anton Midyukov <antohami@altlinux.org> 6.4.9-alt1
- New version 6.4.9 (Closes: 54024).

* Thu Feb 27 2025 Anton Midyukov <antohami@altlinux.org> 6.4.8-alt1
- New version 6.4.8.

* Sun Jan 12 2025 Anton Midyukov <antohami@altlinux.org> 6.4.6-alt1
- New version 6.4.6.
...
* Thu Jul 18 2024 Anton Midyukov <antohami@altlinux.org> 6.2.5-alt1
- 6.2.5

* Thu Jul 11 2024 Anton Midyukov <antohami@altlinux.org> 6.2.4-alt1
- 6.2.4
...
* Fri Dec 29 2023 Anton Midyukov <antohami@altlinux.org> 6.0.3-alt1
- 6.0.3

* Thu Dec 21 2023 Anton Midyukov <antohami@altlinux.org> 6.0.2-alt1
- 6.0.2

* Sun Dec 17 2023 Anton Midyukov <antohami@altlinux.org> 6.0.1-alt1
- 6.0.1
