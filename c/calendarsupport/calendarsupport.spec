...
%define sover 6
%define libkpim6calendarsupport libkpim6calendarsupport%sover
...
BuildRequires: akonadi-calendar-devel kf6-kcalendarcore-devel kcalutils-devel kf6-kcontacts-devel kf6-kholidays-devel
...
%package -n %libkpim6calendarsupport
Group: System/Libraries
Summary: %name library
Requires: %name-common
%description -n %libkpim6calendarsupport
%name library
...
%_K6link/lib*.so
%_libdir/cmake/K*CalendarSupport/

%files -n %libkpim6calendarsupport
%_K6lib/libKPim6CalendarSupport.so.%sover
%_K6lib/libKPim6CalendarSupport.so.*
