...
%files -n lib%name
%doc AUTHORS ChangeLog README.md THANKS FAQ* RELNOTES
%_libdir/*.so.*
...
%changelog
* Sun Jun 21 2026 Andrey Cherepanov <cas@altlinux.org> 4.0.10-alt1
- New version.

* Wed Jun 17 2026 Andrey Cherepanov <cas@altlinux.org> 4.0.9-alt1
- New version.

* Tue Mar 24 2026 Andrey Cherepanov <cas@altlinux.org> 4.0.8-alt1
- New version.

* Wed Jan 21 2026 Andrey Cherepanov <cas@altlinux.org> 4.0.7-alt1
- New version.

* Sat Oct 11 2025 Andrey Cherepanov <cas@altlinux.org> 4.0.6-alt1
- New version.
...
* Wed Sep 04 2024 Andrey Cherepanov <cas@altlinux.org> 4.0.3-alt1
- New version.

* Mon Dec 04 2023 Andrey Cherepanov <cas@altlinux.org> 4.0.2-alt1
- New version.
