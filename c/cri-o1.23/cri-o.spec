...
%changelog
* Thu May 08 2025 Alexander Stepchenko <geochip@altlinux.org> 1.23.5-alt4
- Fix systemd service disabling before package deletion (Closes: #49768)

* Thu Jul 04 2024 Alexander Stepchenko <geochip@altlinux.org> 1.23.5-alt3
- Use macros for systemd instead of absolute paths.

* Tue Oct 31 2023 Alexey Shabalin <shaba@altlinux.org> 1.23.5-alt2
- Update BR golang.
