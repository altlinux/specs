...
Source2: http://releases.llvm.org/%version/lld-%version.src.tar.xz
...
%if_with clang
BuildRequires: clang llvm-devel lld
# FIXME!!
...
Conflicts: llvm4.0-devel llvm6.0-devel
Requires: %name = %EVR
...
Group: Development/C
Conflicts: llvm4.0-devel-static llvm6.0-devel-static
...
Group: Development/C
Conflicts: clang6.0-devel-static
Requires: %clang_name = %EVR
...
%changelog
* Wed May 16 2018 Valery Inozemtsev <shrek@altlinux.ru> 6.0.0-alt1%ubt
