...
BuildRequires: /usr/bin/pcre-config /usr/bin/perl libruby-devel lua-devel perl(DynaLoader.pm) perl(Exporter.pm) perl(base.pm) perl(overload.pm) perl-podlators
