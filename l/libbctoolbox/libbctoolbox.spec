...
# Automatically added by buildreq on Tue Aug 09 2016
# optimized out: CUnit gnu-config libstdc++-devel perl pkg-config python-base
BuildRequires: CUnit-devel gcc-c++ libmbedtls-devel
