...
Vcs: https://github.com/grafana/loki.git
...
go build "$GOFLAGS" -tags "$TAGS" -ldflags="$GOLDFLAGS" ./cmd/lokitool
...
%changelog
* Tue Mar 10 2026 Alexey Shabalin <shaba@altlinux.org> 3.6.7-alt1
- updated from 3.6.6 to 3.6.7

* Thu Feb 19 2026 Alexey Shabalin <shaba@altlinux.org> 3.6.6-alt1
- updated from 3.6.3 to 3.6.6

* Thu Jan 08 2026 Alexey Shabalin <shaba@altlinux.org> 3.6.3-alt1
- New version 3.6.3.
...
* Fri Jul 25 2025 Alexey Shabalin <shaba@altlinux.org> 3.5.3-alt1
- New version 3.5.3.

* Tue Jun 17 2025 Alexey Shabalin <shaba@altlinux.org> 3.5.1-alt1
- New version 3.5.1.
...
* Mon Dec 16 2024 Alexey Shabalin <shaba@altlinux.org> 3.3.1-alt1
- New version 3.3.1.

* Tue Oct 22 2024 Alexey Shabalin <shaba@altlinux.org> 3.2.1-alt1
- New version 3.2.1.

* Thu Oct 17 2024 Alexey Shabalin <shaba@altlinux.org> 3.2.0-alt1
- New version 3.2.0.

* Fri Mar 29 2024 Alexey Shabalin <shaba@altlinux.org> 2.9.6-alt1
- New version 2.9.6.

* Sun Mar 03 2024 Alexey Shabalin <shaba@altlinux.org> 2.9.5-alt1
- New version 2.9.5.
