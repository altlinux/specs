...
%changelog
* Fri Aug 07 2026 Alexander Danilov <admsasha@altlinux.org> 1.0.30-alt1
- New version 1.0.30.

* Fri Jul 25 2025 Alexey Shabalin <shaba@altlinux.org> 1.0.29-alt1
- New version 1.0.29.

* Mon May 19 2025 Alexey Shabalin <shaba@altlinux.org> 1.0.28-alt1
- New version 1.0.28.

* Fri May 03 2024 Alexey Shabalin <shaba@altlinux.org> 1.0.27-alt1
- New version 1.0.27.

* Sat Jul 29 2023 Arseny Maslennikov <arseny@altlinux.org> 1.0.26-alt3
- NMU: Adapted for the /usr merge.
