...
BuildRequires: cmake
BuildRequires: gcc-c++
BuildRequires: llvm%llvmversion.0 >= 17.0.6-alt7
BuildRequires: llvm%llvmversion.0-devel >= 17.0.6-alt7
BuildRequires: clang%llvmversion.0-devel >= 17.0.6-alt7
...
Group: Development/C++
Requires: %name = %EVR
Conflicts: libintel-opencl-clang14-devel, libintel-opencl-clang15-devel libintel-opencl-clang16-devel
...
%changelog
* Mon Sep 14 2026 L.A. Kostis <lakostis@altlinux.ru> 17.0.10-alt1
- 17.0.10.

* Mon Sep 14 2026 L.A. Kostis <lakostis@altlinux.ru> 17.0.9-alt1
- 17.0.9.
