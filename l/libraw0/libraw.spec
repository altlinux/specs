...
Summary: Library for reading RAW files obtained from digital photo cameras
Group: System/Libraries
%description -n %libraw
%{summary}.

%package -n %libraw_r
Summary: Library for reading RAW files obtained from digital photo cameras
Group: System/Libraries
%description -n %libraw_r
%{summary}.
...
mv %buildroot/%_pkgconfigdir/libraw{,%sover}.pc
mv %buildroot/%_pkgconfigdir/libraw_r{,%sover}.pc
install -d %buildroot/%_sysconfdir/alternatives/packages.d/
cat > %buildroot/%_sysconfdir/alternatives/packages.d/%name-devel <<__EOF__
%_pkgconfigdir/libraw.pc %_pkgconfigdir/libraw%sover.pc %EVR
%_pkgconfigdir/libraw_r.pc %_pkgconfigdir/libraw_r%sover.pc %EVR
__EOF__
