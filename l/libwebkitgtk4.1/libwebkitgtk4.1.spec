...
Patch11: webkitgtk-2.52.4-deb-fix-ftbfs-system-malloc.patch
...
%package -n libwebkit2gtk%api_ver
...
%description -n libwebkit2gtk%api_ver
...
%description -n libwebkit2gtk%api_ver-devel
The GTK+ port of WebKit is intended to provide a browser component
primarily for users of the portable GTK+ UI toolkit on platforms like
Linux. This package contains development headers.

%package -n libwebkit2gtk%api_ver-devel-doc
Summary: Development documentation for WebKit2GTK
Group: Development/Documentation
BuildArch: noarch
Conflicts: libwebkit2gtk%api_ver < %version-%release

%description -n libwebkit2gtk%api_ver-devel-doc
The GTK+ port of WebKit is intended to provide a browser component
primarily for users of the portable GTK+ UI toolkit on platforms like
Linux.
...
%package -n libwebkit2gtk%api_ver-gir
...
%description -n libwebkit2gtk%api_ver-gir
GObject introspection data for the Webkit2GTK library

%package -n libwebkit2gtk%api_ver-gir-devel
Summary: GObject introspection devel data for the Webkit2GTK library
Group: Development/Other
BuildArch: noarch
Requires: libwebkit2gtk%api_ver-gir = %EVR
Requires: libwebkit2gtk%api_ver-devel = %EVR
Requires: libjavascriptcoregtk%api_ver-gir = %EVR
Requires: libjavascriptcoregtk%api_ver-devel = %EVR
Requires: libjavascriptcoregtk%api_ver-gir-devel = %EVR

%description -n libwebkit2gtk%api_ver-gir-devel
...
%files -n libwebkit2gtk%api_ver -f WebKitGTK-%api_ver.lang
...
%files -n libwebkit2gtk%api_ver-devel
%_libdir/libwebkit2gtk-%api_ver.so
...
%if_enabled gtkdoc
%files -n libwebkit2gtk%api_ver-devel-doc
%_gtk_docdir/*
%endif
...
- 2.52.6 (fixed CVE-2026-28984, CVE-2026-43804, CVE-2026-64713,
  ...
  CVE-2026-64783, CVE-2026-64787)

* Thu Jul 09 2026 Yuri N. Sedunov <aris@altlinux.org> 2.52.5-alt1
- 2.52.5

* Tue Jun 02 2026 Yuri N. Sedunov <aris@altlinux.org> 2.52.4-alt1
- 2.52.4
...
* Wed Dec 18 2024 Yuri N. Sedunov <aris@altlinux.org> 2.46.5-alt1
- 2.46.5

* Wed Nov 27 2024 Yuri N. Sedunov <aris@altlinux.org> 2.46.4-alt1
- 2.46.4

* Thu Oct 31 2024 Yuri N. Sedunov <aris@altlinux.org> 2.46.3-alt1
- 2.46.3
...
* Sun Mar 17 2024 Yuri N. Sedunov <aris@altlinux.org> 2.44.0-alt1
- 2.44.0
...
* Sat Mar 18 2023 Yuri N. Sedunov <aris@altlinux.org> 2.40.0-alt1
- 2.40.0
...
* Sun Jul 10 2022 Yuri N. Sedunov <aris@altlinux.org> 2.36.4-alt1
- 2.36.4 (4.1 API with libsoup3)
- disabled WebKitWebDriver binary to avoid conflict
