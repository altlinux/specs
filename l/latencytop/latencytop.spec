...
Patch2: latencytop-fedora-add-return-type-c99.patch
Patch3: latencytop-fedora-remove-the-fsync-view.patch
Patch4: latencytop-fedora-better-error-message.patch
...
%changelog
* Mon Feb 10 2025 Ivan A. Melnikov <iv@altlinux.org> 0.5-alt3
- cleanup our old patches
- import a few patches from Fedora
  + fix FTBFS
  + drop fsync view (it did not work anyway)
