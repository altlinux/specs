%define orig_name libopensync-plugin-gpe
Name: libopensync0-plugin-gpe
Version: 0.22
Release: alt2

Summary: Gpe plugin for Opie
License: GPL
...
%description
This plugin allows applications using GPE to synchronise.
