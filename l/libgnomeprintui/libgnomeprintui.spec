...
Patch1: %name-2.18.3-system-config-printer.patch
Patch2: %name-fix-syntax.patch
...
%changelog
* Thu Sep 02 2021 Leontiy Volodin <lvol@altlinux.org> 2.18.6-alt3
- Returned with libgnomeprint for p9 branch
- Apply patch from PCLinuxOS

* Fri Mar 18 2016 Andrey Cherepanov <cas@altlinux.org> 2.18.6-alt2
- Fix build
