...
%changelog
* Sun May 31 2026 Anton Midyukov <antohami@altlinux.org> 2.4.1-alt1
- New version 2.4.1.

* Mon Apr 20 2026 Anton Midyukov <antohami@altlinux.org> 2.4.0-alt1
- New version 2.4.0.

* Thu Apr 02 2026 Anton Midyukov <antohami@altlinux.org> 2.3.3-alt1
- New version 2.3.3.

* Mon Dec 22 2025 Anton Midyukov <antohami@altlinux.org> 2.3.2-alt1
- New version 2.3.2.
...
* Sun Jan 12 2025 Anton Midyukov <antohami@altlinux.org> 2.1.4-alt1
- New version 2.1.4.

* Sun Dec 01 2024 Anton Midyukov <antohami@altlinux.org> 2.1.3-alt1
- New version 2.1.3.

* Mon Nov 25 2024 Anton Midyukov <antohami@altlinux.org> 2.1.2-alt1
- New version 2.1.2.
