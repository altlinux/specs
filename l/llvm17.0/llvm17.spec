...
# gcc 15 fixes
Patch210: compiler-rt-gcc15-build.patch
Patch211: gtest-gcc15-build.patch
Patch212: llvm-gcc15-build.patch
Patch213: mlir-gcc15-build.patch
...
BuildRequires: mold
%endif
BuildRequires: libomp%omp_vmajor
...
# unpackaged files
%ifarch loongarch64
rm %buildroot%_libdir/libomptarget.so.%v_majmin
rm %buildroot%llvm_libdir/libomptarget.so.%v_majmin
...
%llvm_libdir/libomptarget.rtl.amdgpu.so.%v_major
%llvm_libdir/libomptarget.rtl.cuda.so.%v_major
%llvm_libdir/libomptarget.rtl.%libomp_arch.so.%v_major
%llvm_libdir/libomptarget.so.%v_major
%_libdir/libomptarget.rtl.amdgpu.so.%v_major
%_libdir/libomptarget.rtl.cuda.so.%v_major
%_libdir/libomptarget.rtl.%libomp_arch.so.%v_major
%_libdir/libomptarget.so.%v_major
%endif
...
- aarch64: compile with clang/mold again.
