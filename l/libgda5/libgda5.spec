...
%find_lang --with-gnome %_name-%abi_ver
%find_lang --with-gnome --output gda-help.lang gda-sql gda-vala
...
%_includedir/*
%_libdir/*.so
%_libdir/pkgconfig/libgda-%abi_ver.pc
...
%{?_with_ldap:%_libdir/pkgconfig/libgda-ldap-%abi_ver.pc}
%{?_enable_vala:%_vapidir/*.vapi}

%files devel-doc -f gda-help.lang
