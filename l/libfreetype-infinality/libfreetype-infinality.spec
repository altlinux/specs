...
%changelog
* Wed Jun 13 2018 Vladimir Didenko <cow@altlinux.ru> 2.8.0-alt7
- Make package empty (prepare for removing from repo).

* Thu Feb 8 2018 Vladimir Didenko <cow at altlinux.ru> 2.8.0-alt6
