...
Vcs: https://github.com/libjpeg-turbo/libjpeg-turbo

# Source-url: https://github.com/libjpeg-turbo/libjpeg-turbo/archive/%version/libjpeg-turbo-%version.tar.gz
Source: libjpeg-turbo-%version.tar
Patch0: libjpeg-turbo-%version-%release.patch
Patch1: libjpeg-turbo-3.1.0-alt-header-files.patch
...
%changelog
* Wed Jul 01 2026 Leontiy Volodin <lvol@altlinux.org> 3.2.0-alt1
- New version 3.2.0.

* Mon Mar 30 2026 Leontiy Volodin <lvol@altlinux.org> 3.1.4.1-alt1
- New version 3.1.4.1.

* Fri Mar 27 2026 Leontiy Volodin <lvol@altlinux.org> 3.1.4-alt1
- New version 3.1.4.

* Fri Dec 12 2025 Leontiy Volodin <lvol@altlinux.org> 3.1.3-alt1
- New version 3.1.3.

* Thu Sep 04 2025 Leontiy Volodin <lvol@altlinux.org> 3.1.2-alt1
- New version 3.1.2.

* Mon Jun 09 2025 Leontiy Volodin <lvol@altlinux.org> 3.1.1-alt1
- New version 3.1.1.

* Mon Dec 16 2024 Leontiy Volodin <lvol@altlinux.org> 3.1.0-alt1
- New version 3.1.0.
- Added vcs tag.
- Updated patches.

* Mon Sep 16 2024 Leontiy Volodin <lvol@altlinux.org> 3.0.4-alt1
- New version 3.0.4.
...
* Tue Oct 17 2023 Leontiy Volodin <lvol@altlinux.org> 3.0.1-alt1
- New version (3.0.1).
