...
Patch1: %name-2.31-alt-DSO.patch
...
BuildPreReq: gobject-introspection-devel >= 0.6.7 libgtk+2-gir-devel
BuildRequires: gcc-c++
...
%changelog
* Wed Jun 13 2012 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 2.31.2-alt1.1
- Fixed build
