...
%package -n libglvnd0-devel
Summary: Development files for %name
Group: Development/C
Provides: %name-devel = %epoch:%version-%release

%description -n libglvnd0-devel
...
%files -n libglvnd0-devel
%_includedir/glvnd
%_libdir/lib*.so
%_pkgconfigdir/%rname.pc

%changelog
* Sat Oct 20 2018 Valery Inozemtsev <shrek@altlinux.ru> 6:1.1.0-alt0.2
- provides libGLdispatch, libglvnd0-devel
