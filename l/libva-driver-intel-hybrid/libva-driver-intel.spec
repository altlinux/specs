...
Patch: 0001-Revert-for-Gen6-H264-Use-macroblock-pair-to-calculat.patch
...
# due wayland compatiblity and crazy upstream versioning
...
%changelog
* Sat Feb 28 2026 L.A. Kostis <lakostis@altlinux.ru> 2.4.5-alt2
- Apply fix from master:
  + Revert for Gen6: H264: Use macroblock pair to calculate H264
    decoding parameter under MBAFF flag
