...
%define name 			libxdtv-theme-aqua-ru
%define m_name 			libxdtv_theme_aqua_ru
...
- NMU (by repocop): the following fixes applied:
  ...
  * postun_ldconfig for libxdtv-theme-aqua-ru
  * distribution-tag for libxdtv-theme-aqua-ru
