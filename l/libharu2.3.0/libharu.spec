...
Source0:        https://github.com/libharu/${name}/archive/%{gittag0}/libharu-%{version}.tar.gz
...
%description -n libharu
libHaru is a library for generating PDF files.
It is free, open source, written in ANSI C and cross platform.

%prep
%setup -qn libharu-%{gittag0}
# fix cmake build
%patch0 -p1 -b .cmake
...
%changelog
* Wed Jan 31 2024 Anton Farygin <rider@altlinux.ru> 2.3.0-alt3
