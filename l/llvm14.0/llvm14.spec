...
Patch20: lldb-alt-gcc-0002-satisfy-ALT-gcc-s-Werror-return-type.patch
# Present in llvmorg-15.0.0-rc1.
Patch21: clang-D129160.patch

# gentoo patches
Patch30: cmake-disable-gcc-lifetime-dse.patch
Patch31: compiler-rt-sanitizer-remove-uapi-headers.patch
Patch32: debuginfo-accept-register-reads-after-isel.patch
Patch33: llvm-bpf-fix-bpfadjust-bug.patch
Patch34: llvm-bpf-fix-bitfield-relocation-error.patch

# upstream patches
Patch40: lldb-get-rid-of__STDC_LIMIT_MACROS-D134877.patch
...
%changelog
* Tue Sep 12 2023 L.A. Kostis <lakostis@altlinux.ru> 14.0.6-alt2
- Resurrect from orphaned.
- Disable lldb (too many problems with compilation).
- [lldb] Apply upstream fix D134877 (get rid of __STDC_LIMIT_MACROS).
- Apply some patches from gentoo (upstream cherrypicks):
  + cmake-disable-gcc-lifetime-dse.patch
  + compiler-rt-sanitizer-remove-uapi-headers.patch
  + debuginfo-accept-register-reads-after-isel.patch
  + llvm-bpf-fix-bpfadjust-bug.patch
  + llvm-bpf-fix-bitfield-relocation-error.patch
