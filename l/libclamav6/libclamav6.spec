...
Summary: Compatibility package with shared libraries of ClamAV 0.98.7
License: GPLv2 only
...
%changelog
* Fri Dec 04 2015 Sergey Y. Afonin <asy@altlinux.ru> 0.98.7-alt2
- Compatibility package with shared libraries of ClamAV 0.98.7
  (based on clamav 0.98.7-alt1 package)
