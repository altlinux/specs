...
%exclude %luarocks_dbdir_prefix-%target_lua_version/%oname/*/docs

%changelog
* Sun Feb 15 2026 Ildar Mulyukov <ildar@altlinux.ru> 1:3.1.0-alt4_lr1
- get rid of .../luarocks/.../docs symlink (ALT #57745)
