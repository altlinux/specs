...
%if "%(rpmvercmp '%{get_version libicu-devel}' '7.8.1')" < "0"
...
# https://bugzilla.mozilla.org/show_bug.cgi?id=2056504
Patch1: bmo2056504-fix-installed-headers.patch
...
../js/src/configure \
    ...
    %{?_without_system_icu:--without-system-icu} \
    --with-intl-api \
