...
BuildRequires: gcc-c++ asciidoc-a2x ctags hamlib-devel libfftw3-devel openmpi-devel python-devel qt5-base-devel qt5-multimedia-devel qt5-serialport-devel ImageMagick-tools
...
dB more sensitive than JT65 while using less than 10% of the bandwidth.  With
either JT9 or JT65, world-wide QSOs are possible with power levels of a few
