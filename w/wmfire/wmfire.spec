...
Summary(uk_UA.UTF-8): Аплет WindowMaker, який зображає завантаження як полум'я
...
wmfire - цікавий аплет для WindowMaker, який відображує
завантаження системи (чи числові дані з файлу) у вигляді полум'я;
при цьому сам він майже не додає до нього.

Це поновлена версія, котра використовує GDK для зниження
використання процесору при малюванні (приблизно вдвічі).
