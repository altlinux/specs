...
BuildRequires: desktop-file-utils dos2unix fakeroot lazarus rpm-utils sisyphus_check
...
FFMPEG или его форк LibAV. Может видео во все форматы, в которые может
конвертивровать FFMPEG или его форк LibAV.
WinFF может одновременно ковертировать видео в разные форматы.
