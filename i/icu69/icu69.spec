...
Summary: International Components for Unicode (libraries) development files
Group: Development/C++
...
%changelog
* Tue Mar 04 2025 Pavel Skrylev <majioa@altlinux.org> 1:6.9.1-alt3.1
- * restored icu69 to build compatible soft
