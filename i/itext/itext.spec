...
pushd src
 ant -Dant.build.javac.source=1.8 -Dant.build.javac.target=1.8  -Ditext.jdk.core=1.8 \
     -Ditext.jdk.rups=1.8 \
     -Ditext.jdk.toolbox=1.8 \
...
%changelog
* Mon Sep 14 2026 Anton Meleshnikov <alton@altlinux.org> 1:2.1.7-alt8
- FTBFS fix
