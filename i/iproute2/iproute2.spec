...
%changelog
* Mon Dec 01 2025 Arseny Maslennikov <arseny@altlinux.org> 6.18.0-alt1
- 6.17.0 -> 6.18.0.

* Thu Oct 02 2025 Arseny Maslennikov <arseny@altlinux.org> 6.17.0-alt1
- 6.16.0 -> 6.17.0.
...
* Wed Sep 25 2024 Arseny Maslennikov <arseny@altlinux.org> 6.11.0-alt1
- 6.10.0 -> 6.11.0.

* Wed Jul 17 2024 Arseny Maslennikov <arseny@altlinux.org> 6.10.0-alt1
- 6.9.0 -> 6.10.0.

* Wed May 15 2024 Arseny Maslennikov <arseny@altlinux.org> 6.9.0-alt1
- 6.8.0 -> 6.9.0.
...
* Tue Apr 27 2021 Dmitry V. Levin <ldv@altlinux.org> 5.12.0-alt1
- 5.11.0 -> 5.12.0.

* Tue Feb 23 2021 Dmitry V. Levin <ldv@altlinux.org> 5.11.0-alt1
- 5.10.0 -> 5.11.0.

* Tue Dec 15 2020 Dmitry V. Levin <ldv@altlinux.org> 5.10.0-alt1
- 5.9.0 -> 5.10.0.

* Thu Oct 15 2020 Dmitry V. Levin <ldv@altlinux.org> 5.9.0-alt1
- 5.8.0 -> 5.9.0.

* Mon Aug 03 2020 Dmitry V. Levin <ldv@altlinux.org> 5.8.0-alt1
- 5.7.0 -> 5.8.0.
