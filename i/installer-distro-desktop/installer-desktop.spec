...
Provides: installer-desktop-stage2
Obsoletes: installer-desktop-stage2
...
Provides: installer-desktop-stage3
Obsoletes: installer-desktop-stage3
...
%changelog
* Fri Jan 20 2012 Michael Shigorin <mike@altlinux.org> 5.0-alt23
- fixed du(1) output handling

* Tue Oct 13 2009 Michael Shigorin <mike@altlinux.org> 5.0-alt22
- i-f-runlevel5 moved from stage2 to stage3 (following its rewrite)
- added an Url:
- minor spec cleanup

* Thu Oct 01 2009 Andrey Cherepanov <cas@altlinux.org> 5.0-alt21
- fix icon placement and names (closes: #21169)

* Tue Sep 29 2009 Anton V. Boyarshinov <boyarsh@altlinux.ru> 5.0-alt20
- 05-vm-profile fixed (closes: 21324)
