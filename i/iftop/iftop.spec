...
%build
%add_optflags -fno-strict-aliasing -DNO_SYSTEM -std=gnu17
%autoreconf
...
%changelog
* Sun Aug 02 2026 Anton Midyukov <antohami@altlinux.org> 0.17-alt6
- Fix FTBFS with gcc15 (add optflag "-std=gnu17").
