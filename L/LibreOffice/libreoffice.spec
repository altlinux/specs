...
# There is no module ListDataListener in LO 7.5.4.2
%add_findreq_skiplist %lodir/program/wizards/ui/event/ListModelBinder.py
...
%changelog
* Sat Jul 26 2025 kotopesutility <kotopesutility@altlinux.org> 25.2.5.2-alt1
- Update to upstream 25.2.5.2
...
* Thu Nov 14 2024 Daniel Zagaynov <kotopesutility@altlinux.org> 24.8.3.2-alt1
- Update to 24.8.3.2

* Fri Nov 08 2024 Daniel Zagaynov <kotopesutility@altlinux.org> 24.8.3.1-alt1
- Update to 24.8.3.1.
...
* Fri May 03 2024 Daniel Zagaynov <kotopesutility@altlinux.org> 24.2.3.2-alt1
- Update to 24.2.3.2.
