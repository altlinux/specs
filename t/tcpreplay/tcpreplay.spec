...
BuildRequires: gcc-c++ groff-base libdnet-devel libpcap-devel tcpdump libopts-devel /proc
...
%install
%makeinstall_std
rm -rf %buildroot%_libdir/libtcpreplay.a \
       %buildroot%_libdir/pkgconfig \
       %buildroot%_includedir/tcpreplay
...
%changelog
* Sat Aug 15 2026 Anton Farygin <rider@altlinux.org> 4.6.1-alt1
- 4.6.0 -> 4.6.1

* Thu Jul 30 2026 Anton Farygin <rider@altlinux.org> 4.6.0-alt1
- 4.5.3 -> 4.6.0

* Tue Jul 21 2026 Anton Farygin <rider@altlinux.org> 4.5.3-alt1
- 4.5.2 -> 4.5.3

* Sat Sep 13 2025 Anton Farygin <rider@altlinux.com> 4.5.2-alt1
