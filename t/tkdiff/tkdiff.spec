...
Summary(ru_RU.UTF-8): Графический интерфейс к DIFF

License: GPL-2.0-or-later
Group: Development/Other
Url: http://sourceforge.net/projects/tkdiff/

# repacked sources from https://sourceforge.net/projects/tkdiff/files/tkdiff/%version/
...
cut & paste) and support for Subversion, RCS, CVS, SCCS, Mercurial and Git.
...
%changelog
* Wed Feb 05 2020 Vladimir D. Seleznev <vseleznv@altlinux.org> 4.3.5-alt1
- 4.3.5.
- Added watch file.
