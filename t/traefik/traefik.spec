...
%changelog
* Tue Sep 15 2026 Alexander Danilov <admsasha@altlinux.org> 3.7.13-alt1
- Updated from 3.6.25 to 3.7.13 (Fixes: CVE-2026-53622, CVE-2026-88004,
  CVE-2026-88007, CVE-2026-88008, CVE-2026-88009, CVE-2026-88011,
  CVE-2026-88012, CVE-2026-88878, CVE-2026-88879).

* Mon Aug 03 2026 Alexander Danilov <admsasha@altlinux.org> 3.6.25-alt1
- Updated from 3.6.17 to 3.6.25 (Fixes: CVE-2026-48020, CVE-2026-54761,
  CVE-2026-54763, CVE-2026-54764).

* Thu May 21 2026 Alexander Danilov <admsasha@altlinux.org> 3.6.17-alt1
- Updated from 3.6.15 to 3.6.17 (Fixes: CVE-2026-44774).

* Tue May 05 2026 Alexander Danilov <admsasha@altlinux.org> 3.6.15-alt1
- updated from 3.6.12 to 3.6.15 (Fixes: CVE-2026-35051, CVE-2026-41263
  CVE-2026-39858, CVE-2026-40912, CVE-2026-41174).

* Thu Mar 26 2026 Alexander Danilov <admsasha@altlinux.org> 3.6.12-alt1
- updated from 3.6.9 to 3.6.12 (Fixes: CVE-2026-29777).
...
* Tue Nov 25 2025 Alexey Shabalin <shaba@altlinux.org> 3.5.6-alt1
- 3.5.6

* Thu Oct 16 2025 Alexey Shabalin <shaba@altlinux.org> 3.5.3-alt1
- 3.5.3

* Thu Jul 24 2025 Alexey Shabalin <shaba@altlinux.org> 3.5.0-alt1
- 3.5.0 (Fixes: CVE-2025-54386)

* Mon Jun 02 2025 Alexey Shabalin <shaba@altlinux.org> 3.4.1-alt1
- 3.4.1 (Fixes: CVE-2025-47952)

* Tue May 13 2025 Alexey Shabalin <shaba@altlinux.org> 3.4.0-alt1
- 3.4.0 (Fixes: CVE-2025-32431)
...
* Wed May 08 2024 Alexey Shabalin <shaba@altlinux.org> 2.11.2-alt1
- 2.11.2 (Fixes: CVE-2024-28869, CVE-2023-45288)

* Fri Feb 16 2024 Alexey Shabalin <shaba@altlinux.org> 2.11.0-alt1
- 2.11.0
...
* Fri Sep 01 2023 Alexey Shabalin <shaba@altlinux.org> 2.10.4-alt1
- 2.10 branch stapshot

* Wed Jul 12 2023 Alexey Shabalin <shaba@altlinux.org> 2.10.3-alt1
- 2.10.3

* Thu Jun 01 2023 Alexey Shabalin <shaba@altlinux.org> 2.10.1-alt1
- 2.10.1

* Fri Apr 07 2023 Alexey Shabalin <shaba@altlinux.org> 2.9.10-alt1
- 2.9.10 (Fixes: CVE-2023-29013)

* Tue Mar 28 2023 Alexey Shabalin <shaba@altlinux.org> 2.9.9-alt1
- 2.9.9

* Thu Feb 16 2023 Alexey Shabalin <shaba@altlinux.org> 2.9.8-alt1
- 2.9.8 (Fixes: CVE-2022-23469, CVE-2022-46153, CVE-2022-41717, CVE-2022-41724)

* Mon Oct 24 2022 Alexey Shabalin <shaba@altlinux.org> 2.9.1-alt1
- 2.9.1 (Fixes: CVE-2022-39271)
