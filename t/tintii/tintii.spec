...
BuildRequires: boost-devel-headers gcc-c++ libgomp-devel
BuildRequires: libwxGTK3.2-devel bc
...
%changelog
* Mon Apr 15 2024 Michael Shigorin <mike@altlinux.org> 2.10.0-alt2
- switch to wxGTK3.2
- updated (or fixed?) License:

* Mon Oct 19 2015 Michael Shigorin <mike@altlinux.org> 2.10.0-alt1
