...
%changelog
* Fri Apr 17 2026 Andrey Cherepanov <cas@altlinux.org> 2.12.0-alt1
- New version.
...
* Sun Sep 03 2023 Andrey Cherepanov <cas@altlinux.org> 2.9.0-alt1
- New version.

* Mon Jan 02 2023 Andrey Cherepanov <cas@altlinux.org> 2.8.0-alt1
- New version.

* Thu Aug 11 2022 Andrey Cherepanov <cas@altlinux.org> 2.7.0-alt1
- New version.
- Complete Russian translation (thanks Olesya Gerasimenko).

* Thu Mar 03 2022 Andrey Cherepanov <cas@altlinux.org> 2.6.0-alt1
- New version.
- Complete Russian translation (thanks Olesya Gerasimenko).

* Tue Oct 12 2021 Andrey Cherepanov <cas@altlinux.org> 2.5.0-alt1
- New version.
- Complete Russian translation (thanks Olesya Gerasimenko).

* Mon Apr 12 2021 Andrey Cherepanov <cas@altlinux.org> 2.4.0-alt1
- New version.
