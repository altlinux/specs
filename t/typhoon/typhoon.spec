...
%changelog
* Thu Sep 17 2026 Nikolay Strelkov <snk@altlinux.org> 1.9.3-alt1
- New version 1.9.3.

* Fri Aug 21 2026 Nikolay Strelkov <snk@altlinux.org> 1.9.2-alt1
- New version 1.9.2.

* Thu Aug 20 2026 Nikolay Strelkov <snk@altlinux.org> 1.9.1-alt1
- New version 1.9.1.
