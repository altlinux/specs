...
%define common_summary An envelope based delay modulator plugin

%define common_description TIME-12 is a cross-platform is a delay modulator inspired by plugins\
like GrossBeat and ShaperBox. It can be used for a wide range of\
effects like stuttering, tape stop, glitch, scratch, reverse, pitch\
shift and more. It features:\
...
Vcs:     https://github.com/tiagolr/time12.git
...
* Sun Jan 11 2026 Ivan A. Melnikov <iv@altlinux.org> 1.2.2-alt1
- build for Sisyphus
