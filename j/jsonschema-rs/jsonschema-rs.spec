...
%changelog
* Thu Sep 10 2026 Evgeniy Martynenko <enimalojd@altlinux.org> 0.56.0-alt1
- New version (0.56.0).

* Mon Aug 24 2026 Evgeniy Martynenko <enimalojd@altlinux.org> 0.51.0-alt1
- New version (0.51.0).

* Fri Aug 07 2026 Evgeniy Martynenko <enimalojd@altlinux.org> 0.49.6-alt1
- New version (0.49.6).

* Thu Jul 23 2026 Evgeniy Martynenko <enimalojd@altlinux.org> 0.48.5-alt1
- New version (0.48.5).

* Wed Jul 22 2026 Evgeniy Martynenko <enimalojd@altlinux.org> 0.48.2-alt1
- New version (0.48.2).
