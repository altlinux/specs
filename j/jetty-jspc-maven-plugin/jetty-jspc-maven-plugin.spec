...
Provides: jetty-jspc-maven-plugin = 9.3.0-6.fc23
Provides: mvn(org.eclipse.jetty:jetty-jspc-maven-plugin) = 9.3.0.v20150612
Provides: mvn(org.eclipse.jetty:jetty-jspc-maven-plugin:pom:) = 9.3.0.v20150612
...
Release: alt0.1jpp
Source: jetty-jspc-maven-plugin-9.3.0-6.fc23.cpio
