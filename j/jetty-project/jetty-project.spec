...
Provides: jetty-project = 9.3.0-6.fc23
Provides: mvn(org.eclipse.jetty:jetty-project:pom:) = 9.3.0.v20150612
Requires: java-headless
Requires: jpackage-utils
Requires: mvn(org.apache.felix:maven-bundle-plugin)
Requires: mvn(org.apache.maven.plugins:maven-compiler-plugin)
Requires: mvn(org.apache.maven.plugins:maven-jar-plugin)
Requires: mvn(org.apache.maven.plugins:maven-release-plugin)
...
Requires: mvn(org.eclipse.jetty:jetty-parent:pom:)

BuildArch: noarch
Group: Development/Java
Release: alt0.1jpp
Source: jetty-project-9.3.0-6.fc23.cpio
