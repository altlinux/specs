...
%check
sed -n '/REGRESSION_TEST/s@.*`\(.*\)., `\(jot .*\).)@./\2 | cmp tests/regress.\1.out -@p' < tests/regress.sh > tests/regressLinux.sh
...
* Fri Aug 25 2017 Fr. Br. George <george@altlinux.ru> 11.1-alt1
