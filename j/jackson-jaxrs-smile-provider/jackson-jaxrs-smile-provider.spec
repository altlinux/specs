Name: jackson-jaxrs-smile-provider
Version: 2.5.0
Summary: Jackson-JAXRS-Smile
License: ASL 2.0
Url: http://wiki.fasterxml.com/JacksonHome
Packager: Igor Vlasenko <viy@altlinux.ru>
Provides: jackson-jaxrs-smile-provider = 2.5.0-2.fc23
Provides: mvn(com.fasterxml.jackson.jaxrs:jackson-jaxrs-smile-provider) = 2.5.0
Provides: mvn(com.fasterxml.jackson.jaxrs:jackson-jaxrs-smile-provider:pom:) = 2.5.0
Requires: java-headless
Requires: jpackage-utils
Requires: mvn(com.fasterxml.jackson.core:jackson-core)
Requires: mvn(com.fasterxml.jackson.core:jackson-databind)
Requires: mvn(com.fasterxml.jackson.dataformat:jackson-dataformat-smile)
...
Release: alt0.1jpp
Source: jackson-jaxrs-smile-provider-2.5.0-2.fc23.cpio
