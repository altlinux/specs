...
Provides: glassfish-jaxb-bom-ext = 2.3.3-6.fc34
Provides: mvn(com.sun.xml.bind:jaxb-bom-ext:pom:) = 2.3.3
Requires: java-headless
Requires: javapackages-filesystem
Requires: mvn(org.glassfish.jaxb:jaxb-bom:pom:)

BuildArch: noarch
Source: jaxb-bom-ext-2.3.3-6.fc34.cpio
