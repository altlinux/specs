...
if ! echo $suffix | grep -q "debug" ; then
  ...
  cp -a %{buildoutputdir}/bundles/jdk-%{newjavaver}+%{buildver}%{lts_designator_zip}-docs.zip $RPM_BUILD_ROOT%{_javadocdir}/%{uniquejavadocdir}.zip
fi
