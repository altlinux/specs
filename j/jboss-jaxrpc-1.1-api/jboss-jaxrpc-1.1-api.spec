...
%global namedreltag .20120309gita3c227
...
# cd jboss-jaxrpc-1.1-api/ && git archive --format=tar --prefix=jboss-jaxrpc-1.1-api/ a3c2279bc2cd24127870dbadd6b4ba5ae3655396 | xz > jboss-jaxrpc-1.1-api-1.0.1.20120309gita3c227.tar.xz
...
# JAR
install -pm 644 target/jboss-jaxrpc-api_1.1_spec-%{version}-SNAPSHOT.jar $RPM_BUILD_ROOT%{_javadir}/%{name}.jar
