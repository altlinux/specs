...
%changelog
* Tue Jul 07 2026 Anton Zhukharev <ancieg@altlinux.org> 4-alt5
- Built using LLVM 22.1.

* Wed Jul 23 2025 Anton Zhukharev <ancieg@altlinux.org> 4-alt4
- Built using LLVM 20.1.
