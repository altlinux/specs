...
Source2: openUDS-Client_Installer-3.0.0.exe
Source3: openUDS-Managed_Installer-3.0.0.exe
Source4: openUDS-Unmanaged_Installer-3.0.0.exe
...
install -Dp -m 644 %SOURCE2 %buildroot%uds_dir/static/clients/openUDS-Client_Installer-3.0.0.exe
install -Dp -m 644 %SOURCE3 %buildroot%uds_dir/osmanagers/WindowsOsManager/files/openUDS-Managed_Installer-3.0.0.exe
install -Dp -m 644 %SOURCE4 %buildroot%uds_dir/osmanagers/WindowsOsManager/files/openUDS-Unmanaged_Installer-3.0.0.exe
