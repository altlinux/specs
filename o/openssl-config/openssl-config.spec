...
%changelog
* Wed Nov 05 2025 Gleb F-Malinovskiy <glebfm@altlinux.org> 3.5.0-alt1
- Updated the base config from the upstream commit openssl-3.5.0-alpha1~20.

* Wed Jan 15 2025 Gleb F-Malinovskiy <glebfm@altlinux.org> 3.2.0-alt1
- Updated the base config from the upstream commit openssl-3.2.0-beta1~60.
