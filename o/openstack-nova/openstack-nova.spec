...
install -d -m 755 %{buildroot}%{_sysconfdir}/polkit-1/localauthority.conf.d/50-local.d
install -p -D -m 644 %{SOURCE21} %{buildroot}%{_sysconfdir}/polkit-1/localauthority.conf.d/50-local.d/50-nova.pkla
...
%config(noreplace) %{_sysconfdir}/polkit-1/localauthority.conf.d/50-local.d/50-nova.pkla
