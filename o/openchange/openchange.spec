...
%changelog
* Sun Mar 17 2019 Evgeny Sinelnikov <sin@altlinux.org> 2.4-alt36.zentyal23
- Rebuild with headers from new release of Samba-4.9.5
...
* Wed Nov 28 2018 Evgeny Sinelnikov <sin@altlinux.org> 2.4-alt32.zentyal23
- Rebuild with headers from new release of Samba-4.9.3

* Thu Oct 25 2018 Evgeny Sinelnikov <sin@altlinux.org> 2.4-alt31.zentyal23
- Rebuild with headers from new release of Samba-4.9.1

* Thu Sep 27 2018 Evgeny Sinelnikov <sin@altlinux.org> 2.4-alt30.zentyal23
- Rebuild with headers from new release of Samba-4.8.6
- Disable ubt macros due binary package identity changes

* Fri Aug 24 2018 Evgeny Sinelnikov <sin@altlinux.org> 2.4-alt29.zentyal23%ubt
- Rebuild with headers from new release of Samba-4.8.5

* Wed Aug 15 2018 Evgeny Sinelnikov <sin@altlinux.org> 2.4-alt28.zentyal23%ubt
- Rebuild with headers from new release of Samba-4.8.4 (security release)

* Sun Jul 08 2018 Evgeny Sinelnikov <sin@altlinux.org> 2.4-alt27.zentyal23%ubt
- Rebuild with headers from new release of Samba-4.8.3

* Sat Jun 23 2018 Evgeny Sinelnikov <sin@altlinux.org> 2.4-alt26.zentyal23%ubt
- Rebuild with headers from new release of Samba-4.7.8

* Fri May 25 2018 Andrey Cherepanov <cas@altlinux.org> 2.4-alt25.zentyal23%ubt
- Rebuild with libnanomsg 1.1.3

* Thu Apr 19 2018 Evgeny Sinelnikov <sin@altlinux.org> 2.4-alt24.zentyal23%ubt
- Rebuild with headers from new release of Samba-4.7.7

* Fri Mar 23 2018 Evgeny Sinelnikov <sin@altlinux.org> 2.4-alt23.zentyal23%ubt
- Rebuild with headers from new release of Samba-4.7.6
- Adapt for Samba 4.7 features:
  (https://wiki.samba.org/index.php/Samba_4.7_Features_added/changed)
  + Load dcerpc server exchange modules as don't need to free long-lived data
  + Build on samba-DC with reverted 1e8e048bf01447148ffa89ec237e2f9f58ff0ab6 patch,
    where lpcfg_register_defaults_hook() removed and not longer supported

* Tue Mar 13 2018 Evgeny Sinelnikov <sin@altlinux.org> 2.4-alt22.zentyal23%ubt.8
- Rebuild with headers from new release of Samba-4.6.14

* Thu Mar 08 2018 Andrey Cherepanov <cas@altlinux.org> 2.4-alt22.zentyal23%ubt.7.1
- Rebuild with libnanomsg-1.1.2
