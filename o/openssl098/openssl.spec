...
* Wed Nov 17 2010 Dmitry V. Levin <ldv@altlinux.org> 0.9.8p-alt1
- Updated to 0.9.8p (fixes CVE-2010-2939 and CVE-2010-3864).

* Sat Oct 02 2010 Dmitry V. Levin <ldv@altlinux.org> 0.9.8o-alt5
- Hardened conflict with incompatible libssl6 (closes: #24195).

* Fri Oct 01 2010 Dmitry V. Levin <ldv@altlinux.org> 0.9.8o-alt4
- Converted to legacy libraries.

* Fri Oct 01 2010 Dmitry V. Levin <ldv@altlinux.org> 0.9.8o-alt3
- Added conflict with incompatible libssl6 (closes: #24195).
