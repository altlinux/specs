...
* Wed Aug 02 2023 Alexander Burmatov <thatman@altlinux.org> 3.6.0-alt7
- Fixed interaction with the PVE cluster.
...
* Mon Jul 10 2023 Alexander Burmatov <thatman@altlinux.org> 3.6.0-alt4
- Some upgrades for 3.6 version.

* Fri Jun 30 2023 Alexander Burmatov <thatman@altlinux.org> 3.6.0-alt3
- Revert 4.0 changes.

* Wed Jun 28 2023 Alexander Burmatov <thatman@altlinux.org> 3.6.0-alt2
- Use min TLS version 1.3.
