...
VCS: https://github.com/dev47apps/droidcam-obs-plugin

Source: %name-%version.tar
Patch: %name-%version-%release.patch

BuildRequires: gcc-c++ libturbojpeg-devel libusbmuxd-devel libimobiledevice-devel
BuildRequires: libobs-devel >= 24.0 libavcodec-devel
...
%changelog
* Wed Aug 19 2026 L.A. Kostis <lakostis@altlinux.ru> 2.5.1-alt1
- 2.5.1.

* Wed Dec 31 2025 L.A. Kostis <lakostis@altlinux.ru> 2.4.2-alt2
- link with ffmpeg libs.

* Mon Nov 03 2025 L.A. Kostis <lakostis@altlinux.ru> 2.4.2-alt1
- 2.4.2.

* Wed Aug 13 2025 L.A. Kostis <lakostis@altlinux.ru> 2.4.0-alt1
- 2.4.0.
- Update BR: added avcodec.

* Tue Mar 04 2025 Anton Midyukov <antohami@altlinux.org> 2.3.4-alt1
- 2.3.4.
- Add VCS tag.
