...
Summary: Documents editing for owncloud
...
This package provides an ownCloud app to work with office
documents alone and/or collaboratively.
...
rm -rf %buildroot%installdir/src
