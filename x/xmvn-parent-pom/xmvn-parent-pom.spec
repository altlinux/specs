...
Provides: mvn(org.fedoraproject.xmvn:xmvn-parent:pom:) = 2.5.0
Provides: xmvn-parent-pom = 2.5.0-6.fc24
Requires: jpackage-utils
Requires: mvn(org.apache.maven.plugins:maven-compiler-plugin)
Requires: mvn(org.apache.maven.plugins:maven-site-plugin)
Requires: mvn(org.eclipse.sisu:sisu-maven-plugin)

BuildArch: noarch
Group: Development/Java
Release: alt0.1jpp
Source: xmvn-parent-pom-2.5.0-6.fc24.cpio
