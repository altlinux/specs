...
Name: xorg-drv-evdev-thinkpad
Version: 2.9.1
Release: alt3
Epoch: 2
Summary: Thinkpad clickpad driver
License: MIT/X11
Group: System/X11
...
Provides: xorg-drv-evdev = %epoch:%version-%release
Obsoletes: xorg-drv-mouse xorg-drv-keyboard
Conflicts: xorg-drv-evdev
...
%description
evdev-thinkpad  is  an  Xorg  input  driver for Linux generic event 
devices. It therefore supports Thinkpad 40th generation clickpad.
...
%changelog
* Sun Apr 12 2015 Yury A. Romanov <damned@altlinux.ru> 2:2.9.1-alt3
- Added thinkpad patches to the original sources.

* Sun Apr 12 2015 Yury A. Romanov <damned@altlinux.ru> 2:2.9.1-alt2
- Added thinkpad patches to the original sources.
