...
# Source-url: https://archive.apache.org/dist/xerces/c/3/sources/xerces-c-%version.tar.bz2
...
%package -n %libname-3.3
Summary: Shared libraries of Xerces-C++ validating XML parser
Group: System/Libraries
Obsoletes: libxerces-c < %EVR
Provides: libxerces-c = %EVR

%description -n %libname-3.3
Shared library libxerces-c-3.3.so for Xerces-C++ validating XML parser.

%package -n %libname-devel
Group: Development/C++
Summary: Header files for Xerces-C++ validating XML parser
Requires: %libname-3.3 = %EVR
...
Obsoletes: libxerces-c-doc < %EVR
Provides: libxerces-c-doc = %EVR
BuildArch: noarch
...
Group: File tools
Obsoletes: libxerces-c-utils < %EVR
Provides: libxerces-c-utils = %EVR
...
%changelog
* Thu Mar 12 2026 Vitaly Lipatov <lav@altlinux.ru> 3.3.0-alt1
- new version 3.3.0
- rename source package from libxerces-c to xerces-c (for repology)
- apply Shared Libs Policy: library subpackage libxerces-c-3.3
...
* Mon May 21 2018 Vitaly Lipatov <lav@altlinux.ru> 3.2.1-alt1
- new version 3.2.1 (with rpmrb script)

* Sat Feb 24 2018 Vitaly Lipatov <lav@altlinux.ru> 3.2.0-alt1
