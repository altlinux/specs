%define themename BlueGlass
%define themename3d %{themename}3D
%define contentnum 5532
...
%build
%__mv Blue %themename3d
%__subst 's,Blue,%themename3d,' default/index.theme
...
%changelog
* Sun Aug 08 2004 Andrey Rahmatullin <wrar@altlinux.ru> 0.4-alt1
- initial build