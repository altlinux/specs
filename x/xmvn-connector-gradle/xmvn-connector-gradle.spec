...
Provides: mvn(org.fedoraproject.xmvn:xmvn-connector-gradle) = 2.5.0
Provides: mvn(org.fedoraproject.xmvn:xmvn-connector-gradle:pom:) = 2.5.0
Provides: xmvn-connector-gradle = 2.5.0-6.fc24
...
Release: alt0.1jpp
Source: xmvn-connector-gradle-2.5.0-6.fc24.cpio
