...
Provides: mvn(org.apache.xbean:xbean-spring) = 4.3
Provides: mvn(org.apache.xbean:xbean-spring::sources:) = 4.3
Provides: mvn(org.apache.xbean:xbean-spring:pom:) = 4.3
Provides: xbean-spring = 4.3-1.fc23
...
Release: alt0.1jpp
Source: xbean-spring-4.3-1.fc23.cpio

%description
This package provides Schema-driven namespace handler for spring contexts.
