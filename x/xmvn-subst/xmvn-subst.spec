...
Provides: mvn(org.fedoraproject.xmvn:xmvn-subst) = 2.4.0
Provides: mvn(org.fedoraproject.xmvn:xmvn-subst:pom:) = 2.4.0
Provides: xmvn-subst = 2.4.0-5.fc23
Requires: /bin/sh
...
Release: alt0.1jpp
Source: xmvn-subst-2.4.0-5.fc23.cpio
