...
Provides: xorg-drv-keyboard = %serial:%version-%release
Obsoletes: xorg-x11-drv-keyboard xorg-drv-keyboard
...
%changelog
* Fri Oct 26 2012 Led <led@altlinux.ru> 2:1.6.1-alt4
- rename package xorg-drv-keyboard -> xorg-drv-input-keyboard
- removed provides xorg-drv-evdev

* Thu Oct 25 2012 Led <led@altlinux.ru> 2:1.6.1-alt3
- added provides xorg-drv-evdev
