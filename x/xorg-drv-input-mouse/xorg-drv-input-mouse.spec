...
Provides: xorg-drv-mouse = %serial:%version-%release
Obsoletes: xorg-x11-drv-mouse xorg-drv-mouse
...
%changelog
* Fri Oct 26 2012 Led <led@altlinux.ru> 1:1.7.2-alt4
- rename package xorg-drv-mouse -> xorg-drv-input-mouse
- removed provides xorg-drv-evdev
