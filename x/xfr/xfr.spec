...
%changelog
* Sat Sep 05 2026 Alexander Makeenkov <amakeenk@altlinux.org> 0.10.1-alt1
- Updated to version 0.10.1.

* Mon Aug 31 2026 Alexander Makeenkov <amakeenk@altlinux.org> 0.10.0-alt1
- Updated to version 0.10.0.

* Sat Aug 08 2026 Alexander Makeenkov <amakeenk@altlinux.org> 0.9.25-alt1
- Updated to version 0.9.25.

* Tue Jul 07 2026 Alexander Makeenkov <amakeenk@altlinux.org> 0.9.21-alt1
- Updated to version 0.9.21.

* Sun Jul 05 2026 Alexander Makeenkov <amakeenk@altlinux.org> 0.9.20-alt1
- Updated to version 0.9.20.

* Sun Jun 14 2026 Alexander Makeenkov <amakeenk@altlinux.org> 0.9.19-alt1
