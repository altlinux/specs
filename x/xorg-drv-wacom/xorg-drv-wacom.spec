...
install -pD -m644 conf/10-wacom.rules \
	%buildroot%_udevrulesdir/10-wacom.rules

%files
%_bindir/xsetwacom
%_x11modulesdir/input/*.so
%_xorgsysconfigdir/*.conf
%_udevrulesdir/10-wacom.rules
%_man1dir/*.1*
%_man4dir/*.4*
...
%changelog
* Mon Jul 03 2023 Anton Midyukov <antohami@altlinux.org> 1:0.36.1-alt2
- NMU: replace 10-wacom.rules to %%_udevrulesdir (Fix FTBFS)

* Wed Mar 20 2019 Valery Inozemtsev <shrek@altlinux.ru> 1:0.36.1-alt1
- 0.36.1
