...
%changelog
* Sun Jan 11 2026 Anton Midyukov <antohami@altlinux.org> 3.2.2-alt1
- New version 3.2.2.

* Sun Dec 14 2025 Anton Midyukov <antohami@altlinux.org> 3.2.1-alt1
- New version 3.2.1.
...
* Sun May 25 2025 Anton Midyukov <antohami@altlinux.org> 2.8.9-alt1
- New version 2.8.9.

* Fri Dec 13 2024 Anton Midyukov <antohami@altlinux.org> 2.8.7-alt1
- 2.8.7
...
* Fri Jun 07 2024 Anton Midyukov <antohami@altlinux.org> 2.8.3-alt1
- 2.8.3

* Fri Jan 05 2024 Anton Midyukov <antohami@altlinux.org> 2.8.2-alt1
- 2.8.2
...
* Wed Dec 14 2022 Vladimir Didenko <cow@altlinux.org> 2.4.2-alt1
- 2.4.2
