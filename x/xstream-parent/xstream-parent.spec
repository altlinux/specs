...
Provides: mvn(com.thoughtworks.xstream:xstream-parent:pom:) = 1.4.8
Provides: xstream-parent = 1.4.8-2.fc23
...
Requires: mvn(org.codehaus:codehaus-parent:pom:)
Requires: xstream

BuildArch: noarch
Group: Development/Java
Release: alt0.1jpp
Source: xstream-parent-1.4.8-2.fc23.cpio
