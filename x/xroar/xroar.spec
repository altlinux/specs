...
%changelog
* Wed Aug 28 2024 Artyom Bystrov <arbars@altlinux.org> 1.5.5-alt2
- enlarge release (wrong update method)

* Wed Aug 28 2024 Artyom Bystrov <arbars@altlinux.org> 1.5.5-alt1
- update to new version

* Fri Sep 1 2023 Artyom Bystrov <arbars@altlinux.org> 1.4.2-alt1
- update to new version

* Fri May 26 2023 Artyom Bystrov <arbars@altlinux.org> 1.3.1-alt1
- update to new version
