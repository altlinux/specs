...
BuildRequires: libopenal-devel libcairo-devel
BuildRequires: libwxGTK3.2-devel libgomp-devel libwxGTK3.2 libwxGTK3.2-gl 
BuildRequires: libgtk+3-devel libpng-devel libtiff-devel libjpeg-devel
...
cp %buildroot/usr/etc/%{shortname}.cfg %buildroot%_sysconfdir
...
* Thu Sep 19 2024 Ilya Mashkin <oddity@altlinux.ru> 2.1.11-alt1
- 2.1.11

* Wed Sep 11 2024 Ilya Mashkin <oddity@altlinux.ru> 2.1.10-alt1
- 2.1.10
