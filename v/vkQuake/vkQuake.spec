...
install -pDm644 Misc/vkquake.desktop %buildroot%_desktopdir/vkquake.desktop
install -pDm644 Misc/%{name}_256.png %buildroot%_iconsdir/hicolor/256x256/apps/vkquake.png
