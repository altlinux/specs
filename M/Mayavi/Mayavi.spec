...
Patch2: python311-support.patch
...
%changelog
* Sat Dec 23 2023 Anton Vyatkin <toni@altlinux.org> 4.8.1-alt3
- Added python311 support patch.

* Sat Jan 28 2023 Grigory Ustinov <grenka@altlinux.org> 4.8.1-alt2
- Build with recythonizing sources.
