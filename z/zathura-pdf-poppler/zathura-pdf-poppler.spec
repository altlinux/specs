...
BuildRequires: libpoppler-glib-devel libcairo-devel
# For tests
...
* Wed Nov 12 2025 Mikhail Efremov <sem@altlinux.org> 0.3.4-alt1
- Updated BR.
- Updated to 0.3.4.
...
* Thu Jan 09 2020 Mikhail Efremov <sem@altlinux.org> 0.3.0-alt1
- Used Vcs tag.
- Fixed license.
- Fixed URL.
- Updated to 0.3.0.
