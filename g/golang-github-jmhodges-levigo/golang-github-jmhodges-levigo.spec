...
%global with_debug 0
# check fails (cannot create db in koji), on local machine test passes, i686 does not like it
%global with_check 0
...
%if 0%{?with_check}
BuildRequires: libleveldb-devel >= 1.7
%endif
...
%changelog
* Sat Dec 09 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.11.git253793d
- new version
