...
# optimized out: elfutils ghc7.4.2 ghc7.4.2-common ghc7.4.2-mtl ghc7.4.2-transformers libgmp-devel pkg-config python-base rpm-build-haskell
BuildRequires: ghc7.4.2-doc ghc7.4.2-monadcatchio-mtl
...
%changelog
* Sat Jun 30 2012 Denis Smirnov <mithraen@altlinux.ru> 1.0.1.1-alt1
