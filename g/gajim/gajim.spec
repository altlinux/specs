...
%filter_from_requires /^typelib(GdkWin32)/d


Requires: libgtk4-gir libgtksourceview4-gir
Requires: python3-module-nbxmpp >= 7.4.0
...
%add_python3_req_skip winsdk.windows.ui winsdk.windows.ui.viewmanagement winrt.windows.ui winrt.windows.ui.viewmanagement gi.repository.Gdk gi.repository.Gio pysequoia
...
BuildRequires: libgdk-pixbuf-devel libgdk-pixbuf-gir-devel gobject-introspection-devel libgtk4-gir-devel python3-module-pygobject3-devel libgio libgio-devel
BuildRequires: python3-module-nbxmpp >= 7.4.0
...
%changelog
* Tue Sep 22 2026 Ilya Mashkin <oddity@altlinux.ru> 2.6.0-alt1
- 2.6.0
...
* Sat Apr 04 2026 Ilya Mashkin <oddity@altlinux.ru> 2.4.5-alt1
- 2.4.5

* Thu Mar 05 2026 Ilya Mashkin <oddity@altlinux.ru> 2.4.4-alt1
- 2.4.4

* Tue Nov 11 2025 Ilya Mashkin <oddity@altlinux.ru> 2.4.0-alt1
- 2.4.0

* Tue Oct 14 2025 Ilya Mashkin <oddity@altlinux.ru> 2.3.6-alt1
- 2.3.6
...
* Tue Jul 15 2025 Ilya Mashkin <oddity@altlinux.ru> 2.3.3-alt1
- 2.3.3

* Sat Jul 05 2025 Ilya Mashkin <oddity@altlinux.ru> 2.3.2-alt1
- 2.3.2

* Mon Jun 30 2025 Ilya Mashkin <oddity@altlinux.ru> 2.3.1-alt1
- 2.3.1

* Wed May 21 2025 Ilya Mashkin <oddity@altlinux.ru> 2.2.0-alt1
- 2.2.0

* Wed Apr 23 2025 Ilya Mashkin <oddity@altlinux.ru> 2.1.1-alt1
- 2.1.1
...
* Sun Mar 16 2025 Ilya Mashkin <oddity@altlinux.ru> 2.0.3-alt1
- 2.0.3

* Sun Mar 09 2025 Ilya Mashkin <oddity@altlinux.ru> 2.0.1-alt1
- 2.0.1

* Thu Oct 10 2024 Ilya Mashkin <oddity@altlinux.ru> 1.9.5-alt1
- 1.9.5
