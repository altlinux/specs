...
%global commit          d2709f9f1f31ebcda9651b03077758c1f3a0018c
...
cp -rpav test %{buildroot}/%{go_path}/src/%{import_path}/test
echo "%%{go_path}/src/%%{import_path}/test" >> unit-test.file-list
%endif
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 2.2.0-alt1_9
- fc update

* Wed Dec 13 2017 Igor Vlasenko <viy@altlinux.ru> 2.2.0-alt1_8
- new version
