...
# optimized out: elfutils ghc7.4.1 ghc7.4.1-common ghc7.4.1-transformers glib2-devel libgmp-devel pkg-config python-base rpm-build-haskell
BuildRequires: ghc7.4.1-alex ghc7.4.1-c2hs ghc7.4.1-glib ghc7.4.1-happy ghc7.4.1-mtl gtk2hs-buildtools libgio-devel
