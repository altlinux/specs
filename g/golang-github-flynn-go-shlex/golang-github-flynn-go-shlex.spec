...
%description
A simple lexer for go that supports shell-style quoting, commenting, and 
escaping.
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.2.20150515git3f9db97
- fc update

* Sat Dec 09 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.1.20150515git3f9db97
- new version
