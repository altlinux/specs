...
%global project         collectd
%global repo            go-collectd
# https://github.com/collectd/go-collectd
%global provider_prefix %{provider}.%{provider_tld}/%{project}/%{repo}
%global import_path     collectd.org
...
Provides:      golang(%{import_path}/cdtime) = %{version}-%{release}
Provides:      golang(%{import_path}/exec) = %{version}-%{release}
Provides:      golang(%{import_path}/export) = %{version}-%{release}
...
%endif
cp -r network/testdata %{buildroot}/%{go_path}/src/%{import_path}/network/.
echo "%%{go_path}/src/%%{import_path}/network/testdata" >> devel.file-list
...
%gotest %{import_path}/cdtime
%gotest %{import_path}/exec
%gotest %{import_path}/export
%gotest %{import_path}/format
# buffer_test.go:159: Writing bad stream should return an error
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.8.git9fc824c
- fc update

* Sat Dec 09 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.7.git9fc824c
- new version
