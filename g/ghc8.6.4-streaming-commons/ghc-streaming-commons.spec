...
%define h_pkg_name streaming-commons
%define f_pkg_name streaming-commons
...
%changelog
* Thu Aug 17 2023 Anton Zhukharev <ancieg@altlinux.org> 0.2.1.2-alt2
- Fixed FTBFS.

* Sun Jun 21 2020 Denis Smirnov <mithraen@altlinux.ru> 0.2.1.2-alt1
