...
# optimized out: elfutils ghc7.4.2 ghc7.4.2-blaze-builder ghc7.4.2-common ghc7.4.2-text libgmp-devel pkg-config python-base rpm-build-haskell
BuildRequires: ghc7.4.2-alex ghc7.4.2-blaze-markup ghc7.4.2-cpphs ghc7.4.2-doc ghc7.4.2-happy
...
%changelog
* Sat Jun 30 2012 Denis Smirnov <mithraen@altlinux.ru> 0.5.0.0-alt1
