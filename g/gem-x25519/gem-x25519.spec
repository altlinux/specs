...
Requires:      ruby >= 2.5
Provides:      gem(x25519) = 1.0.10.3

%ruby_use_gem_version x25519:1.0.10.3
...
%changelog
* Fri Dec 13 2024 Pavel Skrylev <majioa@altlinux.org> 1.0.10.3-alt0.1
- ^ 1.0.10 -> 1.0.10p3
