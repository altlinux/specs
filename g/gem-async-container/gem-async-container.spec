...
Provides:      gem(async-container) = 0.16.12.1

%ruby_use_gem_version async-container:0.16.12.1
...
Requires:      gem(async-container) = 0.16.12.1
...
%changelog
* Thu Oct 13 2022 Pavel Skrylev <majioa@altlinux.org> 0.16.12.1-alt0.1
- ^ 0.16.12 -> 0.16.12[1]
