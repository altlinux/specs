...
%define h_pkg_name haddock-library
%define f_pkg_name haddock-library
...
%changelog
* Thu Aug 17 2023 Anton Zhukharev <ancieg@altlinux.org> 1.9.0-alt2
- Fixed FTBFS.

* Sun Jun 21 2020 Denis Smirnov <mithraen@altlinux.ru> 1.9.0-alt1
