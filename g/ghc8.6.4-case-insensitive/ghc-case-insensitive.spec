...
%define h_pkg_name case-insensitive
%define f_pkg_name case-insensitive
...
%changelog
* Thu Aug 17 2023 Anton Zhukharev <ancieg@altlinux.org> 1.2.1.0-alt2
- Fixed FTBFS.

* Sun Jun 21 2020 Denis Smirnov <mithraen@altlinux.ru> 1.2.1.0-alt1
