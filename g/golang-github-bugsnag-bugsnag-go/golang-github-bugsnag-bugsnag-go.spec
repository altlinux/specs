...
%global project         bugsnag
%global repo            bugsnag-go
# https://github.com/bugsnag/bugsnag-go
%global provider_prefix %{provider}.%{provider_tld}/%{project}/%{repo}
%global import_path     %{provider_prefix}
%global commit          13fd6b8acda029830ef9904df6b63be0a83369d0
%global shortcommit     %(c=%{commit}; echo ${c:0:7})

Name:           golang-%{provider}-%{project}-%{repo}
Version:        1.0.4
Release:        alt1_9
Summary:        Automatic panic monitoring for golang, net/http and revel
License:        MIT
...
Requires:      golang(github.com/bugsnag/panicwrap)

Provides:      golang(%{import_path}) = %{version}-%{release}
Provides:      golang(%{import_path}/errors) = %{version}-%{release}
Provides:      golang(%{import_path}/revel) = %{version}-%{release}
...
#Requires:        golang(github.com/bitly/go-simplejson)
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 1.0.4-alt1_9
- fc update

* Wed Dec 13 2017 Igor Vlasenko <viy@altlinux.ru> 1.0.4-alt1_8
- new version
