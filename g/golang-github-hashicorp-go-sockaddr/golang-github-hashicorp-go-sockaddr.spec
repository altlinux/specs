...
export GOPATH=%{buildroot}/%{go_path}:$(pwd)/cmd/sockaddr/vendor:%{go_path}
%endif
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.5.gitaf174a6
- fc update

* Wed Dec 13 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.4.gitaf174a6
- new version
