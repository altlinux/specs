...
%if 0%{?with_unit_test}
install -d -p %{buildroot}/%{go_path}/src/%{import_path}/
cp -pav test.ini %{buildroot}/%{go_path}/src/%{import_path}/.
echo "%%{go_path}/src/%%{import_path}/test.ini" >> unit-test.file-list
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.12.gita98ad7e
- fc update

* Wed Dec 13 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.11.gita98ad7e
- new version
