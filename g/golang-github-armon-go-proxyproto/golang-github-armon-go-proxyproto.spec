...
%global repo            go-proxyproto
# https://github.com/armon/go-proxyproto
%global provider_prefix %{provider}.%{provider_tld}/%{project}/%{repo}
%global import_path     %{provider_prefix}
%global commit          48572f11356f1843b694f21a290d4f1006bc5e47
%global commitdate      20170621
...
support the use of a proxy protocol, which provides a simple mechanism for the
server to get the address of the client instead of the load balancer.
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.2.20170621git48572f1
- fc update

* Sat Dec 09 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.1.20170621git48572f1
- new version
