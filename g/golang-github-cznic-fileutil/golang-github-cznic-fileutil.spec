...
%global commit          2d566d841097e1297dfb576f809cf9eeecbdbc37
...
Provides:       golang(%{import_path}/falloc) = %{version}-%{release}
Provides:       golang(%{import_path}/hdb) = %{version}-%{release}
...
%gotest %{import_path}
%gotest %{import_path}/falloc
%gotest %{import_path}/hdb
...
%changelog
* Wed Dec 13 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.5.git2d566d8
- new version
