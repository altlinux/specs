...
Requires:      golang(github.com/gonum/blas/cgo)
Requires:      golang(github.com/gonum/blas/testblas)
Requires:      golang(github.com/gonum/floats)
Requires:      golang(github.com/gonum/inteernal/asm)
Requires:      golang(github.com/gonum/lapack/lapack64)
Requires:      golang(gopkg.in/check.v1)

Provides:      golang(%{import_path}/mat64) = %{version}-%{release}
...
%changelog
* Sat Dec 16 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.5.gitfb13962
- new version
