...
%global project         vjeantet
%global repo            asn1-ber
# https://github.com/vjeantet/asn1-ber
%global provider_prefix %{provider}.%{provider_tld}/%{project}/%{repo}
%global import_path     %{provider_prefix}
%global commit          85041cd0f4769ebf4a5ae600b1e921e630d6aff0
%global shortcommit     %(c=%{commit}; echo ${c:0:7})

Name:           golang-%{provider}-%{project}-%{repo}
Version:        0
Release:        alt1_0.8.git%{shortcommit}
Summary:        ASN1 BER Codec Library for the GO programming language
License:        BSD
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.8.git85041cd
- fc update

* Sat Dec 09 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.7.git85041cd
- new version
