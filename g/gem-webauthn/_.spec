...
BuildRequires: gem(openssl) >= 2.2 gem(openssl) < 3
...
%ruby_use_gem_dependency rubocop-rake >= 0.6,rubocop-rake < 1
...
Requires:      gem(openssl) >= 2.2 gem(openssl) < 3
