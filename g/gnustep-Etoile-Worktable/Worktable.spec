...
Name: gnustep-Etoile-Worktable
Version: r9901
Release: alt2.git20131217
Summary: Etoile's Worktable
License: BSD
Group: Graphical desktop/GNUstep
Url: http://etoileos.com/
Packager: Eugeny A. Rostovtsev (REAL) <real at altlinux.org>

# https://github.com/etoile/Worktable.git
...
%changelog
* Mon Mar 10 2014 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> r9901-alt2.git20131217
- Added menu file (thnx kostyalamer@)

* Fri Mar 07 2014 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> r9901-alt1.git20131217
