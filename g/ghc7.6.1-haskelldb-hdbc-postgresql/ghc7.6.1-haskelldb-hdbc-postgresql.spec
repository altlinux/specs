...
BuildRequires: ghc7.6.1-alex ghc7.6.1-c2hs ghc7.6.1-cpphs ghc7.6.1-doc ghc7.6.1-happy ghc7.6.1-haskelldb-hdbc ghc7.6.1-hdbc-postgresql ghc7.6.1-hscolour postgresql-devel
...
%changelog
* Sat Oct 05 2019 Alexei Takaseev <taf@altlinux.org> 2.1.2-alt1.1
