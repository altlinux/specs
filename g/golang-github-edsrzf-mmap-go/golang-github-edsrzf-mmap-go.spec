...
Source0:        https://%{provider_prefix}/archive/%{commit}/edsrzf-%{repo}-%{shortcommit}.tar.gz
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.4.20170318.git0bce6a6
- fc update

* Sat Dec 09 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.3.20170318.git0bce6a6
- new version
