...
%global import_path     gopkg.in/%{project}/%{repo}.v1
...
echo "%%dir %%{go_path}/src/github.com/fatih/." >> devel.file-list
ln -s %{go_path}/src/%{import_path}/ %{buildroot}%{go_path}/src/%{provider_prefix}
echo "%%{go_path}/src/%{provider_prefix}" >> devel.file-list
%endif
