...
%ruby_use_gem_dependency image_size >= 2.0
%ruby_use_gem_dependency rbs >= 3.10
Requires:      ruby >= 3.1
...
%changelog
* Sun Sep 06 2026 Pavel Skrylev <majioa@altlinux.org> 0.18.0-alt1
- ^ 0.17.1 -> 0.18.0
