...
Provides:       golang(%{import_path}/stun) = %{version}-%{release}
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 0.1.0-alt1_7.20171206.gitd9bbe8f
- fc update
