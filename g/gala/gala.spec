...
cp -pv vapi/libmutter-16.vapi %buildroot%_vapidir/
cp -pv vapi/libmutter-16.deps %buildroot%_vapidir/
...
%changelog
* Sat Sep 20 2025 Nikolay Strelkov <snk@altlinux.org> 8.2.5-alt1
