...
#%%gotest %%{import_path}
%gotest %{import_path}/consistenthash
%gotest %{import_path}/lru
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.12.git02826c3
- fc update

* Sat Dec 09 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.11.git02826c3
- new version
