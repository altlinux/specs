...
Patch712: gcc46-alt-libjava-ltdl.patch
Patch713: gcc46-alt-testsuite.patch
...
Patch719: gcc44-fix-build-with-makeinfo5.patch
...
Requires(pre): gcc-java-common >= 1.4.13
...
Group: Development/Other
Obsoletes: gcc4.5-gnat gcc4.4-gnat gcc4.3-gnat gcc4.2-gnat gcc4.1-gnat
Requires(pre): gcc-common >= 1.4.7
...
Group: Development/Other
BuildArch: noarch
Obsoletes: gcc3.0-doc gcc3.1-doc gcc3.2-doc gcc3.3-doc gcc3.4-doc gcc4.1-doc gcc4.3-doc gcc4.4-doc gcc4.5-doc
...
# libffi is just one of those directories that could
...
%changelog
* Fri Oct 04 2019 Gleb F-Malinovskiy <glebfm@altlinux.org> 4.6.3-alt14
- Fixed build with libtool 2.4.6 (ldv@).
- %name-locales: removed noarch.

* Mon Feb 19 2018 Dmitry V. Levin <ldv@altlinux.org> 4.6.3-alt13
- %name-fortran: do not obsolete gcc-g77.

* Thu Jan 11 2018 Gleb F-Malinovskiy <glebfm@altlinux.org> 4.6.3-alt12
- Fixed build with glibc 2.26, gcc >= 6, and texinfo 6.5.
- Disabled java support.
- Dropped alternatives.

* Mon Feb 08 2016 Gleb F-Malinovskiy <glebfm@altlinux.org> 4.6.3-alt11
