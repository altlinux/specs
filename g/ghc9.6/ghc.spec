...
%else
    %define build_ghc_major %ghc_major
    %define ghc_build_version %ghc_version
%endif
...
%ghc_lib_subpackage -n array -v 0.5.6.0
%ghc_lib_subpackage -n base -v 4.18.2.1
%ghc_lib_subpackage -n binary -v 0.8.9.1
%ghc_lib_subpackage -n bytestring -v 0.11.5.3
...
%ghc_lib_subpackage -n filepath -v 1.4.300.1
%ghc_lib_subpackage -n ghc-bignum -v 1.3
%ghc_lib_subpackage -n ghc-boot-th -v 9.6.6
%ghc_lib_subpackage -n ghc-boot -v 9.6.6
%ghc_lib_subpackage -n ghc-compact -v 0.1.0.0
%ghc_lib_subpackage -n ghc-heap -v 9.6.6
%ghc_lib_subpackage -n ghci -v 9.6.6
...
%ghc_lib_subpackage -n libiserv -v 9.6.6
...
%ghc_lib_subpackage -n unix -v 2.8.4.0
