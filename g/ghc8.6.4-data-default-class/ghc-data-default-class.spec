...
%define h_pkg_name data-default-class
%define f_pkg_name data-default-class
...
%changelog
* Thu Aug 17 2023 Anton Zhukharev <ancieg@altlinux.org> 0.1.2.0-alt2
- Fixed FTBFS.

* Sun Jun 21 2020 Denis Smirnov <mithraen@altlinux.ru> 0.1.2.0-alt1
