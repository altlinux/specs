...
%ruby_use_gem_dependency byebug >= 11.1.3
%ruby_use_gem_dependency pry >= 0.13
%ruby_use_gem_dependency chandler >= 0.9.0
%ruby_use_gem_dependency mdl >= 0.15
%ruby_use_gem_dependency minitest >= 5.14
%ruby_use_gem_dependency minitest-bisect >= 1.5
%ruby_use_gem_dependency rake >= 13.0
%ruby_use_gem_dependency rubocop >= 1.0
Requires:      ruby >= 3.2.0
...
%changelog
* Mon Sep 21 2026 Pavel Skrylev <majioa@altlinux.org> 3.12.0-alt1.2
