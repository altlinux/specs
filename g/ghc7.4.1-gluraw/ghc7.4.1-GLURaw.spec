...
# optimized out: elfutils ghc7.4.1 ghc7.4.1-common ghc7.4.1-prof libGL-devel libgmp-devel pkg-config python-base rpm-build-haskell
BuildRequires: ghc7.4.1-openglraw libGLU-devel
