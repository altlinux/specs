...
%define h_pkg_name splitmix
%define f_pkg_name splitmix
...
%changelog
* Thu Aug 17 2023 Anton Zhukharev <ancieg@altlinux.org> 0.0.5-alt2
- Fixed FTBFS.

* Sun Jun 21 2020 Denis Smirnov <mithraen@altlinux.ru> 0.0.5-alt1
