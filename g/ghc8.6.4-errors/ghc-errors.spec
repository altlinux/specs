...
%define h_pkg_name errors
%define f_pkg_name errors
...
%changelog
* Thu Aug 17 2023 Anton Zhukharev <ancieg@altlinux.org> 2.3.0-alt2
- Fixed FTBFS.

* Sun Jun 21 2020 Denis Smirnov <mithraen@altlinux.ru> 2.3.0-alt1
