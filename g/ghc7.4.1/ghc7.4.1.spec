...
BuildRequires: docbook-dtds docbook-style-xsl ghc7.4.1 libelf-devel libgmp-devel libncurses-devel libedit-devel texlive-latex-base fonts-type1-cm-super-tex time xmltex xorg-cf-files xsltproc
...
%changelog
* Sat Mar 17 2012 Denis Smirnov <mithraen@altlinux.ru> 7.4.1-alt2
- remove ghc7.4.1-prof and libghc7.4.1 subpackage
- fix bug (some files in libghc was not packaged before)

* Sat Mar 17 2012 Denis Smirnov <mithraen@altlinux.ru> 7.4.1-alt1
- bootstrap build
