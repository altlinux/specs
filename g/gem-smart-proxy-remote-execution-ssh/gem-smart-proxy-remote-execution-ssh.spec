...
BuildRequires: gem(minitest) >= 5.23
...
%ruby_use_gem_dependency rack-test >= 2.0.0
...
Provides:      smart_proxy_remote_execution_ssh = %EVR
Provides:      gem(smart_proxy_remote_execution_ssh) = 1.0.3
...
Requires:      gem(smart_proxy_remote_execution_ssh) = 1.0.3
...
%changelog
* Mon Aug 31 2026 Pavel Skrylev <majioa@altlinux.org> 1.0.3-alt1
- ^ 1.0.2 -> 1.0.3
