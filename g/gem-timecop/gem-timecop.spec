...
%files
%doc LICENSE README.markdown History.md
%ruby_gemspec
%ruby_gemlibdir
...
%changelog
* Wed Oct 22 2025 Pavel Skrylev <majioa@altlinux.org> 0.9.10-alt1
- ^ 0.9.6 -> 0.9.10
