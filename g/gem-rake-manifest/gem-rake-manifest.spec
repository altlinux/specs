...
BuildConflicts: gem(simplecov) >= 2
%endif
...
Requires:      ruby >= 2.7.0
Provides:      gem(rake-manifest) = 0.2.4
...
Requires:      gem(rake-manifest) = 0.2.4
...
%changelog
* Mon Aug 31 2026 Pavel Skrylev <majioa@altlinux.org> 0.2.4-alt1
- ^ 0.2.3 -> 0.2.4
