...
Provides:      gem(racc) = 1.8.1.42

%ruby_on_build_rake_tasks compile
%ruby_use_gem_version racc:1.8.1.42
...
GEM_PATH=%buildroot/usr/lib/ruby/gemie ruby -rerb -e 'Kernel.puts ERB.new(IO.read("%SOURCE1")).result' | sed 's,%buildroot,,' > %buildroot%_altdir/%gemname
...
%files
%doc COPYING ChangeLog README.ja.rdoc README.rdoc
%ruby_gemspec
%ruby_gemlibdir
%ruby_gemextdir
...
%changelog
* Wed Oct 01 2025 Pavel Skrylev <majioa@altlinux.org> 1:1.8.1.42-alt0.1
- ^ 1.8.0 -> 1.8.1p42
- ! fixed alternatives virtual symlink to executable (closes ALT#56234)
- * rebased to upstream

* Mon Mar 03 2025 Pavel Skrylev <majioa@altlinux.org> 1:1.8.0-alt2
- ! detection for a new racc gem placement to define path for alternatives

* Tue Jul 23 2024 Pavel Skrylev <majioa@altlinux.org> 1:1.8.0-alt1
- ^ 1.7.3 -> 1.8.0
