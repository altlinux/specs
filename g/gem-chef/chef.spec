...
Requires:      gem(chef-config) = 18.0.91
Requires:      gem(chef-utils) = 18.0.91
...
Requires:      gem(chef) = 18.0.91
Provides:      gem(chef-bin) = 18.0.91
...
Provides:      gem(chef-config) = 18.0.91
...
Requires:      gem(mixlib-cli) >= 2.1.1 gem(mixlib-cli) < 3.0
Requires:      gem(mixlib-archive) >= 0.4 gem(mixlib-archive) < 2.0
Requires:      gem(ohai) >= 17.0 gem(ohai) < 19
...
Provides:      gem(chef-utils) = 18.0.91
...
%ruby_gemsdocdir/chef-bin-18.0.91

%files         -n gem-chef-bin-devel

%files         -n gem-chef-bin
%ruby_gemspecdir/chef-bin-18.0.91.gemspec
%ruby_gemslibdir/chef-bin-18.0.91

%files         -n gem-chef-config
%ruby_gemspecdir/chef-config-18.0.91.gemspec
%ruby_gemslibdir/chef-config-18.0.91

%files         -n gem-chef-config-doc
%ruby_gemsdocdir/chef-config-18.0.91

%files         -n gem-chef-config-devel

%files         -n gem-knife
%doc knife/lib/chef/knife/bootstrap/templates/README.md
%ruby_gemspecdir/knife-18.0.91.gemspec
%ruby_gemslibdir/knife-18.0.91
...
%doc knife/lib/chef/knife/bootstrap/templates/README.md
%ruby_gemsdocdir/knife-18.0.91

%files         -n gem-knife-devel
%doc knife/lib/chef/knife/bootstrap/templates/README.md

%files         -n gem-chef-utils
%ruby_gemspecdir/chef-utils-18.0.91.gemspec
%ruby_gemslibdir/chef-utils-18.0.91

%files         -n gem-chef-utils-doc
%ruby_gemsdocdir/chef-utils-18.0.91
