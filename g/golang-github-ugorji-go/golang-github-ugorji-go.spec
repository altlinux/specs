...
%global commit          ded73eae5db7e7a0ef6f55aace87a2873c5d2b74
...
%if 0%{?with_unit_test}
install -d -p %{buildroot}/%{go_path}/src/%{import_path}/
install -d -p %{buildroot}/%{go_path}/src/%{import_path}/codec
cp -pav codec/test-cbor-goldens.json %{buildroot}/%{go_path}/src/%{import_path}/codec/.
echo "%%{go_path}/src/%%{import_path}/codec/test-cbor-goldens.json" >> unit-test.file-list
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.13.gitded73ea
- fc update

* Wed Dec 13 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.12.gitded73ea
- new version
