...
Provides:       golang(%{import_path}/adler32) = %{version}-%{release}
Provides:       golang(%{import_path}/bozo32) = %{version}-%{release}
Provides:       golang(%{import_path}/buzhash32) = %{version}-%{release}
Provides:       golang(%{import_path}/buzhash64) = %{version}-%{release}
Provides:       golang(%{import_path}/rabinkarp64) = %{version}-%{release}
...
%gotest %{import_path}
%gotest %{import_path}/adler32
%gotest %{import_path}/bozo32
%gotest %{import_path}/buzhash32
%gotest %{import_path}/buzhash64
%gotest %{import_path}/rabinkarp64
%endif
