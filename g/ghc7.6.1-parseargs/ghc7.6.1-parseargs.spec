...
%define h_pkg_name parseargs
%define f_pkg_name parseargs
...
Url: http://wiki.cs.pdx.edu/bartforge/parseargs
Source: %name-%version.tar
Patch: %name-%version-%release.patch
Summary: Command-line argument parsing library for Haskell programs
...
%changelog
* Sun Dec 23 2012 Denis Smirnov <mithraen@altlinux.ru> 0.1.3.4-alt1
