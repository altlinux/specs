...
# copy *.c and *.h files
cp -pav *.c *.h %{buildroot}/%{go_path}/src/%{import_path}/
echo "%%{go_path}/src/%%{import_path}/*.c" >> devel.file-list
echo "%%{go_path}/src/%%{import_path}/*.h" >> devel.file-list
...
%if ! 0%{?with_bundled}
export GOPATH=%{buildroot}/%{go_path}:%{go_path}:/usr/include:/usr/lib64
%else
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.16.gitcbe9e82
- fc update

* Wed Dec 13 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.14.git4c6dbaf
- new version
