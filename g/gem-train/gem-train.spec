...
BuildRequires: gem(googleauth) >= 0.16 gem(googleauth) < 2
%endif
...
Requires:      gem(googleauth) >= 0.16 gem(googleauth) < 2
...
%changelog
* Wed Oct 19 2022 Pavel Skrylev <majioa@altlinux.org> 3.7.6-alt1.1
- !fix gem deps to novel gems
