...
# optimized out: elfutils ghc7.4.2 ghc7.4.2-common libgmp-devel libncurses-devel libtinfo-devel pkg-config python-base rpm-build-haskell
BuildRequires: ghc7.4.2-alex ghc7.4.2-cpphs ghc7.4.2-doc ghc7.4.2-happy libncursesw-devel
...
%changelog
* Sat Jun 30 2012 Denis Smirnov <mithraen@altlinux.ru> 0.3.2.3-alt1
