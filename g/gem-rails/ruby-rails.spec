...
Requires:      gem(activesupport) = 6.1.6.1
Requires:      gem(actionpack) = 6.1.6.1
Requires:      gem(actionview) = 6.1.6.1
Requires:      gem(activemodel) = 6.1.6.1
Requires:      gem(activerecord) = 6.1.6.1
Requires:      gem(actionmailer) = 6.1.6.1
Requires:      gem(activejob) = 6.1.6.1
Requires:      gem(actioncable) = 6.1.6.1
Requires:      gem(activestorage) = 6.1.6.1
Requires:      gem(actionmailbox) = 6.1.6.1
Requires:      gem(actiontext) = 6.1.6.1
Requires:      gem(railties) = 6.1.6.1
Requires:      gem(bundler) >= 1.15.0
Requires:      gem(sprockets-rails) >= 2.0.0
Requires:      rails = %EVR
Obsoletes:     ruby-rails < %EVR
Provides:      ruby-rails = %EVR
Provides:      gem(rails) = 6.1.6.1
...
Provides:      gem(actioncable) = 6.1.6.1
...
Provides:      gem(actionpack) = 6.1.6.1
...
Provides:      gem(actionmailer) = 6.1.6.1
...
Provides:      gem(actionmailbox) = 6.1.6.1
...
Provides:      gem(actionview) = 6.1.6.1
...
Provides:      gem(actiontext) = 6.1.6.1
...
Provides:      gem(activestorage) = 6.1.6.1
...
Provides:      gem(activerecord) = 6.1.6.1
...
Provides:      gem(activemodel) = 6.1.6.1
...
Provides:      gem(activejob) = 6.1.6.1
...
Provides:      gem(activesupport) = 6.1.6.1
...
%doc README.md
%ruby_gemspecdir/actioncable-6.1.6.1.gemspec
%ruby_gemslibdir/actioncable-6.1.6.1

%files         -n gem-actioncable-doc
%doc README.md
%ruby_gemsdocdir/actioncable-6.1.6.1
...
%doc README.md
%ruby_gemspecdir/actionpack-6.1.6.1.gemspec
%ruby_gemslibdir/actionpack-6.1.6.1

%files         -n gem-actionpack-doc
%doc README.md
%ruby_gemsdocdir/actionpack-6.1.6.1
...
%doc README.md
%ruby_gemspecdir/actionmailer-6.1.6.1.gemspec
%ruby_gemslibdir/actionmailer-6.1.6.1

%files         -n gem-actionmailer-doc
%doc README.md
%ruby_gemsdocdir/actionmailer-6.1.6.1
...
%doc README.md
%ruby_gemspecdir/actionmailbox-6.1.6.1.gemspec
%ruby_gemslibdir/actionmailbox-6.1.6.1

%files         -n gem-actionmailbox-doc
%doc README.md
%ruby_gemsdocdir/actionmailbox-6.1.6.1
...
%doc README.md
%ruby_gemspecdir/activejob-6.1.6.1.gemspec
%ruby_gemslibdir/activejob-6.1.6.1

%files         -n gem-activejob-doc
%doc README.md
%ruby_gemsdocdir/activejob-6.1.6.1
...
%doc README.md
%ruby_gemspecdir/actionview-6.1.6.1.gemspec
%ruby_gemslibdir/actionview-6.1.6.1

%files         -n gem-actionview-doc
%doc README.md
%ruby_gemsdocdir/actionview-6.1.6.1
...
%doc README.md
%ruby_gemspecdir/actiontext-6.1.6.1.gemspec
%ruby_gemslibdir/actiontext-6.1.6.1

%files         -n gem-actiontext-doc
%doc README.md
%ruby_gemsdocdir/actiontext-6.1.6.1
...
%doc README.md
%ruby_gemspecdir/activestorage-6.1.6.1.gemspec
%ruby_gemslibdir/activestorage-6.1.6.1

%files         -n gem-activestorage-doc
%doc README.md
%ruby_gemsdocdir/activestorage-6.1.6.1
...
%doc README.md
%ruby_gemspecdir/activerecord-6.1.6.1.gemspec
%ruby_gemslibdir/activerecord-6.1.6.1

%files         -n gem-activerecord-doc
%doc README.md
%ruby_gemsdocdir/activerecord-6.1.6.1
...
%doc README.md
%ruby_gemspecdir/activemodel-6.1.6.1.gemspec
%ruby_gemslibdir/activemodel-6.1.6.1

%files         -n gem-activemodel-doc
%doc README.md
%ruby_gemsdocdir/activemodel-6.1.6.1
...
%doc README.md
%ruby_gemspecdir/railties-6.1.6.1.gemspec
%ruby_gemslibdir/railties-6.1.6.1
...
%doc README.md
%ruby_gemsdocdir/railties-6.1.6.1
...
%doc README.md
%ruby_gemspecdir/activesupport-6.1.6.1.gemspec
%ruby_gemslibdir/activesupport-6.1.6.1

%files         -n gem-activesupport-doc
%doc README.md
%ruby_gemsdocdir/activesupport-6.1.6.1
