...
%define h_pkg_name x509-store
%define f_pkg_name x509-store
...
%changelog
* Thu Aug 17 2023 Anton Zhukharev <ancieg@altlinux.org> 1.6.7-alt2
- Fixed FTBFS.

* Sun Jun 21 2020 Denis Smirnov <mithraen@altlinux.ru> 1.6.7-alt1
