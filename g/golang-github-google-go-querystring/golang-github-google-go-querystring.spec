...
%global repo            go-querystring
# https://github.com/google/go-querystring
%global provider_prefix %{provider}.%{provider_tld}/%{project}/%{repo}
%global import_path     %{provider_prefix}
%global commit          547ef5ac979778feb2f760cdb5f4eae1a2207b86
...
Provides:      golang(%{import_path}/query) = %{version}-%{release}
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.10.git547ef5a
- fc update

* Sat Dec 09 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.9.git547ef5a
- new version
