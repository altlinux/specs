...
BuildRequires: gem(actionpack) >= 5.0.1.rc1
BuildRequires: gem(actionview) >= 5.0.1.rc1
BuildRequires: gem(activesupport) >= 5.0.1.rc1
BuildRequires: gem(railties) >= 5.0.1.rc1
BuildRequires: gem(sqlite3) >= 0

%add_findreq_skiplist %ruby_gemslibdir/**/*
%add_findprov_skiplist %ruby_gemslibdir/**/*
Requires:      gem(actionpack) >= 5.0.1.rc1
Requires:      gem(actionview) >= 5.0.1.rc1
Requires:      gem(activesupport) >= 5.0.1.rc1
Provides:      gem(rails-controller-testing) = 1.0.5
...
Requires:      gem(rails-controller-testing) = 1.0.5
...
Requires:      gem(rails-controller-testing) = 1.0.5
Requires:      gem(railties) >= 5.0.1.rc1
