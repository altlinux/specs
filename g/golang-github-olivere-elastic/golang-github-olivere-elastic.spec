...
%global project         olivere
%global repo            elastic
# https://github.com/olivere/elastic
%global provider_prefix %{provider}.%{provider_tld}/%{project}/%{repo}
%global import_path     gopkg.in/olivere/elastic.v2
...
Provides:      golang(%{import_path}/uritemplates) = %{version}-%{release}
...
%gotest %{import_path}
%gotest %{import_path}/uritemplates
%endif
...
%dir %{go_path}/src/gopkg.in/olivere
%endif
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 2.0.12-alt1_0.7.git3cfe882
- fc update

* Sat Dec 09 2017 Igor Vlasenko <viy@altlinux.ru> 2.0.12-alt1_0.6.git3cfe882
- new version
