...
%define h_pkg_name text-conversions
%define f_pkg_name text-conversions
...
Url: https://github.com/cjdev/text-conversions#readme
...
%changelog
* Thu Aug 17 2023 Anton Zhukharev <ancieg@altlinux.org> 0.3.0-alt2
- Fixed FTBFS.

* Sun Jun 21 2020 Denis Smirnov <mithraen@altlinux.ru> 0.3.0-alt1
