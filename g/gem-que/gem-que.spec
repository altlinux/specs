...
BuildConflicts: gem(activejob) >= 8
...
%ruby_use_gem_dependency minitest-fail-fast >= 0.2.0
%ruby_use_gem_dependency minitest-hooks >= 1.5.2
%ruby_use_gem_dependency minitest-profile >= 0.0.2
%ruby_use_gem_dependency activejob >= 7.1,activejob < 8
%ruby_use_gem_dependency activerecord >= 7.1,activerecord < 8
Requires:      ruby >= 2.7.0
Provides:      gem(que) = 2.4.1.3

%ruby_use_gem_version que:2.4.1.3
...
%changelog
* Thu Aug 27 2026 Pavel Skrylev <majioa@altlinux.org> 2.4.1.3-alt0.1
- ^ 2.4.1 -> 2.4.1p3

* Thu Feb 06 2025 Pavel Skrylev <majioa@altlinux.org> 2.4.1-alt1
- ^ 2.2.1 -> 2.4.1
