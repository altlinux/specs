...
%define _name dumbcloud

Name: %base-%_name
Version: 0.0
Release: alt1

Summary: A GDM2 theme - Dumbcloud
Summary(ru_RU.UTF-8): Тема для GDM2 - Глупое облако
License: GPL
...
%description
Dumb gdm greeter of Silly lines w/ a cloud.

%description -l ru_RU.UTF-8
Простейшее приглашение GDM. Извивающиеся линии и облако.
