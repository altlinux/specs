%define oldname glassfish-jax-rs-api
...
Name:          glassfish-jax-rs-api2.0.1
Version:       2.0.1
Release:       alt2_7jpp8
...
Source0:       %{oldname}-%{namedversion}.tar.xz
...
%description manual
This package contains documentation for %{oldname}.
%endif

%prep
%setup -q -n %{oldname}-%{namedversion}
...
%pom_remove_plugin :maven-javadoc-plugin src/jax-rs-api
...
%changelog
* Wed Jul 10 2019 Igor Vlasenko <viy@altlinux.ru> 2.0.1-alt2_7jpp8
- compat build for old jersey 2.23
