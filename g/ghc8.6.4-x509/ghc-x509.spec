...
%define h_pkg_name x509
%define f_pkg_name x509
...
%changelog
* Thu Aug 17 2023 Anton Zhukharev <ancieg@altlinux.org> 1.7.5-alt2
- Fixed FTBFS.

* Sun Jun 21 2020 Denis Smirnov <mithraen@altlinux.ru> 1.7.5-alt1
