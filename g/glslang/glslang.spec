...
BuildRequires: gcc-c++
BuildRequires: python3-devel libspirv-tools-devel >= 2026.3-alt0.1
...
%files devel
%doc README.md CHANGES.md SECURITY.md
%_libdir/lib*.so
%_libdir/cmake/*
%_includedir/%name
%_includedir/SPIRV
...
%changelog
* Thu Sep 10 2026 L.A. Kostis <lakostis@altlinux.ru> 1:16.4.0-alt1
- 16.4.0 (for sdk-1.4.357.0).

* Thu May 21 2026 L.A. Kostis <lakostis@altlinux.ru> 1:16.3.0-alt1
- 16.3.0 (for sdk-1.4.350.0).
...
* Thu Oct 23 2025 L.A. Kostis <lakostis@altlinux.ru> 1:16.0.0-alt1
- 16.0.0 (for sdk-1.4.328.1).

* Tue Aug 12 2025 L.A. Kostis <lakostis@altlinux.ru> 1:15.4.0-alt1
- 15.4.0 (for sdk-1.4.321.0).

* Sun May 11 2025 L.A. Kostis <lakostis@altlinux.ru> 1:15.3.0-alt1
- 15.3.0 (for sdk-1.4.313.0).

* Wed Feb 05 2025 L.A. Kostis <lakostis@altlinux.ru> 1:15.1.0-alt1
- 15.1.0 (for sdk-1.4.304.0).

* Sat Dec 14 2024 L.A. Kostis <lakostis@altlinux.ru> 1:15.0.0-alt1
- 15.0.0 (for sdk-1.3.296.0).

* Wed Aug 28 2024 L.A. Kostis <lakostis@altlinux.ru> 1:14.3.0-alt1
- 14.3.0 (for sdk-1.3.290.0).

* Thu May 30 2024 L.A. Kostis <lakostis@altlinux.ru> 1:14.2.0-alt1
- 14.2.0 (for sdk-1.3.283.0).
