...
Provides:      gem(puppetserver-ca) = 2.7.0.2.1

%ruby_use_gem_version puppetserver-ca:2.7.0.2.1
...
Requires:      gem(puppetserver-ca) = 2.7.0.2.1
...
%changelog
* Tue Aug 18 2026 Pavel Skrylev <majioa@altlinux.org> 2.7.0.2.1-alt0.1
- ^ 2.7.0[1] -> 2.7.0p2.1
- ! forced set version of ca cert according spec
