...
%global with_debug 0
# Test requires additional dependency "github.com/mgutz/ansi"
%global with_check 0
...
Source0:        https://%{provider_prefix}/archive/%{commit}/context-%{shortcommit}.tar.gz
...
%dir %attr(755,root,root) %{go_path}/src/github.com
%dir %attr(755,root,root) %{go_path}/src/github.com/kdar
%dir %attr(755,root,root) %{go_path}/src/%{import_path}
