...
%define h_pkg_name event-handlers
%define f_pkg_name event-handlers
...
Url: http://code.haskell.org/~mokus/event-handlers
...
%changelog
* Sat Dec 22 2012 Denis Smirnov <mithraen@altlinux.ru> 0.0.0.3-alt1
