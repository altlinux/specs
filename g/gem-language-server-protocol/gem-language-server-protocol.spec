...
Requires:      ruby >= 2.5.0
Provides:      gem(language_server-protocol) = 3.17.0.5
...
Requires:      gem(language_server-protocol) = 3.17.0.5
...
%files
%doc LICENSE.txt README.md CHANGELOG.md CODE_OF_CONDUCT.md
%ruby_gemspec
%ruby_gemlibdir
...
%changelog
* Thu Oct 23 2025 Pavel Skrylev <majioa@altlinux.org> 3.17.0.5-alt1
- ^ 3.17.0.3 -> 3.17.0.5
