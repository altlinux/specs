...
# optimized out: elfutils ghc7.4.1 ghc7.4.1-common ghc7.4.1-transformers libgmp-devel libtinfo-devel pkg-config python-base rpm-build-haskell
BuildRequires: ghc7.4.1-mtl ghc7.4.1-terminfo ghc7.4.1-utf8-string libncurses-devel
...
%changelog
* Sat Mar 17 2012 Denis Smirnov <mithraen@altlinux.ru> 0.6.4.6-alt1
