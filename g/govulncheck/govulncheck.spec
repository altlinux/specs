...
%changelog
* Mon Sep 14 2026 Artem Krasovskiy <aibure@altlinux.org> 1.8.0-alt1
- updated from 1.6.0 to 1.8.0

* Fri Jul 24 2026 Artem Krasovskiy <aibure@altlinux.org> 1.6.0-alt1
- updated from 1.3.0 to 1.6.0
