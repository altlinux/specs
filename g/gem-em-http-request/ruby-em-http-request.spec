...
BuildRequires: gem(mongrel) >= 1.2.0 gem(mongrel) < 1.3
BuildRequires: gem(multi_json) >= 0
BuildRequires: gem(rack) >= 0 gem(rack) < 3
...
Provides:      gem(em-http-request) = 1.1.7
...
Requires:      gem-em-http-request = 1.1.7-alt1
...
Requires:      gem(em-http-request) = 1.1.7
Requires:      gem(mongrel) >= 1.2.0 gem(mongrel) < 1.3
