...
%global project         noahdesu
%global repo            go-ceph
# https://github.com/noahdesu/go-ceph
%global provider_prefix %{provider}.%{provider_tld}/%{project}/%{repo}
%global import_path     %{provider_prefix}
%global commit          b15639c44c05368348355229070361395d9152ee
%global shortcommit     %(c=%{commit}; echo ${c:0:7})

Name:           golang-%{provider}-%{project}-%{repo}
Version:        0.3.0
Release:        alt1_0.8.git%{shortcommit}
Summary:        Go bindings for RADOS, RBD, and CephFS
License:        MIT
...
Provides:      golang(%{import_path}/rados) = %{version}-%{release}
Provides:      golang(%{import_path}/rbd) = %{version}-%{release}
...
# needs rados (not in Fedora)
#%%gotest %%{import_path}
#%%gotest %%{import_path}/rados
# does not work either
#%%gotest %%{import_path}/rbd
%endif
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 0.3.0-alt1_0.8.gitb15639c
- fc update

* Sat Dec 09 2017 Igor Vlasenko <viy@altlinux.ru> 0.3.0-alt1_0.7.gitb15639c
- new version
