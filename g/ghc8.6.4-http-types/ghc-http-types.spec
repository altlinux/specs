...
%define h_pkg_name http-types
%define f_pkg_name http-types
...
%changelog
* Thu Aug 17 2023 Anton Zhukharev <ancieg@altlinux.org> 0.12.3-alt2
- Fixed FTBFS.

* Sun Jun 21 2020 Denis Smirnov <mithraen@altlinux.ru> 0.12.3-alt1
