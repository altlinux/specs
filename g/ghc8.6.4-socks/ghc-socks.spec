...
%define h_pkg_name socks
%define f_pkg_name socks
...
%changelog
* Thu Aug 17 2023 Anton Zhukharev <ancieg@altlinux.org> 0.6.1-alt2
- Fixed FTBFS.

* Sun Jun 21 2020 Denis Smirnov <mithraen@altlinux.ru> 0.6.1-alt1
