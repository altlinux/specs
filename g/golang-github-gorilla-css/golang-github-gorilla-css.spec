...
%global commit          398b0b046082ecb3694c01bec6b336a06a4e530a
%global commitdate      20170217
%global shortcommit     %(c=%{commit}; echo ${c:0:7})

Name:           golang-%{provider}-%{project}-%{repo}
Version:        0
Release:        alt1_0.2.%{commitdate}git%{shortcommit}
Summary:        A CSS3 tokenizer
License:        BSD
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.2.20170217git398b0b0
- fc update

* Sat Dec 09 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.1.20170217git398b0b0
- new version
