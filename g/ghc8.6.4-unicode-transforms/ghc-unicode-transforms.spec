...
%define h_pkg_name unicode-transforms
%define f_pkg_name unicode-transforms
...
Url: http://github.com/harendra-kumar/unicode-transforms
...
%changelog
* Thu Aug 17 2023 Anton Zhukharev <ancieg@altlinux.org> 0.3.6-alt2
- Fixed FTBFS.

* Sun Jun 21 2020 Denis Smirnov <mithraen@altlinux.ru> 0.3.6-alt1
