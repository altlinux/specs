...
%install
%pyproject_install
# these tests are missed on p10, use -f
rm -vf %buildroot/%python3_sitelibdir/%name/*_test.py
rm -vf %buildroot/%python3_sitelibdir/%name/generator/*_test.py
...
%changelog
* Fri Jul 17 2026 Vitaly Lipatov <lav@altlinux.ru> 0.22.2-alt1
- new version 0.22.2

* Mon Mar 09 2026 Vitaly Lipatov <lav@altlinux.ru> 0.21.1-alt1
- new version 0.21.1

* Sat Jan 25 2025 Vitaly Lipatov <lav@altlinux.ru> 0.19.1-alt1
