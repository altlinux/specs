...
for file in $(find . -iname "*.go" \! -iname "*_test.go") ; do
    ...
    while [ ${filedir%%/*} != "$filedir" ]; do
        filedir=${filedir%%/*}
	echo "%%dir %%{go_path}/src/%%{import_path}/$filedir" >> devel.dir-list
    done
done
sort -u devel.dir-list >> devel.file-list
%endif
...
for file in $(find . -iname "*_test.go"); do
    ...
    while [ ${filedir%%/*} != "$filedir" ]; do
        filedir=${filedir%%/*}
	echo "%%dir %%{go_path}/src/%%{import_path}/$filedir" >> unit-test.dir-list
    done
done
sort -u unit-test.dir-list >> unit-test.file-list
%endif
...
%changelog
* Thu Nov 23 2017 Igor Vlasenko <viy@altlinux.ru> 1.1.4-alt1_0.1.git69483b4
- new version
