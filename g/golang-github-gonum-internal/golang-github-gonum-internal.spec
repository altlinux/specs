...
# https://github.com/gonum/internal
%global provider_prefix %{provider}.%{provider_tld}/%{project}/%{repo}
# change all internal to inteernal as from go-1.5 it can not be included
%global import_path     github.com/gonum/inteernal
%global commit          5b84ddfb9d3e72d73b8de858c97650be140935c0
%global shortcommit     %(c=%{commit}; echo ${c:0:7})

Name:           golang-%{provider}-%{project}-%{repo}
Version:        0
Release:        alt1_0.8.git%{shortcommit}
Summary:        Internal routines for the gonum project
License:        BSD
...
Provides:      golang(%{import_path}/asm) = %{version}-%{release}
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.8.git5b84ddf
- fc update

* Sat Dec 09 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.7.git5b84ddf
- new version
