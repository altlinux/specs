...
%global with_debug 0
# zk depends on camlistore.org/pkg/throttle which has more then 10 new packages
%global with_check 0
...
%global project         samuel
%global repo            go-zookeeper
# https://github.com/samuel/go-zookeeper
%global provider_prefix %{provider}.%{provider_tld}/%{project}/%{repo}
%global import_path     %{provider_prefix}
%global commit          d0e0d8e11f318e000a8cc434616d69e329edc374
...
%if 0%{?with_check}
#BuildRequires: golang(camlistore.org/pkg/throttle)
%endif

#Requires:      golang(camlistore.org/pkg/throttle)

Provides:      golang(%{import_path}/zk) = %{version}-%{release}
