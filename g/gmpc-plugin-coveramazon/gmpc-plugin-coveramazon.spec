%define func coveramazon

Name: gmpc-plugin-%func 
Version: 0.18.0
Release: alt1

%define builddeps glib2-devel >= 2.16 libgtk+2-devel libxml2-devel libmpd-devel >= 0.15.98 gmpc-devel >= 0.16.2

BuildRequires(pre): rpm-build-gmpc
%include %gmpc_plugin_incspec

%files
%gmpc_plugin_libdir/caaplugin.so
