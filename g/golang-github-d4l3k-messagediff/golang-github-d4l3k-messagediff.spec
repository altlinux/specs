...
%global project         d4l3k
%global repo            messagediff
# https://github.com/d4l3k/messagediff
%global provider_prefix %{provider}.%{provider_tld}/%{project}/%{repo}
%global import_path     %{provider_prefix}
%global commit          29f32d820d112dbd66e58492a6ffb7cc3106312b
...
%install
# remove examples as we don't want them packaged
rm -r example
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 1.1.0-alt1_0.5.git29f32d8
- fc update

* Sat Dec 09 2017 Igor Vlasenko <viy@altlinux.ru> 1.1.0-alt1_0.4.git29f32d8
- new version
