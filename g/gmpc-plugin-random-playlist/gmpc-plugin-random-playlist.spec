%define func random-playlist

Name: gmpc-plugin-%func 
Version: 0.15.5.0
Release: alt2

%define builddeps libgtk+2-devel libglade-devel libxml2-devel libmpd-devel >= 0.14.99 gmpc-devel >= 0.15.4.102
...
%changelog
* Sun Mar 15 2009 Alexey Rusakov <ktirf@altlinux.org> 0.15.5.0-alt2
- New version
