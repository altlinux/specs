...
Requires:      golang(github.com/wsxiaoys/terminal/color)

Provides:      golang(%{import_path}) = %{version}-%{release}
Provides:      golang(%{import_path}/build) = %{version}-%{release}
...
%changelog
* Wed Dec 13 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.3.git5c2eadb
- new version
