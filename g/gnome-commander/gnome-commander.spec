...
BuildRequires: flex gcc-c++ glibc-devel-static gnome-doc-utils-xslt libgnomeui-devel
BuildRequires: libtag-devel libpoppler-devel libexiv2-devel libgsf-devel python-devel
