...
%global with_debug 0
# Tests need 3 additional packages not yet packaged
%global with_check 0
...
Requires:      golang(github.com/lib/pq/hstore)
...
Requires:        golang(github.com/erikstmartin/go-testdb)
Requires:        golang(github.com/jinzhu/now)
...
%changelog
* Sat Dec 09 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.7.git82d726b
- new version
