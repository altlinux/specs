...
BuildRequires: gem(webmock) >= 1.24.6 gem(webmock) < 4
...
Provides:      gem(fog-openstack) = 1.0.11
...
Requires:      gem(fog-openstack) = 1.0.11
...
Requires:      gem(vcr) >= 0
Requires:      gem(webmock) >= 1.24.6 gem(webmock) < 4
