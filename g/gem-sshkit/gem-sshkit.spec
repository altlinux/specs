...
BuildRequires: gem(net-ssh) >= 2.8.0 gem(net-ssh) < 7
...
BuildRequires: gem(rainbow) >= 2.2.2 gem(rainbow) < 4
BuildRequires: gem(rake) >= 0
BuildRequires: gem(rubocop) >= 0.49.1 gem(rubocop) < 2
BuildRequires: gem(mocha) >= 0
BuildRequires: gem(bcrypt_pbkdf) >= 0
BuildRequires: gem(ed25519) >= 1.2 gem(ed25519) < 2.0

%add_findreq_skiplist %ruby_gemslibdir/**/*
%add_findprov_skiplist %ruby_gemslibdir/**/*
%ruby_use_gem_dependency rubocop >= 1.15.0,rubocop < 2
%ruby_use_gem_dependency net-ssh >= 6.1.0,net-ssh < 7
%ruby_use_gem_dependency rainbow >= 3.0.0,rainbow < 4
Requires:      gem(net-ssh) >= 2.8.0 gem(net-ssh) < 7
Requires:      gem(net-scp) >= 1.1.2
Provides:      gem(sshkit) = 1.21.2
...
Requires:      gem(rainbow) >= 2.2.2 gem(rainbow) < 4
Requires:      gem(rake) >= 0
Requires:      gem(rubocop) >= 0.49.1 gem(rubocop) < 2
Requires:      gem(mocha) >= 0
Requires:      gem(bcrypt_pbkdf) >= 0
Requires:      gem(ed25519) >= 1.2 gem(ed25519) < 2.0
