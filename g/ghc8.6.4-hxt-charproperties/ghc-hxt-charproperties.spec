...
%define h_pkg_name hxt-charproperties
%define f_pkg_name hxt-charproperties
...
%changelog
* Thu Aug 17 2023 Anton Zhukharev <ancieg@altlinux.org> 9.4.0.0-alt2
- Fixed FTBFS.

* Sun Jun 21 2020 Denis Smirnov <mithraen@altlinux.ru> 9.4.0.0-alt1
