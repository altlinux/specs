...
%global commit          e1271ee34c6a305e38566ecd27ae374944907ee9
%global shortcommit     %(c=%{commit}; echo ${c:0:7})

Name:           golang-%{provider}-%{project}-%{repo}
Version:        1.1.0
Release:        alt1_2
Summary:        A little like that j-thing, only in Go
License:        BSD
...
Requires:      golang(github.com/andybalholm/cascadia)
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 1.1.0-alt1_2
- fc update
