...
Conflicts:     gem(dotenv) >= 4
Conflicts:     gem(faraday) >= 3
Conflicts:     gem(octokit) >= 11.0
Conflicts:     gem(reverse_markdown) >= 4
Conflicts:     gem(rugged) >= 2.0
Conflicts:     gem(thor) >= 2
Provides:      gem(licensee) = 9.18.0
...
%files
%doc LICENSE.md licensee.gemspec
%ruby_gemspec
%ruby_gemlibdir
...
%changelog
* Sat Mar 21 2026 Pavel Skrylev <majioa@altlinux.org> 9.18.0-alt1
- ^ 9.15.2 -> 9.18.0
