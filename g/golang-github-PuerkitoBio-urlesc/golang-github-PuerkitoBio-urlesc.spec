...
%global commit          5bd2802263f21d8788851d5305584c82a5c75d7e
%global shortcommit     %(c=%{commit}; echo ${c:0:7})

Name:           golang-%{provider}-%{project}-%{repo}
Version:        0
Release:        alt1_0.6.git%{shortcommit}
Summary:        Package urlesc implements query escaping as per RFC 3986
License:        BSD
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.6.git5bd2802
- fc update

* Sat Dec 09 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.5.git5bd2802
- new version
