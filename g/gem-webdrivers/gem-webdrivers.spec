...
Vcs:           https://github.com/titusfortner/webdrivers.git
...
Provides:      gem(webdrivers) = 5.3.1.3

%ruby_use_gem_version webdrivers:5.3.1.3
...
Autoprov:      yes,noruby
Autoreq:       yes,noruby
Requires:      gem(webdrivers) = 5.3.1.3
...
%changelog
* Wed Nov 19 2025 Pavel Skrylev <majioa@altlinux.org> 5.3.1.3-alt0.1
- ^ 5.3.1 -> 5.3.1p3
- * rebased to upstream
