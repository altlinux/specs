...
%build
%add_optflags -DNDEBUG -DSTANDALONE %optflags_fastmath
%add_optflags -I$PWD/lib/gvc -I$PWD/lib/pathplan
%configure \
	--enable-static \
	--disable-hared \
	--with-pangocairo \
...
install -p -m644 lib/graph/graph.h %buildroot%_includedir/graphviz/
...
%changelog
* Fri Sep 12 2014 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 2.34.0-alt1
- Built frozen library for guitone
