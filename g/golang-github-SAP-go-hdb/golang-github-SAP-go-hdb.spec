...
# Tests require a working SAP HANA database server
%global with_check 0
...
Provides:      golang(%{import_path}/driver/sqltrace) = %{version}-%{release}
...
%gotest %{import_path}/driver/sqltrace
%gotest %{import_path}/internal/protocol
%gotest %{import_path}/internal/unicode/cesu8
%endif
