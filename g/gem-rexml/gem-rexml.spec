...
%changelog
* Mon Oct 13 2025 Alexander Danilov <admsasha@altlinux.org> 3.4.4-alt1
- ^ 3.3.9 -> 3.4.4

* Thu Jan 30 2025 Alexander Danilov <admsasha@altlinux.org> 3.3.9-alt1
- ^ 3.3.2 -> 3.3.9
