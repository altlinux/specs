...
Version:        1.5
Release:        alt1_6
Summary:        Emoji terminal output for golang
License:        MIT
URL:            https://%{provider_prefix}
Source0:        https://%{provider_prefix}/archive/v%{version}/%{version}.tar.gz
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 1.5-alt1_6
- fc update

* Sat Dec 09 2017 Igor Vlasenko <viy@altlinux.ru> 1.5-alt1_5
- new version
