...
BuildRequires: gem(yard) >= 0.9.20 gem(yard) < 0.10
BuildRequires: gem(rack) >= 2.1.4 gem(rack) < 3
...
Requires:      gem(yard) >= 0.9.20 gem(yard) < 0.10
Requires:      gem(rack) >= 2.1.4 gem(rack) < 3
