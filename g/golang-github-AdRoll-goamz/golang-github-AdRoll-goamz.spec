...
%global project         AdRoll
%global repo            goamz
# https://github.com/AdRoll/goamz
%global provider_prefix %{provider}.%{provider_tld}/%{project}/%{repo}
%global import_path     %{provider_prefix}
%global commit          aa6e716d710a0c7941cb2075cfbb9661f16d21f1
...
Provides:      golang(%{import_path}/cloudfront) = %{version}-%{release}
...
%changelog
* Wed Dec 13 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.10.gitaa6e716
- new version
