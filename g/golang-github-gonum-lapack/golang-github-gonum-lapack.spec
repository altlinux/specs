...
Requires:      golang(github.com/gonum/blas)
Requires:      golang(github.com/gonum/blas/blas64)
Requires:      golang(github.com/gonum/floats)

Provides:      golang(%{import_path}) = %{version}-%{release}
Provides:      golang(%{import_path}/cgo) = %{version}-%{release}
Provides:      golang(%{import_path}/cgo/clapack) = %{version}-%{release}
Provides:      golang(%{import_path}/lapack64) = %{version}-%{release}
Provides:      golang(%{import_path}/native) = %{version}-%{release}
Provides:      golang(%{import_path}/testlapack) = %{version}-%{release}
...
%if ! 0%{?with_bundled}
export GOPATH=%{buildroot}/%{go_path}:%{go_path}:/usr/include/lapacke
%else
...
%changelog
* Sat Dec 16 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.9.git88ec467
- new version
