...
%global repo            circonus-gometrics
...
Requires:      golang(github.com/circonus-labs/circonusllhist)
Requires:      golang(github.com/hashicorp/go-retryablehttp)

Provides:      golang(%{import_path}) = %{version}-%{release}
Provides:      golang(%{import_path}/api) = %{version}-%{release}
Provides:      golang(%{import_path}/checkmgr) = %{version}-%{release}
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.4.gitd17a842
- fc update

* Wed Dec 13 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.3.gitd17a842
- new version
