...
%global project         stevvooe
%global repo            resumable
# https://github.com/stevvooe/resumable
%global provider_prefix %{provider}.%{provider_tld}/%{project}/%{repo}
%global import_path     %{provider_prefix}
%global commit          51ad44105773cafcbe91927f70ac68e1bf78f8b4
%global shortcommit     %(c=%{commit}; echo ${c:0:7})

Name:           golang-%{provider}-%{project}-%{repo}
Version:        0
Release:        alt1_0.8.git%{shortcommit}
Summary:        Subset of the Go `crypto` Package with a Resumable Hash Interface
License:        BSD
...
Provides:      golang(%{import_path}/sha256) = %{version}-%{release}
Provides:      golang(%{import_path}/sha512) = %{version}-%{release}
...
%gotest %{import_path}/sha256
%gotest %{import_path}/sha512
%endif
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.8.git51ad441
- fc update

* Sat Dec 09 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.7.git51ad441
- new version
