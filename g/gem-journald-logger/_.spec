...
BuildRequires: gem(journald-native) >= 1.0 gem(journald-native) < 2
...
Requires:      gem(journald-native) >= 1.0 gem(journald-native) < 2
Provides:      gem(journald-logger) = 3.0.1
...
Requires:      gem(journald-logger) = 3.0.1
