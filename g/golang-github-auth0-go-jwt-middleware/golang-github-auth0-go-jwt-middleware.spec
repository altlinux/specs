...
%global project         auth0
%global repo            go-jwt-middleware
# https://github.com/auth0/go-jwt-middleware
%global provider_prefix %{provider}.%{provider_tld}/%{project}/%{repo}
%global import_path     %{provider_prefix}
%global commit          8c897f7c3631a9e9405b9496fd8ce241acdef230
%global shortcommit     %(c=%{commit}; echo ${c:0:7})

Name:           golang-%{provider}-%{project}-%{repo}
Version:        0.1
Release:        alt1_8.git%{shortcommit}
Summary:        A Middleware for Go Programming Language to check for JWTs on HTTP requests
License:        MIT
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 0.1-alt1_8.git8c897f7
- fc update

* Wed Dec 13 2017 Igor Vlasenko <viy@altlinux.ru> 0.1-alt1_7.git8c897f7
- new version
