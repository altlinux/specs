...
%global import_path     golang.org/x/time
...
Provides:      golang(%{import_path}/rate) = %{version}-%{release}
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.6.gitc06e80d
- fc update

* Sat Dec 09 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.5.gitc06e80d
- new version
