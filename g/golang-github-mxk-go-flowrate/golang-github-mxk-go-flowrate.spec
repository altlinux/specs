...
Provides:      golang(%{import_path}/flowrate) = %{version}-%{release}
...
# failure on f23, armv7hl
# -- FAIL: TestWriter (0.38s)
#	io_test.go:126: w.Write(b[20:]) returned ahead of time (381.070371ms)
#%gotest %{import_path}/flowrate
%endif
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.8.gitcca7078
- fc update

* Sat Dec 09 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.7.gitcca7078
- new version
