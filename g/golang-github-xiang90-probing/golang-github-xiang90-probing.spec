...
%global project         xiang90
%global repo            probing
# https://github.com/xiang90/probing
%global provider_prefix %{provider}.%{provider_tld}/%{project}/%{repo}
%global import_path     %{provider_prefix}
%global commit          07dd2e8dfe18522e9c447ba95f2fe95262f63bb2
%global shortcommit     %(c=%{commit}; echo ${c:0:7})

Name:           golang-%{provider}-%{project}-%{repo}
Version:        0
Release:        alt1_0.6.git%{shortcommit}
Summary:        Golang project for probing
License:        MIT
...
%changelog
* Sat Dec 09 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.6.git07dd2e8
- new version
