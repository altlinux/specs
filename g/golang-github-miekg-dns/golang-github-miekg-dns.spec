...
%global commit          d27455715200c7d3e321a1e5cadb27c9ee0b0f02
...
# Fails in Koji:
# remote_test.go:14: failed to exchange: write udp
# 10.5.125.100:36276->176.58.119.54:53: write: operation not permitted
#%gotest %{import_path}
%gotest %{import_path}/idn
%endif
...
%changelog
* Sat Dec 09 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.13.gitd274557
- new version
