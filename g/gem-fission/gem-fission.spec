...
%ruby_use_gem_dependency CFPropertyList >= 2.2
%ruby_use_gem_dependency fakefs >= 0.4.3
%ruby_use_gem_dependency rspec >= 2.14
...
%changelog
* Tue Sep 22 2026 Pavel Skrylev <majioa@altlinux.org> 0.5.0-alt2.2
- ! relaxed deps to some build gems
