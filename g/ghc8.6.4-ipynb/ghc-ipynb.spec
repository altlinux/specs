...
%define h_pkg_name ipynb
%define f_pkg_name ipynb
...
%changelog
* Thu Aug 17 2023 Anton Zhukharev <ancieg@altlinux.org> 0.1.0.1-alt2
- Fixed FTBFS.

* Sun Jun 21 2020 Denis Smirnov <mithraen@altlinux.ru> 0.1.0.1-alt1
