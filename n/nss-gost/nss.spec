...
%if_with gost
Name:		nss-gost
%define		relsuffix .gost%gost_version
%else
Name:		nss
%endif
...
%if_with gost
Patch11:	nss-%version-gost-tls-%gost_version.patch
# GOST algoritms are currently provided by OpenSSL
...
Provides: nss(gost) = %gost_version
Conflicts: libnss
%endif
...
* Thu Nov 07 2019 Paul Wolneykien <manowar@altlinux.org> 3.45.0-alt4.gost1.2
- Provide nss-devel(gost)  = %%gost_version.

* Wed Nov 06 2019 Paul Wolneykien <manowar@altlinux.org> 3.45.0-alt3.gost1.2
- Fixed out-of-bounds DER decoding.

* Mon Oct 28 2019 Paul Wolneykien <manowar@altlinux.org> 3.45.0-alt3.gost1.1
- Fixed regressions in TLS < 1.2.
- Use the curve name to determine the low-level EC key type.
...
* Tue Jul 16 2019 Paul Wolneykien <manowar@altlinux.org> 3.45.0-alt2.gost1.0
- Provide generic packages based on 'nss' name.

* Tue Jul 16 2019 Paul Wolneykien <manowar@altlinux.org> 3.45.0-alt1.gost1.0
- Separate package: nss-gost.
- Provide GOST support markers: nss(gost).
- Add support for GOST TLS ciphersuites based on GOST-28147 (0081h and
  C102h).
