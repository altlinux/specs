...
%attr(644,root,root) %config(noreplace) %_sysconfdir/nftables/*.nft
%_unitdir/*
%_sbindir/*
%_man8dir/*
...
%changelog
* Mon Sep 07 2026 Alexei Takaseev <taf@altlinux.org> 1:1.1.7-alt2
- No replace changed configs (ALT #60434)

* Wed Sep 02 2026 Alexei Takaseev <taf@altlinux.org> 1:1.1.7-alt1
- 1.1.7

* Mon Dec 08 2025 Alexei Takaseev <taf@altlinux.org> 1:1.1.6-alt1
- 1.1.6
- Disable tests

* Thu Aug 28 2025 Alexei Takaseev <taf@altlinux.org> 1:1.1.5-alt1
- 1.1.5

* Fri Aug 08 2025 Alexei Takaseev <taf@altlinux.org> 1:1.1.4-alt1
- 1.1.4

* Tue Apr 22 2025 Alexei Takaseev <taf@altlinux.org> 1:1.1.3-alt1
- 1.1.3

* Tue Apr 15 2025 Alexei Takaseev <taf@altlinux.org> 1:1.1.2-alt1
- 1.1.2
