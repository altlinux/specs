...
%changelog
* Sun Jan 11 2026 Anton Midyukov <antohami@altlinux.org> 6.6.3-alt1
- New version 6.6.3.

* Wed Dec 17 2025 Anton Midyukov <antohami@altlinux.org> 6.6.2-alt1
- New version 6.6.2.

* Sat Dec 13 2025 Anton Midyukov <antohami@altlinux.org> 6.6.1-alt1
- New version 6.6.1.
...
* Fri Dec 13 2024 Anton Midyukov <antohami@altlinux.org> 6.4.3-alt1
- New version 6.4.3.
