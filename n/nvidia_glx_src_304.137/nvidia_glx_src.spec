...
%changelog
* Thu Feb 28 2019 Sergey V Turchin <zerg@altlinux.org> 304.137-alt143
- add fix against kernel < 4.4.163

* Wed Feb 06 2019 Sergey V Turchin <zerg@altlinux.org> 304.137-alt142
- add fix against kernel 4.4 get_user_pages

* Fri Oct 19 2018 Sergey V Turchin <zerg@altlinux.org> 304.137-alt141
- rebuild
