...
%changelog
* Wed Aug 12 2026 Andrey Cherepanov <cas@altlinux.org> 4.2.1-alt1
- New version.

* Sat Jul 04 2026 Andrey Cherepanov <cas@altlinux.org> 4.2.0-alt1
- New version.
...
* Wed Sep 24 2025 Andrey Cherepanov <cas@altlinux.org> 3.44.3-alt2
- Updated build tag.

* Sat Sep 13 2025 Andrey Cherepanov <cas@altlinux.org> 3.44.3-alt1
- New version.

* Fri Aug 15 2025 Andrey Cherepanov <cas@altlinux.org> 3.44.2-alt1
- New version.

* Fri Jul 18 2025 Andrey Cherepanov <cas@altlinux.org> 3.44.1-alt1
- New version.

* Sat Jun 21 2025 Andrey Cherepanov <cas@altlinux.org> 3.44.0-alt1
- New version.

* Fri May 16 2025 Andrey Cherepanov <cas@altlinux.org> 3.42.3-alt1
- New version.

* Mon Apr 28 2025 Ilya Kurdyukov <ilyakurdyukov@altlinux.org> 3.42.2-alt2
- Fixed build for Elbrus.

* Mon Apr 21 2025 Andrey Cherepanov <cas@altlinux.org> 3.42.2-alt1
- New version.

* Sun Mar 23 2025 Andrey Cherepanov <cas@altlinux.org> 3.42.1-alt2
- Real sources of 3.42.1.

* Sat Mar 22 2025 Andrey Cherepanov <cas@altlinux.org> 3.42.1-alt1
- New version.

* Tue Feb 25 2025 Andrey Cherepanov <cas@altlinux.org> 3.42.0-alt2
- Rebuilt with grass-8.4.1.

* Fri Feb 21 2025 Andrey Cherepanov <cas@altlinux.org> 3.42.0-alt1
- New version.
