...
%changelog
* Tue Aug 25 2026 Nikolay Strelkov <snk@altlinux.org> 0.9.7-alt1
- New version 0.9.7.

* Sun Aug 16 2026 Nikolay Strelkov <snk@altlinux.org> 0.9.6-alt1
- New version 0.9.6.

* Sun Jul 26 2026 Nikolay Strelkov <snk@altlinux.org> 0.9.5-alt1
- New version 0.9.5.
