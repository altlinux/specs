...
BuildRequires: cmake gcc-c++ libXScrnSaver-devel libXcomposite-devel libXdamage-devel libXdmcp-devel libXft-devel libXpm-devel libXt-devel libXxf86vm-devel libxkbfile-devel qt4-designer xorg-xf86miscproto-devel
...
%changelog
* Sat Jul 03 2021 Grigory Ustinov <grenka@altlinux.org> 0.4.4-alt1r36.2
- NMU: Fixed FTBFS.
