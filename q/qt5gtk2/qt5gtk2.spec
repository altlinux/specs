...
BuildRequires: qt5-sensors-devel qt5-serialport-devel qt5-speech-devel qt5-svg-devel qt5-tools-devel qt5-wayland-devel qt5-webengine-devel qt5-websockets-devel qt5-x11extras-devel
...
%changelog
* Thu Oct 19 2017 Sergey V Turchin <zerg@altlinux.org> 0.1-alt1.1
