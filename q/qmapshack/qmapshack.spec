...
BuildRequires: cmake libalglib-devel libgdal-devel libjpeg-devel libproj-devel libroutino-devel libtiff-devel qt6-tools-devel qt6-webengine-devel quazip-qt6-devel libsqlite3-devel
...
%changelog
* Mon Jun 15 2026 Andrey Cherepanov <cas@altlinux.org> 1.20.3-alt1
- NMU: new version for gdal 3.13.1.
