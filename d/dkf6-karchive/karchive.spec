...
BuildRequires: dqt6-base-devel dqt6-tools-devel
BuildRequires: bzlib-devel deepin-extra-cmake-modules liblzma-devel zlib-devel libzstd-devel
...
%package -n libdkf6archive
Group: System/Libraries
Summary: KF6 library
Requires: %name-common = %version-%release
%description -n libdkf6archive
KF6 library
...
%_DK6inc/KArchive/
%_DK6link/lib*.so
%_DK6lib/cmake/KF6Archive/
%_DK6lib/pkgconfig/*Archive*.pc

%files -n libdkf6archive
%_DK6lib/libKF6Archive.so.*
