...
BuildRequires: dkf6-kcodecs-devel dkf6-kconfig-devel dkf6-kcoreaddons-devel dkf6-ki18n-devel
...
%package -n libdkf6contacts
Group: System/Libraries
Summary: KF6 library
Requires: %name-common
%description -n libdkf6contacts
KF6 library
...
mkdir -p %buildroot/%_DK6data/kcontacts/

%files common -f %name.lang
%doc LICENSES/* README.md
#%config(noreplace) %_K6xdgconf/*.*categories
%_DK6data/qlogging-categories6/*.*categories
%dir %_DK6data/kcontacts/

%files devel
#%_DK6inc/kcontacts_version.h
%_DK6inc/KContacts/
%_DK6link/lib*.so
%_DK6lib/cmake/KF6Contacts/

%files -n libdkf6contacts
%_DK6lib/libKF6Contacts.so.*
%_DK6qml/org/kde/contacts/
