...
%_documentationdir	%_docsinstalldir	62
EOF
...
* Tue Jul 29 2025 Elena Mishina <lepata@altlinux.org> 11.0-alt1
- update to Simply Linux 11.0beta

* Fri Oct 25 2024 Elena Mishina <lepata@altlinux.org> 10.4-alt1
- update to Simply Linux 10.4

* Fri Apr 19 2024 Elena Mishina <lepata@altlinux.org> 10.2-alt5
- fix prepare boot-disk (closes #48282, #48281)
- small improvements
- update screen

* Tue Oct 24 2023 Elena Mishina <lepata@altlinux.org> 10.2-alt4
