...
BuildRequires: dqt6-declarative-devel dqt6-tools-devel
BuildRequires: vulkan-headers
BuildRequires: dkf6-karchive-devel dkf6-kauth-devel dkf6-kcodecs-devel dkf6-kconfig-devel
BuildRequires: dkf6-kwidgetsaddons-devel dkf6-kcoreaddons-devel dkf6-kguiaddons-devel dkf6-ki18n-devel
BuildRequires: dkf6-kdoctools-devel dkf6-kcolorscheme-devel
...
Requires: dkf6-kauth-devel dkf6-kcodecs-devel dkf6-kconfig-devel dkf6-kwidgetsaddons-devel dkf6-kguiaddons-devel
%description devel
The %name-devel package contains libraries and header files for
developing applications that use %name.

%package -n libdkf6configwidgets
Group: System/Libraries
Summary: KF6 library
Requires: %name-common = %version-%release
%description -n libdkf6configwidgets
KF6 library
...
%_DK6i18n/*/kf6_entry.desktop

%files devel
%_DK6inc/KConfigWidgets/
%_DK6link/lib*.so
%_DK6lib/cmake/KF6ConfigWidgets
%_DK6plug/designer/*.so

%files -n libdkf6configwidgets
%_DK6lib/libKF6ConfigWidgets.so.*
