...
BuildRequires: dqt5-base-devel dqt5-tools-devel glib2-devel
...
%cmake \
  ...
  -DCMAKE_INSTALL_DATAROOTDIR=%_dqt5_datadir \
#
%cmake_build
...
%files
%doc BSD-3-Clause
%_dqt5_datadir/cmake/lxqt-build-tools
%_dqt5_bindir/*
