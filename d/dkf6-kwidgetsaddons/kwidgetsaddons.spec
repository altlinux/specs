...
%endif
BuildRequires: deepin-extra-cmake-modules dqt6-tools-devel-static
...
%package -n libdkf6widgetsaddons
Group: System/Libraries
Summary: KF6 library
Requires: %name-common = %version-%release
%description -n libdkf6widgetsaddons
KF6 library
...
%_DK6inc/KWidgetsAddons/
%_DK6link/lib*.so
%_DK6lib/cmake/KF6WidgetsAddons

%files -n libdkf6widgetsaddons
%_DK6lib/libKF6WidgetsAddons.so.*
