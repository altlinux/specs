...
BuildRequires: glibc-devel-static libX11-devel libXext-devel libfreetype-devel libjpeg-devel libpng-devel libsysfs-devel man
BuildRequires: gcc-c++
...
%changelog
* Wed Aug 26 2026 Andrew A. Vasilyev <andy@altlinux.org> 1.1.0-alt8
