...
BuildRequires: deepin-extra-cmake-modules libavahi-devel dqt6-tools-devel
BuildRequires: vulkan-headers libdqt6-network libdqt6-widgets
...
%package -n libdkf6dnssd
Group: System/Libraries
Summary: KF6 library
Requires: %name-common = %version-%release
%description -n libdkf6dnssd
KF6 library
...
%files devel
#%_DK6inc/kdnssd_version.h
%_DK6inc/KDNSSD/
%_DK6link/lib*.so
%_DK6lib/cmake/KF6DNSSD

%files -n libdkf6dnssd
%_DK6lib/libKF6DNSSD.so.*
