...
BuildRequires: vulkan-headers libdqt6-gui
...
%package -n libdkf6dbusaddons
Group: System/Libraries
Summary: KF6 library
Requires: %name-common = %version-%release
%description -n libdkf6dbusaddons
KF6 library
...
%files devel
#%_DK6inc/kdbusaddons_version.h
%_DK6inc/KDBusAddons/
%_DK6link/lib*.so
%_DK6lib/cmake/KF6DBusAddons

%files -n libdkf6dbusaddons
%_DK6lib/libKF6DBusAddons.so.*
