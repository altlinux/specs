...
BuildRequires: deepin-extra-cmake-modules vulkan-headers
...
#BuildRequires: dqt6-speech-devel
#BuildRequires: libdbusmenu-dqt6-devel
...
#BuildRequires: dkf6-kiconthemes-devel dkf6-kitemviews-devel dkf6-kservice-devel dkf6-kwidgetsaddons-devel
...
%package -n libdkf6notifications
Group: System/Libraries
Summary: KF6 library
Requires: %name-common = %version-%release
%description -n libdkf6notifications
KF6 library
...
%files devel
%_DK6inc/KNotifications/
%_DK6link/lib*.so
%_DK6lib/cmake/KF6Notifications
#%_DK6dbus_iface/*.xml

%files -n libdkf6notifications
%_DK6lib/libKF6Notifications.so.*
%_DK6qml/org/kde/notification/
