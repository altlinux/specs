...
%changelog
* Thu Jun 12 2025 Igor Vlasenko <viy@altlinux.org> 0.459-alt1
- db update

* Wed Oct 18 2023 Igor Vlasenko <viy@altlinux.org> 0.458-alt1
- db update

* Tue Aug 29 2023 Igor Vlasenko <viy@altlinux.org> 0.457-alt1
- db update

* Wed Feb 22 2023 Igor Vlasenko <viy@altlinux.org> 0.456-alt1
- db update

* Thu Oct 06 2022 Igor Vlasenko <viy@altlinux.org> 0.455-alt1
- manual fixes

* Sun Jul 03 2022 Igor Vlasenko <viy@altlinux.org> 0.454-alt1
- db update

* Thu May 05 2022 Igor Vlasenko <viy@altlinux.org> 0.453-alt1
- db update

* Fri Jan 21 2022 Igor Vlasenko <viy@altlinux.org> 0.452-alt1
- db update

* Thu Dec 16 2021 Igor Vlasenko <viy@altlinux.org> 0.451-alt1
- db update

* Wed Oct 20 2021 Igor Vlasenko <viy@altlinux.org> 0.450-alt1
- db update

* Thu Nov 26 2020 Igor Vlasenko <viy@altlinux.ru> 0.449-alt1
- db update

* Wed Sep 02 2020 Igor Vlasenko <viy@altlinux.ru> 0.448-alt1
- db update

* Fri Jun 12 2020 Igor Vlasenko <viy@altlinux.ru> 0.447-alt1
- db update

* Sat Mar 28 2020 Igor Vlasenko <viy@altlinux.ru> 0.446-alt1
- db update

* Fri Jan 03 2020 Igor Vlasenko <viy@altlinux.ru> 0.445-alt1
- db update

* Thu Oct 31 2019 Igor Vlasenko <viy@altlinux.ru> 0.444-alt1
- db update
