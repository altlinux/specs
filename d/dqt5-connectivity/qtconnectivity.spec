...
%global qt_module dqtconnectivity
%def_enable btle

Name: dqt5-connectivity
Version: 5.15.13
Release: alt0.dde.1
...
# optimized out: elfutils libGL-devel libcloog-isl4 libdqt5-clucene libdqt5-concurrent libdqt5-core libdqt5-dbus libdqt5-gui libdqt5-help libdqt5-network libdqt5-qml libdqt5-quick libdqt5-sql libdqt5-widgets libdqt5-xml libstdc++-devel pkg-config python-base dqt5-base-devel dqt5-declarative-devel dqt5-tools ruby ruby-stdlibs
#BuildRequires: gcc-c++ glibc-devel-static libbluez-devel dqt5-script-devel dqt5-tools-devel dqt5-webkit-devel dqt5-xmlpatterns-devel rpm-build-ruby
BuildRequires(pre): rpm-build-ubt rpm-macros-dqt5 dqt5-tools
BuildRequires: gcc-c++ glibc-devel libbluez-devel dqt5-declarative-devel dqt5-xmlpatterns-devel dqt5-tools-devel
...
%package -n libdqt5-bluetooth
Summary: Qt5 library
Group: System/Libraries
AutoProv: no,lib
Requires: %name-common = %EVR
Requires: libdqt5-core = %_dqt5_version
%description -n libdqt5-bluetooth
%summary

%package -n libdqt5-nfc
Summary: Qt5 library
Group: System/Libraries
AutoProv: no,lib
Requires: %name-common = %EVR
Requires: libdqt5-core = %_dqt5_version
%description -n libdqt5-nfc
%summary
...
%files
%_bindir/sdpscanner*
%_dqt5_bindir/sdpscanner

%files -n libdqt5-bluetooth
%_dqt5_libdir/libQt?Bluetooth.so.*
%_dqt5_archdatadir/qml/QtBluetooth/

%files -n libdqt5-nfc
%_dqt5_libdir/libQt?Nfc.so.*
%_dqt5_archdatadir/qml/QtNfc/
