...
Provides: dqt5-qtquickcontrols = %version-%release
Provides: libdqt5-qtquickcontrols = %version-%release
...
#BuildRequires: gcc-c++ glibc-devel-static python-module-distribute dqt5-jsbackend-devel dqt5-script-devel dqt5-tools-devel dqt5-webkit-devel dqt5-xmlpatterns-devel rpm-build-gir rpm-build-python3 rpm-build-ruby
BuildRequires(pre): rpm-build-ubt rpm-macros-dqt5 dqt5-tools
BuildRequires: gcc-c++ glibc-devel
BuildRequires: dqt5-xmlpatterns-devel dqt5-declarative-devel

Requires: libdqt5-gui = %_dqt5_version libdqt5-qml = %_dqt5_version libdqt5-quick = %_dqt5_version
