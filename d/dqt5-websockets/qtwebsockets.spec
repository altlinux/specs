...
BuildRequires: gcc-c++ glibc-devel dqt5-xmlpatterns-devel dqt5-declarative-devel
...
%package -n libdqt5-websockets
Summary: Qt5 library
Group: System/Libraries
AutoProv: no,lib
Requires: %name-common = %EVR
Requires: dqt5-declarative-common
Requires: libdqt5-core = %_dqt5_version
%description -n libdqt5-websockets
%summary
...
%files common
%files -n libdqt5-websockets
%_dqt5_libdir/libQt?WebSockets.so.*
%_dqt5_archdatadir/qml/Qt/WebSockets/
%_dqt5_qmldir/QtWebSockets/
