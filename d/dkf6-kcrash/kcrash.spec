...
BuildRequires: dkf6-kcoreaddons-devel dkf6-kwindowsystem-devel
...
%package -n libdkf6crash
Group: System/Libraries
Summary: KF6 library
Requires: %name-common = %version-%release
%description -n libdkf6crash
KF6 library
...
%files devel
#%_DK6inc/kcrash_version.h
%_DK6inc/KCrash/
%_DK6link/lib*.so
%_DK6lib/cmake/KF6Crash

%files -n libdkf6crash
%_DK6lib/libKF6Crash.so.*
