%setup_docs_module linux_fstypes ru

Name: %packagename
Version: 0.1.2
Release: alt2

Summary: Filesystem types
Summary(ru_RU.KOI8-R): Типы файловых систем
License: %fdl
...
# replace docs-linux_fstypes-kirill
Provides: docs-linux_fstypes-kirill
Obsoletes: docs-linux_fstypes-kirill
...
Типы файловых систем, поддерживаемые Linux.
...
%changelog
* Wed Sep 03 2008 Artem Zolochevskiy <azol@altlinux.ru> 0.1.2-alt2
...
- replaces docs-linux_fstypes-kirill
  + added Provides/Obsoletes

* Mon Mar 10 2008 Artem Zolochevskiy <azol@altlinux.ru> 0.1.1-alt1
- ntfs write support (thanks cas@)
- added missing "." in %% description

* Mon Aug 13 2007 Artem Zolochevskiy <azol@altlinux.ru> 0.1-alt1.1
- fixed previous changelog entry

* Sun Jul 22 2007 Artem Zolochevskiy <azol@altlinux.ru> 0.1-alt1
- initial build for Sisyphus
  + based on docs-linux_fstypes-kirill package

* Fri Jul 20 2007 Kirill Maslinsky <kirill@altlinux.ru> 070720-alt1
- typo fixed (closes #12374)
