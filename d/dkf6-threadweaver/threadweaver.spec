...
BuildRequires: vulkan-headers libdqt6-network libdqt6-xml libdqt6-widgets libdqt6-test
...
%package -n libdkf6threadweaver
Group: System/Libraries
Summary: KF6 library
#Requires: %name-common = %version-%release
%description -n libdkf6threadweaver
KF6 library
...
%files devel
#%_DK6inc/threadweaver_version.h
%_DK6inc/ThreadWeaver/
%_DK6link/lib*.so
%_DK6lib/cmake/KF6ThreadWeaver

%files -n libdkf6threadweaver
%doc LICENSES/* README.md
%_DK6lib/libKF6ThreadWeaver.so.*
