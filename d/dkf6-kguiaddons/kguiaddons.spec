...
Provides: dkf5-kguiaddons = %EVR
Obsoletes: dkf5-kguiaddons < %EVR
...
%endif
BuildRequires: deepin-extra-cmake-modules dqt6-wayland-devel dqt6-tools-devel dqt6-declarative-devel
...
%package -n libdkf6guiaddons
Group: System/Libraries
Summary: KF6 library
Requires: %name-common >= %EVR
%description -n libdkf6guiaddons
KF6 library
...
%install
%DK6install
install -m 0644 %SOURCE10 %buildroot/%_DK6xdgapp/
...
%files
%_DK6bin/*geo*handler*
%_DK6xdgapp/*geo*handler*.desktop

%files devel
%_DK6inc/KGuiAddons/
%_DK6link/lib*.so
%_DK6lib/cmake/KF6GuiAddons/
%_DK6archdata/metatypes/*.json
%_DK6lib/pkgconfig/KF6GuiAddons.pc

%files -n libdkf6guiaddons
%_DK6lib/libKF6GuiAddons.so.*
%_DK6qml/org/kde/guiaddons/
