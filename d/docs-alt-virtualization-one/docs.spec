%define variant alt-virtualization-one
%define Variant ALT Virtualization OpenNebula Edition
...
* Mon Jun 30 2025 Alexander Burmatov <thatman@altlinux.org> 11.0-alt0.1
- package OpenNebula only docs; drop PVE, container and basic virtualization docs (thx darisishe@)
