...
%endif
BuildRequires: deepin-extra-cmake-modules dkf6-kconfig-devel dkf6-kwidgetsaddons-devel dkf6-kcodecs-devel
...
%package -n libdkf6completion
Group: System/Libraries
Summary: KF6 library
Requires: %name-common = %version-%release
%description -n libdkf6completion
KF6 library
...
#%_DK6inc/kcompletion_version.h
%_DK6inc/KCompletion/
%_DK6link/lib*.so
%_DK6lib/cmake/KF6Completion

%files -n libdkf6completion
%_DK6lib/libKF6Completion.so.*
