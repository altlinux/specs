...
BuildRequires: gcc-c++ dqt5-base-devel
BuildRequires: dqt5-script-devel dqt5-svg-devel dqt5-xmlpatterns-devel dqt5-declarative-devel
...
%package -n libdqt5-doc
Summary: Qt5 library
Group: System/Libraries
Requires: %name-common = %EVR
%description -n libdqt5-doc
%summary
