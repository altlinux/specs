...
BuildPreReq: libparmetis-devel libgmp-devel libslepc-%scalar_type-devel
...
BuildPreReq: ghostscript-utils libhwloc-devel libqt4-devel libvtk6.1-devel
...
Requires: libslepc-%scalar_type ffc
...
%changelog
* Sat Jan 03 2015 Ivan A. Melnikov <iv@altlinux.org> 1:1.4.0-alt1.git20141028.1
- rebuild with boost 1.57.0

* Mon Nov 03 2014 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 1:1.4.0-alt1.git20141028
- Version 1.4.0

* Tue Jul 08 2014 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 1:1.3.0-alt3.git20140506
- Fixed build
...
* Thu Jul 11 2013 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 1:1.2.0-alt3.git20130710
- New snapshot
...
* Sun Feb 10 2013 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 1:1.1.0-alt2.bzr20130130
- Rebuilt with Boost 1.53.0

* Thu Jan 31 2013 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 1:1.1.0-alt1.bzr20130130
- Version 1.1.0

* Thu Dec 06 2012 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 1:1.0.0-alt16.bzr20121015
- Rebuilt with updated cppunit

* Thu Nov 29 2012 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 1:1.0.0-alt15.bzr20121015
- Rebuilt with Boost 1.52.0

* Sun Oct 28 2012 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 1:1.0.0-alt14.bzr20121015
- Rebuilt with Trilinos 11.0.3

* Thu Oct 25 2012 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 1:1.0.0-alt13.bzr20121015
- Rebuilt with CGAL 4.1

* Mon Oct 15 2012 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 1:1.0.0-alt12.bzr20121015
- New snapshot

* Tue Oct 02 2012 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 1:1.0.0-alt12.bzr20120818
- Rebuilt with gcc 4.7

* Thu Sep 06 2012 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 1:1.0.0-alt11.bzr20120818
- Rebuilt with Boost 1.51.0

* Mon Sep 03 2012 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 1:1.0.0-alt10.bzr20120818
- Rebuilt with SuiteSparse 4.0.2
