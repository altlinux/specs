...
%package -n libdkf6plotting
Group: System/Libraries
Summary: KF6 library
#Requires: %name-common = %version-%release
%description -n libdkf6plotting
KF6 library
...
%files devel
#%_DK6inc/kplotting_version.h
%_DK6inc/KPlotting/
%_DK6link/lib*.so
%_DK6lib/cmake/KF6Plotting
%_DK6plug/designer/*.so

%files -n libdkf6plotting
%doc LICENSES/* README.md
%_DK6lib/libKF6Plotting.so.*
