...
%endif
BuildRequires: deepin-extra-cmake-modules dkf6-kcoreaddons-devel dkf6-kwindowsystem-devel libpolkitqt6-dqt6-devel dqt6-tools-devel
...
%package -n libdkf6auth
Group: System/Libraries
Summary: KF6 library
Requires: %name-common = %version-%release
%description -n libdkf6auth
KF6 library

%package -n libdkf6authcore
Group: System/Libraries
Summary: KF6 library
Requires: %name-common = %version-%release
%description -n libdkf6authcore
KF6 library
...
%dir %_DK6exec/kauth/
%_DK6dbus/system.d/*auth*.conf

%files devel
%_DK6inc/KAuth*/
%_DK6link/lib*.so
%_DK6lib/cmake/KF6Auth/
%_DK6data/kauth/

%files -n libdkf6authcore
%_DK6lib/libKF6AuthCore.so.*
%_DK6exec/kauth/*
%_DK6plug/kf6/kauth/

#%files -n libdkf6auth
#%_DK6lib/libKF6Auth.so.*
