...
BuildRequires: dde-dock-devel deepin-gettext-tools dqt6-svg-devel dqt6-tools-devel dtk6-common-devel libXext-devel libcups-devel libdtk6widget-devel libnl-devel libpcap-devel libpolkitqt6-dqt6-devel libudev-devel libxcbutil-icccm-devel libwayland-client-devel
BuildRequires: libdqt6-concurrent vulkan-headers libicu-devel
...
%changelog
* Fri Jul 31 2026 Leontiy Volodin <lvol@altlinux.org> 6.5.46-alt1
- New version 6.5.46.

* Fri Jun 05 2026 Leontiy Volodin <lvol@altlinux.org> 6.5.45-alt1
- New version 6.5.45.

* Thu May 14 2026 Leontiy Volodin <lvol@altlinux.org> 6.5.42-alt1
- New version 6.5.42.

* Thu Mar 19 2026 Leontiy Volodin <lvol@altlinux.org> 6.5.39-alt1
- New version 6.5.39.

* Wed Mar 04 2026 Leontiy Volodin <lvol@altlinux.org> 6.5.38-alt1
- New version 6.5.38.
- Fixed build on shrinked dqt6.
- Built on separate polkit-qt6 (no qt6).
...
* Mon Oct 27 2025 Leontiy Volodin <lvol@altlinux.org> 6.5.35-alt1
- New version 6.5.35.
