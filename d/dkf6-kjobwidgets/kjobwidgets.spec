...
%endif
BuildRequires: deepin-extra-cmake-modules dqt6-tools-devel vulkan-headers
BuildRequires: dkf6-kcoreaddons-devel dkf6-kwidgetsaddons-devel dkf6-knotifications-devel
...
%package -n libdkf6jobwidgets
Group: System/Libraries
Summary: KF6 library
Requires: %name-common = %version-%release
%description -n libdkf6jobwidgets
KF6 library
...
%_DK6inc/KJobWidgets/
%_DK6link/lib*.so
%_DK6lib/cmake/KF6JobWidgets
%_DK6dbus_iface/*.xml

%files -n libdkf6jobwidgets
%_DK6lib/libKF6JobWidgets.so.*
