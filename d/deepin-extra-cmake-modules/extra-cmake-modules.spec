...
%add_python3_path %_datadir/DDE-ECM/find-modules

Name: deepin-extra-cmake-modules
Version: 6.28.0
Release: alt0.dde.1

Group: Development/Other
Summary: Deepin fork of extra-cmake-modules
License: BSD
...
Provides: dde-extra-cmake-modules = %EVR
...
BuildRequires: cmake dqt6-tools dqt6-tools-devel
...
%description
This packages provides fork of extra-cmake-modules needed by
deepin packages.
...
if [ "$(arch)" = "e2k" ]; then
	# dkf6-kcoreaddons linking warning gets fatal otherwise (mcst#3675)
	sed -i 's|-Wl,--fatal-warnings|-Wl,--no-warn-shared-textrel|' \
		kde-modules/KDECompilerSettings.cmake
	# dkf6-ki18n ftbfs with -Werror=missing-return (mcst#7001)
	sed -i 's|-Werror|-Wno-error|g' \
		kde-modules/KDECompilerSettings.cmake
fi
# fork for independent deepin packaging
sed -e 's|/ECM/|/DDE-ECM/|' \
	-i CMakeLists.txt \
	-i toolchain/Android.cmake
sed -e 's|-qt5|-dqt5|g' \
	-i find-modules/FindQHelpGenerator.cmake \
	-i kde-modules/KDEInstallDirs5.cmake \
	-i modules/ECMPoQmTools.cmake
sed -e 's|}/KF5|}/DKF5|g;' \
	-e 's|}/kf5|}/dkf5|g;' \
	-i kde-modules/KDEInstallDirs5.cmake
sed -e 's|qt5/|dqt5|;' \
	-e 's|qt6/|dqt6/|;' \
	-i find-modules/FindPoppler.cmake
sed -e 's|}/KF6|}/DKF6|g;' \
	-e 's|}/kf6|}/dkf6|g;' \
	-i kde-modules/KDEGitCommitHooks.cmake \
	-i kde-modules/KDEInstallDirs6.cmake
sed -e 's|include/KF6|include/DKF6|g;' \
	-e 's|include/kf6|include/dkf6|g;' \
	-i tests/ECMGeneratePkgConfigFile/test_imported_targets/CMakeLists.txt \
	-i tests/ECMGeneratePkgConfigFile/test_imported_targets/EGPF_imported_include_dirs_control.pc \
	-i tests/ECMGeneratePkgConfigFile/test_no_interface_include_dirs/CMakeLists.txt \
	-i tests/ECMGeneratePkgConfigFile/test_no_interface_include_dirs/EGPF_no_interface_include_directories.pc

%build
%DQ6cmake \
    -DBUILD_TESTING:BOOL=FALSE \
    -DDOC_INSTALL_DIR:STRING="%_docdir/DDE-ECM" \
    #
...
* Thu Jul 31 2025 Sergey V Turchin <zerg@altlinux.org> 6.15.0-alt2
- hide info message about reusetool
