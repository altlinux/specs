...
%changelog
* Wed May 28 2025 Igor Vlasenko <viy@altlinux.org> 0.068-alt1
- db update

* Wed Mar 27 2024 Igor Vlasenko <viy@altlinux.org> 0.067-alt1
- db update

* Sat Feb 10 2024 Igor Vlasenko <viy@altlinux.org> 0.066-alt1
- db update

* Wed Oct 18 2023 Igor Vlasenko <viy@altlinux.org> 0.065-alt1
- db update

* Tue Aug 29 2023 Igor Vlasenko <viy@altlinux.org> 0.064-alt1
- db update
