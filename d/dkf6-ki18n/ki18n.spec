...
%endif
%add_python3_path %_DK6lib/cmake
...
BuildRequires: vulkan-headers libdqt6-qml
%if_enabled python
...
%package -n libdkf6i18n
Group: System/Libraries
Summary: KF6 library
Requires: %name-common
%description -n libdkf6i18n
KF6 library

%package -n libdkf6i18nqml
Group: System/Libraries
Summary: KF6 library
Requires: %name-common
%description -n libdkf6i18nqml
KF6 library

%package -n libdkf6i18nlocaledata
Group: System/Libraries
Summary: KF6 library
Requires: %name-common
Requires: iso-codes
%description -n libdkf6i18nlocaledata
KF6 library
...
#%dir %_DK6i18n/*/
#%dir %_DK6i18n/*/LC_MESSAGES/
%_DK6i18n/*/LC_SCRIPTS/ki18n6/
%_DK6data/qlogging-categories6/*.*categories

%files devel
#%_DK6inc/ki18n_version.h
%_DK6inc/KI18n/
%_DK6inc/KI18nLocaleData/
%_DK6link/lib*.so
%_DK6lib/cmake/KF6I18n/

%files -n libdkf6i18n
%_DK6lib/libKF6I18n.so.*
%_DK6plug/kf6/ktranscript.so
%files -n libdkf6i18nlocaledata
%_DK6lib/libKF6I18nLocaleData.so.*
%_DK6qml/org/kde/i18n/localeData/
%files -n libdkf6i18nqml
%_DK6lib/libKF6I18nQml.so.*
%_DK6qml/org/kde/ki18n/
