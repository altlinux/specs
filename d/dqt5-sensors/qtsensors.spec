...
# optimized out: elfutils libGL-devel libcloog-isl4 libdqt5-clucene libdqt5-core libdqt5-gui libdqt5-help libdqt5-network libdqt5-qml libdqt5-sql libdqt5-widgets libdqt5-xml libstdc++-devel pkg-config python-base dqt5-base-devel dqt5-declarative-devel dqt5-tools ruby ruby-stdlibs
#BuildRequires: gcc-c++ glibc-devel-static dqt5-script-devel dqt5-tools-devel dqt5-webkit-devel dqt5-xmlpatterns-devel rpm-build-ruby
BuildRequires(pre): rpm-build-ubt rpm-macros-dqt5
BuildRequires: gcc-c++ glibc-devel dqt5-declarative-devel dqt5-xmlpatterns-devel
...
%package -n libdqt5-sensors
Summary: Qt5 library
Group: System/Libraries
Requires: %name-common = %EVR
Requires: libdqt5-core = %_dqt5_version
AutoProv: no,lib
%description -n libdqt5-sensors
%summary
...
%files common
%files -n libdqt5-sensors
%_dqt5_libdir/libQt?Sensors.so.*
%_dqt5_plugindir/sensorgestures/
%_dqt5_plugindir/sensors/
%_dqt5_archdatadir/qml/QtSensors/
