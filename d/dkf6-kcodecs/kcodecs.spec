...
BuildRequires: deepin-extra-cmake-modules gcc-c++ dqt6-tools-devel
...
%package -n libdkf6codecs
Group: System/Libraries
Summary: KF6 library
Requires: %name-common = %version-%release
%description -n libdkf6codecs
KF6 library
...
%_DK6inc/KCodecs/
%_DK6link/lib*.so
%_DK6lib/cmake/KF6Codecs

%files -n libdkf6codecs
%_DK6lib/libKF6Codecs.so.*
