...
VCS: https://github.com/linuxdeepin/deepin-shortcut-viewer

# Source-url: https://github.com/linuxdeepin/deepin-shortcut-viewer/archive/%version/%name-%version.tar.gz
Source: %name-%version.tar
Patch: %name-%version-%release.patch

BuildRequires: cmake dqt6-base-devel libcups-devel dtk6-common-devel libdtk6widget-devel libwayland-client-devel
...
%changelog
* Tue Jan 27 2026 Leontiy Volodin <lvol@altlinux.org> 5.5.6-alt1
- New version 5.5.6.
