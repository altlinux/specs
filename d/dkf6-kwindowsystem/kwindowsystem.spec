...
BuildRequires: deepin-extra-cmake-modules dqt6-base-devel dqt6-tools-devel dqt6-declarative-devel
BuildRequires: dqt6-wayland-devel plasma-wayland-protocols
...
%package -n libdkf6windowsystem
Group: System/Libraries
Summary: KF6 library
Requires: %name-common = %version-%release
%description -n libdkf6windowsystem
KF6 library
...
%files devel
%_DK6inc/KWindowSystem/
%_DK6link/lib*.so
%_DK6lib/cmake/KF6WindowSystem
%_DK6lib/pkgconfig/KF6WindowSystem.pc

%files -n libdkf6windowsystem
%_DK6lib/libKF6WindowSystem.so.*
%_DK6plug/kf6/kwindowsystem/
%_DK6qml/org/kde/kwindowsystem/
