...
%changelog
* Fri Jan 02 2026 Anton Farygin <rider@altlinux.org> 0.6.14-alt1
- 0.6.10 -> 0.6.14

* Mon Jul 26 2021 Aleksei Nikiforov <darktemplar@altlinux.org> 0.6.10-alt1
- Updated to upstream version 0.6.10.

* Fri Jun 11 2021 Aleksei Nikiforov <darktemplar@altlinux.org> 0.6.9-alt1
