...
Shows the last state of a periodic executed commands. Useful as an update
checker or for checking if a remote host is available (through ping).
...
%changelog
* Fri Nov 08 2013 Yuri N. Sedunov <aris@altlinux.org> 0.0.1-alt6
