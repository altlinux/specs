...
mv %buildroot/%_pkgconfigdir/exiv{2,%sover}.pc
install -d %buildroot/%_sysconfdir/alternatives/packages.d/
cat > %buildroot/%_sysconfdir/alternatives/packages.d/%name-devel <<__EOF__
%_pkgconfigdir/exiv2.pc %_pkgconfigdir/exiv%sover.pc %EVR
__EOF__

%check
%ctest

%files -n %libexiv -f exiv2.lang
%_libdir/libexiv2.so.%sover
%_libdir/libexiv2.so.*
...
* Sat Feb 22 2025 Yuri N. Sedunov <aris@altlinux.org> 0.28.5-alt1
- 0.28.5 (fixed CVE-2025-26623)

* Wed Feb 12 2025 Yuri N. Sedunov <aris@altlinux.org> 0.28.4-alt1
- 0.28.4
