...
%package -n %libkpim6eventviews
Group: System/Libraries
Summary: %name library
Requires: %name-common
%description -n %libkpim6eventviews
%name library
...
%_K6link/lib*.so
%_libdir/cmake/K*EventViews/

%files -n %libkpim6eventviews
%_K6lib/libKPim6EventViews.so.%sover
%_K6lib/libKPim6EventViews.so.*
