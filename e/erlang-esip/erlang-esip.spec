...
%changelog
* Sat Apr 11 2026 Anton Farygin <rider@altlinux.org> 1.0.60-alt1
- 1.0.59 -> 1.0.60
...
* Fri Jun 11 2021 Aleksei Nikiforov <darktemplar@altlinux.org> 1.0.42-alt1
- Updated to upstream version 1.0.42.

* Wed Feb 03 2021 Aleksei Nikiforov <darktemplar@altlinux.org> 1.0.41-alt1
- Updated to upstream version 1.0.41.
