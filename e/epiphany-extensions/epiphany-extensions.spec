...
Patch: %name-3.6.0-alt-link.patch
...
%define extensions adblock,auto-reload,extensions-manager-ui,greasemonkey,gestures,html5tube,push-scroller,tab-key-tab-navigate,tab-states
#actions,rss
