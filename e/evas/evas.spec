...
%exclude %_datadir/evas/examples/

%changelog
* Fri Nov 08 2013 Yuri N. Sedunov <aris@altlinux.org> 1:1.7.9-alt1
- 1.7.9

* Fri Aug 23 2013 Yuri N. Sedunov <aris@altlinux.org> 1:1.7.8-alt1
- 1.7.8
