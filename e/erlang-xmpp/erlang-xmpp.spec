...
%add_erlang_req_modules_skiplist erl_tidy
...
%changelog
* Wed Aug 19 2026 Anton Farygin <rider@altlinux.org> 1.13.4-alt1
- 1.13.3 -> 1.13.4
- skip optional erl_tidy require (xdata codec generator)

* Mon Apr 20 2026 Anton Farygin <rider@altlinux.org> 1.13.3-alt1
- 1.12.0 -> 1.13.3

* Thu Jan 22 2026 Anton Farygin <rider@altlinux.org> 1.12.0-alt1
- 1.11.4 -> 1.12.0

* Fri Jan 02 2026 Anton Farygin <rider@altlinux.org> 1.11.4-alt1
- 1.5.6 -> 1.11.4

* Mon Jan 17 2022 Aleksei Nikiforov <darktemplar@altlinux.org> 1.5.6-alt1
- Updated to upstream version 1.5.6.

* Mon Jul 26 2021 Aleksei Nikiforov <darktemplar@altlinux.org> 1.5.4-alt1
- Updated to upstream version 1.5.4.

* Fri Jun 11 2021 Aleksei Nikiforov <darktemplar@altlinux.org> 1.5.3-alt1
- Updated to upstream version 1.5.3.

* Wed Feb 03 2021 Aleksei Nikiforov <darktemplar@altlinux.org> 1.5.2-alt1
- Updated to upstream version 1.5.2.

* Tue Jan 12 2021 Aleksei Nikiforov <darktemplar@altlinux.org> 1.5.1-alt1
- Updated to upstream version 1.5.1.

* Wed Aug 05 2020 Aleksei Nikiforov <darktemplar@altlinux.org> 1.4.9-alt1
