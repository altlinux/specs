...
Group: System/Fonts/X11 bitmap
Summary: Cyrillic bitmap fonts in koi8-u encoding - misc part
Conflicts: fonts-bitmap-%fname-%cname < 1.1-alt14

%description -n fonts-bitmap-%fname-%cname-misc
Collection of cyrillic raster fonts for X Window System  in koi8-ub encoding
by D. Bolkhovityanov, misc part.

%package -n fonts-bitmap-%fname-%cname-75dpi
Group: System/Fonts/X11 bitmap
Summary: Cyrillic bitmap fonts in koi8-u encoding - 75dpi part
Conflicts: fonts-bitmap-%fname-%cname < 1.1-alt14
...
* Tue Jul 03 2018 Igor Vlasenko <viy@altlinux.ru> 1.1-alt14
