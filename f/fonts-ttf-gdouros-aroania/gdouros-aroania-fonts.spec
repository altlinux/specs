...
Source0:        http://users.teilar.gr/~g1951d/Aroania.zip
...
basis of Verdana. In 1927, Victor Julius Scholderer (1880o...1971), on behalf of
...
install -m 0644 -p Aroania.ttf %{buildroot}%{_fontdir}
