...
mv %buildroot{%_iconsdir,%_pixmapsdir}/fritzing.png

desktop-file-install --dir=%buildroot%_desktopdir fritzing.desktop

find %buildroot%_datadir/%name/parts \
	-name *.svg -o -name *.fzp -exec chmod -x {} \;
