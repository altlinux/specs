...
%if_with gost
Patch300:	firefox-%version-gost-ciphersuites-%gost_version.patch
%endif
...
* Thu Nov 07 2019 Paul Wolneykien <manowar@altlinux.org> 68.0-alt1.2.gost1.0
- Fixed NSS GOST build requisites.
...
* Tue Jul 30 2019 Paul Wolneykien <manowar@altlinux.org> 68.0-alt1.1.gost1.0
- Skip building of rpm-build-firefox package in GOST mode.

* Mon Jul 29 2019 Paul Wolneykien <manowar@altlinux.org> 68.0-alt1.gost1.0
- Rebuild with GOST ciphersuite patch.
...
* Thu Jul 11 2019 Paul Wolneykien <manowar@altlinux.org> 67.0.4-alt2.gost1.0
- Separate package: firefox-gost.
- Added configuration options for two GOST ciphersuites based on GOST-28147
  (patch).
