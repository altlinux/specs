%define oldname lohit-punjabi-fonts
...
Patch1: %{oldname}-bug-1002380.patch
...
%patch1 -p1 -b .1-improved-anchoring-of-u0a71
...
* Wed Mar 21 2012 Igor Vlasenko <viy@altlinux.ru> 2.5.0-alt2_3
- rebuild to get rid of #27020

* Sat Jan 21 2012 Igor Vlasenko <viy@altlinux.ru> 2.5.0-alt1_3
- update to new release by fcimport

* Thu Dec 01 2011 Igor Vlasenko <viy@altlinux.ru> 2.5.0-alt1_2
- update to new release by fcimport

* Mon Oct 17 2011 Igor Vlasenko <viy@altlinux.ru> 2.5.0-alt1_1
- update to new release by fcimport

* Wed Aug 24 2011 Igor Vlasenko <viy@altlinux.ru> 2.4.4-alt3_4
- rebuild with new rpm-build-fonts

* Thu Aug 04 2011 Igor Vlasenko <viy@altlinux.ru> 2.4.4-alt2_4
- bugfix release by fcimport

* Wed Aug 03 2011 Igor Vlasenko <viy@altlinux.ru> 2.4.4-alt1_4
