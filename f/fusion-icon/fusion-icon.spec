...
%changelog
* Tue Mar 21 2017 Mikhail Efremov <sem@altlinux.org> 0.1.0-alt7
- Backported from version 0.2.2:
  + Add additional Compiz 0.9.x support.
- Replace simple-ccsm with ccsm again.
