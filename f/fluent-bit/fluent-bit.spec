...
%changelog
* Wed Sep 09 2026 Leontiy Volodin <lvol@altlinux.org> 5.1.2-alt1
- New version 5.1.2.

* Mon Aug 17 2026 Leontiy Volodin <lvol@altlinux.org> 5.1.1-alt1
- New version 5.1.1.

* Thu Aug 06 2026 Leontiy Volodin <lvol@altlinux.org> 5.1.0-alt1
- New version 5.1.0.

* Mon Jul 06 2026 Leontiy Volodin <lvol@altlinux.org> 5.0.9-alt1
- New version 5.0.9.

* Thu Jun 25 2026 Leontiy Volodin <lvol@altlinux.org> 5.0.8-alt1
- New version 5.0.8.

* Mon Jun 08 2026 Leontiy Volodin <lvol@altlinux.org> 5.0.7-alt1
- New version 5.0.7.

* Mon Jun 01 2026 Leontiy Volodin <lvol@altlinux.org> 5.0.6-alt1
- New version 5.0.6.

* Fri May 08 2026 Leontiy Volodin <lvol@altlinux.org> 5.0.5-alt1
- New version 5.0.5.

* Mon May 04 2026 Leontiy Volodin <lvol@altlinux.org> 5.0.4-alt1
- New version 5.0.4.

* Wed Apr 15 2026 Leontiy Volodin <lvol@altlinux.org> 5.0.3-alt1
- New version 5.0.3.

* Thu Apr 02 2026 Leontiy Volodin <lvol@altlinux.org> 5.0.2-alt1
- New version 5.0.2.

* Tue Mar 31 2026 Leontiy Volodin <lvol@altlinux.org> 5.0.1-alt1
- New version 5.0.1.

* Wed Mar 25 2026 Leontiy Volodin <lvol@altlinux.org> 5.0.0-alt1
- New version 5.0.0.

* Fri Feb 20 2026 Leontiy Volodin <lvol@altlinux.org> 4.2.3-alt1
- New version 4.2.3.

* Wed Dec 24 2025 Leontiy Volodin <lvol@altlinux.org> 4.2.2-alt1
- New version 4.2.2.

* Mon Dec 15 2025 Leontiy Volodin <lvol@altlinux.org> 4.2.1-alt1
- New version 4.2.1.

* Wed Nov 12 2025 Leontiy Volodin <lvol@altlinux.org> 4.2.0-alt1
- New version 4.2.0.

* Mon Oct 13 2025 Leontiy Volodin <lvol@altlinux.org> 4.1.1-alt1
- New version 4.1.1.
...
* Mon Sep 08 2025 Leontiy Volodin <lvol@altlinux.org> 4.0.9-alt1
- New version 4.0.9.
...
* Mon Jul 14 2025 Leontiy Volodin <lvol@altlinux.org> 4.0.4-alt1
- New version 4.0.4.

* Mon Jun 02 2025 Leontiy Volodin <lvol@altlinux.org> 4.0.3-alt1
- New version 4.0.3.
...
* Wed Mar 19 2025 Leontiy Volodin <lvol@altlinux.org> 3.2.9-alt1
- New version 3.2.9.

* Wed Mar 05 2025 Leontiy Volodin <lvol@altlinux.org> 3.2.8-alt1
- New version 3.2.8.
...
* Wed Feb 26 2025 Leontiy Volodin <lvol@altlinux.org> 3.2.7-alt1
- New version 3.2.7.
- Fixes:
  + CVE-2024-50608: in_prometheus_remote_write: fix handling of content-length.
  + CVE-2024-50609: in_opentelemetry: fix handling of content-length.

* Wed Feb 12 2025 Leontiy Volodin <lvol@altlinux.org> 3.2.6-alt1
- New version 3.2.6.

* Tue Jan 28 2025 Leontiy Volodin <lvol@altlinux.org> 3.2.5-alt1
- New version 3.2.5.

* Thu Jan 09 2025 Leontiy Volodin <lvol@altlinux.org> 3.2.4-alt1
- New version 3.2.4.

* Fri Dec 20 2024 Leontiy Volodin <lvol@altlinux.org> 3.2.3-alt1
- New version 3.2.3.

* Fri Nov 29 2024 Leontiy Volodin <lvol@altlinux.org> 3.2.2-alt1
- New version 3.2.2.
...
* Tue Sep 17 2024 Leontiy Volodin <lvol@altlinux.org> 3.1.8-alt1
- New version.

* Wed Sep 04 2024 Leontiy Volodin <lvol@altlinux.org> 3.1.7-alt1
- New version.

* Thu Aug 15 2024 Leontiy Volodin <lvol@altlinux.org> 3.1.6-alt1
- New version.

* Tue Aug 13 2024 Leontiy Volodin <lvol@altlinux.org> 3.1.5-alt1
- New version.

* Mon Jul 29 2024 Leontiy Volodin <lvol@altlinux.org> 3.1.4-alt1
- New version.

* Mon Jul 22 2024 Leontiy Volodin <lvol@altlinux.org> 3.1.3-alt1
- New version.

* Thu Jul 11 2024 Leontiy Volodin <lvol@altlinux.org> 3.1.1-alt1
- New version.
