...
Summary:	Festival wrapper for MBROLA voice %{voice}: American English female speaker
...
Festival wrapper for MBROLA voice %{voice}: 
 American English female speaker using the MBROLA us1 database
 This requires the MBROLA prorgram and us1 English database (~6Meg)
