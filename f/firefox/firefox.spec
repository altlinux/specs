...
Source3: firefox-mozconfig
Source4: firefox-prefs.js
Source5: firefox-privacy-prefs.js
Source6: distribution.ini
Source7: firefox-search-provider.ini
Source8: firefox-l10n.txt
Source9: l10n.tar
...
install -D -m 644 %SOURCE4 %buildroot/%firefox_prefix/browser/defaults/preferences/all-altlinux.js
install -D -m 644 %SOURCE5 %buildroot/%_sysconfdir/firefox/defaults/pref/all-privacy.js
...
* Tue Aug 11 2026 Ajrat Makhmutov <rauty@altlinux.org> 153.0.4-alt1
- New version.
...
* Tue Jun 30 2026 Ajrat Makhmutov <rauty@altlinux.org> 152.0.4-alt1
- New version.
- Fixes:
  + CVE-2026-14241: Memory safety bugs fixed in Firefox 152.0.4

* Fri Jun 26 2026 Ajrat Makhmutov <rauty@altlinux.org> 152.0.3-alt1
- New version.

* Wed Jun 24 2026 Ajrat Makhmutov <rauty@altlinux.org> 152.0.2-alt1
- New version.
...
- Backport upstream glslopt 0.1.13 to fix the build with glibc 2.43,
  whose <stdlib.h> now provides once_flag/call_once.
...
* Fri Feb 20 2026 Ajrat Makhmutov <rauty@altlinux.org> 147.0.4-alt1
- New version (147.0.4).
- Fixes:
  + CVE-2026-2447: Heap buffer overflow in libvpx

* Wed Jan 28 2026 Ajrat Makhmutov <rauty@altlinux.org> 147.0.2-alt1
- New version (147.0.2).
- Fixes:
...
* Sat Jan 17 2026 Ajrat Makhmutov <rauty@altlinux.org> 147.0.1-alt1
- New version (147.0.1).
...
* Fri Nov 21 2025 Ajrat Makhmutov <rauty@altlinux.org> 145.0.1-alt1
- New version (145.0.1).
...
* Fri Aug 29 2025 Ajrat Makhmutov <rauty@altlinux.org> 142.0.1-alt1
- New version (142.0.1).
...
* Wed Aug 06 2025 Ajrat Makhmutov <rauty@altlinux.org> 141.0.2-alt1
- New version (141.0.2).
...
* Sat Jun 28 2025 Ajrat Makhmutov <rauty@altlinux.org> 140.0.2-alt1
- New version (140.0.2).
...
* Mon Feb 10 2025 Ajrat Makhmutov <rauty@altlinux.org> 135.0-alt1
- New version (135.0).
- Security fixes:
...
* Fri Jan 24 2025 Ajrat Makhmutov <rauty@altlinux.org> 134.0.2-alt1
- New version (134.0.2).

* Tue Jan 14 2025 Ajrat Makhmutov <rauty@altlinux.org> 134.0.1-alt1
- New version (134.0.1).
...
* Sat Nov 09 2024 Ajrat Makhmutov <rauty@altlinux.org> 132.0.1-alt1
- New version (132.0.1).

* Wed Oct 30 2024 Ajrat Makhmutov <rauty@altlinux.org> 132.0.0-alt1
- New version (132.0.0).
- Security fixes:
...
* Thu Sep 19 2024 Ajrat Makhmutov <rauty@altlinux.org> 130.0.1-alt1
- New version (130.0.1).
...
* Sun Aug 18 2024 Ajrat Makhmutov <rauty@altlinux.org> 129.0.1-alt1
- New version (129.0.1).
...
* Fri Jun 21 2024 Ajrat Makhmutov <rauty@altlinux.org> 127.0.1-alt1
- New version (127.0.1).
...
* Tue Jan 23 2024 Alexey Gladkov <legion@altlinux.ru> 122.0-alt1
- New release (122.0).
- Security fixes:
...
* Wed Jan 10 2024 Alexey Gladkov <legion@altlinux.ru> 121.0.1-alt1
- New release (121.0.1).
