...
Summary(ru_RU.UTF-8): Графическая визуализация занимаемого места на диске
Summary(uk_UA.UTF-8): Графічна візуалізація зайнятого місця на диску
...
Filelight створює графічне уявлення місця, яке займають файли
