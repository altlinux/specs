...
%define disabled_dict_langlist an bn_BD bn_IN cs en_GB en_US en_ZA es_AR es_CL es_ES es_MX ff fi fy_NL ga_IE gu_IN hi_IN hy_AM ja lij lv nb_NO nn_NO pa_IN pt_BR pt_PT sv_SE tr zh_CN zh_TW
