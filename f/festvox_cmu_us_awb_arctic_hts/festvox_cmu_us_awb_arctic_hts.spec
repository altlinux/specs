...
Summary:	Festival voice: Scottish English Male speaker, HTS based, "awb"
...
%description
Based on the CMU_ARTIC "awb" (Scottish English male, but using US English
front end) and using Nagoya Institute of Technology's HTS based synthesizer
