...
Patch1: %{oldname}-script-tag.patch
...
%patch1 -p1 -b .1-removed-wrong-script-tag
...
* Tue Feb 21 2012 Igor Vlasenko <viy@altlinux.ru> 2.5.0-alt1_3
- update to new release by fcimport
...
* Wed Aug 24 2011 Igor Vlasenko <viy@altlinux.ru> 2.4.6-alt3_2
- rebuild with new rpm-build-fonts

* Thu Aug 04 2011 Igor Vlasenko <viy@altlinux.ru> 2.4.6-alt2_2
- bugfix release by fcimport

* Wed Aug 03 2011 Igor Vlasenko <viy@altlinux.ru> 2.4.6-alt1_2
