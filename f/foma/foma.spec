...
Name:           foma
Version:        0.10.0
Release:        alt1_1.7.%{snapshotdate}git%{shortcommit0}
...
%build
sed -i '/^CFLAGS/c\CFLAGS = %{optflags} -Wl,--as-needed -D_GNU_SOURCE -std=c99 -fvisibility=hidden -fPIC -Wno-error=int-conversion' foma/Makefile
...
%changelog
* Tue Apr 08 2025 Andrew A. Vasilyev <andy@altlinux.org> 0.10.0-alt1_1.7.20210601gitdfe1ccb
