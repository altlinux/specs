...
Patch6:  %name-1.2.3-alt-fix_signal.patch
Patch7:  %name-1.2.3-alt-fix_gethostbyname.patch
...
%changelog
* Sun Aug 02 2026 Nikolay A. Fetisov <naf@altlinux.org> 1.2.3-alt7
- Fix build with glibc 2.43
- remove dependensy on shadow-utils
