...
%define common_summary Envelope based filter modulator plugin

%define common_description FILT-R is a cross-platform filter modulator based on plugins like\
ShaperBox and FilterShaper. It features:\
...
Vcs:     https://github.com/tiagolr/filtr.git
...
%changelog
* Sun Jan 11 2026 Ivan A. Melnikov <iv@altlinux.org> 1.0.9-alt1
- build for Sisyphus
