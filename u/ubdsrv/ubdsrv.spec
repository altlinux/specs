...
%check
export LD_LIBRARY_PATH=%buildroot%_libdir PATH=%buildroot%_sbindir:$PATH
...
%changelog
* Wed Mar 19 2025 Vitaly Chikunov <vt@altlinux.org> 1.4-alt1
- Update to v1.4 (2025-03-18).

* Thu Jan 23 2025 Vitaly Chikunov <vt@altlinux.org> 1.3-alt1
- Update to v1.3 (2025-01-17).
