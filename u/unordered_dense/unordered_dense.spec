...
%changelog
* Tue Sep 15 2026 Nazarov Denis <nenderus@altlinux.org> 5.0.1-alt1
- New version 5.0.1.

* Mon Sep 14 2026 Nazarov Denis <nenderus@altlinux.org> 5.0.0-alt1
- New version 5.0.0.

* Wed Sep 02 2026 Nazarov Denis <nenderus@altlinux.org> 4.10.0-alt1
- New version 4.10.0.

* Tue Aug 18 2026 Nazarov Denis <nenderus@altlinux.org> 4.9.2-alt1
- New version 4.9.2.

* Wed Aug 12 2026 Nazarov Denis <nenderus@altlinux.org> 4.9.1-alt1
- New version 4.9.1.
