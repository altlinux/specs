...
%changelog
* Wed Sep 09 2026 Anton Midyukov <antohami@altlinux.org> 1.2.3-alt1
- New version 1.2.3.

* Thu Aug 20 2026 Anton Midyukov <antohami@altlinux.org> 1.2.1-alt1
- New version 1.2.1.

* Sat Jul 11 2026 Anton Midyukov <antohami@altlinux.org> 1.1.1-alt1
- New version 1.1.1.

* Sun May 31 2026 Anton Midyukov <antohami@altlinux.org> 1.0.1-alt1
- New version 1.0.1.
