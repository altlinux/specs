...
%changelog
* Tue Jul 01 2014 Led <led@altlinux.ru> 1.2.9-alt3
- fix build for old kernels

* Wed Jun 25 2014 Led <led@altlinux.ru> 1.2.9-alt2
- upstream fixes

* Wed Jun 18 2014 Led <led@altlinux.ru> 1.2.9-alt1
- 1.2.9

* Tue Apr 01 2014 Led <led@altlinux.ru> 1.2.8-alt2
- fixed build for kernel >= 3.11

* Mon Mar 10 2014 Led <led@altlinux.ru> 1.2.8-alt1
- 1.2.8
