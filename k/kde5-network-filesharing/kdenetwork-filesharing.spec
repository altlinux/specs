...
%files -f %name.lang
%doc LICENSES/*
%_K5plug/kf5/propertiesdialog/*amba*.so
#
...
- new version
- fix crash on file properties dialog (thanks ptrnine@alt)
