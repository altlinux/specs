...
%changelog
* Sun Apr 20 2025 Kernel Bot <kernelbot@altlinux.org> 6.13.12-alt1
- v6.13.12 (2025-04-20).
- Disable BLK_DEV_FD.
- config-aarch64: CONFIG_VIDEO_RASPBERRYPI_PISP_BE=m.
- config-aarch64: enable more configs for qualcomm SoC's support.

* Thu Apr 10 2025 Kernel Bot <kernelbot@altlinux.org> 6.13.11-alt1
- v6.13.11 (2025-04-10).
...
* Sun Mar 23 2025 Kernel Bot <kernelbot@altlinux.org> 6.13.8-alt1
- v6.13.8 (2025-03-22).
- config: Disable obsolete input tablet drivers.
- config-aarch64: enable more configs of battery and charger.

* Thu Mar 13 2025 Kernel Bot <kernelbot@altlinux.org> 6.13.7-alt1
- v6.13.7 (2025-03-13).

* Sat Mar 08 2025 Kernel Bot <kernelbot@altlinux.org> 6.13.6-alt1
- v6.13.6 (2025-03-07).

* Thu Feb 27 2025 Kernel Bot <kernelbot@altlinux.org> 6.13.5-alt1
- v6.13.5 (2025-02-27).
- kiosk: MIN_UID 500 -> 1000.

* Fri Feb 21 2025 Kernel Bot <kernelbot@altlinux.org> 6.13.4-alt1
- v6.13.4 (2025-02-21).

* Mon Feb 17 2025 Kernel Bot <kernelbot@altlinux.org> 6.13.3-alt1
- v6.13.3 (2025-02-17).
