...
%changelog
* Mon Sep 21 2026 Kernel Bot <kernelbot@altlinux.org> 6.18.53-alt1
- v6.18.53 (2026-09-21).
...
* Thu Sep 10 2026 Kernel Bot <kernelbot@altlinux.org> 6.18.50-alt2
- spec: Use kirk to run LTP tests.

* Mon Sep 07 2026 Kernel Bot <kernelbot@altlinux.org> 6.18.50-alt1
- v6.18.50 (2026-09-07).

* Wed Sep 02 2026 Kernel Bot <kernelbot@altlinux.org> 6.18.49-alt1
- v6.18.49 (2026-09-02).

* Fri Aug 28 2026 Kernel Bot <kernelbot@altlinux.org> 6.18.48-alt1
- v6.18.48 (2026-08-28).

* Thu Aug 27 2026 Kernel Bot <kernelbot@altlinux.org> 6.18.47-alt1
- v6.18.47 (2026-08-27).

* Sun Aug 23 2026 Kernel Bot <kernelbot@altlinux.org> 6.18.46-alt1
- v6.18.46 (2026-08-23).
...
* Thu Jul 30 2026 Kernel Bot <kernelbot@altlinux.org> 6.18.41-alt1
- v6.18.41 (2026-07-30).

* Fri Jul 24 2026 Kernel Bot <kernelbot@altlinux.org> 6.18.40-alt1
- v6.18.40 (2026-07-24).

* Sun Jul 19 2026 Kernel Bot <kernelbot@altlinux.org> 6.18.39-alt1
- v6.18.39 (2026-07-18).
- config-aarch64: Add CONFIG_I2C_MUX_MULE=m
- config-aarch64: Enable gpmux, ltc4306 i2c mux, and pinctrl i2c mux/demux devices

* Sat Jul 04 2026 Kernel Bot <kernelbot@altlinux.org> 6.18.38-alt1
- v6.18.38 (2026-07-04).
...
* Fri May 15 2026 Kernel Bot <kernelbot@altlinux.org> 6.18.31-alt1
- v6.18.31 (2026-05-15).
...
* Thu Apr 02 2026 Kernel Bot <kernelbot@altlinux.org> 6.18.21-alt1
- v6.18.21 (2026-04-02).

* Wed Mar 25 2026 Vitaly Chikunov <vt@altlinux.org> 6.18.20-alt1
- Update to v6.18.20 (2026-03-25).
- config: Enable USB_SERIAL_CONSOLE=y.

* Thu Mar 19 2026 Kernel Bot <kernelbot@altlinux.org> 6.18.19-alt1
- v6.18.19 (2026-03-19).
...
* Sat Feb 28 2026 Kernel Bot <kernelbot@altlinux.org> 6.18.15-alt1
- v6.18.15 (2026-02-27).

* Fri Feb 27 2026 Kernel Bot <kernelbot@altlinux.org> 6.18.14-alt1
- v6.18.14 (2026-02-26).

* Thu Feb 19 2026 Kernel Bot <kernelbot@altlinux.org> 6.18.13-alt1
- v6.18.13 (2026-02-19).

* Mon Feb 16 2026 Kernel Bot <kernelbot@altlinux.org> 6.18.12-alt1
- v6.18.12 (2026-02-16).

* Mon Feb 16 2026 Kernel Bot <kernelbot@altlinux.org> 6.18.11-alt1
- v6.18.11 (2026-02-16).
- config-aarch64: CONFIG_RTC_DRV_HYM8563=m.

* Wed Feb 11 2026 Kernel Bot <kernelbot@altlinux.org> 6.18.10-alt1
- v6.18.10 (2026-02-11).

* Fri Feb 06 2026 Kernel Bot <kernelbot@altlinux.org> 6.18.9-alt1
- v6.18.9 (2026-02-06).
- config: CONFIG_LEDS_PCA955X_GPIO=y.

* Fri Jan 30 2026 Kernel Bot <kernelbot@altlinux.org> 6.18.8-alt1
- v6.18.8 (2026-01-30).
- config: Enable CONFIG_PINCTRL_AMDISP=m.

* Fri Jan 23 2026 Kernel Bot <kernelbot@altlinux.org> 6.18.7-alt1
- v6.18.7 (2026-01-23).

* Sat Jan 17 2026 Kernel Bot <kernelbot@altlinux.org> 6.18.6-alt1
- v6.18.6 (2026-01-17).
...
* Fri Jan 02 2026 Kernel Bot <kernelbot@altlinux.org> 6.18.3-alt1
- v6.18.3 (2026-01-02).
