...
%exclude %modules_dir/kernel/drivers/usb/typec/tcpm/fusb302.ko*
%endif
%ifarch aarch64 %arm
...
%modules_dir/kernel/drivers/usb/typec/tcpm/fusb302.ko*
%endif
...
%changelog
* Wed Sep 02 2026 Kernel Bot <kernelbot@altlinux.org> 7.1.13-alt1
- v7.1.13 (2026-09-02).

* Fri Aug 28 2026 Kernel Bot <kernelbot@altlinux.org> 7.1.12-alt1
- v7.1.12 (2026-08-28).

* Thu Aug 27 2026 Kernel Bot <kernelbot@altlinux.org> 7.1.11-alt1
- v7.1.11 (2026-08-27).

* Sun Aug 23 2026 Kernel Bot <kernelbot@altlinux.org> 7.1.10-alt1
- v7.1.10 (2026-08-23).

* Wed Aug 19 2026 Kernel Bot <kernelbot@altlinux.org> 7.1.9-alt1
- v7.1.9 (2026-08-19).

* Mon Aug 10 2026 Kernel Bot <kernelbot@altlinux.org> 7.1.8-alt1
- v7.1.8 (2026-08-09).

* Fri Aug 07 2026 Kernel Bot <kernelbot@altlinux.org> 7.1.7-alt1
- v7.1.7 (2026-08-06).
- arm64: Add DTS for Repka Pi 5 board.
- config-aarch64: Enable ARM PSCI CPU idle driver.
- config: Increase 8250 runtime UARTs to 32.

* Mon Aug 03 2026 Kernel Bot <kernelbot@altlinux.org> 7.1.6-alt1
- v7.1.6 (2026-08-03).
...
* Tue Jul 07 2026 Gleb F-Malinovskiy <glebfm@altlinux.org> 7.1.3-alt1
- Update to v7.1.3 (2026-07-04).
