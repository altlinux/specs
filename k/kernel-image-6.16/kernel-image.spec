...
%changelog
* Sun Oct 12 2025 Kernel Bot <kernelbot@altlinux.org> 6.16.12-alt1
- v6.16.12 (2025-10-12).
- config: enable all accelerometers.
- config: Enable PS4/PS5 controllers.

* Mon Oct 06 2025 Kernel Bot <kernelbot@altlinux.org> 6.16.11-alt1
- v6.16.11 (2025-10-06).
- config: Enable CONFIG_HID_UNIVERSAL_PIDFF=m.
- config-aarch64: CONFIG_REGULATOR_AXP20X=y, CONFIG_MFD_AXP20X_I2C=y.

* Thu Oct 02 2025 Kernel Bot <kernelbot@altlinux.org> 6.16.10-alt1
- v6.16.10 (2025-10-02).
...
* Thu Sep 11 2025 Kernel Bot <kernelbot@altlinux.org> 6.16.7-alt1
- v6.16.7 (2025-09-11).

* Wed Sep 10 2025 Kernel Bot <kernelbot@altlinux.org> 6.16.6-alt1
- v6.16.6 (2025-09-09).

* Fri Sep 05 2025 Kernel Bot <kernelbot@altlinux.org> 6.16.5-alt1
- v6.16.5 (2025-09-04).
