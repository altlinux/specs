...
#BuildRequires: extra-cmake-modules kf5-kcmutils-devel kf5-kcompletion-devel kf5-kdeclarative-devel kf5-kdelibs4support kf5-kdoctools-devel kf5-kitemviews-devel kf5-kpackage-devel kf5-kservice-devel kf5-ktextwidgets-devel kf5-kwindowsystem-devel kf5-kxmlgui-devel libXres-devel python-module-google python3-dev qt5-script-devel qt5-x11extras-devel qt5-xmlpatterns-devel ruby ruby-stdlibs
