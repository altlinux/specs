...
Patch1: subfs-2.6.38-fix-write_lock.patch
...
%changelog
* Thu May 12 2011 Evgeny Sinelnikov <sin@altlinux.ru> 0.9-alt11.132640.8
- Build for kernel-image-ovz-smp-2.6.32-alt8.

* Wed May 11 2011 Anton Protopopov <aspsk@altlinux.org> 0.9-alt11
- Don't lock already locked structure (ALT 25285)
