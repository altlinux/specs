...
Patch3: alt-set-minimum-window-size.patch
...
%changelog
* Mon Jun 10 2024 Dmitrii Fomchenkov <sirius@altlinux.org> 23.08.5-alt2
- set the minimum window size (closes: 49893)
