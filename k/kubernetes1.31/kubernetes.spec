...
%changelog
* Wed Nov 12 2025 Alexander Stepchenko <geochip@altlinux.org> 1.31.14-alt1
- 1.31.13 -> 1.31.14.

* Wed Sep 10 2025 Alexander Stepchenko <geochip@altlinux.org> 1.31.13-alt1
- Update to 1.31.13.

* Mon Aug 18 2025 Alexander Stepchenko <geochip@altlinux.org> 1.31.12-alt1
- Update to 1.31.12.
- Fixes:
  + CVE-2025-5187: Nodes can delete themselves by adding an OwnerReference

* Fri Jul 18 2025 Alexander Stepchenko <geochip@altlinux.org> 1.31.11-alt1
- 1.31.10 -> 1.31.11

* Mon Jun 23 2025 Alexander Stepchenko <geochip@altlinux.org> 1.31.10-alt1
- 1.31.9 -> 1.31.10

* Tue May 20 2025 Alexander Stepchenko <geochip@altlinux.org> 1.31.9-alt1
- 1.31.8 -> 1.31.9

* Wed May 07 2025 Alexander Stepchenko <geochip@altlinux.org> 1.31.8-alt2
- Fix systemd service disabling before package deletion (Closes: #49768)

* Wed Apr 23 2025 Alexander Stepchenko <geochip@altlinux.org> 1.31.8-alt1
- 1.31.7 -> 1.31.8

* Sat Apr 12 2025 Alexander Stepchenko <geochip@altlinux.org> 1.31.7-alt1
- 1.31.6 -> 1.31.7
