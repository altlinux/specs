...
Summary: KDE Frameworks 5 simple XML-RPC client
Url: http://www.kde.org
License: BSD

Source: %rname-%version.tar

# Automatically added by buildreq on Wed Mar 18 2015 (-bi)
# optimized out: cmake cmake-modules elfutils kf5-attica-devel libEGL-devel libGL-devel libcloog-isl4 libqt5-core libqt5-dbus libqt5-gui libqt5-network libqt5-test libqt5-widgets libqt5-x11extras libqt5-xml libstdc++-devel python-base ruby ruby-stdlibs
...
%files devel
%_K5inc/kxmlrpcclient_version.h
%_K5inc/KXmlRpcClient/
%_K5link/lib*.so
%_K5lib/cmake/KF5XmlRpcClient
%_K5archdata/mkspecs/modules/qt_KXmlRpcClient.pri

%files -n libkf5xmlrpcclient
%_K5lib/libKF5XmlRpcClient.so.*
