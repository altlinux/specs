...
VCS: https://invent.kde.org/office/kile.git
...
%description
Kile is a program for KDE 6, that integrates many tools needed to
...
%changelog
* Mon Apr 14 2025 Constantin Sunzow <protvin@altlinux.org> 2.9.94-alt1
- Fix bug (37617, 52218, 53735).
- New version.
