...
%define xapp %nil
Name: %xde-%rname
Version: 25.6.0.10369
Release: alt1

%define qt_bin_dir %_qt6_bindir
%define configure_qmake %qmake_qt6
%define qt_qmake %_qt6_qmake
...
Provides: smplayer-kde6 = %EVR
Provides: kde5-smplayer = %EVR
Obsoletes: kde5-smplayer < %EVR
...
BuildRequires: qt6-base-devel qt6-tools-devel qt6-declarative-devel qt6-5compat-devel
...
BuildArch: noarch
Provides: kde5-smplayer-common = %EVR
Obsoletes: kde5-smplayer-common < %EVR
...
Requires: mpv
Provides: kde5-smplayer-backend-2-mpv = %EVR
Obsoletes: kde5-smplayer-backend-2-mpv < %EVR
...
Requires: %name-common >= %EVR
Requires: mplayer
Provides: kde5-smplayer-backend-4-mplayer = %EVR
Obsoletes: kde5-smplayer-backend-4-mplayer < %EVR
...
%changelog
* Tue Nov 25 2025 Sergey V Turchin <zerg@altlinux.org> 25.6.0.10369-alt1
- build Qt6 version
...
* Wed Feb 01 2023 Sergey V Turchin <zerg@altlinux.org> 22.7.0-alt1
- new version
