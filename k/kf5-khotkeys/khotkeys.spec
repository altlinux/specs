%define rname khotkeys

%define khotkeysprivate_sover 5
...
Summary: KDE Workspace 5 input actions service
...
BuildRequires: kf5-kdesignerplugin-devel kf5-kdoctools kf5-kdoctools-devel-static kf5-kemoticons-devel kf5-kglobalaccel-devel
...
BuildRequires: kf5-kitemviews-devel kf5-kjobwidgets-devel kf5-knotifications-devel kf5-kpackage-devel kf5-kparts-devel kf5-kservice-devel
...
%files devel
#%_K5inc/khotkeys_version.h
#%_K5inc/khotkeys/
#%_K5link/lib*.so
#%_K5lib/cmake/khotkeys
#%_K5archdata/mkspecs/modules/qt_khotkeys.pri
%_K5dbus_iface/*.xml
%_libdir/cmake/KHotKeysDBusInterface/

%files -n %libkhotkeysprivate
%_K5lib/libkhotkeysprivate.so.*
