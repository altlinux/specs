...
BuildRequires: gcc-c++ glib2-devel kde4base-workspace-devel qt4-mobility-devel kde4-kactivities
...
* Wed Apr 18 2012 Sergey V Turchin <zerg@altlinux.org> 0.1.2-alt0.M60P.1
- build for M60P
