# -*- rpm-spec -*-
%define module_name	nvidia-open-525.xx
%define module_version  525.105.17
...
%changelog
* Mon Apr 03 2023 L.A. Kostis <lakostis@altlinux.ru> 525.105.17-alt1
- New R525 release (525.105.17).
