...
BuildRequires: libgpgme-devel libldap-devel libsasl2-devel xsltproc
BuildRequires: kde5-gpgmepp-devel kde5-kcalcore-devel kde5-kcontacts-devel kde5-kidentitymanagement-devel kde5-kimap-devel kde5-kldap-devel
...
BuildRequires: kde5-messagelib-devel kde5-pimcommon-devel kde5-pimlibs-devel
...
#%doc COPYING*
%config(noreplace) %_K5xdgconf/mailcommon.categories
