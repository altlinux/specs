...
#BuildRequires: extra-cmake-modules kde5-libksane-devel kf5-kdelibs4support-devel kf5-kdoctools-devel kf5-kio-devel python-module-google python3-dev ruby ruby-stdlibs
