...
Release: alt2.%kcode.%kbuildrelease
License: GPLv2
...
BuildRequires: %module_name = %module_version
...
* Tue Dec 09 2025 Vitaly Chikunov <vt@altlinux.org> 1.2.2-alt2.%kcode.%kbuildrelease
- spec: Run tests.
