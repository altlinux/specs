...
%changelog
* Thu Jan 26 2012 Vitaly Kuznetsov <vitty@altlinux.ru> 2.6.32-alt55
- merge stable-2.6.32.55

* Thu Jan 26 2012 Vitaly Kuznetsov <vitty@altlinux.ru> 2.6.32-alt48
- merge jeremy/xen/stable-2.6.32.x (2.6.32.48 + xen patches)

* Thu Jul 28 2011 Vitaly Kuznetsov <vitty@altlinux.ru> 2.6.32-alt43
- merge jeremy/xen/stable-2.6.32.x (2.6.32.43 + xen patches)

* Tue May 31 2011 Vitaly Kuznetsov <vitty@altlinux.ru> 2.6.32-alt41
- merge jeremy/xen/stable-2.6.32.x (2.6.32.41 + xen patches)

* Thu May 19 2011 Vitaly Kuznetsov <vitty@altlinux.ru> 2.6.32-alt40
- merge jeremy/xen/stable-2.6.32.x (2.6.32.40 + xen patches)

* Thu May 05 2011 Vitaly Kuznetsov <vitty@altlinux.ru> 2.6.32-alt39
- merge jeremy/xen/stable-2.6.32.x (2.6.32.39 + xen patches)

* Wed Apr 20 2011 Vitaly Kuznetsov <vitty@altlinux.ru> 2.6.32-alt38
- xen 2.6.32.38
- fix ACPI handling on IBM x3400
- add ALT syslog patch (ALT #25434)

* Thu Apr 07 2011 Vitaly Kuznetsov <vitty@altlinux.ru> 2.6.32-alt36.1
- revert merge git://git.kernel.org/pub/scm/linux/kernel/git/konrad

* Wed Apr 06 2011 Vitaly Kuznetsov <vitty@altlinux.ru> 2.6.32-alt36
- merge jeremy/xen/stable-2.6.32.x (2.6.32.36 + xen patches)
- merge git://git.kernel.org/pub/scm/linux/kernel/git/konrad/xen.git

* Wed Mar 23 2011 Vitaly Kuznetsov <vitty@altlinux.ru> 2.6.32-alt33
- merge jeremy/xen/stable-2.6.32.x (2.6.32.33 + xen patches)

* Fri Mar 04 2011 Vitaly Kuznetsov <vitty@altlinux.ru> 2.6.32-alt28
- 2.6.32.28
- epoll: prevent creating circular epoll structures

* Fri Dec 24 2010 Vitaly Kuznetsov <vitty@altlinux.ru> 2.6.32-alt27
- merge jeremy/xen/stable-2.6.32.x (2.6.32.27 + xen patches)

* Thu Nov 25 2010 Vitaly Kuznetsov <vitty@altlinux.ru> 2.6.32-alt26
- merge jeremy/xen/stable-2.6.32.x (2.6.32.26 + xen patches)

* Mon Nov 01 2010 Vitaly Kuznetsov <vitty@altlinux.ru> 2.6.32-alt25
- merge jeremy/xen/stable-2.6.32.x (2.6.32.25 + xen patches)
...
* Fri Aug 27 2010 Vitaly Kuznetsov <vitty@altlinux.ru> 2.6.32-alt21
- xen 2.6.32.21

* Sun Aug 22 2010 Vitaly Kuznetsov <vitty@altlinux.ru> 2.6.32-alt20
- xen 2.6.32.20

* Thu Aug 19 2010 Vitaly Kuznetsov <vitty@altlinux.ru> 2.6.32-alt19
- xen 2.6.32.19 (including ALT #23909 fix)

* Thu Aug 05 2010 Vitaly Kuznetsov <vitty@altlinux.ru> 2.6.32-alt17
- xen 2.6.32.17

* Tue Jul 06 2010 Vitaly Kuznetsov <vitty@altlinux.ru> 2.6.32-alt16
- xen 2.6.32.16

* Wed Jun 02 2010 Vitaly Kuznetsov <vitty@altlinux.ru> 2.6.32-alt15
- xen 2.6.32.15
...
* Thu May 06 2010 Vitaly Kuznetsov <vitty@altlinux.ru> 2.6.32-alt12
- xen 2.6.32.12

* Thu Apr 08 2010 Vitaly Kuznetsov <vitty@altlinux.ru> 2.6.32-alt11
- xen 2.6.32.11

* Tue Jan 19 2010 Vitaly Kuznetsov <vitty@altlinux.ru> 2.6.31-alt1
- xen 2.6.31.10
