...
Summary: The Linux kernel with GRsecurity patches
License: GPL
...
BuildRequires: gcc%kgcc_version-plugin-devel gcc%kgcc_version-c++ libgmp-devel
...
This package contains GRsecurity patches, don't use it if it is not
necassary for you!
...
%changelog
* Mon Mar 02 2015 Anton V. Boyarshinov <boyarsh@altlinux.ru> 1:3.14.34-alt1
- 3.14.34

* Thu Feb 19 2015 Anton V. Boyarshinov <boyarsh@altlinux.ru> 1:3.14.33-alt1
- 3.14.33

* Wed Jan 21 2015 Anton V. Boyarshinov <boyarsh@altlinux.ru> 1:3.14.29-alt2
- description fixed

* Mon Jan 19 2015 Anton V. Boyarshinov <boyarsh@altlinux.ru> 1:3.14.29-alt1
- 3.14.29
