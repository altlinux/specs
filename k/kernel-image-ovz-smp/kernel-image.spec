...
The "ovz-smp" variant of kernel packages is a original OpenVZ kernel.
...
%changelog
* Sat May 14 2011 Evgeny Sinelnikov <sin@altlinux.ru> 1:2.6.32-alt8
- Update to 2.6.32-feoktistov.1
- Add epoch tag to prevent version conflicts with 5.1 branch
- Fix building with filetrigger for kernel update
- Update build from kernel-image-ovz-smp-2.6.32-alt17
 + Build kernel-doc-* as noarch package [but actually we don't build docs]
 + Pack radeon.ko and nouveau.ko (nouveau not supports yet) 
   into separate packages (ALT 25299)
