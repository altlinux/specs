...
%define bluetooth_dir /lib/modules/%kversion-%flavour-%krelease/kernel/drivers/bluetooth/%module_name
...
%makeinstall_std \
  ...
  BTMODDESTDIR=%buildroot%bluetooth_dir
popd

%files
%module_dir/aic*.ko
%bluetooth_dir/aic*.ko
