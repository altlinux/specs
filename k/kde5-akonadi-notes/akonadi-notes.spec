...
#BuildRequires: boost-devel-headers extra-cmake-modules kde5-akonadi-devel kde5-kmime-devel kf5-kdelibs4support-devel kf5-kdoctools-devel kf5-kio-devel python-module-google python3-dev rpm-build-ruby
