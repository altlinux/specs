...
Summary(ru_RU.UTF-8): интерактивная и юморная игра с сетью и звуком
Summary(uk_UA.KOI8-U): інтерактивна та гумористична гра із мережею та звуком
...
Koules ("кульки") - файна цяцька, що попри всієї своєї простоти підкупає
ориґінальними знахідками у області стратегії та пародії.

Вона ґарантує вам чималу кількість згаяного часу. :-)
