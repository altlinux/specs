...
%define build_req_kdevplatform_ver 1.3.80
%define build_req_kdevelop_ver 4.3.90
...
%changelog
* Sun Oct 14 2012 Alexey Morozov <morozov@altlinux.org>  3:1.3.90-alt1.git
- Build a new unstable source snapshot (4d2f1abdc54017b8112621fda36907ef4d4676f3)
  and translations (1316294)

* Thu Apr 05 2012 Alexey Morozov <morozov@altlinux.org>  3:1.3.60-alt0.1.git
- Build of current (early-1.4) kdevelop-for-php git snapshot (b05d09182a4f8ce5cf7bb219fdab71a30e60c3c2)
  Package name now contains upcoming version

* Tue Feb 28 2012 Alexey Morozov <morozov@altlinux.org> 3:1.2.90-alt0.1.git
- Post 4.2.90 (4.3 RC1) build (55842b031b9b67a8294dc8f2a6c70664d7508ffc)
  (minor code cleanup)

* Mon Feb 13 2012 Alexey Morozov <morozov@altlinux.org> 3:1.2.82-alt0.2.git
- build a post 1.2.82 git snapshot (c130f0149f89e33eb472576ff31a563731f93981)

* Mon Feb 13 2012 Alexey Morozov <morozov@altlinux.org> 3:1.2.82-alt0.1.git
- build v1.2.82 (1.3 Beta 2)

* Fri Jan 27 2012 Alexey Morozov <morozov@altlinux.org> 3:1.2.81-alt0.1.git
- build a post 1.2.81 git snapshot (3bb6871bf0538a617e5064fa9eddb3b2cd22c3a0)

* Wed Dec 14 2011 Alexey Morozov <morozov@altlinux.org> 3:1.2.60-alt0.1.git
- build a new unstable git snapshot (bc965d5264ecbc09f3bddcb2216c715bae698ab8)
