...
BuildRequires: kf5-kparts-devel kf5-kservice-devel kf5-ktextwidgets-devel kf5-kunitconversion-devel kf5-kwidgetsaddons-devel
...
#%doc COPYING*
%config(noreplace) %_K5xdgconf/*pimtext*
