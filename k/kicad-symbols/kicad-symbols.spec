...
VCS: https://gitlab.com/kicad/libraries/kicad-symbols
# Source-url: https://gitlab.com/kicad/libraries/kicad-symbols/-/archive/%version/kicad-symbols-%version.tar.gz
...
* Mon Mar 23 2026 Anton Midyukov <antohami@altlinux.org> 10.0.0-alt1
- New version 10.0.0.

* Thu Feb 05 2026 Polina Poidenko <polipoki@altlinux.org> 9.0.7-alt1
- new version (9.0.7) with rpmgs script
...
* Mon Aug 25 2025 Anton Midyukov <antohami@altlinux.org> 9.0.4-alt1
- new version (9.0.4) with rpmgs script

* Sun Jan 12 2025 Anton Midyukov <antohami@altlinux.org> 8.0.8-alt1
- new version (8.0.8) with rpmgs script

* Tue Jan 07 2025 Anton Midyukov <antohami@altlinux.org> 8.0.7-alt1
- new version (8.0.7) with rpmgs script

* Thu Oct 17 2024 Anton Midyukov <antohami@altlinux.org> 8.0.6-alt1
- new version (8.0.6) with rpmgs script

* Tue Sep 10 2024 Anton Midyukov <antohami@altlinux.org> 8.0.5-alt1
