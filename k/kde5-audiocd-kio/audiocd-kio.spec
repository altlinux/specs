...
#BuildRequires: extra-cmake-modules kde5-libkcddb-devel kde5-libkcompactdisc-devel kf5-kdelibs4support-devel kf5-kdoctools-devel kf5-kio-devel lame libalsa-devel libcdparanoia-devel libflac-devel libvorbis-devel python-module-google python3-dev qt5-phonon-devel rpm-build-ruby
...
%_K5plug/plasma/kcms/systemsettings_qwidgets/*audiocd*.so
%_K5xdgapp/*audiocd*.desktop
%_K5cfg/*audiocd*
