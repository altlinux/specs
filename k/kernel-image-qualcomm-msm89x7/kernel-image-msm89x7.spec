Name: kernel-image-qualcomm-msm89x7
Release: alt1
...
%make_build defconfig misc.config pmos.config msm89x7.config altlinux.config
...
%changelog
* Fri Jul 31 2026 David Sultaniiazov <x1z53@altlinux.org> 7.1.3-alt1
- Initial build.
