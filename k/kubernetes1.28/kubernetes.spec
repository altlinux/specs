...
Patch4: kubernetes-1.28.15-alt-fix-build-with-go-1.24.patch
...
%changelog
* Wed May 07 2025 Alexander Stepchenko <geochip@altlinux.org> 1.28.15-alt3
- Fix systemd service disabling before package deletion (Closes: #49768)

* Sat Apr 12 2025 Alexander Stepchenko <geochip@altlinux.org> 1.28.15-alt2
- Fix build with golang 1.24

* Wed Oct 30 2024 Alexander Stepchenko <geochip@altlinux.org> 1.28.15-alt1
- 1.28.14 -> 1.28.15

* Wed Sep 11 2024 Alexander Stepchenko <geochip@altlinux.org> 1.28.14-alt1
- 1.28.13 -> 1.28.14

* Thu Aug 15 2024 Alexander Stepchenko <geochip@altlinux.org> 1.28.13-alt1
- 1.28.12 -> 1.28.13

* Fri Jul 19 2024 Alexander Stepchenko <geochip@altlinux.org> 1.28.12-alt1
- 1.28.11 -> 1.28.12 (Fixes: CVE-2024-5321)

* Wed Jul 10 2024 Alexander Stepchenko <geochip@altlinux.org> 1.28.11-alt1
- 1.28.10 -> 1.28.11
