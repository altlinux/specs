...
Patch4: kubernetes-1.26.15-alt-fix-build-with-go-1.24.patch
...
%changelog
* Wed May 07 2025 Alexander Stepchenko <geochip@altlinux.org> 1.26.15-alt3
- Fix systemd service disabling before package deletion (Closes: #49768)

* Sat Apr 12 2025 Alexander Stepchenko <geochip@altlinux.org> 1.26.15-alt2
