...
%changelog
* Wed May 07 2025 Alexander Stepchenko <geochip@altlinux.org> 1.29.15-alt2
- Fix systemd service disabling before package deletion (Closes: #49768)

* Thu Mar 20 2025 Alexander Stepchenko <geochip@altlinux.org> 1.29.15-alt1
- 1.29.14 -> 1.29.15

* Thu Feb 20 2025 Alexander Stepchenko <geochip@altlinux.org> 1.29.14-alt1
- 1.29.13 -> 1.29.14 (Fixes: CVE-2025-0426)

* Sun Jan 26 2025 Alexander Stepchenko <geochip@altlinux.org> 1.29.13-alt1
- 1.29.10 -> 1.29.13 (Fixes: CVE-2024-9042)

* Wed Oct 30 2024 Alexander Stepchenko <geochip@altlinux.org> 1.29.10-alt1
- 1.29.9 -> 1.29.10

* Thu Sep 12 2024 Alexander Stepchenko <geochip@altlinux.org> 1.29.9-alt1
- 1.29.8 -> 1.29.9

* Thu Aug 15 2024 Alexander Stepchenko <geochip@altlinux.org> 1.29.8-alt1
- 1.29.7 -> 1.29.8

* Fri Jul 19 2024 Alexander Stepchenko <geochip@altlinux.org> 1.29.7-alt1
- 1.29.6 -> 1.29.7 (Fixes: CVE-2024-5321)
