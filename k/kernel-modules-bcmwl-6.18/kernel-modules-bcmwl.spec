...
BuildRequires(pre): rpm-build-kernel
BuildRequires: kernel-source-%module_name >= %module_version-alt14.g6adc981
...
* Tue Jun 02 2026 Gleb F-Malinovskiy <glebfm@altlinux.org> 6.30.223.271-alt22
- Bumped the kernel-source-bcmwl dependency to 6.30.223.271-alt14.g6adc981.
- Dropped the 6.16+ compatibility patch which is now applied in
  the kernel-source-bcmwl package.
...
* Mon Jun 30 2025 L.A. Kostis <lakostis@altlinux.ru> 6.30.223.271-alt19
- BR: bump kernel-source-bcmwl version (for 6.15+).

* Fri Dec 20 2024 L.A. Kostis <lakostis@altlinux.ru> 6.30.223.271-alt18
- Move 6.12+ fix to kernel-source.

* Sat Dec 07 2024 L.A. Kostis <lakostis@altlinux.ru> 6.30.223.271-alt17
- Fix build with 6.12 kernel (due upstream 5f60d5f6 commit change).
- Remove obsoleted centos patch.
