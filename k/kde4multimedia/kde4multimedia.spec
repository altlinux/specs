...
%def_disable build_audiocd
%def_disable build_kscd
...
BuildRequires: libtunepimp-devel libflac-devel
...
%if_disabled build_ffmpegthumbs
    rm -rf ffmpegthumbs*
%endif
%if_disabled build_audiocd
    rm -rf audiocd*
%endif
%if_disabled build_kscd
    rm -rf kscd*
%endif
ls -d1 * | \
while read d
...
# fix desktop files
for app in %{?_enable_build_kscd:kscd} juk
do
