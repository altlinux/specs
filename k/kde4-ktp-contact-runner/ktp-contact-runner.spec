...
#BuildRequires: gcc-c++ glib2-devel kde4-ktp-common-internals-devel kde4libs-devel libicu libqt3-devel python-module-distribute qt4-designer rpm-build-ruby zlib-devel-static
...
%K4find_lang --with-kde --append --output=%rname.lang plasma_runner_ktp_contacts

%files -f %rname.lang
%_K4lib/krunner_ktp_contacts.so
%_K4srv/plasma-runner-ktp-contact.desktop
