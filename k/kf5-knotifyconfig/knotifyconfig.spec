...
Summary: KDE Frameworks 5 configuration dialog for desktop notifications
...
%files devel
#%_K5inc/knotifyconfig_version.h
%_K5inc/KNotifyConfig/
%_K5link/lib*.so
%_K5lib/cmake/KF5NotifyConfig
%_K5archdata/mkspecs/modules/qt_KNotifyConfig.pri
