...
%define kubernetes_minor     22
%define kubernetes_patch     17
...
# kabeadm init fails with segmentation violation
# when built using the latest go compiler
...
%changelog
* Wed Nov 01 2023 Alexey Shabalin <shaba@altlinux.org> 1.22.17-alt2
- Update R: and BR:
...
* Fri Jun 09 2023 Alexander Stepchenko <geochip@altlinux.org> 1.22.17-alt1
- 1.22.8 -> 1.22.17 (Fixes: CVE-2022-3162, CVE-2022-3294)
- Rename the package to include major and minor versions
- Remove unnecessary and commented commands from the spec file
- Use %%release instead of a git commit hash
- Remove the deprecated %%ubt macro
