...
BuildRequires: kde5-kcalcore-devel kde5-kcontacts-devel kde5-kimap-devel kde5-kmime-devel kde5-pimcommon-devel kde5-pimlibs-devel
...
#%doc COPYING*
%config(noreplace) %_K5xdgconf/libgravatar.categories
