...
Patch0: kubernetes-1.23.17-alt-fix-build-with-go-1.24.patch
...
%changelog
* Wed May 07 2025 Alexander Stepchenko <geochip@altlinux.org> 1.23.17-alt4
- Fix systemd service disabling before package deletion (Closes: #49768)

* Thu Apr 10 2025 Alexander Stepchenko <geochip@altlinux.org> 1.23.17-alt3
- Fix build with golang 1.24

* Wed Nov 01 2023 Alexey Shabalin <shaba@altlinux.org> 1.23.17-alt2
- Update R: and BR:
...
* Tue Jul 04 2023 Alexander Stepchenko <geochip@altlinux.org> 1.23.17-alt1
- 1.22.17 -> 1.23.17
