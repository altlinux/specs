...
%changelog
* Thu Apr 27 2023 Dmitry Terekhin <jqt4@altlinux.org> 1:5.15.106-alt0.1
- New flavour rbs-def for RBS Repka Pi 3 board,
  https://rbs-computers.ru/repkapi3
  forked from std-def.
- Added some Armbian patches for sunxi-5.15 from
  https://gitflic.ru/project/imptovskii/armbian-repkapi
- arm64:dts:allwinner: add sun50i-h5-repka-pi3.dts
