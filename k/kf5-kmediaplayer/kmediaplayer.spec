...
Summary: KDE Frameworks 5 interface for media player KParts
...
# optimized out: cmake cmake-modules elfutils libEGL-devel libGL-devel libcloog-isl4 libjson-c libqt5-core libqt5-dbus libqt5-gui libqt5-network libqt5-printsupport libqt5-svg libqt5-test libqt5-widgets libqt5-x11extras libqt5-xml libstdc++-devel libxcbutil-keysyms python-base ruby ruby-stdlibs
...
BuildRequires: kf5-kjobwidgets-devel kf5-knotifications-devel kf5-kparts-devel kf5-kservice-devel
...
#%_K5archdata/mkspecs/modules/qt_KMediaPlayer.pri
%_K5dbus_iface/*.xml

%files -n libkf5mediaplayer
%_K5lib/libKF5MediaPlayer.so.*
%_K5srvtyp/*.desktop
