...
# commits from branch alt-patches-1.35
...
%changelog
* Mon Jun 01 2026 Alexander Stepchenko <geochip@altlinux.org> 1.36.1-alt1
- 1.35.5 -> 1.36.1.

* Wed May 27 2026 Alexander Stepchenko <geochip@altlinux.org> 1.35.5-alt1
- 1.35.2 -> 1.35.5.

* Sat Feb 28 2026 Alexander Stepchenko <geochip@altlinux.org> 1.35.2-alt1
- 1.35.0 -> 1.35.2.

* Wed Dec 24 2025 Alexander Stepchenko <geochip@altlinux.org> 1.35.0-alt1
- 1.34.3 -> 1.35.0.
- Fixes:
...
* Fri Dec 12 2025 Alexander Stepchenko <geochip@altlinux.org> 1.33.7-alt1
- 1.33.6 -> 1.33.7.

* Wed Nov 12 2025 Alexander Stepchenko <geochip@altlinux.org> 1.33.6-alt1
- 1.33.5 -> 1.33.6.

* Wed Sep 10 2025 Alexander Stepchenko <geochip@altlinux.org> 1.33.5-alt1
- Update to 1.33.5.

* Sat Aug 30 2025 Alexander Stepchenko <geochip@altlinux.org> 1.33.4-alt1
- Update to 1.33.4.
- Fixes:
...
* Wed Apr 23 2025 Alexander Stepchenko <geochip@altlinux.org> 1.32.4-alt1
- 1.32.3 -> 1.32.4

* Sat Apr 12 2025 Alexander Stepchenko <geochip@altlinux.org> 1.32.3-alt1
- 1.32.2 -> 1.32.3
