...
with fixes and improvements to support the latest kernels (up to 7.1).
...
%changelog
* Fri Jun 05 2026 Danila Skachedubov <skachedubov@altlinux.org> 5.11.2.3-alt2.git85f3b62
- Add kernel 7.1(+) support.
