...
Requires: %name-auth-pam >= 2.0.0.2009112400.0.20120706-alt1
...
%triggerun base -- moodle2.0 <= 2.0.4.20110817-alt2.1, moodle2.0-base <= 2.0.7.20120217-alt2, moodle <= 1.9.13.20110817-alt2.1, moodle-base <= 1.9.16.20120217-alt3, moodle-apache <= 1.9.10-alt2.cvs20101110, moodle-apache2 <= 1.9.10-alt2.cvs20101110
...
* Sat Jul 07 2012 Cronbuild Service <cronbuild@altlinux.org> 2.0.10.20120706-alt1
- repocop cronbuild 20120707. At your service.
- 2.0.10 (Build: 20120706)

* Tue Jul 03 2012 Cronbuild Service <cronbuild@altlinux.org> 2.0.9.20120701-alt1
- repocop cronbuild 20120703. At your service.
- 2.0.9+ (Build: 20120701)

* Tue Jun 26 2012 Cronbuild Service <cronbuild@altlinux.org> 2.0.9.20120624-alt1
- repocop cronbuild 20120626. At your service.
- 2.0.9+ (Build: 20120624)

* Wed Jun 13 2012 Cronbuild Service <cronbuild@altlinux.org> 2.0.9.20120612-alt1
- repocop cronbuild 20120613. At your service.
- 2.0.9+ (Build: 20120612)

* Fri Jun 01 2012 Cronbuild Service <cronbuild@altlinux.org> 2.0.9.20120601-alt1
- repocop cronbuild 20120601. At your service.
- 2.0.9+ (Build: 20120601)

* Sat May 26 2012 Cronbuild Service <cronbuild@altlinux.org> 2.0.9.20120525-alt1
- repocop cronbuild 20120526. At your service.
- 2.0.9+ (Build: 20120525)

* Sun May 20 2012 Cronbuild Service <cronbuild@altlinux.org> 2.0.9.20120519-alt1
- repocop cronbuild 20120520. At your service.
- 2.0.9+ (Build: 20120519)

* Fri May 18 2012 Aleksey Avdeev <solo@altlinux.ru> 2.0.9.20120514-alt1
- 2.0.9 (Build: 20120514)
- Fix requires for %%name subpackage

* Tue May 08 2012 Aleksey Avdeev <solo@altlinux.ru> 2.0.8.20120504-alt2
- Move plugins to subpackage:
  + %%name-auth-pam

* Fri May 04 2012 Cronbuild Service <cronbuild@altlinux.org> 2.0.8.20120504-alt1
- repocop cronbuild 20120504. At your service.
- 2.0.8+ (Build: 20120504)

* Sat Apr 28 2012 Cronbuild Service <cronbuild@altlinux.org> 2.0.8.20120427-alt1
- repocop cronbuild 20120428. At your service.
- 2.0.8+ (Build: 20120427)

* Fri Apr 20 2012 Cronbuild Service <cronbuild@altlinux.org> 2.0.8.20120419-alt1
- repocop cronbuild 20120420. At your service.
- 2.0.8+ (Build: 20120419)

* Thu Apr 12 2012 Cronbuild Service <cronbuild@altlinux.org> 2.0.8.20120412-alt1
- repocop cronbuild 20120412. At your service.
- 2.0.8+ (Build: 20120412)

* Fri Apr 06 2012 Cronbuild Service <cronbuild@altlinux.org> 2.0.8.20120405-alt1
- repocop cronbuild 20120406. At your service.
- 2.0.8+ (Build: 20120405)

* Thu Mar 29 2012 Cronbuild Service <cronbuild@altlinux.org> 2.0.8.20120329-alt1
- repocop cronbuild 20120329. At your service.
- 2.0.8+ (Build: 20120329)

* Fri Mar 23 2012 Cronbuild Service <cronbuild@altlinux.org> 2.0.8.20120323-alt1
- repocop cronbuild 20120323. At your service.
- 2.0.8+ (Build: 20120323)

* Fri Mar 16 2012 Cronbuild Service <cronbuild@altlinux.org> 2.0.8.20120315-alt1
- repocop cronbuild 20120316. At your service.
- 2.0.8+ (Build: 20120315)

* Tue Mar 13 2012 Cronbuild Service <cronbuild@altlinux.org> 2.0.8.20120312-alt1
- repocop cronbuild 20120313. At your service.
- 2.0.8 (Build: 20120312)

* Fri Mar 09 2012 Cronbuild Service <cronbuild@altlinux.org> 2.0.7.20120309-alt1
- repocop cronbuild 20120309. At your service.
- 2.0.7+ (Build: 20120309)

* Thu Mar 01 2012 Cronbuild Service <cronbuild@altlinux.org> 2.0.7.20120301-alt1
- repocop cronbuild 20120301. At your service.
- 2.0.7+ (Build: 20120301)

* Fri Feb 24 2012 Cronbuild Service <cronbuild@altlinux.org> 2.0.7.20120223-alt1
- repocop cronbuild 20120224. At your service.
- 2.0.7+ (Build: 20120223)

* Tue Feb 21 2012 Aleksey Avdeev <solo@altlinux.ru> 2.0.7.20120217-alt3
...
* Sat Feb 18 2012 Aleksey Avdeev <solo@altlinux.ru> 2.0.7.20120217-alt2
- Moodle datadir is moved to
  %%_localstatedir/%%moodle_name/%%moodle_defaultdatadirname

* Sat Feb 18 2012 Cronbuild Service <cronbuild@altlinux.org> 2.0.7.20120217-alt1
- repocop cronbuild 20120218. At your service.
- 2.0.7+ (Build: 20120217)

* Thu Feb 02 2012 Cronbuild Service <cronbuild@altlinux.org> 2.0.7.20120202-alt1
- repocop cronbuild 20120202. At your service.
- 2.0.7+ (Build: 20120202)

* Fri Jan 27 2012 Cronbuild Service <cronbuild@altlinux.org> 2.0.7.20120127-alt1
- repocop cronbuild 20120127. At your service.
- 2.0.7+ (Build: 20120127)

* Tue Jan 24 2012 Aleksey Avdeev <solo@altlinux.ru> 2.0.7.20120119-alt2
- Fix distrolib.php

* Mon Jan 23 2012 Cronbuild Service <cronbuild@altlinux.org> 2.0.7.20120119-alt1
- repocop cronbuild 20120123. At your service.
- 2.0.7+ (Build: 20120119)

* Mon Jan 23 2012 Aleksey Avdeev <solo@altlinux.ru> 2.0.7.20120112-alt3
- Fix for cronbuild use

* Sat Jan 21 2012 Aleksey Avdeev <solo@altlinux.ru> 2.0.7.20120112-alt2
- Update cronbuild use

* Sat Jan 14 2012 Cronbuild Service <cronbuild@altlinux.org> 2.0.7.20120112-alt1
- repocop cronbuild 20120114. At your service.
- 2.0.7+ (Build: 20120112)

* Wed Jan 11 2012 Cronbuild Service <cronbuild@altlinux.org> 2.0.7.20120109-alt1
- repocop cronbuild 20120111. At your service.
- 2.0.7 (Build: 20120109)

* Sat Dec 24 2011 Cronbuild Service <cronbuild@altlinux.org> 2.0.6.20111223-alt1
- repocop cronbuild 20111224. At your service.
- 2.0.6+ (Build: 20111223)

* Fri Dec 09 2011 Cronbuild Service <cronbuild@altlinux.org> 2.0.6.20111209-alt1
- repocop cronbuild 20111209. At your service.
- 2.0.6+ (Build: 20111209)

* Tue Dec 06 2011 Cronbuild Service <cronbuild@altlinux.org> 2.0.6.20111205-alt1
- repocop cronbuild 20111206. At your service.
- 2.0.6+ (Build: 20111205)

* Sat Dec 03 2011 Cronbuild Service <cronbuild@altlinux.org> 2.0.6.20111201-alt1
- repocop cronbuild 20111203. At your service.
- 2.0.6+ (Build: 20111201)

* Wed Nov 30 2011 Cronbuild Service <cronbuild@altlinux.org> 2.0.6.20111128-alt1
- repocop cronbuild 20111130. At your service.
- 2.0.6 (Build: 20111128)

* Sun Nov 27 2011 Cronbuild Service <cronbuild@altlinux.org> 2.0.5.20111125-alt1
- repocop cronbuild 20111127. At your service.
- 2.0.5+ (Build: 20111125)

* Fri Nov 18 2011 Cronbuild Service <cronbuild@altlinux.org> 2.0.5.20111118-alt1
- repocop cronbuild 20111118. At your service.
- 2.0.5+ (Build: 20111118)

* Tue Nov 15 2011 Cronbuild Service <cronbuild@altlinux.org> 2.0.5.20111115-alt1
- repocop cronbuild 20111115. At your service.
- 2.0.5+ (Build: 20111115)

* Wed Nov 02 2011 Cronbuild Service <cronbuild@altlinux.org> 2.0.5.20111102-alt1
- repocop cronbuild 20111102. At your service.
- 2.0.5+ (Build: 20111102)

* Fri Oct 28 2011 Aleksey Avdeev <solo@altlinux.ru> 2.0.5.20111027-alt2
- Update for cronbuild use

* Thu Oct 27 2011 Cronbuild Service <cronbuild@altlinux.org> 2.0.5.20111027-alt1
- repocop cronbuild 20111027. At your service.
- 2.0.5+ (Build: 20111027)

* Mon Oct 24 2011 Aleksey Avdeev <solo@altlinux.ru> 2.0.5.20111019-alt2
- Fix for cronbuild use

* Wed Oct 19 2011 Cronbuild Service <cronbuild@altlinux.org> 2.0.5.20111019-alt1
- repocop cronbuild 20111019. At your service.
- 2.0.5+ (Build: 20111019)

* Fri Oct 14 2011 Cronbuild Service <cronbuild@altlinux.org> 2.0.5.20111012-alt1
- repocop cronbuild 20111014. At your service.
- 2.0.5+ (Build: 20111012)

* Wed Oct 12 2011 Aleksey Avdeev <solo@altlinux.ru> 2.0.5.20111010-alt1
- Fix package version

* Tue Oct 11 2011 Cronbuild Service <cronbuild@altlinux.org> 2.0.4.20111010-alt1
- repocop cronbuild 20111011. At your service.
- 2.0.5 (Build: 20111010)

* Tue Oct 11 2011 Aleksey Avdeev <solo@altlinux.ru> 2.0.4.20110928-alt4
- Fix for cronbuild use

* Mon Oct 10 2011 Aleksey Avdeev <solo@altlinux.ru> 2.0.4.20110928-alt3
- Fix for cronbuild use

* Thu Oct 06 2011 Aleksey Avdeev <solo@altlinux.ru> 2.0.4.20110928-alt2
- Fix for cronbuild use

* Wed Oct 05 2011 Aleksey Avdeev <solo@altlinux.ru> 2.0.4.20110928-alt1
- 2.0.4+ (Build: 20110928)

* Fri Sep 23 2011 Aleksey Avdeev <solo@altlinux.ru> 2.0.4.20110921-alt1
- 2.0.4+ (Build: 20110921)

* Wed Sep 21 2011 Aleksey Avdeev <solo@altlinux.ru> 2.0.4.20110916-alt1
- 2.0.4+ (Build: 20110916)

* Tue Sep 13 2011 Aleksey Avdeev <solo@altlinux.ru> 2.0.4.20110907-alt1
- 2.0.4+ (Build: 20110907)

* Mon Sep 05 2011 Aleksey Avdeev <solo@altlinux.ru> 2.0.4.20110831-alt2
- Fix Conflicts for %%name-base

* Mon Sep 05 2011 Aleksey Avdeev <solo@altlinux.ru> 2.0.4.20110831-alt1
- 2.0.4+ (Build: 20110831)

* Wed Aug 31 2011 Aleksey Avdeev <solo@altlinux.ru> 2.0.4.20110826-alt1
- 2.0.4+ (Build: 20110826)

* Thu Aug 25 2011 Aleksey Avdeev <solo@altlinux.ru> 2.0.4.20110817-alt4
- Fix subpackage provides

* Thu Aug 25 2011 Aleksey Avdeev <solo@altlinux.ru> 2.0.4.20110817-alt3
- Base part of Moodle highlighted in the %%name-base subpackage

* Tue Aug 23 2011 Aleksey Avdeev <solo@altlinux.ru> 2.0.4.20110817-alt2
- Add trigger for set $CFG->directorypermissions to 02770
- Fix trigger for update apache2 config

* Fri Aug 19 2011 Aleksey Avdeev <solo@altlinux.ru> 2.0.4.20110817-alt1
