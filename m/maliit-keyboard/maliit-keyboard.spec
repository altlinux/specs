...
%changelog
* Fri Aug 01 2025 Sergey V Turchin <zerg@altlinux.org> 2.3.1-alt8
- fix l10n (thanks smasher@alt)
...
* Mon Oct 02 2023 Sergey V Turchin <zerg@altlinux.org> 2.3.1-alt3
- fix to fix to launch settings
