...
Name: mojo-maven2-plugin-emma
Version: 17
Summary: Emma plugin from mojo-maven2-plugins
...
Release: alt21_0jpp
Source: mojo-maven2-plugin-emma-17-alt20_8jpp6.cpio

%description
Emma plugin from mojo-maven2-plugins.
