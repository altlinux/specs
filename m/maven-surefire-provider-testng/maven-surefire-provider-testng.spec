...
Provides: maven-surefire-provider-testng = 0:2.18.1-2.fc23
Provides: mvn(org.apache.maven.surefire:surefire-testng) = 2.18.1
Provides: mvn(org.apache.maven.surefire:surefire-testng-utils) = 2.18.1
Provides: mvn(org.apache.maven.surefire:surefire-testng-utils:pom:) = 2.18.1
Provides: mvn(org.apache.maven.surefire:surefire-testng:pom:) = 2.18.1
...
Release: alt0.1jpp
Source: maven-surefire-provider-testng-2.18.1-2.fc23.cpio
