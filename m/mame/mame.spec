...
%changelog
* Fri Jul 31 2026 Artyom Bystrov <arbars@altlinux.org> 0.289-alt1
- Update version
...
* Mon Jan 12 2026 Artyom Bystrov <arbars@altlinux.org> 0.284-alt1
- Update to new version

* Fri Dec  5 2025 Artyom Bystrov <arbars@altlinux.org> 0.283-alt1
- Update to new version

* Mon Sep 15 2025 Artyom Bystrov <arbars@altlinux.org> 0.280-alt1
- Update to new version
...
* Sat Jan  4 2025 Artyom Bystrov <arbars@altlinux.org> 0.273-alt1
- Update to new version
...
* Sun Aug  4 2024 Artyom Bystrov <arbars@altlinux.org> 0.268-alt1
- Update to new version

* Sun Jul  7 2024 Artyom Bystrov <arbars@altlinux.org> 0.267-alt1
- Update to new version

* Wed May  1 2024 Artyom Bystrov <arbars@altlinux.org> 0.265-alt1
- Update to new version

* Fri Mar 29 2024 Artyom Bystrov <arbars@altlinux.org> 0.264-alt1
- Update to new version
...
* Sun Oct 29 2023 Artyom Bystrov <arbars@altlinux.org> 0.260-alt1
- Update to new version
...
* Wed Aug  2 2023 Artyom Bystrov <arbars@altlinux.org> 0.257-alt1
- Update to new version

* Fri Jun 30 2023 Artyom Bystrov <arbars@altlinux.org> 0.256-alt1
- Update to new version

* Fri Jun  2 2023 Artyom Bystrov <arbars@altlinux.org> 0.255-alt1
- Update to new version

* Wed May 17 2023 Artyom Bystrov <arbars@altlinux.org> 0.254-alt1
- Update to new version

* Mon Apr 24 2023 Artyom Bystrov <arbars@altlinux.org> 0.253-alt1
- Update to new version

* Wed Feb 22 2023 Artyom Bystrov <arbars@altlinux.org> 0.252-alt1
- Update to new version
