...
Provides: maven-doxia-modules = 0:1.6-3.fc23
Provides: mvn(org.apache.maven.doxia:doxia-modules:pom:) = 1.6
Requires: java-headless
Requires: jpackage-utils
Requires: mvn(org.apache.maven.doxia:doxia-core)
Requires: mvn(org.apache.maven.doxia:doxia-sink-api)
Requires: mvn(org.apache.maven.doxia:doxia:pom:)
Requires: mvn(org.codehaus.plexus:plexus-component-annotations)

BuildArch: noarch
Group: Development/Java
Release: alt0.1jpp
Source: maven-doxia-modules-1.6-3.fc23.cpio
