...
Provides: maven-doxia-module-apt = 0:1.6-3.fc23
Provides: mvn(org.apache.maven.doxia:doxia-module-apt) = 1.6
Provides: mvn(org.apache.maven.doxia:doxia-module-apt:pom:) = 1.6
...
Release: alt0.1jpp
Source: maven-doxia-module-apt-1.6-3.fc23.cpio
