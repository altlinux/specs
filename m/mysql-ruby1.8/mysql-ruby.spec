...
%define pkgname mysql-ruby%{ruby_major}
...
BuildRequires: libruby%{ruby_major}-devel libMySQL-devel
...
%changelog
* Tue May 10 2011 Timur Aitov <timonbl4@altlinux.org> 2.8.2-alt4
- Upstream version

* Wed Apr 27 2011 Timur Aitov <timonbl4@altlinux.org> 2.8.2-alt3
- Rebuild for ruby1.8
