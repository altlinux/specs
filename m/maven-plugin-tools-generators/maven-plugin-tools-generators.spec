...
Provides: maven-plugin-tools-generators = 0:3.4-3.fc23
Provides: mvn(org.apache.maven.plugin-tools:maven-plugin-tools-generators) = 3.4
Provides: mvn(org.apache.maven.plugin-tools:maven-plugin-tools-generators:pom:) = 3.4
Requires: java-headless
Requires: jpackage-utils
Requires: mvn(net.sf.jtidy:jtidy)
...
Release: alt0.1jpp
Source: maven-plugin-tools-generators-3.4-3.fc23.cpio
