# Have to disable lto because of ring crate - https://github.com/briansmith/ring/issues/1444
...
%add_python3_req_skip synapse.synapse_rust.push synapse.synapse_rust.acl synapse.synapse_rust.events synapse.synapse_rust.rendezvous synapse.synapse_rust.http_client
...
install -m644 -D %SOURCE11 %buildroot%_sysusersdir/%name.conf
...
* Thu Jan 15 2026 Vitaly Lipatov <lav@altlinux.ru> 1.145.0-alt1
- new version 1.145.0
- switch to maturin build backend
- disable LTO due to ring crate issue

* Thu Jan 15 2026 Vitaly Lipatov <lav@altlinux.ru> 1.144.0-alt1
- new version 1.144.0

* Thu Jul 24 2025 Vitaly Lipatov <lav@altlinux.ru> 1.134.0-alt1
- new version 1.134.0 (with rpmrb script)
