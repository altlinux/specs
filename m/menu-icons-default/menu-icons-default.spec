...
* Wed Jul 20 2016 Sergey V Turchin <zerg@altlinux.org> 0.2.0.19-alt1
- Add basealt icon for all popular icon sizes and in SVG format

* Wed Jun 22 2016 Andrey Cherepanov <cas@altlinux.org> 0.2.0.18-alt1
