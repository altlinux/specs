...
Provides: maven-enforcer-plugin = 1.4-2.fc23
Provides: mvn(org.apache.maven.plugins:maven-enforcer-plugin) = 1.4
Provides: mvn(org.apache.maven.plugins:maven-enforcer-plugin:pom:) = 1.4
Requires: java-headless
Requires: jpackage-utils
Requires: mvn(commons-lang:commons-lang)
Requires: mvn(org.apache.maven.enforcer:enforcer-api)
Requires: mvn(org.apache.maven.enforcer:enforcer-rules)
...
Release: alt0.1jpp
Source: maven-enforcer-plugin-1.4-2.fc23.cpio
