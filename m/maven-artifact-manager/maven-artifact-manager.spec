...
Provides: maven-artifact-manager = 2.2.1-52.fc23
Provides: mvn(org.apache.maven:maven-artifact-manager) = 2.2.1
Provides: mvn(org.apache.maven:maven-artifact-manager:pom:) = 2.2.1
...
Release: alt5jpp
Source: maven-artifact-manager-2.2.1-52.fc23.cpio
