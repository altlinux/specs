...
Provides: maven-plugin-tools-annotations = 0:3.4-3.fc23
Provides: mvn(org.apache.maven.plugin-tools:maven-plugin-tools-annotations) = 3.4
Provides: mvn(org.apache.maven.plugin-tools:maven-plugin-tools-annotations:pom:) = 3.4
...
Release: alt0.1jpp
Source: maven-plugin-tools-annotations-3.4-3.fc23.cpio
