...
%changelog
* Wed Apr 07 2021 Anton V. Boyarshinov <boyarsh@altlinux.org> 20070301-alt2
- build with gcc10 fixed
- license set to GPLv2+, which seems correct for code from 2000 without GPL version
