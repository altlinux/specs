...
%changelog
* Sun Sep 13 2026 Alexey Shabalin <shaba@altlinux.org> 1.6.45-alt1
- updated from 1.6.42 to 1.6.45
- fixed build with glibc 2.43 (const-qualified memchr in vendor/mcmc)
...
* Mon May 19 2025 Alexey Shabalin <shaba@altlinux.org> 1.6.38-alt1
- New version 1.6.38.

* Fri Oct 25 2024 Alexey Shabalin <shaba@altlinux.org> 1.6.32-alt1
- New version 1.6.32.

* Sat Sep 14 2024 Alexey Shabalin <shaba@altlinux.org> 1.6.31-alt1
- New version 1.6.31.

* Thu Jul 04 2024 Alexey Shabalin <shaba@altlinux.org> 1.6.29-alt1
- New version 1.6.29.
...
* Wed Jun 15 2022 Alexey Shabalin <shaba@altlinux.org> 1.6.15-alt1
- new version 1.6.15
