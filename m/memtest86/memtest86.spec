...
%changelog
* Mon Sep 03 2018 Michael Shigorin <mike@altlinux.org> 4.0a-alt4
- fixed broken uk_UA description encoding (closes: #35307)

* Mon Jan 09 2017 Michael Shigorin <mike@altlinux.org> 4.0a-alt3
