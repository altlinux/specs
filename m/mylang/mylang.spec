...
Release: alt1
License: GPLv2
Url: https://github.com/erdizz/mylang
Source: %name-%version.tar
Group: System/Libraries
Summary: MyLang is a set of parsing tools for the MyNC project
Packager: Slava Dubrovskiy <dubrsl@altlinux.ru>

BuildRequires: gcc-c++ libmycpp-devel

%description
MyLang is a set of parsing tools for the MyNC project
