...
Provides: msv-rngconv = 1:2013.6.1-6.fc23
Provides: mvn(net.java.dev.msv:msv-rngconverter) = 2013.6.1
Provides: mvn(net.java.dev.msv:msv-rngconverter:pom:) = 2013.6.1
Requires: /bin/bash
Requires: java-headless
Requires: jpackage-utils
Requires: mvn(net.java.dev.msv:msv-core)
Requires: mvn(net.java.dev.msv:xsdlib)
...
Release: alt0.1jpp
Source: msv-rngconv-2013.6.1-6.fc23.cpio

%description
Multi-Schema Validator RNG Converter.
