...
Provides: msv-xmlgen = 1:2013.6.1-6.fc23
Provides: mvn(net.java.dev.msv:msv-generator) = 2013.6.1
Provides: mvn(net.java.dev.msv:msv-generator:pom:) = 2013.6.1
Requires: /bin/bash
...
Release: alt0.1jpp
Source: msv-xmlgen-2013.6.1-6.fc23.cpio

%description
Multi-Schema Validator Generator.
