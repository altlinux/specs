...
Provides: maven-project = 2.2.1-52.fc23
Provides: mvn(org.apache.maven:maven-project) = 2.2.1
Provides: mvn(org.apache.maven:maven-project:pom:) = 2.2.1
...
Release: alt5jpp
Source: maven-project-2.2.1-52.fc23.cpio
...
%changelog
* Fri Jan 22 2016 Igor Vlasenko <viy@altlinux.ru> 1:2.2.1-alt5jpp
