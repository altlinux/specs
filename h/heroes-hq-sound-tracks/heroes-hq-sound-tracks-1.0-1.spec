Name:           heroes-hq-sound-tracks
Version:        1.0
Release:        alt0.1

Summary:        Heroes high quality sound tracks.
License:      GPL
Group:          Games/Arcade
...
%files
%doc AUTHORS AUTHORS COPYING ChangeLog INSTALL NEWS README
%_gamesdatadir/heroes/hqmod/sound.conf
%_gamesdatadir/heroes/hqmod/*.xm
