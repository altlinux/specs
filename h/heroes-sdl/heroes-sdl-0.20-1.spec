...
# to build man pages correctly, we need to execute heroes --help,
# which, in turn, requires the data to be installed.
BuildRequires: heroes-data
...
- Fix FTBFS, again
  ...
  + add BR heroes-data to fix man page generation.
