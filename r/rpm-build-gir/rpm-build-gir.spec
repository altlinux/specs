...
%changelog
* Wed Apr 26 2023 Yuri N. Sedunov <aris@altlinux.org> 0.7.3-alt3.1
- replaced "egrep" with "grep -E"

* Mon Dec 02 2019 Yuri N. Sedunov <aris@altlinux.org> 0.7.3-alt3
- gir-python.req: switched to libpeas-python3-loader
