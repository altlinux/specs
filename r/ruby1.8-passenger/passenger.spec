...
BuildRequires: rpm-build-ruby rpm-macros-apache2
BuildRequires: %(eval echo %apache2_apr_buildreq)

# Automatically added by buildreq on Sat Feb 26 2011
BuildRequires: apache2-devel gcc-c++ libcrypto7 libcurl-devel libruby%ruby_major-devel ruby%ruby_major-rack ruby%ruby_major-rubygems

BuildPreReq: ruby%ruby_major-rake apache2-httpd-worker zlib-devel
BuildPreReq: apache2-devel libapr1-devel libaprutil1-devel libssl-devel

Requires: ruby%ruby_major-rails ruby-mime-types >= 1.15
...
Group: System/Servers
Requires: ruby%ruby_major-rails ruby-mime-types >= 1.15 apache2-httpd-worker %name = %version
...
- Update to release for ruby-1.8
