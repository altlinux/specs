...
sed -i 's@os.path.join(i, "lib")@os.path.join(i, "lib64")@g' module/setuplib.py
%endif
...
* Wed Apr 09 2014 Fr. Br. George <george@altlinux.ru> 6.17.3-alt1
- Autobuild version bump to 6.17.3

* Mon Mar 03 2014 Fr. Br. George <george@altlinux.ru> 6.17.2-alt1
- Autobuild version bump to 6.17.2
- Fix build
