...
BuildRequires: libGL-devel libX11-devel libfreeglut-devel libruby%{ruby_major}-devel ruby%{ruby_major}-mkrf
...
%changelog
* Tue May 03 2011 Timur Aitov <timonbl4@altlinux.org> 0.60.1-alt3
- Rebuild for ruby1.8
