...
BuildRequires: ruby%{ruby_major} rpm-build-ruby ruby%{ruby_major}-activerecord-sqlite3-adapter ruby%{ruby_major}-builder ruby%{ruby_major}-i18n ruby%{ruby_major}-mocha ruby%{ruby_major}-rack ruby%{ruby_major}-redcloth ruby%{ruby_major}-tool-rdoc ruby-tool-setup
