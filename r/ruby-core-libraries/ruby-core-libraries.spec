...
%ruby_use_gem_dependency minitest >= 7
...
%package       -n gem-google-logging-utils
Version:       0.1.0
Release:       alt1.1
...
%description   -n gem-google-logging-utils
...
%files         -n gem-google-logging-utils
%doc CODE_OF_CONDUCT.md CONTRIBUTING.md LICENSE README.md
...
%changelog
* Tue Aug 18 2026 Pavel Skrylev <majioa@altlinux.org> 20240827-alt1.1
