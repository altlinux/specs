...
BuildRequires: libfcgi-devel libruby%{ruby_major}-devel ruby-tool-setup
...
%changelog
* Thu Apr 28 2011 Timur Aitov <timonbl4@altlinux.org> 0.8.8-alt2
- Rebuild for ruby1.8
