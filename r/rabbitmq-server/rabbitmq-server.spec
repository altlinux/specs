...
BuildRequires: xmlto p7zip zip unzip netcat rsync

#Disable erlang autoreq to avoid unmet dependencies on rabbitmq plugins
AutoReq: noerlang
Requires: elixir
Requires: erlang >= 1:26.2
Requires: erlang-otp >= 1:26.2
...
%changelog
* Thu Apr 23 2026 Egor Ignatov <egori@altlinux.org> 4.3.0-alt1
- 4.3.0

* Mon Mar 30 2026 Egor Ignatov <egori@altlinux.org> 4.2.5-alt1
- 4.2.5
...
* Tue Jan 27 2026 Egor Ignatov <egori@altlinux.org> 4.1.8-alt1
- 4.1.8
...
* Sun Dec 31 2023 Egor Ignatov <egori@altlinux.org> 3.12.11-alt1
- 3.12.11

* Thu Dec 07 2023 Egor Ignatov <egori@altlinux.org> 3.12.10-alt1
- 3.12.10
...
* Tue May 30 2023 Egor Ignatov <egori@altlinux.org> 3.11.17-alt1
- 3.11.17
