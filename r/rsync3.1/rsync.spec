...
# git://git.samba.org/rsync refs/heads/master
Source: %name.tar

# git://git.altlinux.org/gears/r/rsync.git
Patch: rsync-%version-alt.patch
...
%changelog
* Mon Nov 07 2011 Ildar Mulyukov <ildar@altlinux.ru> 3.1-alt1.g8dd6ea1
- package rsync3.1: unstable GIT branch
