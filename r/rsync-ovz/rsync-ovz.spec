...
Summary: Special rsync for OpenVZ 7 migration tool
License: GPLv3+
...
%description
Special rsync with additional features for OpenVZ 7 vzmigrate(1).
For another purposes use original rsync(1).
...
mv %buildroot%_bindir/rsync{,-ovz}
rm -f %buildroot%_man1dir/rsync*
rm -f %buildroot%_man5dir/rsync*

%files
%_bindir/%name

%changelog
* Sat Feb 12 2022 Andrew A. Vasilyev <andy@altlinux.org> 3.1.3-alt3
- Build for OpenVZ 7.
