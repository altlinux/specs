...
%define common_summary Convolution reverb plugin with pre and post modulation

%define common_description REEV-R is a cross-platform convolution reverb with\
modulation for pre/send and post/volume signals. It features:\
...
Vcs:     https://github.com/tiagolr/reevr.git
