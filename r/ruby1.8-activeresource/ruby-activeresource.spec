...
BuildRequires: ruby%{ruby_major} rpm-build-ruby ruby%{ruby_major}-activesupport ruby%{ruby_major}-builder ruby%{ruby_major}-mocha ruby%{ruby_major}-tool-rdoc ruby-tool-setup
