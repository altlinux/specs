...
Name: ruby%ruby_major-tool-%pkgname
Version: 3.4.1
Release: alt1
...
BuildRequires: ruby%ruby_major(etc) ruby%ruby_major(fileutils) ruby%ruby_major(stringio)

Source: %pkgname-%version.tar
Patch: ruby-tool-%pkgname-%version-%release.patch
...
%changelog
* Sun Dec 18 2011 Evgeny Sinelnikov <sin@altlinux.ru> 3.4.1-alt1
- Build tool-setup for ruby-1.8
