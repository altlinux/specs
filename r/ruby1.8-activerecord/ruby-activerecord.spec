...
BuildRequires: ruby%{ruby_major} rpm-build-ruby ruby%{ruby_major}-activesupport ruby%{ruby_major}-builder ruby%{ruby_major}-mocha ruby%{ruby_major}-rake ruby%{ruby_major}-tool-rdoc ruby-tool-setup sqlite3 sqlite3-ruby%{ruby_major} tzdata
...
Requires: ruby%{ruby_major}(mysql)
...
Requires: %name = %version-%release
# Hidden from ruby.req...
Requires: ruby%{ruby_major}(sqlite3)
...
%changelog
* Wed Apr 27 2011 Timur Aitov <timonbl4@altlinux.org> 2.3.11-alt2
- Rebuild for ruby1.8
