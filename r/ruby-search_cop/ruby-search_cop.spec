%define  pkgname search_cop

Name:    ruby-%pkgname
Version: 1.0.5
Release: alt1

Summary: Search engine like fulltext query support for ActiveRecord
License: MIT
...
%changelog
* Mon Feb 04 2019 Mikhail Gordeev <obirvalger@altlinux.org> 1.0.5-alt1
