...
Patch9: alt-assert.patch
Patch10: x265-4.0.patch
Patch11: alt-find-sdl2.patch
Patch12: alt-detect-aarch64.patch
#
Patch100: avidemux-opencore-check.patch
...
BuildRequires: qt6-base-devel qt6-declarative-devel qt6-tools
...
sed -i "s|/usr/local/include/ffnvcodec|$PWD/nv-codec-headers/ffnvcodec|" avidemux_core/cmake/admCheckNvEnc.cmake 
cat nv-codec-headers/ffnvcodec.pc.in | sed "s|@@PREFIX@@|%_prefix|" > nv-codec-headers/ffnvcodec.pc
...
%endif
%add_optflags -Wno-error=return-type %optflags_shared
...
sh bootStrap.bash \
    ...
    #
#    --with-system-libass \
#lrelease-qt6 avidemux/qt4/i18n/*.ts
#for p in po/*.po ; do
...
ln -s avidemux3_qt6 %buildroot/%_bindir/%rname
...
* Tue Jun 03 2025 Sergey V Turchin <zerg@altlinux.org> 2.8.1-alt7
- fix compile with new x264

* Mon Apr 14 2025 Sergey V Turchin <zerg@altlinux.org> 2.8.1-alt6
- remove unnecessary assert (closes: 53813)

* Mon Apr 07 2025 Sergey V Turchin <zerg@altlinux.org> 2.8.1-alt5
