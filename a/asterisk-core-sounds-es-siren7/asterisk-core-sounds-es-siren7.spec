...
Name: asterisk-core-sounds-es-siren7
...
BuildArch: noarch
Obsoletes: asterisk-sounds-es-siren7 < %version-%release 
Conflicts: asterisk-sounds-es-siren7 
...
%install
ast-install-core-sounds es siren7 %buildroot
%files -f sounds.list
