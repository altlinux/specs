...
%package -n aelparse-trunk
Summary: Asterisk AEL2 parser
Group: %group
Requires: asterisk-trunk-common

%description -n aelparse-trunk
...
Group: %group
BuildArch: noarch
Requires: aelparse-trunk = %version-%release
...
Requires: conf2ael-trunk = %version-%release
...
%package -n conf2ael-trunk
Summary: extensions.conf -> ael2 converter
Group: %group
Requires: asterisk-trunk-common

%description -n conf2ael-trunk
extensions.conf -> ael2 converter


%package -n libasteriskssl-trunk
Summary: Asterisk SSL functions
Group: %group

%description -n libasteriskssl-trunk
...
ln -sf asterisk-%version %buildroot%_sbindir/rasterisk-%version
mv %buildroot%_man8dir/asterisk.8 %buildroot%_man8dir/asterisk-%version.8
gzip -9 %buildroot%_man8dir/asterisk-%version.8
...
mv %buildroot/var/lib/asterisk/documentation/*.xslt %buildroot/%ast_doc_dir/ ||:
...
%files -n conf2ael-trunk
%_sbindir/conf2ael-%version
%_altdir/conf2ael-%version

%files -n libasteriskssl-trunk
