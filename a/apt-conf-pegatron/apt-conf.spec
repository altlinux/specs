...
%define distro pegatron
%define Distro pegatron snapshot
...
%build
%make_build REPOSITORIES=pegatron-snapshot
...
%changelog
* Wed Jul 04 2012 Anton V. Boyarshinov <boyarsh@altlinux.ru> 1-alt1
- sisyphus snapshot for tablet distro
