...
%package -n aelparse1.8
Summary: Asterisk AEL2 parser
Group: %group
Requires: asterisk1.8-common

%description -n aelparse1.8
...
Group: %group
BuildArch: noarch
Requires: aelparse1.8 = %version-%release
...
%package -n conf2ael1.8
Summary: extensions.conf -> ael2 converter
Group: %group
Requires: asterisk1.8-common

%description -n conf2ael1.8
...
mkdir -p %buildroot/usr/share/asterisk/documentation/1.8
mv %buildroot/var/lib/asterisk/documentation/*.xml %buildroot/usr/share/asterisk/documentation/1.8/
mv %buildroot/var/lib/asterisk/documentation/*.dtd %buildroot/usr/share/asterisk/documentation/1.8/
...
%dir /usr/share/asterisk/documentation/1.8
/usr/share/asterisk/documentation/1.8/appdocsxml.dtd
/usr/share/asterisk/documentation/1.8/core-en_US.xml
...
* Wed Mar 18 2015 Denis Smirnov <mithraen@altlinux.ru> 1.8.32.2-alt1
- new version 1.8.32.2
...
* Tue Mar 11 2014 Denis Smirnov <mithraen@altlinux.ru> 1.8.26.1-alt1
- new version 1.8.26.1

* Wed Jan 15 2014 Denis Smirnov <mithraen@altlinux.ru> 1.8.25.0-alt1
- new version 1.8.25.0

* Sun Sep 01 2013 Denis Smirnov <mithraen@altlinux.ru> 1.8.23.1-alt1
- new version 1.8.23.1

* Tue Aug 27 2013 Denis Smirnov <mithraen@altlinux.ru> 1.8.23.0-alt2
- compatibility with asterisk-base 0.67

* Thu Aug 01 2013 Denis Smirnov <mithraen@altlinux.ru> 1.8.23.0-alt1
- new version 1.8.23.0

* Sun May 19 2013 Denis Smirnov <mithraen@altlinux.ru> 1.8.22.0-alt1
- new version 1.8.22.0

* Wed Apr 10 2013 Denis Smirnov <mithraen@altlinux.ru> 1.8.21.0-alt1
- new version 1.8.21.0

* Wed Feb 06 2013 Denis Smirnov <mithraen@altlinux.ru> 1.8.20.1-alt2
- exclude from package some unneeded files

* Sat Jan 26 2013 Denis Smirnov <mithraen@altlinux.ru> 1.8.20.1-alt1
- new version 1.8.20.1

* Mon Jan 21 2013 Denis Smirnov <mithraen@altlinux.ru> 1.8.20.0-alt1
- new version 1.8.20.0
...
* Sun Nov 11 2012 Denis Smirnov <mithraen@altlinux.ru> 1.8.18.0-alt1
- 1.8.18.0

* Fri Nov 02 2012 Denis Smirnov <mithraen@altlinux.ru> 1.8.17.0-alt1
- 1.8.17.0

* Mon Sep 24 2012 Denis Smirnov <mithraen@altlinux.ru> 1.8.16.0-alt2
- disable build with -march=native

* Sun Sep 16 2012 Denis Smirnov <mithraen@altlinux.ru> 1.8.16.0-alt1
- 1.8.16.0
...
* Wed Feb 08 2012 Denis Smirnov <mithraen@altlinux.ru> 1.8.9.1-alt1
- 1.8.9.1

* Mon Jan 02 2012 Denis Smirnov <mithraen@altlinux.ru> 1.8.8.1-alt1
- 1.8.8.1

* Sat Dec 17 2011 Denis Smirnov <mithraen@altlinux.ru> 1.8.8.0-alt1
- 1.8.8.0

* Wed Oct 26 2011 Denis Smirnov <mithraen@altlinux.ru> 1.8.7.1-alt1
- 1.8.7.1
- CVE-2011-4063

* Wed Oct 05 2011 Denis Smirnov <mithraen@altlinux.ru> 1.8.7.0-alt1
- 1.8.7.0

* Fri Sep 02 2011 Denis Smirnov <mithraen@altlinux.ru> 1.8.6.0-alt1
- 1.8.6.0

* Fri Jul 22 2011 Denis Smirnov <mithraen@altlinux.ru> 1.8.5.0-alt1
- 1.8.5.0
- fix internal documentation

* Thu May 19 2011 Denis Smirnov <mithraen@altlinux.ru> 1.8.4-alt3
- fix build

* Mon Mar 21 2011 Denis Smirnov <mithraen@altlinux.ru> 1.8.4-alt2
- fix build

* Sat Feb 26 2011 Denis Smirnov <mithraen@altlinux.ru> 1.8.4-alt1
- 1.8.4

* Thu Feb 17 2011 Denis Smirnov <mithraen@altlinux.ru> 1.8.3-alt0.rc3
- 1.8.3-rc3
- fix alternatives

* Wed Feb 09 2011 Denis Smirnov <mithraen@altlinux.ru> 1.8.3-alt0.rc2.1
- rebuild with new openr2

* Thu Jan 27 2011 Denis Smirnov <mithraen@altlinux.ru> 1.8.3-alt0.rc2
- 1.8.3-rc2
- little fix queue log locking

* Fri Jan 21 2011 Denis Smirnov <mithraen@altlinux.ru> 1.8.3-alt0.rc1.1
- build with more debug info
- build chan_usbradio
- build chan_misdn
- build with SS7 support
- fix subpackages

* Fri Jan 21 2011 Denis Smirnov <mithraen@altlinux.ru> 1.8.3-alt0.rc1
- 1.8.3-rc1
- CVE-2011-0495

* Sat Jan 15 2011 Denis Smirnov <mithraen@altlinux.ru> 1.8.2-alt1
- 1.8.2

* Sun Dec 26 2010 Denis Smirnov <mithraen@altlinux.ru> 1.8.2-alt0.rc1.1
- fix xml docs packaging

* Mon Dec 20 2010 Denis Smirnov <mithraen@altlinux.ru> 1.8.2-alt0.rc1
- 1.8.2-rc1

* Sun Dec 12 2010 Denis Smirnov <mithraen@altlinux.ru> 1.8.1-alt1
- 1.8.1

* Sun Nov 14 2010 Denis Smirnov <mithraen@altlinux.ru> 1.8.0-alt2
- fix alternatives.
- aelparse: remove empty output file and return -1 if error
- add asterisk1.8-common

* Fri Oct 22 2010 Denis Smirnov <mithraen@altlinux.ru> 1.8.0-alt1
- 1.8.0 release

* Tue Oct 19 2010 Denis Smirnov <mithraen@altlinux.ru> 1.8.0-alt0.rc5
- 1.8.0-rc5

* Mon Oct 11 2010 Denis Smirnov <mithraen@altlinux.ru> 1.8.0-alt0.rc3.1
- auto rebuild

* Fri Oct 08 2010 Denis Smirnov <mithraen@altlinux.ru> 1.8.0-alt0.rc3
- 1.8.0-rc3

* Sun Sep 26 2010 Denis Smirnov <mithraen@altlinux.ru> 1.8.0-alt0.rc2.1
- make %name-crypto and %name-complete noarch
- move applications docs to versioned subdir

* Sat Sep 25 2010 Denis Smirnov <mithraen@altlinux.ru> 1.8.0-alt0.rc2
- 1.8.0-rc2

* Sun Sep 19 2010 Denis Smirnov <mithraen@altlinux.ru> 1.8.0-alt0.beta5.2
- rebuild with new libmysqlclient

* Fri Sep 10 2010 Denis Smirnov <mithraen@altlinux.ru> 1.8.0-alt0.beta5.1
- fix build

* Fri Sep 10 2010 Denis Smirnov <mithraen@altlinux.ru> 1.8.0-alt0.beta5
- 1.8.0-beta5

* Fri Sep 03 2010 Denis Smirnov <mithraen@altlinux.ru> 1.8.0-alt0.beta4.1
- rebuild with new libpri

* Tue Aug 24 2010 Denis Smirnov <mithraen@altlinux.ru> 1.8.0-alt0.beta4
- 1.8.0-beta4

* Wed Aug 11 2010 Denis Smirnov <mithraen@altlinux.ru> 1.8.0-alt0.beta3.1
- fix build format_mp3

* Wed Aug 11 2010 Denis Smirnov <mithraen@altlinux.ru> 1.8.0-alt0.beta3
- 1.8.0-beta3

* Tue Jul 27 2010 Denis Smirnov <mithraen@altlinux.ru> 1.8.0-alt0.beta2
- 1.8.0-beta2

* Sun Jul 25 2010 Denis Smirnov <mithraen@altlinux.ru> 1.8.0-alt0.beta1.1
- fix requires in %name-compete

* Sat Jul 24 2010 Denis Smirnov <mithraen@altlinux.ru> 1.8.0-alt0.beta1
