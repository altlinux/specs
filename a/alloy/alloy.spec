...
# Prebuilt Beyla executables embedded into Alloy on Linux AMD64 and ARM64.
# Generated by .gear/download-beyla.sh.
Source4: beyla-binaries.tar.gz
...
tar -xf %SOURCE4 \
    -C collector/vendor/github.com/grafana/alloy/internal/component/beyla/ebpf
...
%make_build alloy -o download-beyla
...
%changelog
* Tue Sep 01 2026 Maria Alexeeva <alxvmr@altlinux.org> 1.19.2-alt1
- Update version to v1.19.2
- Bundle Beyla binaries for offline builds and skip the upstream
  download step.
