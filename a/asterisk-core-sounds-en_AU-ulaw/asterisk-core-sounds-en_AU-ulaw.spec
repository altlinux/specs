...
Name: asterisk-core-sounds-en_AU-ulaw
...
BuildArch: noarch
Obsoletes: asterisk-sounds-en_AU-ulaw < %version-%release 
Conflicts: asterisk-sounds-en_AU-ulaw 
...
%install
ast-install-core-sounds en_AU ulaw %buildroot
%files -f sounds.list
