...
%{expand:%%global o_list apt-conf < 0:4.0 %(for n in Castle Compact Junior Master Spring centaurus desktop hpc junior master office-server platform5 school server terminal branch; do echo -n "apt-conf-$n "; done)}
...
* Tue Jun 04 2019 Ivan A. Melnikov <iv@altlinux.org> 9.0-alt4
