...
Name: asterisk-core-sounds-ru-ulaw
...
BuildArch: noarch
Obsoletes: asterisk-sounds-ru-ulaw < %version-%release 
Conflicts: asterisk-sounds-ru-ulaw 
...
%install
ast-install-core-sounds ru ulaw %buildroot
%files -f sounds.list
