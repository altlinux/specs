...
Name: asterisk-core-sounds-fr-g729
...
BuildArch: noarch
Obsoletes: asterisk-sounds-fr-g729 < %version-%release 
Conflicts: asterisk-sounds-fr-g729 
...
%install
ast-install-core-sounds fr g729 %buildroot
%files -f sounds.list
...
* Fri May 08 2015 Cronbuild Service <cronbuild@altlinux.org> 1.4.27-alt1
- new version 1.4.27
