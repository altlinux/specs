...
Name: asterisk-core-sounds-en_AU-alaw
...
BuildArch: noarch
Obsoletes: asterisk-sounds-en_AU-alaw < %version-%release 
Conflicts: asterisk-sounds-en_AU-alaw 
...
%install
ast-install-core-sounds en_AU alaw %buildroot
%files -f sounds.list
