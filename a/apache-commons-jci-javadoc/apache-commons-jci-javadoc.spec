Name: apache-commons-jci-javadoc
Version: 1.1
Summary: Javadoc for apache-commons-jci
License: ASL 2.0
Url: http://commons.apache.org/jci/
Epoch: 1
Packager: Igor Vlasenko <viy@altlinux.ru>
Provides: apache-commons-jci-javadoc = 1.1-2.fc23
Requires: jpackage-utils

BuildArch: noarch
Group: Development/Java
Release: alt0.1jpp
Source: apache-commons-jci-javadoc-1.1-2.fc23.cpio

%description
This package contains javadoc for apache-commons-jci.
