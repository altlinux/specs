...
Name: asterisk-core-sounds-en-siren7
...
BuildArch: noarch
Obsoletes: asterisk-sounds-en-siren7 < %version-%release 
Conflicts: asterisk-sounds-en-siren7 
...
%install
ast-install-core-sounds en siren7 %buildroot
%files -f sounds.list
