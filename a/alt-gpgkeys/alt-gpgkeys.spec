...
%changelog
* Mon Aug 31 2026 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.147-alt1
- Updated key: ancieg@ (16159AB3; closes: #46624).

* Mon Aug 03 2026 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.146-alt1
- Added key: alt-c11@ (BECE5265).

* Mon Jul 27 2026 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.145-alt1
- Updated expired key: george@ (CE50396C; closes: #59955).

* Wed Jul 22 2026 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.144-alt1
- Added keys:
  + bogdanb@ (005FAE41; see #58540);
  + valk@ (A48A3D3A; see #56879);
  + toreonify@ (1030A824; see #52935).

* Thu Jun 25 2026 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.143-alt1
- Updated key: armatik@ (155FD922; closes: #59339).

* Thu May 28 2026 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.142-alt1
- Updated key: armatik@ (155FD922; closes: #59339).
- Added keys:
  + joycap@ (B8C5469B; see #58559);
  + parovoz@ (782560DF; see #52258);
  + nst@ (3BA91496; see #58572).

* Sun Apr 26 2026 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.141-alt1
- Added keys:
  + usam@ (2189F084; see #57202);
  + l27001@ (C978E881; see #58414).
...
* Fri Feb 13 2026 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.136-alt1
- Updated expired key: updates@ (231114B3).

* Thu Feb 05 2026 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.135-alt1
- Added key: ampernic@ (D8DAF28B; see #57701).

* Wed Feb 04 2026 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.134-alt1
- Updated key: alt-p10@ (C7EB80F9).

* Tue Feb 03 2026 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.133-alt1
- Replaced keys:
  + repocop@ (E029A65B -> F2465945; closes: #57736);
  + viy@ (845A2763 -> F534DEB3; closes: #57736).

* Tue Feb 03 2026 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.132-alt1
- Updated expired key: bircoph@ (5372756C; closes: #57748).

* Sat Jan 31 2026 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.131-alt1
- Added keys:
  + karonus@ (B124CC5E; see #57486);
  + crystarm@ (0E9543C5; see #57062).

* Mon Jan 26 2026 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.130-alt1
- Replaced keys:
  + cas@ (A9EBF131 -> 3229D4E1; closes: #57632);
  + fruktime@ (16D721C0 -> 93623610; closes: #57660).

* Sat Jan 24 2026 Evgeny Sinelnikov <sin@altlinux.org> 0.8.129-alt1
- Replaced key: sin@ (A921DACA -> 430ED6B0).

* Thu Jan 22 2026 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.128-alt1
- Replaced key: iv@ (2A82451F -> BC44C1EE; closes: #57598).

* Tue Jan 20 2026 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.127-alt1
- Added key: olkmv@ (80468C70; see #54552).

* Wed Jan 14 2026 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.126-alt1
- Updated key: naf@ (DD7132A6; closes: #57484).

* Tue Dec 09 2025 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.125-alt1
- Added keys:
  + scala@ (D949063C; see #56411);
  + udalov@ (4191D94E; see #56328);
  + mukav@ (FED33E18; see #57115).

* Sun Dec 07 2025 Dmitry V. Levin <ldv@altlinux.org> 0.8.124-alt1
- Replaced key: ldv@ (A340AEB7 -> 73F8C2D6).

* Tue Dec 02 2025 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.123-alt1
- Updated expired key: egori@ (6BDF202A; closes: #44525).
- Replaced key: vsu@ (441FB2A2 -> 1C97D65A; closes: #56958).

* Mon Oct 27 2025 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.122-alt1
- Updated keys:
  + asy@ (54F8ABD4; closes: #56627);
  + glebfm@ (D098D624).
- Added keys:
  + vladp@ (3B55261A; see #56237);
  + silverducks@ (3E3EE088; see #56287);
  + nexxy@ (B467C24F; see #56268).

* Thu Oct 23 2025 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.121-alt1
- Replaced key: shrek@ (5E47BC8A -> D1BF6708; closes: #56575).

* Wed Oct 22 2025 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.120-alt1
- Added key: radiolamp@ (970B482C; see #56325).

* Fri Oct 17 2025 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.119-alt1
- Replaced key: mithraen@ (88E114A2 -> 0402EFA7; closes: #56249).

* Thu Oct 16 2025 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.118-alt1
- Added keys:
  + kuzmaav@ (DC50818A; see #55584);
  + cobalt@ (46D5C4D8; see #56224).

* Wed Oct 15 2025 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.117-alt1
- Added keys:
  + treza@ (82F25608; see #49528);
  + romenskiy@ (887F96FE; see #56063);
  + artos@ (2B5D3F1E; see #56039);
  + general@ (174CF8B4; see #55292).

* Wed Oct 01 2025 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.116-alt1
- Added keys:
  + asd@ (269C6A39; see #55964);
  + trogjan@ (911E7F1A; see #55790);
  + polipoki@ (FA92DDF3; see #55688).
- Updated key: rirusha@ (8FA48966; closes: #56173).

* Mon Sep 15 2025 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.115-alt1
- Added key: phobos@ (19290F83; see #55581).

* Mon Sep 15 2025 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.114-alt1
- Updated expired key: ancieg@ (16159AB3; closes: #46624).
- Added keys:
  + lesyafox@ (56D4AD84; see #53345);
  + alehandro@ (09D3BCB7; see #51664);
  + nash@ (23937166; see #55219).

* Tue Aug 05 2025 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.113-alt1
- Added key: nicourced@ (C6BDD359; see #55213).

* Mon Aug 04 2025 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.112-alt1
- Added key: nuke@ (0875AAE8; see #55297).

* Fri Jun 27 2025 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.111-alt1
- Replaced key: smasher@ (EBC2B57E -> 03AC07BB; closes: #54539).
- Added keys:
  + usoltsevpv@ (DBA8FC62; see #52347);
  + r9odt@ (6047891A; see #54472);
  + alvshemetov@ (985EBB11; see #53172);
  + tyaplyapych@ (B7316A63; see #52061).

* Thu May 22 2025 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.110-alt1
- Added keys:
  + esgor@ (4C3716E7; see #52276);
  + tascad@ (FAB0A0AE; see #47561).

* Tue May 20 2025 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.109-alt1
- Replaced key: aris@ (96C47AC2 -> E72D4C76; closes: #33523).

* Fri Apr 18 2025 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.108-alt1
- Updated key: manowar@ (B9F22864; closes: #38344).
- Added key: xeno@ (4F3653B0; see #53279).

* Tue Mar 18 2025 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.107-alt1
- Added keys:
  + gamzin@ (C08345B6; see #51831);
  + kiper@ (64603544; see #50974);
  + x1z53@ (0839C0D5; see #53003).

* Thu Mar 06 2025 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.106-alt1
- Replaced key: kozyrevid@ (9E383564 -> 4EA669A4; see: #46635).

* Wed Mar 05 2025 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.105-alt1
- Added key: paladindev@ (E2AAFB2A; see #53275).

* Tue Feb 25 2025 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.104-alt1
- Added keys:
  + tulskijms@ (89FCFA4D; see #53130);
  + medovi@ (758A18DD; see #51665).

* Wed Feb 19 2025 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.103-alt1
- Added key: maks1ms@ (5606437F; see #52444).

* Tue Feb 18 2025 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.102-alt1
- Removed key: paulelms@ (02A9FF96; see #34005).
- Added keys:
  + skachedubov@ (BE90F53E; see #45885);
  + chur1q@ (D666B174; see #52334);
  + sovtouch@ (B499561C; see #52737).

* Mon Feb 10 2025 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.101-alt1
- Replaced keys:
  + rx1513@ (CA8FE3D4 -> 55A3C19E; closes: #52680);
  + ender@ (A734232C -> 9192BB14; closes: #51761).
- Added key: manul@ (07FA07E7; see #52144).

* Fri Jan 31 2025 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.100-alt1
- Added keys:
  + minergenon@ (8D439063; see #51153);
  + kozyrevid@ (9E383564; see #46635).

* Thu Jan 09 2025 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.99-alt1
- Added keys:
  + writers@ (87A7B35B; see #51827);
  + alton@ (7516A54F; see #51553).

* Thu Dec 12 2024 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.98-alt1
- Added key: protvin@ (1E27BB07; see #52248).

* Wed Dec 11 2024 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.97-alt1
- Added keys:
  + kozorizki@ (43A9D83F; see #51835);
  + darisishe@ (82FFA7AD; see #51830).

* Mon Dec 09 2024 Gleb F-Malinovskiy <glebfm@altlinux.org> 0.8.96-alt1
- Replaced key: nofex@ (93E72A2D -> 255A3309; closes: #52256).
- Updated key: gremlin@ (3D879005; closes: #52354).
- Added keys:
  + alpacost@ (C537050A; see #51531);
  + swaggyglice@ (D380C3CA; see #51751);
  + ulysses@ (CA075B93; see #51793).
...
- Added keys:
  + cheese@ (7BCF62F3; see #51280);
  + rx1513@ (CA8FE3D4; see #50906).
