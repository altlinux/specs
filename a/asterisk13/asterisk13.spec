...
Requires: conf2ael13 = %version-%release
...
%package -n libasteriskssl13
Summary: Asterisk SSL functions
Group: %group

%description -n libasteriskssl13
...
mkdir -p %buildroot/usr/share/asterisk/documentation/13
mv %buildroot/var/lib/asterisk/documentation/*.xml %buildroot/usr/share/asterisk/documentation/13/
...
%files -n libasteriskssl13
%_libdir/libasteriskssl13.so.1

%changelog
* Fri Jun 27 2014 Cronbuild Service <cronbuild@altlinux.org> 13-alt0.417459
- update from svn revision 417459

* Tue Jun 24 2014 Cronbuild Service <cronbuild@altlinux.org> 13-alt0.417180
- update from svn revision 417180

* Sat Jun 21 2014 Cronbuild Service <cronbuild@altlinux.org> 13-alt0.416990
- update from svn revision 416990

* Sat Jun 21 2014 Denis Smirnov <mithraen@altlinux.ru> 13-alt0.416888
- update from svn revision 416888

* Sat Jun 21 2014 Denis Smirnov <mithraen@altlinux.ru> 13-alt0.413542.1
- use pbx-astgenkey instead of included

* Fri May 09 2014 Cronbuild Service <cronbuild@altlinux.org> 13-alt0.413542
- update from svn revision 413542

* Sat May 03 2014 Cronbuild Service <cronbuild@altlinux.org> 13-alt0.413300
- update from svn revision 413300

* Tue Apr 29 2014 Cronbuild Service <cronbuild@altlinux.org> 13-alt0.413116
- update from svn revision 413116

* Sat Apr 26 2014 Cronbuild Service <cronbuild@altlinux.org> 13-alt0.413032
- update from svn revision 413032
...
* Fri Jan 10 2014 Cronbuild Service <cronbuild@altlinux.org> 13-alt0.405309
- update from svn revision 405309
...
* Wed Dec 04 2013 Cronbuild Service <cronbuild@altlinux.org> 13-alt0.403390
- update from svn revision 403390

* Sat Nov 30 2013 Cronbuild Service <cronbuild@altlinux.org> 13-alt0.403251
- update from svn revision 403251

* Wed Nov 27 2013 Cronbuild Service <cronbuild@altlinux.org> 13-alt0.403206
- update from svn revision 403206

* Sun Nov 24 2013 Cronbuild Service <cronbuild@altlinux.org> 13-alt0.403146
- update from svn revision 403146

* Fri Nov 22 2013 Cronbuild Service <cronbuild@altlinux.org> 13-alt0.403005
- update from svn revision 403005

* Sun Nov 17 2013 Cronbuild Service <cronbuild@altlinux.org> 13-alt0.402874
- update from svn revision 402874

* Thu Nov 14 2013 Cronbuild Service <cronbuild@altlinux.org> 13-alt0.402829
- update from svn revision 402829

* Mon Nov 11 2013 Cronbuild Service <cronbuild@altlinux.org> 13-alt0.402706
- update from svn revision 402706

* Fri Nov 08 2013 Cronbuild Service <cronbuild@altlinux.org> 13-alt0.402603
- update from svn revision 402603
...
* Sat Nov 02 2013 Denis Smirnov <mithraen@altlinux.ru> 13-alt0.402439
- update from svn revision 402439
