...
Name: asterisk-core-sounds-en_AU-siren14
...
BuildArch: noarch
Obsoletes: asterisk-sounds-en_AU-siren14 < %version-%release 
Conflicts: asterisk-sounds-en_AU-siren14 
...
%install
ast-install-core-sounds en_AU siren14 %buildroot
%files -f sounds.list
