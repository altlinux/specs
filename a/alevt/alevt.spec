...
VCS: https://gitlab.com/alevt/alevt

Source: %name-%version.tar
Source1: alevt.desktop

Patch0: alevt-1.8.3-pixmap.patch
Patch1: alevt-1.8.3-manpath.patch
...
%prep
%setup
subst 's|VER=1.8.2|VER=%version|' Makefile
%patch0 -p0
%patch1 -p0
%patch2 -p1 -b .double
%patch3 -p1 -b .zlib
...
make USR_X11R6=%prefix MAN=%_mandir rpm-install
...
%changelog
* Thu Jun 11 2026 Aleksandr Shamaraev <shad@altlinux.org> 1.8.3-alt1
- 1.8.1 -> 1.8.3
- spec cleanup
- drop alevt-c99.patch
