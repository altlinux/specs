...
Name: asterisk-core-sounds-fr-sln16
...
BuildArch: noarch
Obsoletes: asterisk-sounds-fr-sln16 < %version-%release 
Conflicts: asterisk-sounds-fr-sln16 
...
%install
ast-install-core-sounds fr sln16 %buildroot
%files -f sounds.list
