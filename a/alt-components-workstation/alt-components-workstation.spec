...
%_alterator_datadir/components/categories/clients/
%_alterator_datadir/components/categories/group-policies/
%_alterator_datadir/components/categories/multimedia/
%_alterator_datadir/components/categories/networking/
%_alterator_datadir/components/categories/office/
%_alterator_datadir/components/categories/other/
%_alterator_datadir/components/categories/third-party/
