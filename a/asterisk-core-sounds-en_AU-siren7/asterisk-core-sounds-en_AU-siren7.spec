...
Name: asterisk-core-sounds-en_AU-siren7
...
BuildArch: noarch
Obsoletes: asterisk-sounds-en_AU-siren7 < %version-%release 
Conflicts: asterisk-sounds-en_AU-siren7 
...
%install
ast-install-core-sounds en_AU siren7 %buildroot
%files -f sounds.list
