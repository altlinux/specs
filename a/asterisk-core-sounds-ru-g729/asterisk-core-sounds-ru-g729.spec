...
Name: asterisk-core-sounds-ru-g729
...
BuildArch: noarch
Obsoletes: asterisk-sounds-ru-g729 < %version-%release 
Conflicts: asterisk-sounds-ru-g729 
...
%install
ast-install-core-sounds ru g729 %buildroot
%files -f sounds.list
