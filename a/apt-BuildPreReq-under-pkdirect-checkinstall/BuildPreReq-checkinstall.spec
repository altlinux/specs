...
Name: %(sed -Ee 's/(-checkinstall|)$/-checkinstall/' <<<'apt-BuildPreReq-under-pkdirect-checkinstall')
Version: 1
Release: alt2
...
%global other_pkg %(sed -Ee 's/BuildPreReq-//' <<<'apt-BuildPreReq-under-pkdirect-checkinstall')
