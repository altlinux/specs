...
Name: asterisk-core-sounds-en-siren14
...
BuildArch: noarch
Obsoletes: asterisk-sounds-en-siren14 < %version-%release 
Conflicts: asterisk-sounds-en-siren14 
...
%install
ast-install-core-sounds en siren14 %buildroot
%files -f sounds.list
