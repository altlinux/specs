...
* Mon Oct 10 2011 Michael Shigorin <mike@altlinux.org> 2.8.6-alt1.1
- NMU: rebuilt against current libwv

* Tue Jul 20 2010 Damir Shayhutdinov <damir@altlinux.ru> 2.8.6-alt1
- Updated to 2.8.6
  + Improve OpenDocument filter
  + Some bugfixes
  + Add explicit Conflicts with abiword-light

* Sun Apr 18 2010 Damir Shayhutdinov <damir@altlinux.ru> 2.8.4-alt1
- Updated to 2.8.4
