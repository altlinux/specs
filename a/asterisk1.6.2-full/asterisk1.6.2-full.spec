Name: asterisk1.6.2-full
Summary: Asterisk 1.6.2 -- full package
BuildArch: noarch
Version: 4.0.1
Release: alt1
License: GPL
...
Requires: asterisk1.6.2-sources

# builded from asterisk SRPM
# All this packages requires one asterisk version
Requires: asterisk1.6.2-complete

Requires: asterisk1.6.2-chan_ss7
Requires: asterisk1.6.2-app_konference
Requires: asterisk1.6.2-addons
Requires: asterisk1.6.2-chan_datacard
