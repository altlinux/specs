...
Name: asterisk-core-sounds-es-sln16
...
BuildArch: noarch
Obsoletes: asterisk-sounds-es-sln16 < %version-%release 
Conflicts: asterisk-sounds-es-sln16 
...
%install
ast-install-core-sounds es sln16 %buildroot
%files -f sounds.list
