...
* Thu Jul 16 2026 Ajrat Makhmutov <rauty@altlinux.org> 2.9.186-alt1
- alterator-kopidel: update template and russian translation.
...
* Sun Apr 05 2026 Andrey Cherepanov <cas@altlinux.org> 2.9.183-alt1
- alterator-auth: updated supported domain types.
...
* Mon Feb 16 2026 Anton Midyukov <antohami@altlinux.org> 2.9.179-alt1
- alterator-users: restore commented strings of russian translations.

* Sat Feb 14 2026 Sergey Konev <darisishe@altlinux.org> 2.9.178-alt1
- alterator-net-ng: initial translation.

* Fri Feb 13 2026 Anton Midyukov <antohami@altlinux.org> 2.9.177-alt1
- alterator-officer: initial translation.

* Tue Dec 23 2025 Anton Midyukov <antohami@altlinux.org> 2.9.176-alt1
- help/ru_RU/users.html: update.
...
* Thu Aug 28 2025 Ajrat Makhmutov <rauty@altlinux.org> 2.9.167-alt1
...
* Tue Aug 12 2025 Ajrat Makhmutov <rauty@altlinux.org> 2.9.164-alt1
- alterator-kopidel: new translations from 1.0.0

* Sun Aug 10 2025 Kirill Sharov <sheriffkorov@altlinux.org> 2.9.163-alt1
- alterator-editions: add Russian translation
...
* Tue Apr 08 2025 Sergey Konev <darisishe@altlinux.org> 2.9.158-alt1
- alterator-blivet: update translations and help

* Thu Apr 03 2025 Ajrat Makhmutov <rauty@altlinux.org> 2.9.157-alt1
- alterator-kopidel: new translations from 0.1.0

* Fri Mar 28 2025 Andrey Cherepanov <cas@altlinux.org> 2.9.156-alt1
- alterator-sslkey: update translations

* Fri Mar 07 2025 Andrey Cherepanov <cas@altlinux.org> 2.9.155-alt1
- ru/alterator-mirror: return manually translated messages
...
* Wed Nov 06 2024 Oleg Solovyov <mcpain@altlinux.org> 2.9.147-alt1
- alterator-vm: new translations from EVMS (Closes: #51903)
...
* Wed Nov 08 2023 Elena Mishina <lepata@altlinux.org> 2.9.137-alt4
- installer-alterator-remount-destination: add en help
- alterator-net-domain: update help
