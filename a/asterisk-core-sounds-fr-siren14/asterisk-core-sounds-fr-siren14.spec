...
Name: asterisk-core-sounds-fr-siren14
...
BuildArch: noarch
Obsoletes: asterisk-sounds-fr-siren14 < %version-%release 
Conflicts: asterisk-sounds-fr-siren14 
...
%install
ast-install-core-sounds fr siren14 %buildroot
%files -f sounds.list
