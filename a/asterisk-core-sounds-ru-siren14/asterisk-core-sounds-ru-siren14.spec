...
Name: asterisk-core-sounds-ru-siren14
...
BuildArch: noarch
Obsoletes: asterisk-sounds-ru-siren14 < %version-%release 
Conflicts: asterisk-sounds-ru-siren14 
...
%install
ast-install-core-sounds ru siren14 %buildroot
%files -f sounds.list
