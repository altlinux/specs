...
%define obsolete_list altlinux-4.0 altlinux-release altlinux-release-desktop altlinux-release-junior altlinux-release-master altlinux-release-server altlinux-release-terminal fedora-release redhat-release
%endif

Name: altlinux-release-office-server
Version: %timestamp
Release: alt1
...
%changelog
* Fri Apr 25 2008 Grigory Batalov <bga@altlinux.ru> %timestamp-alt1
