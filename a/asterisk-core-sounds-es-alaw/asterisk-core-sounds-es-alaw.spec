...
Name: asterisk-core-sounds-es-alaw
...
BuildArch: noarch
Obsoletes: asterisk-sounds-es-alaw < %version-%release 
Conflicts: asterisk-sounds-es-alaw 
...
%install
ast-install-core-sounds es alaw %buildroot
%files -f sounds.list
