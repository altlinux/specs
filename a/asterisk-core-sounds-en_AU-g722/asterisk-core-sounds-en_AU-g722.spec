...
Name: asterisk-core-sounds-en_AU-g722
...
BuildArch: noarch
Obsoletes: asterisk-sounds-en_AU-g722 < %version-%release 
Conflicts: asterisk-sounds-en_AU-g722 
...
%install
ast-install-core-sounds en_AU g722 %buildroot
%files -f sounds.list
