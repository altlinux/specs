...
Name: asterisk-core-sounds-en_AU-gsm
...
BuildArch: noarch
Obsoletes: asterisk-sounds-en_AU-gsm < %version-%release 
Conflicts: asterisk-sounds-en_AU-gsm 
...
%install
ast-install-core-sounds en_AU gsm %buildroot
%files -f sounds.list
