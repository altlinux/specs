...
Name: asterisk-core-sounds-en_AU-g729
...
BuildArch: noarch
Obsoletes: asterisk-sounds-en_AU-g729 < %version-%release 
Conflicts: asterisk-sounds-en_AU-g729 
...
%install
ast-install-core-sounds en_AU g729 %buildroot
%files -f sounds.list
