...
Name: asterisk-core-sounds-en-sln16
...
BuildArch: noarch
Obsoletes: asterisk-sounds-en-sln16 < %version-%release 
Conflicts: asterisk-sounds-en-sln16 
...
%install
ast-install-core-sounds en sln16 %buildroot
%files -f sounds.list
