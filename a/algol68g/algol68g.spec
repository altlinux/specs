...
%changelog
* Sat Feb 07 2026 Andrey Bergman <vkni@altlinux.org> 3.10.10-alt1
- Version update

* Mon Jan 26 2026 Andrey Bergman <vkni@altlinux.org> 3.10.9-alt1
- Version update

* Sat Dec 13 2025 Andrey Bergman <vkni@altlinux.org> 3.10.8-alt1
- Version update

* Tue Nov 25 2025 Andrey Bergman <vkni@altlinux.org> 3.10.7-alt1
- Version update

* Tue Oct 14 2025 Andrey Bergman <vkni@altlinux.org> 3.10.3-alt1
- Version update

* Mon Sep 15 2025 Andrey Bergman <vkni@altlinux.org> 3.9.5-alt1
- Version update

* Mon Sep 01 2025 Andrey Bergman <vkni@altlinux.org> 3.8.5-alt1
- Version update

* Wed Aug 13 2025 Andrey Bergman <vkni@altlinux.org> 3.7.7-alt1
- Version update

* Sat Mar 22 2025 Andrey Bergman <vkni@altlinux.org> 3.5.14-alt1
- Version update

* Tue Feb 04 2025 Andrey Bergman <vkni@altlinux.org> 3.5.12-alt1
- Version update

* Sun Jan 05 2025 Andrey Bergman <vkni@altlinux.org> 3.5.11-alt1
- Version update

* Mon Oct 14 2024 Andrey Bergman <vkni@altlinux.org> 3.5.8-alt1
- Version update
...
* Wed Jun 05 2024 Andrey Bergman <vkni@altlinux.org> 3.5.2-alt1
- Version update

* Mon Feb 19 2024 Andrey Bergman <vkni@altlinux.org> 3.5.0-alt1
- Version update

* Tue Oct 31 2023 Andrey Bergman <vkni@altlinux.org> 3.4.4-alt1
- Version update

* Sun Sep 24 2023 Andrey Bergman <vkni@altlinux.org> 3.3.24-alt1
- Version update

* Mon Sep 11 2023 Andrey Bergman <vkni@altlinux.org> 3.3.16-alt1
- Version update

* Sun Aug 27 2023 Andrey Bergman <vkni@altlinux.org> 3.3.5-alt1
- Version update

* Wed Aug 16 2023 Andrey Bergman <vkni@altlinux.org> 3.3.0-alt1
- Version update

* Fri Jul 28 2023 Andrey Bergman <vkni@altlinux.org> 3.2.1-alt1
- Version update

* Mon Jul 10 2023 Andrey Bergman <vkni@altlinux.org> 3.2.0-alt1
- Version update
