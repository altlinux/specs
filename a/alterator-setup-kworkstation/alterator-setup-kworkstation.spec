...
%changelog
* Tue Mar 04 2025 Sergey V Turchin <zerg@altlinux.org> 0.0.8-alt1
- fix minimum user UID

* Fri Nov 01 2024 Dmitrii Fomchenkov <sirius@altlinux.org> 0.0.7-alt1
- fix the path to the step icon
